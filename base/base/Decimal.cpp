...
template <typename T>
const Decimal<T>& Decimal<T>::operator+=(const T& x) {
  value += x;
  return *this;
}
template <typename T>
...
template <typename T>
void NO_SANITIZE_UNDEFINED Decimal<T>::addOverflow(const T& x) {
  value += x;
}
...
template <typename T>
template <typename U>
const Decimal<T>& Decimal<T>::operator+=(const Decimal<U>& x) {
  value += static_cast<T>(x.value);
  return *this;
}
template <typename T>
template <typename U>
