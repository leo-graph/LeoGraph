...
inline int memcmpSmallAllowOverflow15(const Char *a, size_t a_size, const Char *b, size_t b_size) {
  ...
  for (size_t offset = 0; offset < min_size; offset += 16) {
    uint16_t mask = _mm_cmp_epi8_mask(_mm_loadu_si128(reinterpret_cast<const __m128i *>(a + offset)),
...
inline int memcmp16(const Char *a, const Char *b) {
  uint16_t mask = _mm_cmp_epi8_mask(_mm_loadu_si128(reinterpret_cast<const __m128i *>(a)),
...
inline int memcmpSmallAllowOverflow15(const Char *a, size_t a_size, const Char *b, size_t b_size) {
  ...
  for (size_t offset = 0; offset < min_size; offset += 16) {
    uint16_t mask = static_cast<uint16_t>(_mm_movemask_epi8(_mm_cmpeq_epi8(
        _mm_loadu_si128(reinterpret_cast<const __m128i *>(a + offset)), _mm_loadu_si128(reinterpret_cast<const __m128i *>(b + offset)))));
...
inline int memcmpSmallLikeZeroPaddedAllowOverflow15(const Char *a, size_t a_size, const Char *b, size_t b_size) {
  ...
  for (size_t offset = min_size; offset < max_size; offset += 16) {
    uint16_t mask = static_cast<uint16_t>(
        _mm_movemask_epi8(_mm_cmpeq_epi8(_mm_loadu_si128(reinterpret_cast<const __m128i *>(longest + offset)), zero16)));
    mask = static_cast<uint16_t>(~mask);
 ...
 */
inline bool memequal16(const void *a, const void *b) {
  return 0xFFFF == _mm_movemask_epi8(_mm_cmpeq_epi8(_mm_loadu_si128(reinterpret_cast<const __m128i *>(a)),
...
inline int memcmpSmallAllowOverflow15(const Char *a, size_t a_size, const Char *b, size_t b_size) {
  ...
  for (size_t offset = 0; offset < min_size; offset += 16) {
    uint64_t mask = getNibbleMask(vceqq_u8(vld1q_u8(reinterpret_cast<const unsigned char *>(a + offset)),
                                           vld1q_u8(reinterpret_cast<const unsigned char *>(b + offset))));
    mask = ~mask;
...
inline int memcmp16(const Char *a, const Char *b) {
  uint64_t mask =
      getNibbleMask(vceqq_u8(vld1q_u8(reinterpret_cast<const unsigned char *>(a)), vld1q_u8(reinterpret_cast<const unsigned char *>(b))));
  mask = ~mask;
  if (mask) {
...
inline bool memequal16(const void *a, const void *b) {
  return 0xFFFFFFFFFFFFFFFFull == getNibbleMask(vceqq_u8(vld1q_u8(reinterpret_cast<const unsigned char *>(a)),
                                                         vld1q_u8(reinterpret_cast<const unsigned char *>(b))));
}
...
inline int memcmpSmallLikeZeroPaddedAllowOverflow15(const Char *a, size_t a_size, const Char *b, size_t b_size) {
  ...
  if (auto res = memcmp(a, b, min_size)) return res;

  for (size_t i = min_size; i < max_size; ++i)
    if (longest[i] != 0) return size_cmp;
...
inline bool memequal16(const void *a, const void *b) { return 0 == memcmp(a, b, 16); }
