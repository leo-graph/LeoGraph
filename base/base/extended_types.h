...
template <typename T>
concept is_integer = std::is_integral_v<T> || std::is_same_v<T, Int128> || std::is_same_v<T, UInt128> || std::is_same_v<T, Int256> ||
...
template <typename T>
concept is_floating_point = std::is_floating_point_v<T> || std::is_same_v<T, BFloat16>;
