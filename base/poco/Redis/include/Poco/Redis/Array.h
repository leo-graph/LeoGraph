...
inline Array &Array::operator<<(const std::vector<std::string> &strings) { return add(strings); }
...
inline Array &Array::addSimpleString(const std::string &value) { return addRedisType(new Type<std::string>(value)); }

inline Array::const_iterator Array::begin() const { return _elements.value().begin(); }
...
inline Array::const_iterator Array::end() const { return _elements.value().end(); }

inline bool Array::isNull() const { return _elements.isNull(); }
...
inline size_t Array::size() const { return _elements.value().size(); }
