...
inline Net::SocketAddress Client::address() const { return _address; }
...
inline void Client::setReceiveTimeout(const Timespan &timeout) { _socket.setReceiveTimeout(timeout); }
