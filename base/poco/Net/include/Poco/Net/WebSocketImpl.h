...
/// to the WebSocket protocol described in RFC 6455.
{
 ...
 protected:
  enum { FRAME_FLAG_MASK = 0x80, MAX_HEADER_LENGTH = 14 };
...
// inlines
//
inline int WebSocketImpl::frameFlags() const { return _frameFlags; }

inline bool WebSocketImpl::mustMaskPayload() const { return _mustMaskPayload; }

inline int WebSocketImpl::getMaxPayloadSize() const { return _maxPayloadSize; }
