...
class Net_API SocketOutputStream : public SocketIOS,
                                   public std::ostream
...
class Net_API SocketInputStream : public SocketIOS,
                                  public std::istream
...
class Net_API SocketStream : public SocketIOS,
                             public std::iostream
...
// inlines
//
inline StreamSocketImpl* SocketStreamBuf::socketImpl() const { return _pImpl; }
