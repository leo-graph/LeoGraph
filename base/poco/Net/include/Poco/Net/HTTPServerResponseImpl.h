...
// inlines
//
inline bool HTTPServerResponseImpl::sent() const { return _pStream != 0; }

inline void HTTPServerResponseImpl::attachRequest(HTTPServerRequestImpl *pRequest) { _pRequest = pRequest; }
