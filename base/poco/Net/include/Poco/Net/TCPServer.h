...
/// Already served connections, however, will continue being served.
{
 public:
  ...
  TCPServer(TCPServerConnectionFactory::Ptr pFactory, Poco::ThreadPool &threadPool, const ServerSocket &socket,
...
// inlines
//
inline const ServerSocket &TCPServer::socket() const { return _socket; }

inline Poco::UInt16 TCPServer::port() const { return _socket.address().port(); }

inline TCPServerConnectionFilter::Ptr TCPServer::getConnectionFilter() const { return _pConnectionFilter; }
