...
HTTPBasicCredentials::HTTPBasicCredentials(const std::string& authInfo) { parseAuthInfo(authInfo); }
...
void HTTPBasicCredentials::setUsername(const std::string& username) { _username = username; }

void HTTPBasicCredentials::setPassword(const std::string& password) { _password = password; }
