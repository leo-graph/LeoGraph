...
HTTPSessionInstantiator::HTTPSessionInstantiator() : _proxyPort(0) {}
...
void HTTPSessionInstantiator::unregisterInstantiator() { HTTPSessionFactory::defaultFactory().unregisterProtocol("http"); }
