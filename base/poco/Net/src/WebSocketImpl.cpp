...
void WebSocketImpl::connect(const SocketAddress& address) { throw Poco::InvalidAccessException("Cannot connect() a WebSocketImpl"); }
...
void WebSocketImpl::connectNB(const SocketAddress& address) { throw Poco::InvalidAccessException("Cannot connectNB() a WebSocketImpl"); }
...
void WebSocketImpl::listen(int backlog) { throw Poco::InvalidAccessException("Cannot listen() on a WebSocketImpl"); }
...
void WebSocketImpl::shutdownReceive() { _pStreamSocketImpl->shutdownReceive(); }

void WebSocketImpl::shutdownSend() { _pStreamSocketImpl->shutdownSend(); }

void WebSocketImpl::shutdown() { _pStreamSocketImpl->shutdown(); }
...
void WebSocketImpl::sendUrgent(unsigned char data) { throw Poco::InvalidAccessException("Cannot sendUrgent() on a WebSocketImpl"); }

bool WebSocketImpl::secure() const { return _pStreamSocketImpl->secure(); }

void WebSocketImpl::setSendTimeout(const Poco::Timespan& timeout) { _pStreamSocketImpl->setSendTimeout(timeout); }

Poco::Timespan WebSocketImpl::getSendTimeout() { return _pStreamSocketImpl->getSendTimeout(); }

void WebSocketImpl::setReceiveTimeout(const Poco::Timespan& timeout) { _pStreamSocketImpl->setReceiveTimeout(timeout); }

Poco::Timespan WebSocketImpl::getReceiveTimeout() { return _pStreamSocketImpl->getReceiveTimeout(); }

void WebSocketImpl::setSendThrottler(const Poco::Net::ThrottlerPtr& throttler) { _pStreamSocketImpl->setSendThrottler(throttler); }

Poco::Net::ThrottlerPtr WebSocketImpl::getSendThrottler() const { return _pStreamSocketImpl->getSendThrottler(); }

void WebSocketImpl::setReceiveThrottler(const Poco::Net::ThrottlerPtr& throttler) { _pStreamSocketImpl->setReceiveThrottler(throttler); }

Poco::Net::ThrottlerPtr WebSocketImpl::getReceiveThrottler() const { return _pStreamSocketImpl->getReceiveThrottler(); }
