...
enum { punycode_success = 0, punycode_overflow = -1, punycode_big_output = -2, punycode_bad_input = -3 };
...
HostEntry DNS::thisHost() { return hostByName(hostName()); }
...
int DNS::lastError() { return h_errno; }
...
static unsigned decode_digit(int cp) { return (unsigned)(cp - 48 < 10 ? cp - 22 : cp - 65 < 26 ? cp - 65 : cp - 97 < 26 ? cp - 97 : base); }
