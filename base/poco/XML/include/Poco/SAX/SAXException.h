...
/// Since this exception is a subclass of SAXException, it inherits the ability to wrap another exception.
{
 ...
 protected:
  static std::string buildMessage(const std::string& msg, const XMLString& publicId, const XMLString& systemId, int lineNumber,
                                  int columnNumber);
...
// inlines
//
inline const XMLString& SAXParseException::getPublicId() const { return _publicId; }

inline const XMLString& SAXParseException::getSystemId() const { return _systemId; }

inline int SAXParseException::getLineNumber() const { return _lineNumber; }

inline int SAXParseException::getColumnNumber() const { return _columnNumber; }
