...
/// attribute values.
{
 ...
 protected:
  Attr(Document *pOwnerDocument, Element *pOwnerElement, const XMLString &namespaceURI, const XMLString &localName, const XMLString &qname,
       const XMLString &value, bool specified = true);
...
// inlines
//
inline const XMLString &Attr::name() const { return _name.qname(); }

inline const XMLString &Attr::value() const { return _value; }

inline const XMLString &Attr::getValue() const { return _value; }

inline bool Attr::specified() const { return _specified; }

inline Element *Attr::ownerElement() const { return static_cast<Element *>(_pParent); }
