...
class XML_API XMLWriter : public ContentHandler,
...
/// prefixes in the form ns1, ns2, etc.
{
 public:
  ...
  void dataElement(const XMLString& namespaceURI, const XMLString& localName, const XMLString& qname, const XMLString& data,
                   const XMLString& attr1 = XMLString(), const XMLString& value1 = XMLString(), const XMLString& attr2 = XMLString(),
                   const XMLString& value2 = XMLString(), const XMLString& attr3 = XMLString(), const XMLString& value3 = XMLString());
 ...
 protected:
  ...
  void writeCanonicalStartElement(const XMLString& namespaceURI, const XMLString& localName, const XMLString& qname,
...
// inlines
//
inline int XMLWriter::depth() const { return _depth; }
