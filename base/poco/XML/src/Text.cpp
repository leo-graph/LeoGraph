...
Text::Text(Document* pOwnerDocument, const Text& text) : CharacterData(pOwnerDocument, text) {}
...
const XMLString& Text::nodeName() const { return NODE_NAME; }

unsigned short Text::nodeType() const { return Node::TEXT_NODE; }

XMLString Text::innerText() const { return nodeValue(); }

Node* Text::copyNode(bool deep, Document* pOwnerDocument) const { return new Text(pOwnerDocument, *this); }
