...
DocumentFragment::DocumentFragment(Document* pOwnerDocument) : AbstractContainerNode(pOwnerDocument) {}
...
const XMLString& DocumentFragment::nodeName() const { return NODE_NAME; }

unsigned short DocumentFragment::nodeType() const { return Node::DOCUMENT_FRAGMENT_NODE; }
