...
DOMException::DOMException(unsigned short code) : XMLException(message(code)), _code(code) {}

DOMException::DOMException(const DOMException& exc) : XMLException(exc), _code(exc._code) {}
...
const char* DOMException::name() const noexcept { return "DOMException"; }

const char* DOMException::className() const noexcept { return typeid(*this).name(); }

Poco::Exception* DOMException::clone() const { return new DOMException(*this); }

void DOMException::rethrow() const { throw *this; }
