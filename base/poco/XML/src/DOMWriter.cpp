...
DOMWriter::DOMWriter() : _pTextEncoding(0), _options(0), _indent("\t") {}
...
void DOMWriter::setOptions(int options) { _options = options; }

void DOMWriter::setNewLine(const std::string& newLine) { _newLine = newLine; }

void DOMWriter::setIndent(const std::string& indent) { _indent = indent; }
