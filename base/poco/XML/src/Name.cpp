...
Name::Name(const XMLString& qname) : _qname(qname) {}

Name::Name(const XMLString& qname, const XMLString& namespaceURI)
    : _qname(qname), _namespaceURI(namespaceURI), _localName(localName(qname)) {}

Name::Name(const XMLString& qname, const XMLString& namespaceURI, const XMLString& localName)
    : _qname(qname), _namespaceURI(namespaceURI), _localName(localName) {}

Name::Name(const Name& name) : _qname(name._qname), _namespaceURI(name._namespaceURI), _localName(name._localName) {}

Name::Name(Name&& name) noexcept
    : _qname(std::move(name._qname)), _namespaceURI(std::move(name._namespaceURI)), _localName(std::move(name._localName)) {}
...
XMLString Name::prefix() const { return prefix(_qname); }
