...
void Event::stopPropagation() { _stopped = true; }

void Event::preventDefault() { _canceled = true; }
...
void Event::setTarget(EventTarget* pTarget) { _pTarget = pTarget; }

void Event::setCurrentPhase(PhaseType phase) { _currentPhase = phase; }

void Event::setCurrentTarget(EventTarget* pTarget) { _pCurrentTarget = pTarget; }

void Event::autoRelease() { _pOwner->autoReleasePool().add(this); }
