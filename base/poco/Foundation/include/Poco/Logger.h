...
///     poco_information_f2(logger, "An informational message with args: %d, %d", 1, 2);
{
 public:
  ...
  void fatal(const std::string &fmt, const Any &value1, const Any &value2, const Any &value3, const Any &value4, const Any &value5,
             const Any &value6, const Any &value7, const Any &value8, const Any &value9, const Any &value10);
...
// inlines
//
inline const std::string &Logger::name() const { return _name; }

inline int Logger::getLevel() const { return _level; }
...
inline void Logger::fatal(const std::string &msg) { log(msg, Message::PRIO_FATAL); }

inline void Logger::fatal(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_FATAL, file, line); }

inline void Logger::fatal(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_FATAL); }
...
inline void Logger::critical(const std::string &msg) { log(msg, Message::PRIO_CRITICAL); }

inline void Logger::critical(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_CRITICAL, file, line); }

inline void Logger::critical(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_CRITICAL); }
...
inline void Logger::error(const std::string &msg) { log(msg, Message::PRIO_ERROR); }

inline void Logger::error(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_ERROR, file, line); }

inline void Logger::error(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_ERROR); }
...
inline void Logger::warning(const std::string &msg) { log(msg, Message::PRIO_WARNING); }

inline void Logger::warning(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_WARNING, file, line); }

inline void Logger::warning(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_WARNING); }
...
inline void Logger::notice(const std::string &msg) { log(msg, Message::PRIO_NOTICE); }

inline void Logger::notice(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_NOTICE, file, line); }

inline void Logger::notice(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_NOTICE); }
...
inline void Logger::information(const std::string &msg) { log(msg, Message::PRIO_INFORMATION); }

inline void Logger::information(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_INFORMATION, file, line); }

inline void Logger::information(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_INFORMATION); }
...
inline void Logger::debug(const std::string &msg) { log(msg, Message::PRIO_DEBUG); }

inline void Logger::debug(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_DEBUG, file, line); }

inline void Logger::debug(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_DEBUG); }
...
inline void Logger::trace(const std::string &msg) { log(msg, Message::PRIO_TRACE); }

inline void Logger::trace(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_TRACE, file, line); }

inline void Logger::trace(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_TRACE); }
...
inline void Logger::test(const std::string &msg) { log(msg, Message::PRIO_TEST); }

inline void Logger::test(const std::string &msg, const char *file, int line) { log(msg, Message::PRIO_TEST, file, line); }

inline void Logger::test(const std::string &fmt, const Any &value1) { log(Poco::format(fmt, value1), Message::PRIO_TEST); }
...
inline bool Logger::is(int level) const { return _level >= level; }

inline bool Logger::fatal() const { return _level >= Message::PRIO_FATAL; }

inline bool Logger::critical() const { return _level >= Message::PRIO_CRITICAL; }

inline bool Logger::error() const { return _level >= Message::PRIO_ERROR; }

inline bool Logger::warning() const { return _level >= Message::PRIO_WARNING; }

inline bool Logger::notice() const { return _level >= Message::PRIO_NOTICE; }

inline bool Logger::information() const { return _level >= Message::PRIO_INFORMATION; }

inline bool Logger::debug() const { return _level >= Message::PRIO_DEBUG; }

inline bool Logger::trace() const { return _level >= Message::PRIO_TRACE; }

inline bool Logger::test() const { return _level >= Message::PRIO_TEST; }
