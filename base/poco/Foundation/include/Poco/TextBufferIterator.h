...
// inlines
//
inline bool TextBufferIterator::operator==(const TextBufferIterator& it) const { return _it == it._it; }

inline bool TextBufferIterator::operator!=(const TextBufferIterator& it) const { return _it != it._it; }

inline void swap(TextBufferIterator& it1, TextBufferIterator& it2) { it1.swap(it2); }

inline TextBufferIterator TextBufferIterator::end() const { return TextBufferIterator(_end); }
