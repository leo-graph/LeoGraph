...
class Foundation_API LogStream : public LogIOS,
                                 public std::ostream
...
// inlines
//
inline Message::Priority LogStreamBuf::getPriority() const { return _priority; }

inline Logger& LogStreamBuf::logger() const { return _logger; }
