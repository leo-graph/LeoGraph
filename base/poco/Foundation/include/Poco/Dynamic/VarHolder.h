...
/// throw BadCastException.
{
 ...
 protected:
  ...
  /// If upper limit is within the target data type limits, the conversion is performed.
  {
    ...
    if (from < 0) throw RangeException("Value too small.");
    checkUpperLimit<F, T>(from);
    to = static_cast<T>(from);
  }
 ...
 private:
  ...
  void checkUpperLimitFloat(const F &from) const {
    if (from > std::numeric_limits<T>::max()) throw RangeException("Value too large.");
  }

  template <typename F, typename T>
  void checkLowerLimitFloat(const F &from) const {
    if (from < -std::numeric_limits<T>::max()) throw RangeException("Value too small.");
  }

  template <typename F, typename T>
  void checkLowerLimit(const F &from) const {
    if (from < std::numeric_limits<T>::min()) throw RangeException("Value too small.");
  }
};
...
inline void VarHolder::convert(Int8 & /*val*/) const { throw BadCastException("Can not convert to Int8"); }

inline void VarHolder::convert(Int16 & /*val*/) const { throw BadCastException("Can not convert to Int16"); }

inline void VarHolder::convert(Int32 & /*val*/) const { throw BadCastException("Can not convert to Int32"); }

inline void VarHolder::convert(Int64 & /*val*/) const { throw BadCastException("Can not convert to Int64"); }

inline void VarHolder::convert(UInt8 & /*val*/) const { throw BadCastException("Can not convert to UInt8"); }

inline void VarHolder::convert(UInt16 & /*val*/) const { throw BadCastException("Can not convert to UInt16"); }

inline void VarHolder::convert(UInt32 & /*val*/) const { throw BadCastException("Can not convert to UInt32"); }

inline void VarHolder::convert(UInt64 & /*val*/) const { throw BadCastException("Can not convert to UInt64"); }

inline void VarHolder::convert(DateTime & /*val*/) const { throw BadCastException("Can not convert to DateTime"); }

inline void VarHolder::convert(LocalDateTime & /*val*/) const { throw BadCastException("Can not convert to LocalDateTime"); }

inline void VarHolder::convert(Timestamp & /*val*/) const { throw BadCastException("Can not convert to Timestamp"); }
...
inline void VarHolder::convert(long long & /*val*/) const { throw BadCastException("Can not convert to long long"); }

inline void VarHolder::convert(unsigned long long & /*val*/) const { throw BadCastException("Can not convert to unsigned long long"); }

#endif

inline void VarHolder::convert(bool & /*val*/) const { throw BadCastException("Can not convert to bool"); }

inline void VarHolder::convert(float & /*val*/) const { throw BadCastException("Can not convert to float"); }

inline void VarHolder::convert(double & /*val*/) const { throw BadCastException("Can not convert to double"); }

inline void VarHolder::convert(char & /*val*/) const { throw BadCastException("Can not convert to char"); }

inline void VarHolder::convert(std::string & /*val*/) const { throw BadCastException("Can not convert to std::string"); }

inline void VarHolder::convert(Poco::UTF16String & /*val*/) const { throw BadCastException("Can not convert to Poco::UTF16String"); }

inline bool VarHolder::isArray() const { return true; }

inline bool VarHolder::isVector() const { return false; }

inline bool VarHolder::isList() const { return false; }

inline bool VarHolder::isDeque() const { return false; }

inline bool VarHolder::isStruct() const { return false; }

inline bool VarHolder::isInteger() const { return false; }

inline bool VarHolder::isSigned() const { return false; }

inline bool VarHolder::isNumeric() const { return false; }

inline bool VarHolder::isBoolean() const { return false; }

inline bool VarHolder::isString() const { return false; }

inline bool VarHolder::isDate() const { return false; }

inline bool VarHolder::isTime() const { return false; }

inline bool VarHolder::isDateTime() const { return false; }

inline std::size_t VarHolder::size() const { return 1u; }
...
class VarHolderImpl<Int8> : public VarHolder {
 public:
  ...
  void convert(char &val) const { val = static_cast<char>(_val); }
  ...
  const Int8 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<Int8>::is_integer; }

  bool isSigned() const { return std::numeric_limits<Int8>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<Int8>::is_specialized; }
...
class VarHolderImpl<Int16> : public VarHolder {
 public:
  ...
  const Int16 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<Int16>::is_integer; }

  bool isSigned() const { return std::numeric_limits<Int16>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<Int16>::is_specialized; }
...
class VarHolderImpl<Int32> : public VarHolder {
 public:
  ...
  const Int32 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<Int32>::is_integer; }

  bool isSigned() const { return std::numeric_limits<Int32>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<Int32>::is_specialized; }
...
class VarHolderImpl<Int64> : public VarHolder {
 public:
  ...
  void convert(DateTime &dt) const { dt = Timestamp(_val); }

  void convert(LocalDateTime &ldt) const { ldt = Timestamp(_val); }

  void convert(Timestamp &val) const { val = Timestamp(_val); }

  VarHolder *clone(Placeholder<VarHolder> *pVarHolder = 0) const { return cloneHolder(pVarHolder, _val); }

  const Int64 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<Int64>::is_integer; }

  bool isSigned() const { return std::numeric_limits<Int64>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<Int64>::is_specialized; }
...
class VarHolderImpl<UInt8> : public VarHolder {
 public:
  ...
  void convert(long long &val) const { val = static_cast<long long>(_val); }
  ...
  const UInt8 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<UInt8>::is_integer; }

  bool isSigned() const { return std::numeric_limits<UInt8>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<UInt8>::is_specialized; }
...
class VarHolderImpl<UInt16> : public VarHolder {
 public:
  ...
  const UInt16 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<UInt16>::is_integer; }

  bool isSigned() const { return std::numeric_limits<UInt16>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<UInt16>::is_specialized; }
...
class VarHolderImpl<UInt32> : public VarHolder {
 public:
  ...
  const UInt32 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<UInt32>::is_integer; }

  bool isSigned() const { return std::numeric_limits<UInt32>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<UInt32>::is_specialized; }
...
class VarHolderImpl<UInt64> : public VarHolder {
 public:
  ...
  const UInt64 &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<UInt64>::is_integer; }

  bool isSigned() const { return std::numeric_limits<UInt64>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<UInt64>::is_specialized; }
...
class VarHolderImpl<bool> : public VarHolder {
 public:
  ...
  void convert(long long &val) const { val = static_cast<long long>(_val ? 1 : 0); }

  void convert(unsigned long long &val) const { val = static_cast<unsigned long long>(_val ? 1 : 0); }

#endif

  void convert(bool &val) const { val = _val; }

  void convert(float &val) const { val = (_val ? 1.0f : 0.0f); }

  void convert(double &val) const { val = (_val ? 1.0 : 0.0); }

  void convert(char &val) const { val = static_cast<char>(_val ? 1 : 0); }

  void convert(std::string &val) const { val = (_val ? "true" : "false"); }

  VarHolder *clone(Placeholder<VarHolder> *pVarHolder = 0) const { return cloneHolder(pVarHolder, _val); }

  const bool &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<bool>::is_integer; }

  bool isSigned() const { return std::numeric_limits<bool>::is_signed; }
...
class VarHolderImpl<float> : public VarHolder {
 public:
  ...
  void convert(long long &val) const { convertToSmaller(_val, val); }

  void convert(unsigned long long &val) const { convertSignedFloatToUnsigned(_val, val); }

#endif

  void convert(bool &val) const { val = !(_val <= std::numeric_limits<float>::min() && _val >= -1 * std::numeric_limits<float>::min()); }

  void convert(float &val) const { val = _val; }

  void convert(double &val) const { val = _val; }
  ...
  const float &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<float>::is_integer; }

  bool isSigned() const { return std::numeric_limits<float>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<float>::is_specialized; }
...
class VarHolderImpl<double> : public VarHolder {
 public:
  ...
  void convert(bool &val) const { val = !(_val <= std::numeric_limits<double>::min() && _val >= -1 * std::numeric_limits<double>::min()); }
  ...
  const double &value() const { return _val; }

  bool isArray() const { return false; }

  bool isStruct() const { return false; }

  bool isInteger() const { return std::numeric_limits<double>::is_integer; }

  bool isSigned() const { return std::numeric_limits<double>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<double>::is_specialized; }
...
class VarHolderImpl<char> : public VarHolder {
 public:
  ...
  void convert(unsigned long long &val) const { val = static_cast<unsigned long long>(_val); }
  ...
  void convert(char &val) const { val = _val; }

  void convert(std::string &val) const { val = std::string(1, _val); }
  ...
  bool isInteger() const { return std::numeric_limits<char>::is_integer; }

  bool isSigned() const { return std::numeric_limits<char>::is_signed; }

  bool isNumeric() const { return std::numeric_limits<char>::is_specialized; }
...
class VarHolderImpl<std::string> : public VarHolder {
 public:
  ...
  void convert(long long &val) const { val = NumberParser::parse64(_val); }

  void convert(unsigned long long &val) const { val = NumberParser::parseUnsigned64(_val); }
  ...
  void convert(double &val) const { val = NumberParser::parseFloat(_val); }
  ...
  void convert(std::string &val) const { val = _val; }

  void convert(Poco::UTF16String &val) const { Poco::UnicodeConverter::convert(_val, val); }

  void convert(DateTime &val) const {
    int tzd = 0;
    if (!DateTimeParser::tryParse(DateTimeFormat::ISO8601_FORMAT, _val, val, tzd)) throw BadCastException("string -> DateTime");
  }

  void convert(LocalDateTime &ldt) const {
    int tzd = 0;
    DateTime tmp;
    if (!DateTimeParser::tryParse(DateTimeFormat::ISO8601_FORMAT, _val, tmp, tzd)) throw BadCastException("string -> LocalDateTime");
  ...
  void convert(Timestamp &ts) const {
    int tzd = 0;
    DateTime tmp;
    if (!DateTimeParser::tryParse(DateTimeFormat::ISO8601_FORMAT, _val, tmp, tzd)) throw BadCastException("string -> Timestamp");
  ...
  std::size_t size() const { return _val.length(); }
...
class VarHolderImpl<UTF16String> : public VarHolder {
 public:
  ...
  void convert(long long &val) const { val = NumberParser::parse64(toStdString()); }

  void convert(unsigned long long &val) const { val = NumberParser::parseUnsigned64(toStdString()); }
  ...
  void convert(double &val) const { val = NumberParser::parseFloat(toStdString()); }
  ...
  void convert(Poco::UTF16String &val) const { val = _val; }

  void convert(std::string &val) const { UnicodeConverter::convert(_val, val); }

  void convert(DateTime &val) const {
    int tzd = 0;
    if (!DateTimeParser::tryParse(DateTimeFormat::ISO8601_FORMAT, toStdString(), val, tzd)) throw BadCastException("string -> DateTime");
  }
  ...
  void convert(Timestamp &ts) const {
    int tzd = 0;
    DateTime tmp;
    if (!DateTimeParser::tryParse(DateTimeFormat::ISO8601_FORMAT, toStdString(), tmp, tzd)) throw BadCastException("string -> Timestamp");
  ...
  const Poco::UTF16String &value() const { return _val; }
...
class VarHolderImpl<std::list<T>> : public VarHolder {
 public:
  ...
  T &operator[](typename std::list<T>::size_type n) {
    if (n >= size()) throw RangeException("List index out of range");
...
class VarHolderImpl<DateTime> : public VarHolder {
 public:
  ...
  void convert(long long &val) const { val = _val.timestamp().epochMicroseconds(); }

  void convert(unsigned long long &val) const { val = _val.timestamp().epochMicroseconds(); }

#endif

  void convert(std::string &val) const { val = DateTimeFormatter::format(_val, Poco::DateTimeFormat::ISO8601_FORMAT); }

  void convert(DateTime &val) const { val = _val; }

  void convert(LocalDateTime &ldt) const { ldt = _val.timestamp(); }

  void convert(Timestamp &ts) const { ts = _val.timestamp(); }

  VarHolder *clone(Placeholder<VarHolder> *pVarHolder = 0) const { return cloneHolder(pVarHolder, _val); }

  const DateTime &value() const { return _val; }
  ...
  bool isDateTime() const { return true; }
...
class VarHolderImpl<LocalDateTime> : public VarHolder {
 public:
  ...
  void convert(DateTime &val) const { val = _val.timestamp(); }

  void convert(LocalDateTime &ldt) const { ldt = _val; }

  void convert(Timestamp &ts) const { ts = _val.timestamp(); }

  VarHolder *clone(Placeholder<VarHolder> *pVarHolder = 0) const { return cloneHolder(pVarHolder, _val); }

  const LocalDateTime &value() const { return _val; }
...
class VarHolderImpl<Timestamp> : public VarHolder {
 public:
  ...
  void convert(long long &val) const { val = _val.epochMicroseconds(); }

  void convert(unsigned long long &val) const { val = _val.epochMicroseconds(); }
  ...
  void convert(Timestamp &ts) const { ts = _val; }

  VarHolder *clone(Placeholder<VarHolder> *pVarHolder = 0) const { return cloneHolder(pVarHolder, _val); }

  const Timestamp &value() const { return _val; }
