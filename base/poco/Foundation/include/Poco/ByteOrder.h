...
inline Int16 ByteOrder::flipBytes(Int16 value) { return Int16(flipBytes(UInt16(value))); }
...
inline Int32 ByteOrder::flipBytes(Int32 value) { return Int32(flipBytes(UInt32(value))); }
...
inline Int64 ByteOrder::flipBytes(Int64 value) { return Int64(flipBytes(UInt64(value))); }

//
// some macro trickery to automate the method implementation
//
#define POCO_IMPLEMENT_BYTEORDER_NOOP_(op, type) \
  inline type ByteOrder::op(type value) { return value; }
#define POCO_IMPLEMENT_BYTEORDER_FLIP_(op, type) \
  inline type ByteOrder::op(type value) { return flipBytes(value); }
