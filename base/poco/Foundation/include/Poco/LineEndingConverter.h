...
class Foundation_API InputLineEndingConverter : public LineEndingConverterIOS,
                                                public std::istream
...
class Foundation_API OutputLineEndingConverter : public LineEndingConverterIOS,
                                                 public std::ostream
