...
// inlines
//
inline Task* TaskNotification::task() const { return _pTask; }

inline const Exception& TaskFailedNotification::reason() const { return *_pException; }

inline float TaskProgressNotification::progress() const { return _progress; }
