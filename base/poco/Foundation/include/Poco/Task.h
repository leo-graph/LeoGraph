...
class Foundation_API Task : public Runnable,
...
{
 public:
  enum TaskState { TASK_IDLE, TASK_STARTING, TASK_RUNNING, TASK_CANCELLING, TASK_FINISHED };
...
// inlines
//
inline const std::string &Task::name() const { return _name; }
...
inline bool Task::isCancelled() const { return _state == TASK_CANCELLING; }

inline Task::TaskState Task::state() const { return _state; }
