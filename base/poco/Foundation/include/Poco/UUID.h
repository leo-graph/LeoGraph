...
// inlines
//
inline bool UUID::operator==(const UUID& uuid) const { return compare(uuid) == 0; }
...
inline UUID::Version UUID::version() const { return Version(_timeHiAndVersion >> 12); }

inline bool UUID::isNull() const { return compare(null()) == 0; }

inline void swap(UUID& u1, UUID& u2) { u1.swap(u2); }
