...
/// expiring of registrations to AbstractPriorityDelegate.
{
 public:
  ...
  ~PriorityExpire() { delete _pDelegate; }
  ...
  AbstractPriorityDelegate<TArgs> *clone() const { return new PriorityExpire(*this); }

  void disable() { _pDelegate->disable(); }

  const AbstractPriorityDelegate<TArgs> *unwrap() const { return this->_pDelegate; }
...
/// expiring of registrations to AbstractPriorityDelegate.
{
 public:
  ...
  AbstractPriorityDelegate<void> *clone() const { return new PriorityExpire(*this); }

  void disable() { _pDelegate->disable(); }

  const AbstractPriorityDelegate<void> *unwrap() const { return this->_pDelegate; }
