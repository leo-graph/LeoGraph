...
/// caused the message.
{
 public:
  ...
  Message(const std::string& source, const std::string& text, Priority prio, std::string&& file, int line, std::string_view fmt_str = {},
          const std::vector<std::string>& fmt_str_args = {});
  Message(std::string&& source, std::string&& text, Priority prio, std::string&& file, int line, std::string_view fmt_str,
...
// inlines
//
inline const std::string& Message::getSource() const { return _source; }

inline const std::string& Message::getText() const { return _text; }

inline Message::Priority Message::getPriority() const { return _prio; }

inline const Timestamp& Message::getTime() const { return _time; }

inline const std::string& Message::getThread() const { return _thread; }

inline long Message::getTid() const { return _tid; }

inline const std::string& Message::getSourceFile() const { return _file; }

inline int Message::getSourceLine() const { return _line; }

inline void swap(Message& m1, Message& m2) { m1.swap(m2); }
