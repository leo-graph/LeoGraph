...
{
 public:
  explicit ThreadPool(int minCapacity = 2, int maxCapacity = 16, int idleTime = 60, int stackSize = POCO_THREAD_STACK_SIZE,
                      size_t global_profiler_real_time_period_ns_ = 0, size_t global_profiler_cpu_time_period_ns_ = 0);
  ...
  explicit ThreadPool(const std::string &name, int minCapacity = 2, int maxCapacity = 16, int idleTime = 60,
                      int stackSize = POCO_THREAD_STACK_SIZE, size_t global_profiler_real_time_period_ns_ = 0,
...
// inlines
//
inline void ThreadPool::setStackSize(int stackSize) { _stackSize = stackSize; }

inline int ThreadPool::getStackSize() const { return _stackSize; }

inline const std::string &ThreadPool::name() const { return _name; }
