...
class MessageNotification : public Notification {
 public:
  MessageNotification(const Message& msg) : _msg(msg) {}
...
AsyncChannel::AsyncChannel(Channel* pChannel, Thread::Priority prio) : _pChannel(pChannel), _thread("AsyncChannel") {
...
Channel* AsyncChannel::getChannel() const { return _pChannel; }
