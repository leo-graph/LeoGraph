...
const char* ASCIIEncoding::_names[] = {"ASCII", NULL};
...
const char* ASCIIEncoding::canonicalName() const { return _names[0]; }
...
const TextEncoding::CharacterMap& ASCIIEncoding::characterMap() const { return _charMap; }

int ASCIIEncoding::convert(const unsigned char* bytes) const { return _charMap[*bytes]; }
...
int ASCIIEncoding::sequenceLength(const unsigned char* bytes, int length) const { return 1; }
