...
bool NumberParser::tryParse(const std::string& s, int& value, char thSep) { return strToInt(s.c_str(), value, NUM_BASE_DEC, thSep); }
...
bool NumberParser::tryParseOct(const std::string& s, unsigned& value) { return strToInt(s.c_str(), value, NUM_BASE_OCT); }
...
bool NumberParser::tryParse64(const std::string& s, Int64& value, char thSep) { return strToInt(s.c_str(), value, NUM_BASE_DEC, thSep); }
...
bool NumberParser::tryParseOct64(const std::string& s, UInt64& value) { return strToInt(s.c_str(), value, NUM_BASE_OCT); }
