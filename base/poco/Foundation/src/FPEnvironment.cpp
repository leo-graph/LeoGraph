...
FPEnvironment::FPEnvironment(RoundingMode rm) { setRoundingMode(rm); }
...
void FPEnvironment::keepCurrent() { keepCurrentImpl(); }

void FPEnvironment::clearFlags() { clearFlagsImpl(); }
