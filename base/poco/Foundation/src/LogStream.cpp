...
void LogStreamBuf::setPriority(Message::Priority priority) { _priority = priority; }
...
LogStreamBuf* LogIOS::rdbuf() { return &_buf; }

//
// LogStream
//

LogStream::LogStream(Logger& logger, Message::Priority priority) : LogIOS(logger, priority), std::ostream(&_buf) { poco_ios_init(&_buf); }

LogStream::LogStream(const std::string& loggerName, Message::Priority priority)
    : LogIOS(Logger::get(loggerName), priority), std::ostream(&_buf) {}

LogStream::~LogStream() {}

LogStream& LogStream::fatal() { return priority(Message::PRIO_FATAL); }
...
LogStream& LogStream::critical() { return priority(Message::PRIO_CRITICAL); }
...
LogStream& LogStream::error() { return priority(Message::PRIO_ERROR); }
...
LogStream& LogStream::warning() { return priority(Message::PRIO_WARNING); }
...
LogStream& LogStream::notice() { return priority(Message::PRIO_NOTICE); }
...
LogStream& LogStream::information() { return priority(Message::PRIO_INFORMATION); }
...
LogStream& LogStream::debug() { return priority(Message::PRIO_DEBUG); }
...
LogStream& LogStream::trace() { return priority(Message::PRIO_TRACE); }
...
LogStream& LogStream::test() { return priority(Message::PRIO_TEST); }
