...
RotateByIntervalStrategy::RotateByIntervalStrategy(const Timespan& span) : _span(span), _lastRotate(0) {
...
bool RotateBySizeStrategy::mustRotate(LogFile* pFile) { return pFile->size() >= _size; }
