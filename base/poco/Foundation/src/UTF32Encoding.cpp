...
const char* UTF32Encoding::_names[] = {"UTF-32", "UTF32", NULL};
...
void UTF32Encoding::setByteOrder(int byteOrderMark) { _flipBytes = byteOrderMark != 0xFEFF; }

const char* UTF32Encoding::canonicalName() const { return _names[0]; }
...
const TextEncoding::CharacterMap& UTF32Encoding::characterMap() const { return _charMap; }
...
int UTF32Encoding::sequenceLength(const unsigned char* bytes, int length) const { return 4; }
