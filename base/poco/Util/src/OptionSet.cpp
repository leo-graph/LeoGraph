...
OptionSet::OptionSet(const OptionSet& options) : _options(options._options) {}
...
OptionSet::Iterator OptionSet::begin() const { return _options.begin(); }

OptionSet::Iterator OptionSet::end() const { return _options.end(); }
