...
IniFileConfiguration::IniFileConfiguration(const std::string& path) { load(path); }
...
void IniFileConfiguration::setRaw(const std::string& key, const std::string& value) { _map[key] = value; }
...
bool IniFileConfiguration::ICompare::operator()(const std::string& s1, const std::string& s2) const { return icompare(s1, s2) < 0; }
