...
bool PrivateKeyFactoryMgr::hasFactory(const std::string& name) const { return _factories.find(name) != _factories.end(); }
...
void PrivateKeyFactoryMgr::removeFactory(const std::string& name) { _factories.erase(name); }
