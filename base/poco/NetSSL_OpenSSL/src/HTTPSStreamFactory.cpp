...
HTTPSStreamFactory::HTTPSStreamFactory() : _proxyPort(HTTPSession::HTTP_PORT) {}
...
HTTPSStreamFactory::HTTPSStreamFactory(const std::string& proxyHost, Poco::UInt16 proxyPort, const std::string& proxyUsername,
...
void HTTPSStreamFactory::registerFactory() { URIStreamOpener::defaultOpener().registerStreamFactory("https", new HTTPSStreamFactory); }

void HTTPSStreamFactory::unregisterFactory() { URIStreamOpener::defaultOpener().unregisterStreamFactory("https"); }
