...
// Poco::Net::SSLManager::instance().certificateHandlerFactoryMgr().setFactory(name, new
// Poco::Net::CertificateHandlerFactoryImpl<MyConsoleHandler>());
#define POCO_REGISTER_CHFACTORY(API, PKCLS)                                            \
  static Poco::Net::CertificateHandlerFactoryRegistrar aRegistrar(std::string(#PKCLS), \
                                                                  new Poco::Net::CertificateHandlerFactoryImpl<PKCLS>());
