...
ObjectStorageQueueFilenameParser::ObjectStorageQueueFilenameParser(const std::string &partition_regex,
                                                                   const std::string &partition_component)
    : partition_component_name(partition_component), log(getLogger("ObjectStorageQueueFilenameParser")) {
