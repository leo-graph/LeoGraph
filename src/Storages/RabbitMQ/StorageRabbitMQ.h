...
class StorageRabbitMQ final : public IStorage, WithContext {
 public:
  StorageRabbitMQ(const StorageID& table_id_, ContextPtr context_, const ColumnsDescription& columns_, const String& comment,
 ...
 private:
  ...
  static String getRandomName() {
    ...
    for (auto& c : random_str) c = static_cast<char>(distribution(thread_local_rng));
    return random_str;
  }
};
