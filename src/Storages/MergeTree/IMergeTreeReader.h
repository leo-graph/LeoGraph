...
class IMergeTreeReader : private boost::noncopyable {
 public:
  ...
  IMergeTreeReader(MergeTreeDataPartInfoForReaderPtr data_part_info_for_read_, const NamesAndTypesList& columns_,
  ...
  virtual size_t readRows(size_t from_mark, size_t current_task_last_mark, bool continue_reading, size_t max_rows_to_read,
  ...
  ALWAYS_INLINE const NamesAndTypesList& getColumns() const {
...
MergeTreeReaderPtr createMergeTreeReader(const MergeTreeDataPartInfoForReaderPtr& read_info, const NamesAndTypesList& columns,
