...
class ReplicatedMergeTreePartHeader {
 public:
  ...
  static ReplicatedMergeTreePartHeader fromColumnsAndChecksumsZNodes(const String& columns_znode, const String& checksums_znode);

  static ReplicatedMergeTreePartHeader fromColumnsAndChecksums(const NamesAndTypesList& columns,
