...
struct MergeConstraint {
  MergeConstraint(size_t max_size_bytes_, size_t max_size_rows_) : max_size_bytes(max_size_bytes_), max_size_rows(max_size_rows_) {}
...
class IMergeSelector {
 public:
   ...
   */
  virtual PartsRanges select(const PartsRanges& parts_ranges, const MergeConstraints& merge_constraints,
