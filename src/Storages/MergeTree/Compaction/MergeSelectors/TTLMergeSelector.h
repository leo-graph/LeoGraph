...
class ITTLMergeSelector : public IMergeSelector {
 ...
 private:
  ...
  PartsIterator findLeftRangeBorder(const CenterPosition& center_position, size_t& usable_memory, size_t& usable_rows, size_t& usable_parts,
                                    DisjointPartsRangesSet& disjoint_set) const;

  PartsIterator findRightRangeBorder(const CenterPosition& center_position, size_t& usable_memory, size_t& usable_rows,
