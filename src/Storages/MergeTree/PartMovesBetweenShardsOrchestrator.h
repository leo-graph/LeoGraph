  ...
  struct EntryState {
    ...
    String toString() const {
      switch (value) {
        ...
        case DESTINATION_ATTACH:
          return "DESTINATION_ATTACH";
        case SOURCE_DROP_PRE_DELAY:
          return "SOURCE_DROP_PRE_DELAY";
        case SOURCE_DROP:
          return "SOURCE_DROP";
        case SOURCE_DROP_POST_DELAY:
          return "SOURCE_DROP_POST_DELAY";
        case REMOVE_UUID_PIN:
    ...
    static EntryState::Value fromString(String in) {
      ...
      if (in == "SYNC_SOURCE") return SYNC_SOURCE;
      if (in == "SYNC_DESTINATION") return SYNC_DESTINATION;
      if (in == "DESTINATION_FETCH") return DESTINATION_FETCH;
      if (in == "DESTINATION_ATTACH") return DESTINATION_ATTACH;
      if (in == "SOURCE_DROP_PRE_DELAY") return SOURCE_DROP_PRE_DELAY;
      if (in == "SOURCE_DROP") return SOURCE_DROP;
      if (in == "SOURCE_DROP_POST_DELAY") return SOURCE_DROP_POST_DELAY;
      if (in == "REMOVE_UUID_PIN") return REMOVE_UUID_PIN;
      if (in == "DONE") return DONE;
      if (in == "CANCELLED") return CANCELLED;
