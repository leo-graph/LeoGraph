...
class ColumnsSubstreams {
 public:
  ...
  size_t getSubstreamPosition(size_t column_position, const NameAndTypePair& name_and_type,
                              const ISerialization::SubstreamPath& substream_path, const MergeTreeSettingsPtr& storage_settings) const;
