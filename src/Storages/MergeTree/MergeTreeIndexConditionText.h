...
struct TextSearchQuery {
  TextSearchQuery(String function_name_, TextSearchMode search_mode_, TextIndexDirectReadMode direct_read_mode_,
...
class MergeTreeIndexConditionText final : public IMergeTreeIndexCondition, public WithContext {
 public:
  MergeTreeIndexConditionText(const ActionsDAG::Node *predicate, ContextPtr context_, const Block &index_sample_block,
                              TokenizerPtr tokenizer_, MergeTreeIndexTextPreprocessorPtr preprocessor_);
 ...
 private:
  ...
  bool traverseFunctionNode(const RPNBuilderFunctionTreeNode &function_node, const RPNBuilderTreeNode &index_column_node,
                            const DataTypePtr &value_type, const Field &value_field, RPNElement &out) const;
  ...
  bool tryPrepareSetForTextSearch(const RPNBuilderTreeNode &lhs, const RPNBuilderTreeNode &rhs, const String &function_name,
