...
struct ReplicatedMergeTreeLogEntryData {
  ...
  std::vector<std::string> deduplication_block_ids;  /// For parts of level zero, the block identifier for deduplication (node name in
                                                     /// /blocks/ or /deduplication_hashes/ or /async_blocks/).
