...
class MergeTreeDataPartCompact : public IMergeTreeDataPart {
 public:
  ...
  MergeTreeDataPartCompact(const MergeTreeData& storage_, const MergeTreeSettings& storage_settings, const String& name_,
 ...
 protected:
  static void loadIndexGranularityImpl(MergeTreeIndexGranularityPtr& index_granularity_,
                                       const MergeTreeIndexGranularityInfo& index_granularity_info_, size_t marks_per_granule,
                                       const IDataPartStorage& data_part_storage_, const MergeTreeSettings& storage_settings);
