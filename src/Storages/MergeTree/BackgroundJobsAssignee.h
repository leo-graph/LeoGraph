...
class BackgroundJobsAssignee : public WithContext {
 public:
  ...
  enum class Type : uint8_t { DataProcessing, Moving };
  ...
  BackgroundJobsAssignee(IBackgroundOperation& data_, const StorageID& storage_id_, Type type, ContextPtr global_context_);
