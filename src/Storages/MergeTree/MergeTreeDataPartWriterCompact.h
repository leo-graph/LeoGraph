...
class MergeTreeDataPartWriterCompact : public MergeTreeDataPartWriterOnDisk {
 ...
 public:
  MergeTreeDataPartWriterCompact(const String& data_part_name_, const String& logger_name_, const SerializationByName& serializations_,
 ...
 private:
  ...
  struct CompressedStream {
    ...
    CompressedStream(WriteBuffer& buf, const CompressionCodecPtr& codec) : compressed_buf(buf, codec), hashing_buf(compressed_buf) {}
  };
