...
struct ReplicatedFetchListElement : private boost::noncopyable {
  ...
  ReplicatedFetchListElement(const std::string& database_, const std::string& table_, const std::string& partition_id_,
                             const std::string& result_part_name_, const std::string& result_part_path_,
                             const std::string& source_replica_path_, const Poco::URI& uri, UInt8 to_detached_,
...
class ReplicatedFetchList final : public BackgroundProcessList<ReplicatedFetchListElement, ReplicatedFetchInfo> {
 ...
 public:
  ReplicatedFetchList() : Parent(CurrentMetrics::ReplicatedFetch) {}
};
