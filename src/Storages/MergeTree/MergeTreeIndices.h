...
[[nodiscard]] inline RPNEvaluationIndexUsefulnessState evalAndRpnIndexStates(RPNEvaluationIndexUsefulnessState lhs,
                                                                             RPNEvaluationIndexUsefulnessState rhs) {
...
[[nodiscard]] inline RPNEvaluationIndexUsefulnessState evalOrRpnIndexStates(RPNEvaluationIndexUsefulnessState lhs,
                                                                            RPNEvaluationIndexUsefulnessState rhs) {
...
class IMergeTreeIndexCondition {
 public:
  ...
  virtual bool mayBeTrueOnGranule(MergeTreeIndexGranulePtr granule,
                                  const UpdatePartialDisjunctionResultFn &update_partial_disjunction_result_fn) const = 0;
  ...
  bool rpnEvaluatesAlwaysUnknownOrTrue(const std::vector<RPNElement> &rpn,
                                       const std::unordered_set<typename RPNElement::Function> &matchingFunctions) const {
...
struct IMergeTreeIndex {
  explicit IMergeTreeIndex(const IndexDescription &index_) : index(index_) {}
  ...
  virtual MergeTreeIndexFormat getDeserializedFormat(const MergeTreeDataPartChecksums &checksums,
  ...
  virtual MergeTreeIndexConditionPtr createIndexCondition(const ActionsDAG::Node * /*predicate*/, ContextPtr /*context*/,
