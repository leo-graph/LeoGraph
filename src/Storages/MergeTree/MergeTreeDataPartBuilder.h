...
class MergeTreeDataPartBuilder {
 public:
  ...
  static PartStorageAndMarkType getPartStorageAndMarkType(const VolumePtr &volume_, const String &root_path_, const String &part_dir_,
 ...
 private:
  ...
  static MutableDataPartStoragePtr getPartStorageByType(MergeTreeDataPartStorageType storage_type_, const VolumePtr &volume_,
