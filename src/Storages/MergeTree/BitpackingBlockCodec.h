...
struct BitpackingBlockCodecImpl<true> {
  ...
  static size_t encode(std::span<uint32_t> &in, int32_t max_bits, std::span<char> &out) {
    if (max_bits > 32) throw DB::Exception(DB::ErrorCodes::LOGICAL_ERROR, "Invalid bit width {} bits must be in [0, 32].", max_bits);
...
struct BitpackingBlockCodecImpl<false> {
  ...
  [[maybe_unused]] static uint32_t maxbitsLength(const std::span<uint32_t> &in) noexcept {
    ...
    // Tail
    for (size_t k = offset; k < n; ++k) xored_in |= in[k];
  ...
  [[maybe_unused]] static size_t bitpackingCompressedBytes(size_t count, uint32_t bits) noexcept {
    if (bits == 0) return 0;
    if (bits == 32) return count * sizeof(uint32_t);
  ...
  [[maybe_unused]] static uint32_t maskForBits(size_t bits) noexcept {
    return (bits == 32) ? 0xFFFFFFFFu : (bits == 0) ? 0u : static_cast<uint32_t>((static_cast<uint64_t>(1) << bits) - 1u);
  }
  ...
  [[maybe_unused]] static char *packFixed(const uint32_t *in, size_t groups, char *out) noexcept {
    ...
    if constexpr (Bits == 0) return out;
    ...
    for (size_t i = 0; i < groups; ++i) {
      ...
      if (acc_bits >= 32) {
        uint32_t tmp[4] = {
            static_cast<uint32_t>(acc0),
            static_cast<uint32_t>(acc1),
            static_cast<uint32_t>(acc2),
            static_cast<uint32_t>(acc3),
        };
        std::memcpy(p, tmp, 16);
        p += 16;
  ...
  [[maybe_unused]] static packing_func getPackFixedFunc(uint32_t bits) {
    ...
    static const packing_func table[33] = {
        &packFixed<0>,  &packFixed<1>,  &packFixed<2>,  &packFixed<3>,  &packFixed<4>,  &packFixed<5>,  &packFixed<6>,
        &packFixed<7>,  &packFixed<8>,  &packFixed<9>,  &packFixed<10>, &packFixed<11>, &packFixed<12>, &packFixed<13>,
        &packFixed<14>, &packFixed<15>, &packFixed<16>, &packFixed<17>, &packFixed<18>, &packFixed<19>, &packFixed<20>,
        &packFixed<21>, &packFixed<22>, &packFixed<23>, &packFixed<24>, &packFixed<25>, &packFixed<26>, &packFixed<27>,
        &packFixed<28>, &packFixed<29>, &packFixed<30>, &packFixed<31>, &packFixed<32>,
    };
    return table[bits];
  }
  ...
  [[maybe_unused]] static packing_func getPackTailFunc(uint32_t bits) {
    ...
    static const packing_func table[33] = {
        &packTail<0>,  &packTail<1>,  &packTail<2>,  &packTail<3>,  &packTail<4>,  &packTail<5>,  &packTail<6>,
        &packTail<7>,  &packTail<8>,  &packTail<9>,  &packTail<10>, &packTail<11>, &packTail<12>, &packTail<13>,
        &packTail<14>, &packTail<15>, &packTail<16>, &packTail<17>, &packTail<18>, &packTail<19>, &packTail<20>,
        &packTail<21>, &packTail<22>, &packTail<23>, &packTail<24>, &packTail<25>, &packTail<26>, &packTail<27>,
        &packTail<28>, &packTail<29>, &packTail<30>, &packTail<31>, &packTail<32>,
    };
    return table[bits];
  }
  ...
  [[maybe_unused]] static unpack_func getUnpackFixedFunc(uint32_t bit) {
    ...
    static const unpack_func table[33] = {
        &unpackFixed<0>,  &unpackFixed<1>,  &unpackFixed<2>,  &unpackFixed<3>,  &unpackFixed<4>,  &unpackFixed<5>,  &unpackFixed<6>,
        &unpackFixed<7>,  &unpackFixed<8>,  &unpackFixed<9>,  &unpackFixed<10>, &unpackFixed<11>, &unpackFixed<12>, &unpackFixed<13>,
        &unpackFixed<14>, &unpackFixed<15>, &unpackFixed<16>, &unpackFixed<17>, &unpackFixed<18>, &unpackFixed<19>, &unpackFixed<20>,
        &unpackFixed<21>, &unpackFixed<22>, &unpackFixed<23>, &unpackFixed<24>, &unpackFixed<25>, &unpackFixed<26>, &unpackFixed<27>,
        &unpackFixed<28>, &unpackFixed<29>, &unpackFixed<30>, &unpackFixed<31>, &unpackFixed<32>,
    };
    return table[bit];
  }
  ...
  [[maybe_unused]] static unpack_func getUnpackTailFunc(uint32_t bit) {
    ...
    static const unpack_func table[33] = {
        &unpackTail<0>,  &unpackTail<1>,  &unpackTail<2>,  &unpackTail<3>,  &unpackTail<4>,  &unpackTail<5>,  &unpackTail<6>,
        &unpackTail<7>,  &unpackTail<8>,  &unpackTail<9>,  &unpackTail<10>, &unpackTail<11>, &unpackTail<12>, &unpackTail<13>,
        &unpackTail<14>, &unpackTail<15>, &unpackTail<16>, &unpackTail<17>, &unpackTail<18>, &unpackTail<19>, &unpackTail<20>,
        &unpackTail<21>, &unpackTail<22>, &unpackTail<23>, &unpackTail<24>, &unpackTail<25>, &unpackTail<26>, &unpackTail<27>,
        &unpackTail<28>, &unpackTail<29>, &unpackTail<30>, &unpackTail<31>, &unpackTail<32>,
    };
    return table[bit];
  }
