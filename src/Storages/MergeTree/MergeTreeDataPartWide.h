...
class MergeTreeDataPartWide : public IMergeTreeDataPart {
 public:
  MergeTreeDataPartWide(const MergeTreeData& storage_, const MergeTreeSettings& storage_settings, const String& name_,
 ...
 protected:
  static void loadIndexGranularityImpl(MergeTreeIndexGranularityPtr& index_granularity_ptr,
                                       MergeTreeIndexGranularityInfo& index_granularity_info_, const IDataPartStorage& data_part_storage_,
                                       const std::string& any_column_file_name, const MergeTreeSettings& storage_settings);
