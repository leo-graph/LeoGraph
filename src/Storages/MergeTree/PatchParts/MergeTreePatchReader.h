...
class MergeTreePatchReader : private boost::noncopyable {
 public:
  ...
  virtual std::vector<PatchReadResultPtr> readPatches(MarkRanges &ranges, const ReadResult &main_result, const Block &result_header,
...
class MergeTreePatchReaderMerge : public MergeTreePatchReader {
 public:
  ...
  std::vector<PatchReadResultPtr> readPatches(MarkRanges &ranges, const ReadResult &main_result, const Block &result_header,
