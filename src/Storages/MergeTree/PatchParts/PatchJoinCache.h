...
using PatchOffsetsMap = absl::btree_map<UInt64, std::pair<UInt32, UInt32>, std::less<>,
                                        AllocatorWithMemoryTracking<std::pair<const UInt64, std::pair<UInt32, UInt32>>>>;

using PatchHashMap = absl::node_hash_map<UInt64, PatchOffsetsMap, HashCRC32<UInt64>, std::equal_to<>,
