 ...
 *
 * Patch parts have special index which helps to understand whether it is needed to apply patch part to the original part (see
 * SourcePartsSetForPatch.h).
 *
 ...
 *  2. if X contains part B and C, which are covered by part A. It happens if there was a merge (B, C) -> A running when UPDATE was
 * executed.
 *
