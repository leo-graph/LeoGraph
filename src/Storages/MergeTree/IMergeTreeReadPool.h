...
class IMergeTreeReadPool : private boost::noncopyable {
 public:
  ...
  /// to get required task. E.g. it may be number of thread in case of Default reading type or an index of a part in case of
  /// InOrder/InReverseOrder reading type.
