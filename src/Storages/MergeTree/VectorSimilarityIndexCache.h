...
struct VectorSimilarityIndexCacheCell {
  ...
  explicit VectorSimilarityIndexCacheCell(MergeTreeIndexGranulePtr granule_)
      : granule(std::move(granule_)), memory_bytes(granule->memoryUsageBytes() + ENTRY_OVERHEAD_BYTES_GUESS) {}
...
struct VectorSimilarityIndexCacheWeightFunction {
  size_t operator()(const VectorSimilarityIndexCacheCell &cell) const { return cell.memory_bytes; }
};

/// Cache of deserialized vector index granules.
class VectorSimilarityIndexCache : public CacheBase<VectorSimilarityIndexCacheKey, VectorSimilarityIndexCacheCell,
                                                    VectorSimilarityIndexCacheHashFunction, VectorSimilarityIndexCacheWeightFunction> {
 public:
  using Base = CacheBase<VectorSimilarityIndexCacheKey, VectorSimilarityIndexCacheCell, VectorSimilarityIndexCacheHashFunction,
                         VectorSimilarityIndexCacheWeightFunction>;

  VectorSimilarityIndexCache(const String &cache_policy, size_t max_size_in_bytes, size_t max_count, double size_ratio)
      : Base(cache_policy, CurrentMetrics::VectorSimilarityIndexCacheBytes, CurrentMetrics::VectorSimilarityIndexCacheCells,
