...
enum class TransformType : uint8_t { STRUCT, ARRAY, MAP };
...
class ExecutableEvolutionFunction : public IExecutableFunction {
 public:
  explicit ExecutableEvolutionFunction(DataTypePtr type_, DataTypePtr old_type_, Poco::SharedPtr<Poco::JSON::Object> old_json_,
 ...
 private:
  ...
  static void pushNewNode(std::stack<TraverseItem> &walk_stack, Poco::JSON::Object::Ptr old_node, Poco::JSON::Object::Ptr new_node,
                          std::vector<IcebergChangeSchemaOperation::Edge> *current_path);
...
class EvolutionFunctionStruct : public IFunctionBase {
 public:
  explicit EvolutionFunctionStruct(const DataTypes &types_, const DataTypes &old_types_, Poco::SharedPtr<Poco::JSON::Object> old_json_,
                                   Poco::SharedPtr<Poco::JSON::Object> field_)
