...
class DeltaLakeMetadataDeltaKernel final : public IDataLakeMetadata {
 public:
  ...
  DeltaLakeMetadataDeltaKernel(ObjectStoragePtr object_storage_, StorageObjectStorageConfigurationWeakPtr configuration_);
  ...
  static DataLakeMetadataPtr create(ObjectStoragePtr object_storage_, StorageObjectStorageConfigurationWeakPtr configuration) {
  ...
  DeltaLake::TableChangesPtr getTableChanges(const DeltaLake::TableChangesVersionRange &version_range, const Block &header,
                                             const std::optional<FormatSettings> &format_settings, ContextPtr context) const;

  SinkToStoragePtr write(SharedHeader sample_block, const StorageID &table_id, ObjectStoragePtr object_storage_,
 ...
 private:
  ...
  DeltaLake::TableSnapshotPtr getTableSnapshot(std::optional<SnapshotVersion> version = std::nullopt) const;
