...
class ReadBufferIterator : public IReadBufferIterator, WithContext {
 public:
  ReadBufferIterator(ObjectStoragePtr object_storage_, StorageObjectStorageConfigurationPtr configuration_,
 ...
 private:
  ...
  std::optional<ColumnsDescription> tryGetColumnsFromCache(const ObjectInfos::iterator& begin, const ObjectInfos::iterator& end);
