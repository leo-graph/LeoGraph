...
class StorageKafka2 final : public IStorage, WithContext {
 ...
 public:
  ...
  StorageKafka2(const StorageID& table_id_, ContextPtr context_, const ColumnsDescription& columns_, const String& comment,
 ...
 private:
  ...
  std::optional<BlocksAndGuard> pollConsumer(KeeperHandlingConsumer& consumer, const Stopwatch& watch, const ContextPtr& modified_context);
