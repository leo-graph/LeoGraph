...
struct KafkaConfigLoader {
  ...
  static cppkafka::Configuration getConsumerConfiguration(
      TKafkaStorage& storage, const ConsumerConfigParams& params,
      IKafkaExceptionInfoSinkPtr exception_info_sink_ptr = IKafkaExceptionInfoSinkPtr());
