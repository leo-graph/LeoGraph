...
class StorageMongoDB final : public IStorage {
 public:
  ...
  StorageMongoDB(const StorageID &table_id_, MongoDBConfiguration configuration_, const ColumnsDescription &columns_,
 ...
 private:
  ...
  std::optional<bsoncxx::document::value> visitWhereConstant(const ContextPtr &context, const ConstantNode *const_node,
                                                             const JoinNode *join_node);

  std::optional<bsoncxx::document::value> visitWhereFunction(const ContextPtr &context, const FunctionNode *func,
                                                             const JoinNode *join_node);

  std::optional<bsoncxx::document::value> visitWhereFunctionArguments(const ColumnNode *column_node, const ConstantNode *const_node,
                                                                      const FunctionNode *func, bool invert_comparison);

  std::optional<bsoncxx::document::value> visitWhereNode(const ContextPtr &context, const QueryTreeNodePtr &where_node,
                                                         const JoinNode *join_node);

  bsoncxx::document::value buildMongoDBQuery(const ContextPtr &context, mongocxx::options::find &options, const SelectQueryInfo &query,
