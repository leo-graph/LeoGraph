...
SQLQueryPiece dropMetricName(SQLQueryPiece&& query_piece, ConverterContext& context) {
  if (query_piece.metric_name_dropped) return std::move(query_piece);
  ...
  switch (query_piece.store_method) {
    ...
    case StoreMethod::VECTOR_GRID: {
      ...
      ASTPtr metric_name_removing_query;
      {
        ...
        builder.select_list.push_back(makeASTFunction("timeSeriesRemoveTag", make_intrusive<ASTIdentifier>(ColumnNames::Group),
        ...
        builder.having =
            makeASTFunction("equals",
                            makeASTFunction("timeSeriesThrowDuplicateSeriesIf",
