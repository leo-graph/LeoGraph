...
class TimeSeriesInnerTablesCreator : public WithContext {
 public:
  ...
  TimeSeriesInnerTablesCreator(ContextPtr context_, StorageID time_series_storage_id_,
  ...
  boost::intrusive_ptr<ASTCreateQuery> getInnerTableCreateQuery(ViewTarget::Kind inner_table_kind, const UUID& inner_table_uuid,
                                                                const ASTStorage* inner_storage_def) const;

  /// Creates an inner table.
  StorageID createInnerTable(ViewTarget::Kind inner_table_kind, const UUID& inner_table_uuid, const ASTStorage* inner_storage_def) const;
