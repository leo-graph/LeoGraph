...
class TimeSeriesColumnsValidator {
 public:
  ...
  TimeSeriesColumnsValidator(StorageID time_series_storage_id_, std::reference_wrapper<const TimeSeriesSettings> time_series_settings_);
  ...
  void validateTargetColumns(ViewTarget::Kind target_kind, const StorageID& target_table_id,
