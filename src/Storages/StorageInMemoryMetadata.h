...
struct StorageInMemoryMetadata {
  ...
  StorageInMemoryMetadata &operator=(StorageInMemoryMetadata &&other) =
  ...
  ColumnDependencies getColumnDependencies(const NameSet &updated_columns, bool include_ttl_target,
