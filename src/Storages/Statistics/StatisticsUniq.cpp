...
StatisticsUniq::StatisticsUniq(const SingleStatisticsDescription &description, const DataTypePtr &data_type) : IStatistics(description) {
...
StatisticsUniq::~StatisticsUniq() { collector->destroy(data); }
