...
class StorageSQLite final : public IStorage, public WithContext {
 public:
  ...
  StorageSQLite(const StorageID& table_id_, SQLitePtr sqlite_db_, const String& database_path_, const String& remote_table_name_,
  ...
  static ColumnsDescription getTableStructureFromData(const SQLitePtr& sqlite_db_, const String& table);
