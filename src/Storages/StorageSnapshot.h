...
struct StorageSnapshot {
  ...
  StorageSnapshot(const IStorage& storage_, StorageMetadataPtr metadata_, VirtualsDescriptionPtr virtual_columns_);

  StorageSnapshot(const IStorage& storage_, StorageMetadataPtr metadata_, DataPtr data_);

  StorageSnapshot(const IStorage& storage_, StorageMetadataPtr metadata_, VirtualsDescriptionPtr virtual_columns_, DataPtr data_);
