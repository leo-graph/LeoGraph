...
class StorageValues final : public IStorage {
 public:
  ...
  StorageValues(const StorageID& table_id_, const ColumnsDescription& columns_, Block res_block_, VirtualColumnsDescription virtuals_ = {});

  StorageValues(const StorageID& table_id_, const ColumnsDescription& columns_, Pipe prepared_pipe_,
