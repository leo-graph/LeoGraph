...
struct IndexDescription {
  ...
  static IndexDescription getIndexFromAST(const ASTPtr& definition_ast, const ColumnsDescription& columns, bool is_implicitly_created,
                                          bool escape_filenames, ContextPtr context);
...
struct IndicesDescription : public std::vector<IndexDescription>, IHints<> {
  ...
  static IndicesDescription parse(const String& str, const ColumnsDescription& columns, bool escape_index_filenames, ContextPtr context);
