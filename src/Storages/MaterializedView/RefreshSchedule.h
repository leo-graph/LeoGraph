...
struct RefreshSchedule {
  ...
  std::chrono::sys_seconds timeslotForCompletedRefresh(std::chrono::sys_seconds last_completed_timeslot,
                                                       std::chrono::sys_seconds start_time, std::chrono::sys_seconds end_time,
                                                       bool out_of_schedule) const;
