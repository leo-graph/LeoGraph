...
ColumnsDescription StorageSystemZooKeeperConnection::getColumnsDescription() {
  ...
  return ColumnsDescription{
      ...
      /* 5 */
      {"session_uptime_elapsed_seconds", std::make_shared<DataTypeUInt64>(), "Seconds elapsed since the connection was established."},
...
void StorageSystemZooKeeperConnection::fillData(MutableColumns &res_columns, ContextPtr context, const ActionsDAG::Node *,
