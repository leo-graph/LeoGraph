...
ColumnsDescription StorageSystemServerSettings::getColumnsDescription() {
  auto changeable_without_restart_type = std::make_shared<DataTypeEnum8>(DataTypeEnum8::Values{
...
void StorageSystemServerSettings::fillData(MutableColumns &res_columns, ContextPtr context, const ActionsDAG::Node *,
