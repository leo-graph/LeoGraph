...
class StorageSystemNumbers final : public IStorage {
 public:
  ...
  StorageSystemNumbers(const StorageID& table_id, bool multithreaded_, const std::string& column_name,
                       std::optional<UInt64> limit_ = std::nullopt, UInt64 offset_ = 0, UInt64 step_ = 1);
