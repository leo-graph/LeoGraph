...
StorageSystemJemallocProfileText::StorageSystemJemallocProfileText(const StorageID& table_id_) : IStorage(table_id_) {
...
Pipe StorageSystemJemallocProfileText::read([[maybe_unused]] const Names& column_names,
                                            [[maybe_unused]] const StorageSnapshotPtr& storage_snapshot, SelectQueryInfo& /*query_info*/,
                                            [[maybe_unused]] ContextPtr context, QueryProcessingStage::Enum /*processed_stage*/,
                                            [[maybe_unused]] const size_t max_block_size, const size_t /*num_streams*/) {
#if USE_JEMALLOC
  ...
  auto source = std::make_shared<JemallocProfileSource>(last_profile, std::make_shared<const Block>(std::move(header)), max_block_size,
                                                        format, symbolize_with_inline, collapsed_use_count);
