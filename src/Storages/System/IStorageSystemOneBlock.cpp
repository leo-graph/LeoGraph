...
class ReadFromSystemOneBlock : public SourceStepWithFilter {
 public:
  ...
  ReadFromSystemOneBlock(const Names &column_names_, const SelectQueryInfo &query_info_, const StorageSnapshotPtr &storage_snapshot_,
                         const ContextPtr &context_, SharedHeader sample_block, std::shared_ptr<IStorageSystemOneBlock> storage_,
...
void IStorageSystemOneBlock::read(QueryPlan &query_plan, const Names &column_names, const StorageSnapshotPtr &storage_snapshot,
  ...
  auto reading = std::make_unique<ReadFromSystemOneBlock>(column_names, query_info, storage_snapshot, std::move(context),
                                                          std::make_shared<const Block>(std::move(sample_block)), std::move(this_ptr),
