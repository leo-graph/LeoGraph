...
class ReadFromSystemOneStep final : public ISourceStep {
 public:
  ReadFromSystemOneStep(const Names &column_names_, const StorageSnapshotPtr &storage_snapshot_);
  ...
  QueryPlanStepPtr clone() const override { return std::make_unique<ReadFromSystemOneStep>(*this); }
