...
ColumnsDescription StorageSystemInstrumentation::getColumnsDescription() {
  ...
  return ColumnsDescription{
      ...
      {"function_name", std::make_shared<DataTypeLowCardinality>(std::make_shared<DataTypeString>()),
       "Name used to instrument the function."},
      {"handler", std::make_shared<DataTypeLowCardinality>(std::make_shared<DataTypeString>()),
       "Handler that was patched into instrumentation points of the function."},
