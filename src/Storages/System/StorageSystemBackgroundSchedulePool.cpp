...
ColumnsDescription StorageSystemBackgroundSchedulePool::getColumnsDescription() {
  return ColumnsDescription{
      ...
      {"deactivated", std::make_shared<DataTypeUInt8>(),
       "Whether the task is deactivated (always false, since deactivated tasks removed from the pool)."},
...
void StorageSystemBackgroundSchedulePool::fillData(MutableColumns &res_columns, ContextPtr context, const ActionsDAG::Node *,
