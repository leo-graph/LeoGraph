...
void StorageSystemRoleGrants::fillData(MutableColumns &res_columns, ContextPtr context, const ActionsDAG::Node *,
  ...
  auto add_row = [&](const String &grantee_name, AccessEntityType grantee_type, const String &granted_role_name,
                     const UUID &granted_role_id, bool is_default, bool with_admin_option) {
  ...
  auto add_rows = [&](const String &grantee_name, AccessEntityType grantee_type, const GrantedRoles &granted_roles,
