...
StorageSystemOne::StorageSystemOne(const StorageID &table_id_) : IStorage(table_id_) {
...
void StorageSystemOne::read(QueryPlan &query_plan, const Names &column_names, const StorageSnapshotPtr &storage_snapshot,
...
ReadFromSystemOneStep::ReadFromSystemOneStep(const Names &column_names_, const StorageSnapshotPtr &storage_snapshot_)
