...
class DatabaseOnDisk : public DatabaseWithOwnTablesBase {
 public:
  ...
  static ASTPtr parseQueryFromMetadata(LoggerPtr logger, ContextPtr context, DiskPtr disk, const String &metadata_file_path,
                                       bool throw_on_error = true, bool remove_empty = false);

  static ASTPtr parseQueryFromMetadata(LoggerPtr logger, ContextPtr context, const String &metadata_file_path, const String &query,
 ...
 protected:
  ...
  virtual void commitCreateTable(const ASTCreateQuery &query, const StoragePtr &table, const String &table_metadata_tmp_path,
