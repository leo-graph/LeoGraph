...
class Throttler : public IThrottler {
 public:
  ...
  Throttler(size_t max_speed_, size_t max_burst_, const ThrottlerPtr& parent_ = nullptr,
            ProfileEvents::Event event_amount_ = ProfileEvents::end(), ProfileEvents::Event event_sleep_us_ = ProfileEvents::end())
  ...
  Throttler(size_t max_speed_, size_t max_burst_, ProfileEvents::Event event_amount_ = ProfileEvents::end(),
  ...
  explicit Throttler(size_t max_speed_, const ThrottlerPtr& parent_ = nullptr, ProfileEvents::Event event_amount_ = ProfileEvents::end(),
                     ProfileEvents::Event event_sleep_us_ = ProfileEvents::end());

  Throttler(size_t max_speed_, ProfileEvents::Event event_amount_, ProfileEvents::Event event_sleep_us_);
  ...
  Throttler(size_t max_speed_, size_t limit_, const char* limit_exceeded_exception_message_, const ThrottlerPtr& parent_ = nullptr);
  ...
  /// Not thread safe
  void setParent(const ThrottlerPtr& parent_) { parent = parent_; }
