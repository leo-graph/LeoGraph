...
[[maybe_unused]] static NO_INLINE const void* getAddress() { return __builtin_return_address(0); }
...
int main(int argc, char** argv) {
  ...
  for (const auto& elem : symbol_index.symbols()) std::cout << elem.name << ": " << elem.offset_begin << " ... " << elem.offset_end << "\n";
  std::cout << "\n";
