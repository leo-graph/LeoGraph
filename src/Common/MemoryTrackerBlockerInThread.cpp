...
MemoryTrackerBlockerInThread::MemoryTrackerBlockerInThread(VariableContext level_) : previous_level(level) { level = level_; }

MemoryTrackerBlockerInThread::~MemoryTrackerBlockerInThread() { reset(); }
