...
[[nodiscard]] inline String quoteString(std::same_as<std::string_view> auto x) { return quoteString(std::string_view{x.data, x.size}); }

[[nodiscard]] String quoteStringSingleQuoteWithSingleQuote(std::string_view x);

[[nodiscard]] inline String quoteStringPostgreSQL(std::string_view x) { return quoteStringSingleQuoteWithSingleQuote(x); }

[[nodiscard]] inline String quoteStringSQLite(std::string_view x) { return quoteStringSingleQuoteWithSingleQuote(x); }
