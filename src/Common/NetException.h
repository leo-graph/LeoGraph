...
class NetException : public Exception {
 public:
  ...
  template <>
  NetException(int code, const String &message) : Exception(message, code) {}
  template <>
  NetException(int code, String &message) : Exception(message, code) {}
  template <>
  NetException(int code, String &&message) : Exception(std::move(message), code) {}
