...
TEST_P(CgroupsMemoryUsageObserverFixture, ReadMemoryUsageTest) {
  ...
  ASSERT_EQ(reader->readMemoryUsage(), version == ICgroupsReader::CgroupsVersion::V1 ? /* rss from memory.stat */ 2232029184
...
INSTANTIATE_TEST_SUITE_P(CgroupsMemoryUsageObserverTests, CgroupsMemoryUsageObserverFixture,
