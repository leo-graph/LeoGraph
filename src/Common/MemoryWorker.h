...
#if defined(OS_LINUX)
  static std::shared_ptr<ICgroupsReader> createCgroupsReader(ICgroupsReader::CgroupsVersion version,
...
class MemoryWorker {
 public:
  ...
  enum class MemoryUsageSource : uint8_t { None, Cgroups, Jemalloc };
