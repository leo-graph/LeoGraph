...
using NamedCollectionDependencies = boost::multi_index_container<
    ...
    boost::multi_index::indexed_by<
        ...
        boost::multi_index::hashed_non_unique<
            ...
            boost::multi_index::const_mem_fun<NamedCollectionDependency, UUID, &NamedCollectionDependency::getUUID>, std::hash<UUID> >,
        ...
        boost::multi_index::hashed_non_unique<
            ...
            boost::multi_index::composite_key<
                ...
                boost::multi_index::const_mem_fun<NamedCollectionDependency, const String &,
                                                  &NamedCollectionDependency::getTableName> > > > >;
...
class NamedCollectionFactory : boost::noncopyable {
 ...
 protected:
  ...
  bool exists(const std::string &collection_name, std::lock_guard<std::mutex> &lock) const;
  ...
  void loadFromConfig(const Poco::Util::AbstractConfiguration &config, std::lock_guard<std::mutex> &lock);
