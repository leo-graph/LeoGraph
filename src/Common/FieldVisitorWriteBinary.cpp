...
void FieldVisitorWriteBinary::operator()(const Int128 &x, WriteBuffer &buf) const { writeVarInt(static_cast<Int64>(x), buf); }
...
void FieldVisitorWriteBinary::operator()(const bool &x, WriteBuffer &buf) const { writeBinary(static_cast<UInt8>(x), buf); }
