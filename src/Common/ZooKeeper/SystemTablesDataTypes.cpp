...
DB::DataTypePtr SystemTablesDataTypes::errorCodeEnum() {
  static DB::DataTypePtr result = std::make_shared<DB::DataTypeEnum8>(DataTypeEnum8::Values{
...
DB::DataTypePtr SystemTablesDataTypes::operationEnum() {
  static DB::DataTypePtr result = std::make_shared<DataTypeEnum16>(DataTypeEnum16::Values{
      {"Watch", 0},
...
DB::DataTypePtr SystemTablesDataTypes::watchEventTypeEnum() {
  static DB::DataTypePtr result = std::make_shared<DataTypeEnum8>(DataTypeEnum8::Values{
