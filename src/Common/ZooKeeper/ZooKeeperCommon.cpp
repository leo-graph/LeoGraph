...
void ZooKeeperResponse::write(WriteBuffer &out, bool use_xid_64) const {
  ...
  if (error == Error::ZOK) response_size += sizeImpl();
  ...
  if (error == Error::ZOK) writeImpl(out);
}
...
std::string ZooKeeperRequest::toString(bool short_format) const {
  return fmt::format(
      ...
      "OpNum = {}\n"
      "Additional info:\n{}",
      xid, getOpNum(), toStringImpl(short_format));
}
...
void ZooKeeperSyncRequest::writeImpl(WriteBuffer &out) const { Coordination::write(path, out); }

size_t ZooKeeperSyncRequest::sizeImpl() const { return Coordination::size(path); }

void ZooKeeperSyncRequest::readImpl(ReadBuffer &in) { Coordination::read(path, in); }

std::string ZooKeeperSyncRequest::toStringImpl(bool /*short_format*/) const { return fmt::format("path = {}", path); }

void ZooKeeperSyncResponse::readImpl(ReadBuffer &in) { Coordination::read(path, in); }

void ZooKeeperSyncResponse::writeImpl(WriteBuffer &out) const { Coordination::write(path, out); }

size_t ZooKeeperSyncResponse::sizeImpl() const { return Coordination::size(path); }
...
std::string ZooKeeperReconfigRequest::toStringImpl(bool /*short_format*/) const {
  return fmt::format("joining = {}\nleaving = {}\nnew_members = {}\nversion = {}", joining, leaving, new_members, version);
}
...
size_t ZooKeeperReconfigResponse::sizeImpl() const { return Coordination::size(value) + Coordination::size(stat); }
...
size_t ZooKeeperWatchResponse::sizeImpl() const { return Coordination::size(type) + Coordination::size(state) + Coordination::size(path); }

void ZooKeeperWatchResponse::write(WriteBuffer &out, bool use_xid_64) const {
  if (error == Error::ZOK) ZooKeeperResponse::write(out, use_xid_64);
...
size_t ZooKeeperAuthRequest::sizeImpl() const { return Coordination::size(type) + Coordination::size(scheme) + Coordination::size(data); }
...
void ZooKeeperCreateRequest::writeImpl(WriteBuffer &out) const {
  ...
  if (is_ephemeral) flags |= 1;
  if (is_sequential) flags |= 2;
...
void ZooKeeperCreateRequest::readImpl(ReadBuffer &in) {
  ...
  if (flags & 1) is_ephemeral = true;
  if (flags & 2) is_sequential = true;
}
...
std::string ZooKeeperCreateRequest::toStringImpl(bool /*short_format*/) const {
  return fmt::format(
      ...
      "is_ephemeral = {}\n"
      "is_sequential = {}",
      path, is_ephemeral, is_sequential);
}

void ZooKeeperCreateResponse::readImpl(ReadBuffer &in) { Coordination::read(path_created, in); }

void ZooKeeperCreateResponse::writeImpl(WriteBuffer &out) const { Coordination::write(path_created, out); }

size_t ZooKeeperCreateResponse::sizeImpl() const { return Coordination::size(path_created); }
...
size_t ZooKeeperCreate2Response::sizeImpl() const { return Coordination::size(path_created) + Coordination::size(zstat); }
...
size_t ZooKeeperRemoveRequest::sizeImpl() const { return Coordination::size(path) + Coordination::size(version); }
...
size_t ZooKeeperRemoveRecursiveRequest::sizeImpl() const { return Coordination::size(path) + Coordination::size(remove_nodes_limit); }

std::string ZooKeeperRemoveRecursiveRequest::toStringImpl(bool /*short_format*/) const {
  return fmt::format(
      "path = {}\n"
      "remove_nodes_limit = {}",
      path, remove_nodes_limit);
}
...
size_t ZooKeeperExistsRequest::sizeImpl() const { return Coordination::size(path) + Coordination::size(has_watch); }
...
std::string ZooKeeperExistsRequest::toStringImpl(bool /*short_format*/) const { return fmt::format("path = {}", path); }

void ZooKeeperExistsResponse::readImpl(ReadBuffer &in) { Coordination::read(stat, in); }

void ZooKeeperExistsResponse::writeImpl(WriteBuffer &out) const { Coordination::write(stat, out); }

size_t ZooKeeperExistsResponse::sizeImpl() const { return Coordination::size(stat); }
...
size_t ZooKeeperGetRequest::sizeImpl() const { return Coordination::size(path) + Coordination::size(has_watch); }
...
std::string ZooKeeperGetRequest::toStringImpl(bool /*short_format*/) const { return fmt::format("path = {}", path); }
...
size_t ZooKeeperGetResponse::sizeImpl() const { return Coordination::size(data) + Coordination::size(stat); }
...
size_t ZooKeeperSetRequest::sizeImpl() const { return Coordination::size(path) + Coordination::size(data) + Coordination::size(version); }
...
void ZooKeeperSetResponse::readImpl(ReadBuffer &in) { Coordination::read(stat, in); }

void ZooKeeperSetResponse::writeImpl(WriteBuffer &out) const { Coordination::write(stat, out); }

size_t ZooKeeperSetResponse::sizeImpl() const { return Coordination::size(stat); }
...
size_t ZooKeeperListRequest::sizeImpl() const { return Coordination::size(path) + Coordination::size(has_watch); }
...
std::string ZooKeeperListRequest::toStringImpl(bool /*short_format*/) const { return fmt::format("path = {}", path); }
...
std::string ZooKeeperFilteredListWithStatsAndDataRequest::toStringImpl(bool /*short_format*/) const {
  return fmt::format(
      ...
      "with_stat = {}\n"
      "with_data = {}",
      path, list_request_type, with_stat, with_data);
}
...
size_t ZooKeeperListResponse::sizeImpl() const { return Coordination::size(names) + Coordination::size(stat); }
...
void ZooKeeperSimpleListResponse::readImpl(ReadBuffer &in) { Coordination::read(names, in); }

void ZooKeeperSimpleListResponse::writeImpl(WriteBuffer &out) const { Coordination::write(names, out); }

size_t ZooKeeperSimpleListResponse::sizeImpl() const { return Coordination::size(names); }
...
void ZooKeeperSetACLResponse::writeImpl(WriteBuffer &out) const { Coordination::write(stat, out); }

size_t ZooKeeperSetACLResponse::sizeImpl() const { return Coordination::size(stat); }

void ZooKeeperSetACLResponse::readImpl(ReadBuffer &in) { Coordination::read(stat, in); }

void ZooKeeperGetACLRequest::readImpl(ReadBuffer &in) { Coordination::read(path, in); }

void ZooKeeperGetACLRequest::writeImpl(WriteBuffer &out) const { Coordination::write(path, out); }

size_t ZooKeeperGetACLRequest::sizeImpl() const { return Coordination::size(path); }

std::string ZooKeeperGetACLRequest::toStringImpl(bool /*short_format*/) const { return fmt::format("path = {}", path); }
...
size_t ZooKeeperGetACLResponse::sizeImpl() const { return Coordination::size(acl) + Coordination::size(stat); }
...
size_t ZooKeeperCheckWatchRequest::sizeImpl() const { return sizeof(type) + Coordination::size(path); }
...
ZooKeeperResponsePtr ZooKeeperCheckWatchRequest::makeResponse() const { return std::make_shared<ZooKeeperCheckWatchResponse>(); }

void ZooKeeperCheckWatchResponse::readImpl(ReadBuffer &) {}

void ZooKeeperCheckWatchResponse::writeImpl(WriteBuffer &) const {}

size_t ZooKeeperCheckWatchResponse::sizeImpl() const { return 0; }
...
size_t ZooKeeperRemoveWatchRequest::sizeImpl() const { return sizeof(type) + Coordination::size(path); }
...
ZooKeeperResponsePtr ZooKeeperRemoveWatchRequest::makeResponse() const { return std::make_shared<ZooKeeperRemoveWatchResponse>(); }

void ZooKeeperRemoveWatchResponse::readImpl(ReadBuffer &) {}

void ZooKeeperRemoveWatchResponse::writeImpl(WriteBuffer &) const {}

size_t ZooKeeperRemoveWatchResponse::sizeImpl() const { return 0; }
...
size_t ZooKeeperAddWatchRequest::sizeImpl() const { return sizeof(mode) + Coordination::size(path); }
...
size_t ZooKeeperAddWatchResponse::sizeImpl() const { return sizeof(int32_t); }
...
std::string ZooKeeperSetWatchesRequest::toStringImpl(bool /*short_format*/) const {
  ...
  for (const auto &elem : data_watches) result += fmt::format("data_watch: {}\n", elem);

  for (const auto &elem : exist_watches) result += fmt::format("exist_watch: {}\n", elem);

  for (const auto &elem : child_watches) result += fmt::format("child_watch: {}\n", elem);
  return result;
}

ZooKeeperResponsePtr ZooKeeperSetWatchesRequest::makeResponse() const { return std::make_shared<ZooKeeperSetWatchResponse>(); }
...
size_t ZooKeeperSetWatches2Request::sizeImpl() const {
  return sizeof(zxid) + Coordination::size(data_watches) + Coordination::size(exist_watches) + Coordination::size(child_watches) +
         Coordination::size(persistent_watches) + Coordination::size(persistent_recursive_watches);
}
...
std::string ZooKeeperSetWatches2Request::toStringImpl(bool /*short_format*/) const {
  ...
  for (const auto &elem : persistent_watches) result += fmt::format("persistent_watches: {}\n", elem);

  for (const auto &elem : persistent_recursive_watches) result += fmt::format("persistent_recursive_watches: {}\n", elem);

  return result;
}

ZooKeeperResponsePtr ZooKeeperSetWatches2Request::makeResponse() const { return std::make_shared<ZooKeeperSetWatch2Response>(); }

void ZooKeeperSetWatchResponse::readImpl(ReadBuffer &) {}

void ZooKeeperSetWatchResponse::writeImpl(WriteBuffer &) const {}

size_t ZooKeeperSetWatchResponse::sizeImpl() const { return 0; }

void ZooKeeperSetWatch2Response::readImpl(ReadBuffer &) {}

void ZooKeeperSetWatch2Response::writeImpl(WriteBuffer &) const {}

size_t ZooKeeperSetWatch2Response::sizeImpl() const { return 0; }

OpNum ZooKeeperCheckRequest::getOpNum() const {
  if (not_exists) return OpNum::CheckNotExists;

  if (stat_to_check.has_value()) return OpNum::CheckStat;
...
size_t ZooKeeperCheckRequest::sizeImpl() const {
  return Coordination::size(path) + Coordination::size(version) +
         (stat_to_check.has_value() ? Coordination::size(stat_to_check.value()) : 0);
}
...
void ZooKeeperCheckRequest::readImpl(ReadBuffer &in) {
  ...
  if (stat_to_check) Coordination::read(stat_to_check.value(), in);
}
...
void ZooKeeperErrorResponse::readImpl(ReadBuffer &in) {
  ...
  if (read_error != error)
    throw Exception(Error::ZMARSHALLINGERROR, "Error code in ErrorResponse ({}) doesn't match error code in header ({})", read_error,
                    error);
}

void ZooKeeperErrorResponse::writeImpl(WriteBuffer &out) const { Coordination::write(error, out); }

size_t ZooKeeperErrorResponse::sizeImpl() const { return Coordination::size(error); }
...
ZooKeeperMultiRequest::ZooKeeperMultiRequest(std::span<const Coordination::RequestPtr> generic_requests, const ACLs &default_acls) {
  ...
  for (const auto &generic_request : generic_requests) {
    if (const auto *concrete_request_create = dynamic_cast<const ZooKeeperCreateRequest *>(generic_request.get())) {
      ...
      if (create->acls.empty()) create->acls = default_acls;
    ...
    } else if (const auto *concrete_request_remove_recursive =
                   dynamic_cast<const ZooKeeperRemoveRecursiveRequest *>(generic_request.get())) {
      checkOperationType(Write);
...
void ZooKeeperMultiRequest::readImpl(ReadBuffer &in) { readImpl(in, /*request_validator=*/{}); }
...
void ZooKeeperMultiRequest::readImpl(ReadBuffer &in, RequestValidator request_validator) {
  while (true) {
    ...
    if (done) {
      ...
      if (error != -1)
        throw Exception::fromMessage(Error::ZMARSHALLINGERROR,
                                     "Unexpected error value received at the end of results for multi transaction");
      break;
    }

    ZooKeeperRequestPtr request = ZooKeeperRequestFactory::instance().get(op_num);
    request->readImpl(in);
    if (request_validator) request_validator(*request);
    requests.push_back(request);

    if (in.eof()) throw Exception::fromMessage(Error::ZMARSHALLINGERROR, "Not enough results received for multi transaction");
  }
}
...
std::string ZooKeeperMultiRequest::toStringImpl(bool short_format) const {
  ...
  if (short_format && requests_to_print.size() > subrequests_to_print_in_short_format) {
    fmt::format_to(std::back_inserter(out), "Subrequests size = {}\nFirst {} requests\n", requests.size(),
                   subrequests_to_print_in_short_format);
...
bool ZooKeeperMultiRequest::isReadRequest() const { return getOpNum() == OpNum::MultiRead; }
...
void ZooKeeperMultiResponse::readImpl(ReadBuffer &in) {
  for (auto &response : responses) {
    ...
    if (done) throw Exception::fromMessage(Error::ZMARSHALLINGERROR, "Not enough results received for multi transaction");

    /// op_num == -1 is special for multi transaction.
    /// For unknown reason, error code is duplicated in header and in response body.

    if (op_num == OpNum::Error) response = std::make_shared<ZooKeeperErrorResponse>();
    ...
    if (op_error != Error::ZOK) {
      ...
      if (error == Error::ZOK && op_error != Error::ZRUNTIMEINCONSISTENCY) error = op_error;
    }

    if (op_error == Error::ZOK || op_num == OpNum::Error) dynamic_cast<ZooKeeperResponse &>(*response).readImpl(in);
  ...
  /// Footer.
  {
    ...
    if (!done) throw Exception::fromMessage(Error::ZMARSHALLINGERROR, "Too many results received for multi transaction");
    if (op_num != OpNum::Error)
      throw Exception::fromMessage(Error::ZMARSHALLINGERROR, "Unexpected op_num received at the end of results for multi transaction");
    if (error_read != -1)
...
void ZooKeeperMultiResponse::writeImpl(WriteBuffer &out) const {
  for (const auto &response : responses) {
    ...
    if (op_error == Error::ZOK || op_num == OpNum::Error) zk_response.writeImpl(out);
  }
...
size_t ZooKeeperMultiResponse::sizeImpl() const {
  ...
  for (const auto &response : responses) {
    ...
    if (op_error == Error::ZOK || op_num == OpNum::Error) total_size += zk_response.sizeImpl();
  }
...
ZooKeeperResponsePtr ZooKeeperCreateRequest::makeResponse() const {
  if (include_stats) return std::make_shared<ZooKeeperCreate2Response>();
  if (not_exists) return std::make_shared<ZooKeeperCreateIfNotExistsResponse>();
  return std::make_shared<ZooKeeperCreateResponse>();
}

ZooKeeperResponsePtr ZooKeeperCheckRequest::makeResponse() const {
  if (not_exists) return std::make_shared<ZooKeeperCheckNotExistsResponse>();

  if (stat_to_check.has_value()) return std::make_shared<ZooKeeperCheckStatResponse>();
...
void ZooKeeperRequestFactory::registerRequest(OpNum op_num, Creator creator) {
  if (!op_num_to_request.try_emplace(op_num, creator).second)
    throw Coordination::Exception(Coordination::Error::ZRUNTIMEINCONSISTENCY, "Request type {} already registered", op_num);
}
...
ZooKeeperRequestPtr ZooKeeperRequestFactory::get(OpNum op_num) const {
  ...
  if (it == op_num_to_request.end()) throw Exception(Error::ZBADARGUMENTS, "Unknown operation type {}", op_num);
...
PathMatchResult matchPath(std::string_view path, std::string_view match_to) {
  ...
  if (path.ends_with('/')) path.remove_suffix(1);

  if (match_to.ends_with('/')) match_to.remove_suffix(1);

  auto [first_it, second_it] = std::mismatch(path.begin(), path.end(), match_to.begin(), match_to.end());

  if (second_it != match_to.end()) return NOT_MATCH;

  if (first_it == path.end()) return EXACT;
...
std::string_view parentNodePath(std::string_view path) {
  ...
  if (rslash_pos > 0) return path.substr(0, rslash_pos);
  return "/";
}
...
ComponentGuard::ComponentGuard(StaticString component) : previous_component(current_component) { current_component = component; }

ComponentGuard::~ComponentGuard() { current_component = previous_component; }

StaticString getCurrentComponent() { return current_component; }
