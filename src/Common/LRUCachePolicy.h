...
class LRUCachePolicy : public ICachePolicy<Key, Mapped, HashFunction, WeightFunction> {
 public:
   ...
   */
  LRUCachePolicy(CurrentMetrics::Metric size_in_bytes_metric_, CurrentMetrics::Metric count_metric_, size_t max_size_in_bytes_,
                 size_t max_count_, OnRemoveEntryFunction on_remove_entry_function_)
  ...
  ~LRUCachePolicy() override { clearImpl(); }
