...
enum class WKBGeometry : UInt32 { Point = 1, LineString = 2, Polygon = 3, MultiLineString = 5, MultiPolygon = 6 };

using GeometricObject = std::variant<CartesianPoint, LineString<CartesianPoint>, MultiLineString<CartesianPoint>, Polygon<CartesianPoint>,
