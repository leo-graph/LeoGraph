...
void FrequencyHolder::loadEncodingsFrequency() {
  ...
  if (resource.empty()) throw Exception(ErrorCodes::FILE_DOESNT_EXIST, "There is no embedded charset frequencies");
...
void FrequencyHolder::loadEmotionalDict() {
  ...
  if (resource.empty()) throw Exception(ErrorCodes::FILE_DOESNT_EXIST, "There is no embedded emotional dictionary");
...
void FrequencyHolder::loadProgrammingFrequency() {
  ...
  if (resource.empty()) throw Exception(ErrorCodes::FILE_DOESNT_EXIST, "There is no embedded programming languages frequencies");
