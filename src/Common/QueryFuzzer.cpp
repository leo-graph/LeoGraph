...
Field QueryFuzzer::getRandomField(int type) {
  static constexpr Int64 bad_int64_values[] = {-2,
                                               -1,
                                               0,
                                               1,
                                               2,
  ...
  switch (type) {
    ...
    case 2: {
      ...
      return DecimalField<Decimal64>(bad_int64_values[fuzz_rand() % std::size(bad_int64_values)],
...
Field QueryFuzzer::fuzzField(Field field) {
  ...
  if (type == Field::Types::Int64 || type == Field::Types::UInt64) {
    ...
    type_index = 1;
  } else if (type == Field::Types::Decimal32 || type == Field::Types::Decimal64 || type == Field::Types::Decimal128 ||
  ...
  if (type == Field::Types::String) {
    ...
    if (fuzz_rand() % 5 == 0) {
      if (!arr.empty()) {
        ...
        if (debug_stream) *debug_stream << fmt::format("inserted (pos {})\n", pos);
      } else {
...
ASTPtr QueryFuzzer::getRandomExpressionList(const size_t nproj) {
  ...
  for (size_t i = 0; i < fuzz_rand() % 5 + 1; ++i) {
    ...
    new_ast->children.emplace_back(nproj && (fuzz_rand() % 4 == 0) ? make_intrusive<ASTLiteral>((fuzz_rand() % nproj) + 1)
                                                                   : getRandomColumnLike());
  }
  return new_ast;
}
...
void QueryFuzzer::fuzzOrderByElement(ASTOrderByElement *elem) {
  switch (fuzz_rand() % 10) {
    ...
    case 4:
      ...
      break;
    case 5:
      if (fuzz_rand() % 5 == 0) elem->with_fill = !elem->with_fill;
      break;
    default:
      // do nothing
      break;
...
void QueryFuzzer::fuzzWindowFrame(ASTWindowDefinition &def) {
  ...
  switch (fuzz_rand() % 20) {
    case 0: {
      ...
      def.frame_type = r == 0 ? WindowFrame::FrameType::ROWS : r == 1 ? WindowFrame::FrameType::RANGE : WindowFrame::FrameType::GROUPS;
      break;
    }
    case 1: {
      const auto r = fuzz_rand() % 3;
...
bool QueryFuzzer::isSuitableForFuzzing(const ASTCreateQuery &create) { return create.columns_list && create.columns_list->columns; }

static String getOriginalTableName(const String &full_name) { return full_name.substr(0, full_name.find("__fuzz_")); }

static String getFuzzedTableName(const String &original_name, size_t index) { return original_name + "__fuzz_" + toString(index); }
...
void QueryFuzzer::fuzzCreateQuery(ASTCreateQuery &create) {
    ...
    for (auto &ast : create.columns_list->indices->children) {
      ...
      if (index_type->name == "text" && index_type->arguments) {
        for (auto &arg_ast : index_type->arguments->children) {
          ...
          if (!equals_fn || equals_fn->name != "equals" || !equals_fn->arguments || equals_fn->arguments->children.size() != 2) continue;
          ...
          if (param_id->name() == "tokenizer") {
            if (value_ast->as<ASTLiteral>() && fuzz_rand() % 5 == 0) {
              ...
              } else if (tok_fn->name == "sparseGrams" && tok_fn->arguments && tok_fn->arguments->children.size() == 3 &&
                         fuzz_rand() % 5 == 0) {
            ...
            if (fuzz_rand() % 5 == 0) value_ast = make_intrusive<ASTLiteral>(pickRandomly(fuzz_rand, posting_list_codecs));
          } else if (param_id->name() == "dictionary_block_frontcoding_compression") {
            if (fuzz_rand() % 5 == 0) value_ast = make_intrusive<ASTLiteral>(UInt64(fuzz_rand() % 2));
          } else if (param_id->name() == "dictionary_block_size" || param_id->name() == "posting_list_block_size") {
            if (fuzz_rand() % 5 == 0) value_ast = make_intrusive<ASTLiteral>(UInt64(fuzz_rand() % 2048 + 1));
          }
        }
      }

      /// Fuzz index granularity (1/10 probability).
      if (fuzz_rand() % 10 == 0) index->granularity = UInt64(1) << (fuzz_rand() % 14);  /// 1 to 8192
      ...
      if (fuzz_rand() % 10 == 0) {
        if (bf_index_types.contains(index_type->name)) {
          ...
          if (index_type->arguments) index_type->arguments->children.clear();
        }
      }
    }
  }
  ...
  if (create.storage && create.storage->engine) {
    ...
    if (endsWith(engine_name, "MergeTree") && fuzz_rand() % 20 == 0) {
      ...
      if (auto &arguments = create.storage->engine->arguments) arguments->children.clear();
    }
  }
  ...
  if (create.storage && create.storage->engine && endsWith(create.storage->engine->name, "MergeTree")) {
    static const Strings hot_bool_settings = {"add_minmax_index_for_numeric_columns",
    ...
    for (const auto &name : hot_bool_settings)
      if (fuzz_rand() % 20 == 0) fuzz_setting(name, UInt64(1));

    if (fuzz_rand() % 20 == 0)
      fuzz_setting("deduplicate_merge_projection_mode", String(pickRandomly(fuzz_rand, Strings{"ignore", "throw", "drop", "rebuild"})));
    if (fuzz_rand() % 20 == 0) fuzz_setting("inactive_parts_to_delay_insert", UInt64(fuzz_rand() % 50 + 1));
    if (fuzz_rand() % 20 == 0) fuzz_setting("index_granularity", UInt64(1) << (fuzz_rand() % 14));
    if (fuzz_rand() % 20 == 0)
      fuzz_setting("lightweight_mutation_projection_mode", String(pickRandomly(fuzz_rand, Strings{"throw", "drop", "rebuild"})));
    if (fuzz_rand() % 20 == 0) fuzz_setting("max_avg_part_size_for_too_many_parts", UInt64(fuzz_rand() % (1 << 24)));
    if (fuzz_rand() % 20 == 0) fuzz_setting("merge_max_block_size", UInt64(1) << (fuzz_rand() % 14));
    if (fuzz_rand() % 20 == 0) fuzz_setting("merge_with_ttl_timeout", Int64(fuzz_rand() % 7200));
    if (fuzz_rand() % 20 == 0) fuzz_setting("min_bytes_for_full_part_storage", UInt64(1) << (fuzz_rand() % 14));
    if (fuzz_rand() % 20 == 0) fuzz_setting("min_bytes_for_wide_part", UInt64(fuzz_rand() % 2));
    if (fuzz_rand() % 20 == 0) fuzz_setting("nullable_serialization_version", String(fuzz_rand() % 2 == 0 ? "basic" : "allow_sparse"));
    if (fuzz_rand() % 20 == 0) fuzz_setting("number_of_partitions_to_consider_for_merge", UInt64(fuzz_rand() % 50 + 1));
    if (fuzz_rand() % 20 == 0) fuzz_setting("parts_to_delay_insert", UInt64(fuzz_rand() % 50 + 1));
    if (fuzz_rand() % 20 == 0) fuzz_setting("ratio_of_defaults_for_sparse_serialization", Float64(fuzz_rand() % 101) / 100.0);
    if (fuzz_rand() % 20 == 0) fuzz_setting("remove_empty_parts", UInt64(0));
    if (fuzz_rand() % 20 == 0)
      fuzz_setting("string_serialization_version", String(fuzz_rand() % 2 == 0 ? "single_stream" : "with_size_stream"));
    if (fuzz_rand() % 20 == 0) fuzz_setting("vertical_merge_algorithm_min_bytes_to_activate", UInt64(1) << (fuzz_rand() % 14));
  }

  /// Toggle CREATE ↔ CREATE OR REPLACE
  if (fuzz_rand() % 100 == 0) create.create_or_replace = !create.create_or_replace;
  ...
  if (create.storage) {
    ...
    if (fuzz_rand() % 50 == 0) drop_storage_clause(create.storage->sample_by);
    if (fuzz_rand() % 50 == 0) drop_storage_clause(create.storage->primary_key);
    if (fuzz_rand() % 50 == 0) drop_storage_clause(create.storage->ttl_table);
    /// PARTITION BY removal is rarer — changes table sharding fundamentally
    if (fuzz_rand() % 100 == 0) drop_storage_clause(create.storage->partition_by);
  }
  ...
  if (create.columns_list) create.columns_list->updateTreeHash(sip_hash, /*ignore_aliases=*/true);
  if (create.storage) create.storage->updateTreeHash(sip_hash, /*ignore_aliases=*/true);

  const auto hash = getSipHash128AsPair(sip_hash);

  /// Save only tables with unique definition.
  if (created_tables_hashes.insert(hash).second) original_table_name_to_fuzzed[original_name].insert(new_name);
}
...
void QueryFuzzer::fuzzColumnDeclaration(ASTColumnDeclaration &column) {
  if (auto type = column.getType()) {
    ...
    column.setType(parseQuery(parser, data_type->getName(), DBMS_DEFAULT_MAX_QUERY_SIZE, DBMS_DEFAULT_MAX_PARSER_DEPTH,
  ...
  if (auto stats = column.getStatisticsDesc()) {
    ...
    if (stats_decl && stats_decl->types) {
      for (auto &type_ast : stats_decl->types->children) {
        if (auto *fn = type_ast->as<ASTFunction>(); fn && fuzz_rand() % 5 == 0) fn->name = pickRandomly(fuzz_rand, stat_types);
      }
    }
  }
...
DataTypePtr QueryFuzzer::fuzzDataType(DataTypePtr type) {
  ...
  if (type_array && fuzz_rand() % 4 != 0) return std::make_shared<DataTypeArray>(fuzzDataType(type_array->getNestedType()));

  const auto *type_tuple = typeid_cast<const DataTypeTuple *>(type.get());
  if (type_tuple && fuzz_rand() % 4 != 0) {
    DataTypes elements;
    for (const auto &element : type_tuple->getElements()) elements.push_back(fuzzDataType(element));
    /// Occasionally add a new alternative
    if (elements.size() < 10 && fuzz_rand() % 10 == 0) elements.push_back(getRandomType());
    /// Occasionally drop an alternative (keep at least 1)
    if (elements.size() > 1 && fuzz_rand() % 10 == 0) elements.erase(elements.begin() + fuzz_rand() % elements.size());
    if (type_tuple->hasExplicitNames()) {
      ...
      while (names.size() < elements.size()) names.push_back("f" + std::to_string(names.size()));
  ...
  if (type_map && fuzz_rand() % 4 != 0) {
    ...
    if (!DataTypeMap::isValidKeyType(key_type)) key_type = type_map->getKeyType();
  ...
  if (type_nullable) {
    ...
    if (tmp == 0) return fuzzDataType(type_nullable->getNestedType());

    if (tmp == 1) {
      auto nested_type = fuzzDataType(type_nullable->getNestedType());
      if (nested_type->canBeInsideNullable()) return std::make_shared<DataTypeNullable>(nested_type);
    }
  }
  ...
  if (type_low_cardinality) {
    size_t tmp = fuzz_rand() % 3;
    if (tmp == 0) return fuzzDataType(type_low_cardinality->getDictionaryType());

    if (tmp == 1) {
      auto nested_type = fuzzDataType(type_low_cardinality->getDictionaryType());
      if (nested_type->canBeInsideLowCardinality()) return std::make_shared<DataTypeLowCardinality>(nested_type);
    }
  }
  ...
  if (type_fixed_string && fuzz_rand() % 4 != 0) {
    ...
    const size_t new_n = (fuzz_rand() % 4 == 0) ? (fuzz_rand() % MAX_FIXEDSTRING_SIZE_WITHOUT_SUSPICIOUS + 1)
  ...
  if (type_datetime64 && fuzz_rand() % 4 != 0) return std::make_shared<DataTypeDateTime64>(fuzz_rand() % 10);  /// scale in [0, 9]

  const auto *type_dynamic = typeid_cast<const DataTypeDynamic *>(type.get());
  if (type_dynamic && fuzz_rand() % 4 != 0) return std::make_shared<DataTypeDynamic>(fuzz_rand() % 255);

  const auto *type_variant = typeid_cast<const DataTypeVariant *>(type.get());
  if (type_variant && fuzz_rand() % 4 != 0) {
    DataTypes variants;
    for (const auto &v : type_variant->getVariants()) variants.push_back(fuzzDataType(v));
    /// Occasionally add a new alternative
    if (variants.size() < 10 && fuzz_rand() % 4 == 0) variants.push_back(getRandomType());
    /// Occasionally drop an alternative (keep at least 1)
    if (variants.size() > 1 && fuzz_rand() % 4 == 0) variants.erase(variants.begin() + fuzz_rand() % variants.size());
...
#define FUZZ_ENUM(INT_TYPE)                                                                                             \
  if (const auto *dt_enum = typeid_cast<const DataTypeEnum<INT_TYPE> *>(type.get()); dt_enum && fuzz_rand() % 4 != 0) { \
    ...
    if (values.size() < 50 && fuzz_rand() % 3 == 0) {                                                                   \
      ...
      if (!dt_enum->hasValue(new_val)) values.emplace_back("e" + std::to_string(values.size()), new_val);               \
    }                                                                                                                   \
    if (values.size() > 1 && fuzz_rand() % 3 == 0) values.erase(values.begin() + fuzz_rand() % values.size());          \
    if (!values.empty()) return std::make_shared<DataTypeEnum<INT_TYPE>>(values);                                       \
  }
  FUZZ_ENUM(Int8)
  FUZZ_ENUM(Int16)
#undef FUZZ_ENUM
...
#undef FUZZ_DECIMAL
  ...
  if (tmp == 0) return std::make_shared<DataTypeArray>(type);

  if (tmp <= 1 && type->canBeInsideNullable()) return std::make_shared<DataTypeNullable>(type);

  if (tmp <= 2 && type->canBeInsideLowCardinality()) return std::make_shared<DataTypeLowCardinality>(type);

  if (tmp <= 3) return getRandomType();
...
DataTypePtr QueryFuzzer::getRandomType() {
  ...
  static const std::vector<TypeIndex> &random_types = {
      ...
      TypeIndex::BFloat16,   TypeIndex::Float32,        TypeIndex::Float64,     TypeIndex::Date,   TypeIndex::Date32,  TypeIndex::DateTime,
      TypeIndex::DateTime64, TypeIndex::String,         TypeIndex::FixedString, TypeIndex::Enum8,  TypeIndex::Enum16,  TypeIndex::Decimal32,
      TypeIndex::Decimal64,  TypeIndex::Decimal128,     TypeIndex::Decimal256,  TypeIndex::UUID,   TypeIndex::Array,   TypeIndex::Tuple,
      TypeIndex::Nullable,   TypeIndex::LowCardinality, TypeIndex::Map,         TypeIndex::IPv4,   TypeIndex::IPv6,    TypeIndex::Variant,
...
#define DISPATCH(DECIMAL)                                                                       \
  case TypeIndex::DECIMAL:                                                                      \
    return std::make_shared<DataTypeDecimal<DECIMAL>>(DataTypeDecimal<DECIMAL>::maxPrecision(), \
  ...
  switch (type_id) {
    case TypeIndex::Tuple: {
      ...
      DataTypes elements;
      for (size_t i = 0; i < tuple_size; ++i) elements.push_back(getRandomType());
      return std::make_shared<DataTypeTuple>(elements);
    }
    ...
    case TypeIndex::Enum8: {
      ...
      for (size_t i = 0; i < n; ++i) values.emplace_back("v" + std::to_string(i), static_cast<Int8>(i));
      return std::make_shared<DataTypeEnum<Int8>>(values);
    }
    case TypeIndex::Enum16: {
      DataTypeEnum<Int16>::Values values;
      const size_t n = fuzz_rand() % 4 + 1;
      for (size_t i = 0; i < n; ++i) values.emplace_back("v" + std::to_string(i), static_cast<Int16>(i));
...
ASTExplainQuery::ExplainKind QueryFuzzer::fuzzExplainKind(ASTExplainQuery::ExplainKind kind) {
  ...
  static const std::vector<ASTExplainQuery::ExplainKind> explain_kinds = {
      ASTExplainQuery::ExplainKind::ParsedAST,     ASTExplainQuery::ExplainKind::AnalyzedSyntax,
      ASTExplainQuery::ExplainKind::QueryTree,     ASTExplainQuery::ExplainKind::QueryPlan,
      ASTExplainQuery::ExplainKind::QueryPipeline, ASTExplainQuery::ExplainKind::QueryEstimates,
      ASTExplainQuery::ExplainKind::TableOverride, ASTExplainQuery::ExplainKind::CurrentTransaction};
...
ASTs QueryFuzzer::getDropQueriesForFuzzedTables(const ASTDropQuery &drop_query) {
  if (drop_query.kind != ASTDropQuery::Drop) return {};

  auto table_name = drop_query.getTable();
  auto it = index_of_fuzzed_table.find(table_name);
  if (it == index_of_fuzzed_table.end()) return {};
...
void QueryFuzzer::notifyQueryFailed(ASTPtr ast) {
  ...
  auto remove_fuzzed_table = [this](const auto &table_name) {
    ...
    if (pos != std::string::npos) {
      ...
      auto it = original_table_name_to_fuzzed.find(original_name);
      if (it != original_table_name_to_fuzzed.end()) it->second.erase(table_name);
    }
  };

  if (const auto *create = ast->as<ASTCreateQuery>()) remove_fuzzed_table(create->getTable());

  if (const auto *insert = ast->as<ASTInsertQuery>()) remove_fuzzed_table(insert->getTable());
}
...
ASTPtr QueryFuzzer::fuzzLiteralUnderExpressionList(ASTPtr child) {
  ...
  if (type == Field::Types::Which::String && fuzz_rand() % 7 == 0) {
    ...
    child =
        makeASTFunction("toFixedString", make_intrusive<ASTLiteral>(value), make_intrusive<ASTLiteral>(static_cast<UInt64>(value.size())));
    ...
    if (decimal == 0)
      child = makeASTFunction("toDecimal32", make_intrusive<ASTLiteral>(l->value.safeGet<Float64>()),
                              make_intrusive<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 9)));
    else if (decimal == 1)
      child = makeASTFunction("toDecimal64", make_intrusive<ASTLiteral>(l->value.safeGet<Float64>()),
                              make_intrusive<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 18)));
    else if (decimal == 2)
      child = makeASTFunction("toDecimal128", make_intrusive<ASTLiteral>(l->value.safeGet<Float64>()),
                              make_intrusive<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 38)));
    else
      child = makeASTFunction("toDecimal256", make_intrusive<ASTLiteral>(l->value.safeGet<Float64>()),
                              make_intrusive<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 76)));
  }

  if (fuzz_rand() % 7 == 0) child = makeASTFunction("toNullable", child);

  if (fuzz_rand() % 7 == 0) child = makeASTFunction("toLowCardinality", child);

  if (fuzz_rand() % 7 == 0) child = makeASTFunction("materialize", child);
...
ASTPtr QueryFuzzer::reverseLiteralFuzzing(ASTPtr child) {
  if (auto *function = child.get()->as<ASTFunction>()) {
    static const std::unordered_set<String> can_be_reverted{
        ...
        "toDecimal64",   "toDecimal128", "toDecimal256",
        "toFixedString",  /// Same as toDecimal
        "toInt128",      "toInt256",     "toLowCardinality", "toNullable", "toUInt128", "toUInt256"};
    if (can_be_reverted.contains(function->name) && function->children.size() == 1) {
      if (fuzz_rand() % 7 == 0) return function->children[0];
    }
  }
...
static const Strings comparison_comparators = {"equals", "notEquals",    "greater",          "greaterOrEquals",
                                               "less",   "lessOrEquals", "isNotDistinctFrom"};
    ...
    if (!colids.empty()) {
      ...
      for (int i = 0; i < nconditions; i++) {
        ...
        if (nprob == 0) {
          ...
          next_condition =
              makeASTFunction(comparison_comparators[(fuzz_rand() % 10 == 0) ? (fuzz_rand() % (comparison_comparators.size() - 1)) : 0],
                              expression_1, expression_2);
        }
...
void QueryFuzzer::fuzzMandatoryPredicate(ASTPtr &predicate, ASTs &children) {
  ...
  if (fuzz_rand() % 50 == 0)
    ...
    if (permuted != predicate) new_pred = permuted;
  }

  if (new_pred) {
    for (auto &child : children)
      if (child == predicate) child = new_pred;
    predicate = new_pred;
  }
}
...
void QueryFuzzer::fuzzJoinType(ASTTableJoin *table_join) {
  if (table_join->kind < JoinKind::Cross) {
    ...
    static const std::vector<JoinStrictness> all_strictness_values = {JoinStrictness::Unspecified, JoinStrictness::Any,
                                                                      JoinStrictness::All,         JoinStrictness::Asof,
                                                                      JoinStrictness::Anti,        JoinStrictness::Semi};
    static const std::vector<JoinStrictness> right_strictness_values = {JoinStrictness::Unspecified, JoinStrictness::RightAny,
                                                                        JoinStrictness::All, JoinStrictness::Semi, JoinStrictness::Anti};
    static const std::vector<JoinKind> kind_values = {JoinKind::Inner, JoinKind::Left, JoinKind::Right,
                                                      JoinKind::Full /*,JoinKind::Cross,JoinKind::Comma,JoinKind::Paste*/};
...
static String getOldALias(const ASTPtr &input) {
  if (const auto *texp = typeid_cast<const ASTTableExpression *>(input.get())) {
    const auto &child =
        texp->database_and_table_name ? texp->database_and_table_name : (texp->table_function ? texp->table_function : texp->subquery);
  ...
  if (!table_like.empty() && !colids.empty()) {
    ...
    if (old_alias.empty() || fuzz_rand() % 2 == 0) {
      ...
      if (typeid_cast<ASTTableExpression *>(input_table.get())) {
        ...
        auto &otable_exp_child = otexp->database_and_table_name ? otexp->database_and_table_name
...
static const std::map<size_t, Strings> swapAggrs = {
    {1,
     {"any",
      ...
      "varSamp"}},
    {2,
     {"argMax", "argMin", "avgWeighted", "boundingRatio", "corr", "covarPop", "covarPopStable", "deltaSumTimestamp", "maxIntersections",
      "maxIntersectionsPosition", "uniq"}}};

static const std::vector<std::unordered_set<String>> &swapFuncs = {  /// String pattern matching operators
    ...
    {"toIntervalDay", "toIntervalHour", "toIntervalMicrosecond", "toIntervalMillisecond", "toIntervalMinute", "toIntervalMonth",
     "toIntervalNanosecond", "toIntervalQuarter", "toIntervalSecond", "toIntervalWeek", "toIntervalYear"},
    ...
    /// Integer type casts
    {"toInt8", "toInt16", "toInt32", "toInt64", "toInt128", "toInt256", "toUInt8", "toUInt16", "toUInt32", "toUInt64", "toUInt128",
     "toUInt256"},
    ...
    {"has", "hasAll", "hasAny", "hasToken", "hasTokenCaseInsensitive", "hasTokenCaseInsensitiveOrNull", "hasTokenOrNull", "hasAnyTokens",
     "hasAllTokens"},
    ...
    {"startsWith", "startsWithUTF8", "startsWithCaseInsensitive", "startsWithCaseInsensitiveUTF8", "endsWith", "endsWithUTF8",
     "endsWithCaseInsensitive", "endsWithCaseInsensitiveUTF8"},
    ...
    {"domain", "domainWithoutWWW", "topLevelDomain", "protocol", "path", "queryString", "fragment", "firstSignificantSubdomain",
    ...
    {"simpleJSONHas", "simpleJSONExtractBool", "simpleJSONExtractFloat", "simpleJSONExtractInt", "simpleJSONExtractRaw",
     "simpleJSONExtractString", "simpleJSONExtractUInt"}};
...
void QueryFuzzer::fuzz(ASTPtr &ast) {
  ...
  if (!inserted) {
    fmt::print(stderr,
               ...
               static_cast<void *>(ast.get()), current_ast_depth, debug_visited_nodes.size(), (*debug_top_ast)->dumpTree());
    std::abort();
  }
  ...
  if (auto *with_union = typeid_cast<ASTSelectWithUnionQuery *>(ast.get())) {
    ...
    if (union_members.size() > 1 && fuzz_rand() % 100 == 0) {
      ...
      if (!with_union->list_of_modes.empty()) with_union->list_of_modes.pop_back();
    ...
    if (table_expr->sample_size) {
      ...
      if (fuzz_rand() % 50 == 0) {
        ...
        if (table_expr->sample_offset) ch.erase(std::remove(ch.begin(), ch.end(), table_expr->sample_offset), ch.end());
    ...
    if (select->with()) {
      if (fuzz_rand() % 50 == 0) {
        ...
        if (fuzz_rand() % 200 == 0) select->recursive_with = !select->recursive_with;
    ...
    if (select->limitLength()) {
      if (fuzz_rand() % 50 == 0) select->limit_with_ties = !select->limit_with_ties;
      ...
      if (fuzz_rand() % 50 == 0) {
        ...
        if (select->limitOffset()) {
          if (fuzz_rand() % 50 == 0) select->setExpression(ASTSelectQuery::Expression::LIMIT_OFFSET, {});
        } else if (fuzz_rand() % 50 == 0) {
          select->setExpression(ASTSelectQuery::Expression::LIMIT_OFFSET,
                                make_intrusive<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 1001)));
        }
      }
    } else if (fuzz_rand() % 50 == 0) {
      /// Add a LIMIT clause
      select->setExpression(ASTSelectQuery::Expression::LIMIT_LENGTH, make_intrusive<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 1001)));
    }
    /// Fuzz LIMIT BY offset/length
    if (select->limitBy()) {
      if (select->limitByLength()) {
        if (fuzz_rand() % 50 == 0) select->setExpression(ASTSelectQuery::Expression::LIMIT_BY_LENGTH, {});
      } else if (fuzz_rand() % 50 == 0) {
        select->setExpression(ASTSelectQuery::Expression::LIMIT_BY_LENGTH,
                              make_intrusive<ASTLiteral>(static_cast<UInt64>(fuzz_rand() % 1001)));
      }
      if (select->limitByOffset()) {
        if (fuzz_rand() % 50 == 0) select->setExpression(ASTSelectQuery::Expression::LIMIT_BY_OFFSET, {});
      } else if (fuzz_rand() % 50 == 0) {
    ...
    if (select->settings()) {
      if (fuzz_rand() % 100 == 0) select->setExpression(ASTSelectQuery::Expression::SETTINGS, {});
    }
    ...
    for (auto &c : set->changes)
      if (fuzz_rand() % 50 == 0) c.value = fuzzField(c.value);
    ...
    if (fuzz_rand() % 100 == 0) create_query->attach = !create_query->attach;
    fuzzCreateQuery(*create_query);
  } else if (auto *drop_query = typeid_cast<ASTDropQuery *>(ast.get())) {
    /// Cycle between DROP / DETACH / TRUNCATE
    if (fuzz_rand() % 100 == 0) drop_query->kind = static_cast<ASTDropQuery::Kind>(fuzz_rand() % 3);
    /// DETACH PERMANENTLY: object survives server restart without re-attach
    if (drop_query->kind == ASTDropQuery::Detach && fuzz_rand() % 30 == 0) drop_query->permanently = !drop_query->permanently;
    /// DROP SYNC: wait for all mutations/merges to finish before returning
    if (drop_query->kind == ASTDropQuery::Drop && fuzz_rand() % 20 == 0) drop_query->sync = !drop_query->sync;
    ...
    if (insert_query->columns && insert_query->columns->children.size() > 1 && fuzz_rand() % 100 == 0) {
      insert_query->columns->children.erase(insert_query->columns->children.begin() + fuzz_rand() % insert_query->columns->children.size());
    }
    ...
    if (update_query->assignments && update_query->assignments->children.size() > 1 && fuzz_rand() % 50 == 0) {
      update_query->assignments->children.erase(update_query->assignments->children.begin() +
                                                fuzz_rand() % update_query->assignments->children.size());
    }
    ...
    switch (alter_cmd->type) {
      ...
      case ASTAlterCommand::UPDATE:
        ...
        if (alter_cmd->type == ASTAlterCommand::UPDATE && alter_cmd->update_assignments) {
          ...
          if (asgns.size() > 1 && fuzz_rand() % 50 == 0) asgns.erase(asgns.begin() + fuzz_rand() % asgns.size());
        }
        break;
      ...
      case ASTAlterCommand::MODIFY_COLUMN:
        ...
        if (alter_cmd->col_decl)
          if (auto *col = alter_cmd->col_decl->as<ASTColumnDeclaration>()) fuzzColumnDeclaration(*col);
        if (fuzz_rand() % 20 == 0) alter_cmd->first = !alter_cmd->first;
        break;
      case ASTAlterCommand::DROP_COLUMN:
        if (fuzz_rand() % 20 == 0) alter_cmd->clear_column = !alter_cmd->clear_column;
        break;
      case ASTAlterCommand::DROP_INDEX:
        if (fuzz_rand() % 20 == 0) alter_cmd->clear_index = !alter_cmd->clear_index;
        break;
      case ASTAlterCommand::DROP_PROJECTION:
        if (fuzz_rand() % 20 == 0) alter_cmd->clear_projection = !alter_cmd->clear_projection;
        break;
      case ASTAlterCommand::DROP_STATISTICS:
        if (fuzz_rand() % 20 == 0) alter_cmd->clear_statistics = !alter_cmd->clear_statistics;
        break;
      case ASTAlterCommand::DROP_PARTITION:
      case ASTAlterCommand::ATTACH_PARTITION:
      case ASTAlterCommand::MOVE_PARTITION:
      case ASTAlterCommand::DROP_DETACHED_PARTITION:
        if (fuzz_rand() % 20 == 0) alter_cmd->detach = !alter_cmd->detach;
        if (fuzz_rand() % 20 == 0) alter_cmd->part = !alter_cmd->part;
        break;
      default:
        break;
    }
    ...
    if (fuzz_rand() % 200 == 0) with_elem->name = "cte_" + std::to_string(fuzz_rand() % 10);
    ...
    if (fuzz_rand() % 200 == 0) interpolate_elem->column = "col_" + std::to_string(fuzz_rand() % 10);
    ...
    if (fuzz_rand() % 50 == 0) apply->column_name_prefix = fuzz_rand() % 2 == 0 ? "" : "f_";
    fuzz(apply->children);
  } else if (auto *except_transformer = typeid_cast<ASTColumnsExceptTransformer *>(ast.get())) {
    if (fuzz_rand() % 50 == 0) except_transformer->is_strict = !except_transformer->is_strict;
    fuzz(except_transformer->children);
  } else if (auto *replace_transformer = typeid_cast<ASTColumnsReplaceTransformer *>(ast.get())) {
    if (fuzz_rand() % 50 == 0) replace_transformer->is_strict = !replace_transformer->is_strict;
 ...
 */
void QueryFuzzer::collectFuzzInfoMain(ASTPtr ast) { collectFuzzInfoRecurse(ast); }
