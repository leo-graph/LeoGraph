...
class SipHash {
 ...
 public:
  ...
  /// ATTENTION: This is not constant method, if you call it several times, it will return different results, because of the finalization
  /// step.
...
inline UInt128 sipHash128(const char *data, const size_t size) { return sipHash128Keyed(0, 0, data, size); }

inline String sipHash128String(const char *data, const size_t size) { return getHexUIntLowercase(sipHash128(data, size)); }

inline String sipHash128String(const String &str) { return sipHash128String(str.data(), str.size()); }
...
inline UInt128 sipHash128Reference(const char *data, const size_t size) { return sipHash128ReferenceKeyed(0, 0, data, size); }
...
inline UInt64 sipHash64(const char *data, const size_t size) { return sipHash64Keyed(0, 0, data, size); }
...
inline UInt64 sipHash64(const std::string &s) { return sipHash64(s.data(), s.size()); }
