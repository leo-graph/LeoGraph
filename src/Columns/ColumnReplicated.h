...
class ColumnReplicated final : public COWHelper<IColumnHelper<ColumnReplicated>, ColumnReplicated> {
 ...
 public:
  ...
  static Ptr create(const ColumnPtr& nested_column_) { return Base::create(nested_column_->assumeMutable()); }
  ...
  static MutablePtr create(MutableColumnPtr&& nested_column_) { return Base::create(std::move(nested_column_)); }
