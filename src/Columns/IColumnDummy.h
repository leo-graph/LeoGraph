...
class IColumnDummy : public IColumnHelper<IColumnDummy> {
 public:
  ...
  std::string_view getDataAt(size_t) const override { return {}; }
  ...
  WeakHash32 getWeakHash32() const override { return WeakHash32(s); }
  ...
  void updatePermutation(IColumn::PermutationSortDirection /*direction*/, IColumn::PermutationSortStability /*stability*/, size_t, int,
                         Permutation &, EqualRanges &) const override {}
