...
class IColumnUnique : public IColumn {
 public:
  ...
  virtual IndexesWithOverflow uniqueInsertRangeWithOverflow(const IColumn &src, size_t start, size_t length,
  ...
  void insert(const Field &) override { throwNotImplementedForColumnUnique("insert"); }

  bool tryInsert(const Field &) override { throwNotImplementedForColumnUnique("tryInsert"); }
  ...
  void insertData(const char *, size_t) override { throwNotImplementedForColumnUnique("insertData"); }

  void insertDefault() override { throwNotImplementedForColumnUnique("insertDefault"); }

  void popBack(size_t) override { throwNotImplementedForColumnUnique("popBack"); }

  void gather(ColumnGathererStream &) override { throwNotImplementedForColumnUnique("gather"); }
  ...
  ColumnPtr index(const IColumn &, size_t) const override { throwNotImplementedForColumnUnique("index"); }

  ColumnPtr cut(size_t, size_t) const override { throwNotImplementedForColumnUnique("cut"); }

  ColumnPtr filter(const IColumn::Filter &, ssize_t) const override { throwNotImplementedForColumnUnique("filter"); }

  void filter(const IColumn::Filter &) override { throwNotImplementedForColumnUnique("in-place filter"); }

  void expand(const IColumn::Filter &, bool) override { throwNotImplementedForColumnUnique("expand"); }

  ColumnPtr permute(const IColumn::Permutation &, size_t) const override { throwNotImplementedForColumnUnique("permute"); }

  ColumnPtr replicate(const IColumn::Offsets &) const override { throwNotImplementedForColumnUnique("replicate"); }

  void getPermutation(IColumn::PermutationSortDirection, IColumn::PermutationSortStability, size_t, int,
                      IColumn::Permutation &) const override {
  ...
  std::vector<MutableColumnPtr> scatter(size_t, const IColumn::Selector &) const override { throwNotImplementedForColumnUnique("scatter"); }

  WeakHash32 getWeakHash32() const override { throwNotImplementedForColumnUnique("getWeakHash32"); }

  void updateHashFast(SipHash &) const override { throwNotImplementedForColumnUnique("updateHashFast"); }

  void compareColumn(const IColumn &, size_t, PaddedPODArray<UInt64> *, PaddedPODArray<Int8> &, int, int) const override {
    throwNotImplementedForColumnUnique("compareColumn");
  }

  bool hasEqualValues() const override { throwNotImplementedForColumnUnique("hasEqualValues"); }

  ColumnPtr updateFrom(const IColumn::Patch &) const override { throwNotImplementedForColumnUnique("updateFrom"); }

  void updateInplaceFrom(const IColumn::Patch &) override { throwNotImplementedForColumnUnique("updateInplaceFrom"); }
