...
class ColumnObject final : public COWHelper<IColumnHelper<ColumnObject>, ColumnObject> {
 ...
 private:
  ...
  ColumnObject(std::unordered_map<String, MutableColumnPtr> typed_paths_, std::unordered_map<String, MutableColumnPtr> dynamic_paths_,
               MutableColumnPtr shared_data_, size_t max_dynamic_paths_, size_t global_max_dynamic_paths_, size_t max_dynamic_types_,
  ...
  using PathToColumnMap =
      std::unordered_map<String, WrappedPtr, StringHashForHeterogeneousLookup, StringHashForHeterogeneousLookup::transparent_key_equal>;
  using PathToDynamicColumnPtrMap = std::unordered_map<String, ColumnDynamic *, StringHashForHeterogeneousLookup,
 ...
 public:
  ...
  static Ptr create(const std::unordered_map<String, ColumnPtr> &typed_paths_, const std::unordered_map<String, ColumnPtr> &dynamic_paths_,
                    const ColumnPtr &shared_data_, size_t max_dynamic_paths_, size_t global_max_dynamic_paths_, size_t max_dynamic_types_,
                    const StatisticsPtr &statistics_ = {});

  static MutablePtr create(std::unordered_map<String, MutableColumnPtr> typed_paths_,
  ...
  size_t size() const override { return shared_data->size(); }
  ...
  void getPermutation(PermutationSortDirection direction, PermutationSortStability stability, size_t limit, int nan_direction_hint,
                      Permutation &res) const override;
  void updatePermutation(PermutationSortDirection direction, PermutationSortStability stability, size_t limit, int nan_direction_hint,
                         Permutation &res, EqualRanges &equal_ranges) const override;
  ...
  static std::tuple<const ColumnString *, const ColumnString *, const Offsets *> getSharedDataPathsValuesAndOffsets(
  ...
  static void serializePathAndValueIntoSharedData(ColumnString *shared_data_paths, ColumnString *shared_data_values, std::string_view path,
                                                  const ColumnDynamic &column, size_t n);
  ...
  static void fillPathColumnFromSharedData(IColumn &path_column, std::string_view path, const ColumnPtr &shared_data_column, size_t start,
                                           size_t end);
 ...
 private:
  void insertFromSharedDataAndFillRemainingDynamicPaths(const ColumnObject &src_object_column,
                                                        std::vector<std::string_view> &&src_dynamic_paths_for_shared_data, size_t start,
                                                        size_t length);
  void serializePathAndValueIntoArena(Arena &arena, const char *&begin, std::string_view path, std::string_view value,
