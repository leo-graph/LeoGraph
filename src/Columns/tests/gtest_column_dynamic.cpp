...
TEST(ColumnDynamic, InsertFields) {
  ...
  std::unordered_map<String, UInt8> expected_variant_name_to_discriminator = {
      {"Float64", 0}, {"Int8", 1}, {"SharedVariant", 2}, {"String", 3}};
...
ColumnDynamic::MutablePtr getDynamicWithManyVariants(size_t num_variants, Field tuple_element = Field(42)) {
  ...
  for (size_t i = 0; i != num_variants; ++i) {
    Tuple tuple;
    for (size_t j = 0; j != i + 1; ++j) tuple.push_back(tuple_element);
    column->insert(tuple);
  }
...
void checkInsertFrom(const ColumnDynamic::MutablePtr &column_from, ColumnDynamic::MutablePtr &column_to,
                     const std::string &expected_variant, const std::vector<String> &expected_names,
                     const std::unordered_map<String, UInt8> &expected_variant_name_to_discriminator) {
...
TEST(ColumnDynamic, InsertFrom1) {
  ...
  checkInsertFrom(getInsertFromColumn(), column_to, "Variant(Float64, Int8, SharedVariant, String)",
                  {"Float64", "Int8", "SharedVariant", "String"}, {{"Float64", 0}, {"Int8", 1}, {"SharedVariant", 2}, {"String", 3}});
}
...
TEST(ColumnDynamic, InsertFrom3) {
  ...
  checkInsertFrom(getInsertFromColumn(), column_to, "Variant(Array(Int8), Float64, Int8, SharedVariant, String)",
                  {"Array(Int8)", "Float64", "Int8", "SharedVariant", "String"},
                  {{"Array(Int8)", 0}, {"Float64", 1}, {"Int8", 2}, {"SharedVariant", 3}, {"String", 4}});
}
...
void checkInsertManyFrom(const ColumnDynamic::MutablePtr &column_from, ColumnDynamic::MutablePtr &column_to,
                         const std::string &expected_variant, const std::vector<String> &expected_names,
                         const std::unordered_map<String, UInt8> &expected_variant_name_to_discriminator) {
...
TEST(ColumnDynamic, InsertManyFrom1) {
  auto column_to = ColumnDynamic::create(254);
  checkInsertManyFrom(getInsertFromColumn(), column_to, "Variant(Float64, Int8, SharedVariant, String)",
                      {"Float64", "Int8", "SharedVariant", "String"}, {{"Float64", 0}, {"Int8", 1}, {"SharedVariant", 2}, {"String", 3}});
}
...
TEST(ColumnDynamic, InsertManyFrom3) {
  ...
  checkInsertManyFrom(getInsertFromColumn(), column_to, "Variant(Array(Int8), Float64, Int8, SharedVariant, String)",
                      {"Array(Int8)", "Float64", "Int8", "SharedVariant", "String"},
                      {{"Array(Int8)", 0}, {"Float64", 1}, {"Int8", 2}, {"SharedVariant", 3}, {"String", 4}});
}
...
void checkInsertRangeFrom(const ColumnDynamic::MutablePtr &column_from, ColumnDynamic::MutablePtr &column_to,
                          const std::string &expected_variant, const std::vector<String> &expected_names,
                          const std::unordered_map<String, UInt8> &expected_variant_name_to_discriminator) {
...
TEST(ColumnDynamic, InsertRangeFrom1) {
  auto column_to = ColumnDynamic::create(254);
  checkInsertRangeFrom(getInsertFromColumn(2), column_to, "Variant(Float64, Int8, SharedVariant, String)",
                       {"Float64", "Int8", "SharedVariant", "String"}, {{"Float64", 0}, {"Int8", 1}, {"SharedVariant", 2}, {"String", 3}});
}
...
TEST(ColumnDynamic, InsertRangeFrom3) {
  ...
  checkInsertRangeFrom(getInsertFromColumn(2), column_to, "Variant(Array(Int8), Float64, Int8, SharedVariant, String)",
                       {"Array(Int8)", "Float64", "Int8", "SharedVariant", "String"},
                       {{"Array(Int8)", 0}, {"Float64", 1}, {"Int8", 2}, {"SharedVariant", 3}, {"String", 4}});
}
...
TEST(ColumnDynamic, rollback) {
  ...
  dynamic_checkpoints.emplace_back(column->getCheckpoint(),
                                   std::unordered_map<String, size_t>{{"SharedVariant", 0}, {"Int8", 1}, {"String", 1}});

  column->insert("str2");
  variant_checkpoints_sizes.emplace_back(std::vector<size_t>{0, 1, 2});
  dynamic_checkpoints.emplace_back(column->getCheckpoint(),
                                   std::unordered_map<String, size_t>{{"SharedVariant", 0}, {"Int8", 1}, {"String", 2}});

  column->insert(Array({1, 2}));
  variant_checkpoints_sizes.emplace_back(std::vector<size_t>{1, 1, 2});
  dynamic_checkpoints.emplace_back(column->getCheckpoint(),
                                   std::unordered_map<String, size_t>{{"SharedVariant", 1}, {"Int8", 1}, {"String", 2}});

  column->insert(Field(42.42));
  variant_checkpoints_sizes.emplace_back(std::vector<size_t>{2, 1, 2});
  dynamic_checkpoints.emplace_back(column->getCheckpoint(),
                                   std::unordered_map<String, size_t>{{"SharedVariant", 2}, {"Int8", 1}, {"String", 2}});
...
TEST(ColumnDynamic, InsertRangeFrom4) {
  ...
  for (const auto &variant : column_to->getVariantColumn().getVariants()) total_variants_sizes += variant->size();
