...
void stableGetColumnPermutation(const IColumn& column, IColumn::PermutationSortDirection direction, size_t limit, int nan_direction_hint,
...
void columnGetPermutation(const IColumn& column, IColumn::PermutationSortDirection direction, size_t limit, int nan_direction_hint,
                          IColumn::Permutation& out_permutation) {
...
void assertColumnPermutation(const IColumn& column, IColumn::PermutationSortDirection direction, size_t limit, int nan_direction_hint,
                             IColumn::Permutation& actual_permutation, IColumn::Permutation& expected_permutation) {
...
void assertColumnPermutations(ColumnCreateFunc column_create_func, ValueTransform value_transform) {
  ...
  for (const auto& range_size : range_sizes) {
    ...
    while (true) {
      ...
      if (!std::next_permutation(ranges_permutations.begin(), ranges_permutations.end())) break;
    }
  }
}
...
struct IndexInRangeDecimal64Transform {
  Field operator()(size_t range_index, size_t index_in_range) const { return Field(static_cast<Decimal64>(range_index * index_in_range)); }
};
...
TEST(StablePermutation, ColumnTuple) {
  ...
  }
  {
    ...
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeNullableTransform<IndexInRangeInt64Transform>, IndexInRangeFloat64Transform>());
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeNullableTransform<IndexInRangeToNullTransform>, IndexInRangeFloat64Transform>());
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeNullableTransform<IndexInRangeInt64Transform>, IndexInRangeFloat64Transform>());
  }
  {
    ...
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeFloat64Transform, IndexInRangeNullableTransform<IndexInRangeInt64Transform>>());
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeFloat64Transform, IndexInRangeNullableTransform<IndexInRangeToNullTransform>>());
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeFloat64Transform, IndexInRangeNullableTransform<IndexInRangeInt64Transform>>());
  }
  {
    ...
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeNullableTransform<IndexInRangeFloat64Transform>, IndexInRangeFloat64Transform>());
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeNullableTransform<IndexInRangeToNullTransform>, IndexInRangeFloat64Transform>());
    assertColumnPermutations(create_column,
                             TupleTransform<IndexInRangeNullableTransform<IndexInRangeFloat64Transform>, IndexInRangeFloat64Transform>());
