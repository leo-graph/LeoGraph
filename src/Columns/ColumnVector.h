...
class ColumnVector final : public COWHelper<IColumnHelper<ColumnVector<T>, ColumnFixedSizeHelper>, ColumnVector<T>> {
 ...
 public:
  ...
  void popBack(size_t n) override {
    if (n > size()) throwCannotPopBack(n, this->getName(), size());
  ...
  ColumnPtr createWithOffsets(const IColumn::Offsets &offsets, const ColumnConst &column_with_default_value, size_t total_rows,
