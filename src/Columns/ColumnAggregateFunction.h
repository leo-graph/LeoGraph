...
class ColumnAggregateFunction final : public COWHelper<IColumnHelper<ColumnAggregateFunction>, ColumnAggregateFunction> {
 ...
 public:
  ...
  double getRatioOfDefaultRows(double) const override { return 0.0; }

  UInt64 getNumberOfDefaultRows() const override { return 0; }
  ...
  void updatePermutation(PermutationSortDirection direction, PermutationSortStability stability, size_t limit, int, Permutation &res,
