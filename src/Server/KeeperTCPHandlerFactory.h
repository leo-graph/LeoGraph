...
class KeeperTCPHandlerFactory : public TCPServerConnectionFactory {
 ...
 public:
  KeeperTCPHandlerFactory(ConfigGetter config_getter_, std::shared_ptr<KeeperDispatcher> keeper_dispatcher_,
                          uint64_t receive_timeout_seconds, uint64_t send_timeout_seconds, bool secure)
