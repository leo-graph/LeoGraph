...
ProtocolServerAdapter::ProtocolServerAdapter(const std::string& listen_host_, const char* port_name_, const std::string& description_,
                                             std::unique_ptr<TCPServer> tcp_server_, bool supports_runtime_reconfiguration_)
...
ProtocolServerAdapter::ProtocolServerAdapter(const std::string& listen_host_, const char* port_name_, const std::string& description_,
                                             std::unique_ptr<IGRPCServer> grpc_server_, bool supports_runtime_reconfiguration_)
    : listen_host(listen_host_),
      port_name(port_name_),
      description(description_),
