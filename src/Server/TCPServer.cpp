...
TCPServer::TCPServer(TCPServerConnectionFactory::Ptr factory_, Poco::ThreadPool& thread_pool, Poco::Net::ServerSocket& socket_,
                     Poco::Net::TCPServerParams::Ptr params, const TCPServerConnectionFilter::Ptr& filter)
