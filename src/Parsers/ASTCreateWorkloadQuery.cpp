...
void ASTCreateWorkloadQuery::formatImpl(WriteBuffer &ostr, const IAST::FormatSettings &format, IAST::FormatState &,
...
bool ASTCreateWorkloadQuery::hasParent() const { return workload_parent != nullptr; }
