...
String ASTEnumDataType::getID(char delim) const { return "EnumDataType" + (delim + name); }
...
void ASTEnumDataType::formatImpl(WriteBuffer& ostr, const FormatSettings& /*settings*/, FormatState& /*state*/,
