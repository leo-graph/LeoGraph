...
bool parseIntervalKind(IParser::Pos& pos, Expected& expected, IntervalKind& result) {
  if (ParserKeyword(Keyword::NANOSECOND).ignore(pos, expected) || ParserKeyword(Keyword::NANOSECONDS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_NANOSECOND).ignore(pos, expected) || ParserKeyword(Keyword::NS).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::MILLISECOND).ignore(pos, expected) || ParserKeyword(Keyword::MILLISECONDS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_MILLISECOND).ignore(pos, expected) || ParserKeyword(Keyword::MS).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::SECOND).ignore(pos, expected) || ParserKeyword(Keyword::SECONDS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_SECOND).ignore(pos, expected) || ParserKeyword(Keyword::SS).ignore(pos, expected) ||
      ParserKeyword(Keyword::S).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::MINUTE).ignore(pos, expected) || ParserKeyword(Keyword::MINUTES).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_MINUTE).ignore(pos, expected) || ParserKeyword(Keyword::MI).ignore(pos, expected) ||
      ParserKeyword(Keyword::N).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::HOUR).ignore(pos, expected) || ParserKeyword(Keyword::HOURS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_HOUR).ignore(pos, expected) || ParserKeyword(Keyword::HH).ignore(pos, expected) ||
      ParserKeyword(Keyword::H).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::DAY).ignore(pos, expected) || ParserKeyword(Keyword::DAYS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_DAY).ignore(pos, expected) || ParserKeyword(Keyword::DD).ignore(pos, expected) ||
      ParserKeyword(Keyword::D).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::WEEK).ignore(pos, expected) || ParserKeyword(Keyword::WEEKS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_WEEK).ignore(pos, expected) || ParserKeyword(Keyword::WK).ignore(pos, expected) ||
      ParserKeyword(Keyword::WW).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::MONTH).ignore(pos, expected) || ParserKeyword(Keyword::MONTHS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_MONTH).ignore(pos, expected) || ParserKeyword(Keyword::MM).ignore(pos, expected) ||
      ParserKeyword(Keyword::M).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::QUARTER).ignore(pos, expected) || ParserKeyword(Keyword::QUARTERS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_QUARTER).ignore(pos, expected) || ParserKeyword(Keyword::QQ).ignore(pos, expected) ||
      ParserKeyword(Keyword::Q).ignore(pos, expected)) {
  ...
  if (ParserKeyword(Keyword::YEAR).ignore(pos, expected) || ParserKeyword(Keyword::YEARS).ignore(pos, expected) ||
      ParserKeyword(Keyword::SQL_TSI_YEAR).ignore(pos, expected) || ParserKeyword(Keyword::YYYY).ignore(pos, expected) ||
      ParserKeyword(Keyword::YY).ignore(pos, expected)) {
