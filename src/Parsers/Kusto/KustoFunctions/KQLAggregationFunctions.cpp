...
bool ArgMax::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "argMax"); }

bool ArgMin::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "argMin"); }

bool Avg::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "avg"); }

bool AvgIf::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "avgIf"); }

bool BinaryAllAnd::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "groupBitAnd"); }

bool BinaryAllOr::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "groupBitOr"); }

bool BinaryAllXor::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "groupBitXor"); }
...
bool Count::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "count"); }

bool CountIf::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "countIf"); }
...
bool Max::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "max"); }

bool MaxIf::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "maxIf"); }

bool Min::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "min"); }

bool MinIf::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "minIf"); }
...
bool Percentiles::convertImpl(String& out, IParser::Pos& pos) {
  ...
  while (pos->type != TokenType::ClosingRoundBracket) {
    if (pos->type != TokenType::Comma) {
      ...
      expr = expr + value + "/100";
      ++pos;
      if (pos->type != TokenType::ClosingRoundBracket) expr += ", ";
    } else
      ++pos;
  }
...
bool PercentilesArray::convertImpl(String& out, IParser::Pos& pos) {
  ...
  ++pos;
  if (pos->type != TokenType::ClosingRoundBracket) --pos;
...
bool StdevIf::convertImpl(String& out, IParser::Pos& pos) {
  ...
  ++pos;
  const auto expr = getConvertedArgument(fn_name, pos);
  if (pos->type != TokenType::Comma) return false;
...
bool Sum::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "sum"); }

bool SumIf::convertImpl(String& out, IParser::Pos& pos) { return directMapping(out, pos, "sumIf"); }
