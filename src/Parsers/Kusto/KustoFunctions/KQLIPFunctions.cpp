...
bool Ipv4Compare::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      kqlCallToExpression("ipv4_netmask_suffix", {rhs}, pos.max_depth, pos.max_backtracks), mask ? *mask : "32",
...
bool Ipv4IsInRange::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      ip_address, kqlCallToExpression("parse_ipv4", {ip_range}, pos.max_depth, pos.max_backtracks),
      kqlCallToExpression("ipv4_netmask_suffix", {ip_range}, pos.max_depth, pos.max_backtracks), generateUniqueIdentifier());
  return true;
}
...
bool Ipv4IsMatch::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out =
      fmt::format("equals({}, 0)", kqlCallToExpression("ipv4_compare", {lhs, rhs, mask ? *mask : "32"}, pos.max_depth, pos.max_backtracks));
  return true;
}
...
bool Ipv4NetmaskSuffix::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      ip_range, generateUniqueIdentifier());
  return true;
}
...
bool ParseIpv4::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      ip_address, generateUniqueIdentifier());
  return true;
}
...
bool ParseIpv4Mask::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      ip_address, mask, generateUniqueIdentifier());
  return true;
}
...
bool Ipv6Compare::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      generateUniqueIdentifier(), lhs, rhs, calculated_mask);
  return true;
}
...
bool Ipv6IsMatch::convertImpl(String& out, IParser::Pos& pos) {
  ...
  const auto rhs = getArgument(function_name, pos, ArgumentState::Raw);
  const auto mask = getOptionalArgument(function_name, pos, ArgumentState::Raw);
  out = fmt::format("equals({}, 0)",
                    kqlCallToExpression("ipv6_compare", {lhs, rhs, mask ? *mask : "128"}, pos.max_depth, pos.max_backtracks));
  return true;
}
...
bool ParseIpv6Mask::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      kqlCallToExpression("parse_ipv6", {"strcat(tostring(parse_ipv6(" + ip_address + ")), '/', tostring(" + mask + "))"}, pos.max_depth,
                          pos.max_backtracks),
      kqlCallToExpression("parse_ipv6", {"ipv4_" + unique_identifier}, pos.max_depth, pos.max_backtracks), unique_identifier);
  return true;
}
...
bool FormatIpv4::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      ParserKQLBase::getExprFromToken(ip_address, pos.max_depth, pos.max_backtracks), mask ? *mask : "32",
      kqlCallToExpression("parse_ipv4", {"tostring(" + ip_address + ")"}, pos.max_depth, pos.max_backtracks), generateUniqueIdentifier());
  return true;
}
...
bool FormatIpv4Mask::convertImpl(String& out, IParser::Pos& pos) {
  ...
  out = fmt::format(
      ...
      kqlCallToExpression("format_ipv4", {ip_address, calculated_mask}, pos.max_depth, pos.max_backtracks), generateUniqueIdentifier(),
