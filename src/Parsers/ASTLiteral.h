...
class ASTLiteral : public ASTWithAlias {
 ...
 public:
  ...
  void setUseLegacyColumnNameOfTuple(bool _value) { flags<ASTLiteralFlags>().use_legacy_column_name_of_tuple = _value; }

  bool getUseLegacyColumnNameOfTuple() const { return flags<ASTLiteralFlags>().use_legacy_column_name_of_tuple; }
