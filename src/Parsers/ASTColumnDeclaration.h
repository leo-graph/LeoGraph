...
enum class ColumnDefaultSpecifier : UInt8 { Empty = 0, Default, Materialized, Alias, Ephemeral, AutoIncrement };
...
class ASTColumnDeclaration : public IAST {
 ...
 private:
  ...
  enum IndexSlot : UInt8 { TYPE = 0, DEFAULT_EXPR = 4, COMMENT = 8, CODEC = 12, STATS = 16, TTL = 20, COLLATION = 24, SETTINGS = 28 };
