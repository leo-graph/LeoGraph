 ...
 *     [SETTINGS variable [= value] [MIN [=] min_value] [MAX [=] max_value] [CONST|READONLY|WRITABLE|CHANGEABLE_IN_READONLY] | PROFILE
 * 'profile_name'] [,...] [TO {role [,...] | ALL | ALL EXCEPT role [,...]}]
 *
 ...
 * PROFILES] [DROP ALL SETTINGS] [TO {role [,...] | ALL | ALL EXCEPT role [,...]}]
 */
class ASTCreateSettingsProfileQuery : public IAST, public ASTQueryWithOnCluster {
 public:
  ...
  ASTPtr getRewrittenASTWithoutOnCluster(const WithoutOnClusterASTRewriteParams &) const override {
    return removeOnCluster<ASTCreateSettingsProfileQuery>(clone());
  }
