...
class ParserSettingsProfileElement : public IParserBase {
 public:
  ParserSettingsProfileElement& useIDMode(bool id_mode_ = true) {
    id_mode = id_mode_;
    return *this;
  }
  ParserSettingsProfileElement& useInheritKeyword(bool use_inherit_keyword_ = true) {
    use_inherit_keyword = use_inherit_keyword_;
    return *this;
  }
...
class ParserSettingsProfileElements : public IParserBase {
 public:
  ParserSettingsProfileElements& useIDMode(bool id_mode_ = true) {
    id_mode = id_mode_;
    return *this;
  }
  ParserSettingsProfileElements& useInheritKeyword(bool use_inherit_keyword_ = true) {
    use_inherit_keyword = use_inherit_keyword_;
    return *this;
  }
...
class ParserAlterSettingsProfileElements : public IParserBase {
 public:
  ParserAlterSettingsProfileElements& useInheritKeyword(bool use_inherit_keyword_ = true) {
    use_inherit_keyword = use_inherit_keyword_;
    return *this;
  }
