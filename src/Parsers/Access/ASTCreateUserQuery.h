 ...
 * [,...] | ANY | NONE] [DEFAULT ROLE role [,...]] [DEFAULT DATABASE database | NONE] [SETTINGS variable [= value] [MIN [=] min_value] [MAX
 * [=] max_value] [CONST|READONLY|WRITABLE|CHANGEABLE_IN_READONLY] | PROFILE 'profile_name'] [,...] [GRANTEES {user | role | ANY | NONE}
 * [,...] [EXCEPT {user | role} [,...]]]
 *
...
class ASTCreateUserQuery : public IAST, public ASTQueryWithOnCluster {
 public:
  ...
  ASTPtr getRewrittenASTWithoutOnCluster(const WithoutOnClusterASTRewriteParams &) const override {
    return removeOnCluster<ASTCreateUserQuery>(clone());
  }
