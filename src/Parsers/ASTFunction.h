...
inline boost::intrusive_ptr<ASTFunction> addParametersToAggregateFunction(boost::intrusive_ptr<ASTFunction> &&function) {
  return std::move(function);
}

template <typename... OtherParameters>
boost::intrusive_ptr<ASTFunction> addParametersToAggregateFunction(boost::intrusive_ptr<ASTFunction> &&function, ASTPtr parameter,
