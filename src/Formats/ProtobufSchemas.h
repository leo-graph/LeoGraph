 ...
 public:
  ...
  struct DescriptorHolder {
    DescriptorHolder(std::shared_ptr<ImporterWithSourceTree> importer_, const google::protobuf::Descriptor* message_descriptor_)
        : importer(std::move(importer_)), message_descriptor(message_descriptor_) {}
  ...
  DescriptorHolder getMessageTypeForFormatSchema(const FormatSchemaInfo& info, WithEnvelope with_envelope,
