...
class NumpyDataTypeInt : public NumpyDataType {
 public:
  NumpyDataTypeInt(Endianness endianness_, size_t size_, bool is_signed_) : NumpyDataType(endianness_), size(size_), is_signed(is_signed_) {
    switch (size) {
      case 1:
        type_index = is_signed ? NumpyDataTypeIndex::Int8 : NumpyDataTypeIndex::UInt8;
        break;
      case 2:
        type_index = is_signed ? NumpyDataTypeIndex::Int16 : NumpyDataTypeIndex::UInt16;
        break;
      case 4:
        type_index = is_signed ? NumpyDataTypeIndex::Int32 : NumpyDataTypeIndex::UInt32;
        break;
      case 8:
        type_index = is_signed ? NumpyDataTypeIndex::Int64 : NumpyDataTypeIndex::UInt64;
        break;
      default:
...
class NumpyDataTypeFloat : public NumpyDataType {
 public:
  NumpyDataTypeFloat(Endianness endianness_, size_t size_) : NumpyDataType(endianness_), size(size_) {
    switch (size) {
      case 2:
        type_index = NumpyDataTypeIndex::Float16;
        break;
      case 4:
        type_index = NumpyDataTypeIndex::Float32;
        break;
      case 8:
        type_index = NumpyDataTypeIndex::Float64;
        break;
      default:
