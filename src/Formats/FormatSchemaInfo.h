...
class FormatSchemaInfo {
 public:
  FormatSchemaInfo(const String& format_schema_source, const String& format_schema, const String& format_schema_message_name,
                   const String& format, bool require_message, bool is_server, const String& format_schema_path, bool generated_ = false);
 ...
 private:
  void handleSchemaFile(const String& format_schema, const String& format, bool require_message, bool is_server,
...
class MaybeAutogeneratedFormatSchemaInfo {
 public:
  MaybeAutogeneratedFormatSchemaInfo(const FormatSettings& settings, const String& format, const Block& header,
                                     bool use_autogenerated_schema, bool with_envelope = false);
