...
class RemoteQueryExecutorReadContext : public AsyncTaskExecutor {
 public:
  explicit RemoteQueryExecutorReadContext(RemoteQueryExecutor& executor_, bool suspend_when_query_sent_, bool read_packet_type_separately_);
 ...
 private:
  ...
  enum class PacketPart : uint8_t { None = 0, Type = 1, Body = 2 };
