...
size_t ProfileInfo::getRowsBeforeLimit() const { return rows_before_limit; }

bool ProfileInfo::hasAppliedLimit() const { return applied_limit; }

size_t ProfileInfo::getRowsBeforeAggregation() const { return rows_before_aggregation; }

bool ProfileInfo::hasAppliedAggregation() const { return applied_aggregation; }

void ProfileInfo::update(Block& block) { update(block.rows(), block.bytes()); }
