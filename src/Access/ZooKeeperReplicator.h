...
class ZooKeeperReplicator {
 public:
  ZooKeeperReplicator(const String& storage_name_, const String& zookeeper_path_, zkutil::GetZooKeeper get_zookeeper_,
                      AccessChangesNotifier& changes_notifier_, MemoryAccessStorage& memory_storage_, bool throw_on_invalid_entities_);
 ...
 private:
  ...
  bool updateZooKeeper(const zkutil::ZooKeeperPtr& zookeeper, const UUID& id, const IAccessStorage::UpdateFunc& update_func,
