...
class ReplicatedAccessStorage : public IAccessStorage {
 public:
  ...
  ReplicatedAccessStorage(const String& storage_name, const String& zookeeper_path, zkutil::GetZooKeeper get_zookeeper,
                          AccessChangesNotifier& changes_notifier_, bool allow_backup, bool throw_on_invalid_entities_);
 ...
 private:
  bool insertImpl(const UUID& id, const AccessEntityPtr& new_entity, bool replace_if_exists, bool throw_if_exists,
