...
class GrantedRoles {
 public:
  ...
  friend bool operator==(const GrantedRoles& left, const GrantedRoles& right) {
    return (left.roles == right.roles) && (left.roles_with_admin_option == right.roles_with_admin_option);
  }
