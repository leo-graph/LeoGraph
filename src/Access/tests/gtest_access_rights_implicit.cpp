...
AccessFlags addImplicitPrivileges(AccessFlags flags, const AccessFlags& /*min_flags_with_children*/,
                                  const AccessFlags& max_flags_with_children, const size_t level, bool /*grant_option*/,
  ...
  if ((res & AccessFlags::allTableFlags()) || (level <= 2 && (res & show_columns)) ||
