...
class ContextAccessParams {
 public:
  ContextAccessParams(std::optional<UUID> user_id_, bool full_access_, bool use_default_roles_,
                      ...
                      const String& current_database_, const ClientInfo& client_info_, const std::optional<UUID>& initial_user_id_);
