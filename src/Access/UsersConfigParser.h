...
class UsersConfigParser {
 public:
  ...
  std::vector<AccessEntityPtr> parseRoles(const Poco::Util::AbstractConfiguration& config,
                                          const std::unordered_set<UUID>& role_ids_from_users_config) const;
  ...
  std::vector<AccessEntityPtr> parseSettingsProfiles(const Poco::Util::AbstractConfiguration& config,
  ...
  static std::unordered_set<UUID> getAllowedIDs(const Poco::Util::AbstractConfiguration& config, const String& configuration_key,
