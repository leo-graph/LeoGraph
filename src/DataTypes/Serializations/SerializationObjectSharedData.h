...
class SerializationObjectSharedData final : public SimpleTextSerialization {
 public:
  struct SerializationVersion {
    enum Value {
      ...
      ///     <marks of the beginning of the substreams list and substreams marks of each path in ObjectSharedDataSubstreams and
      ///     ObjectSharedDataSubstreamsMarks streams>
      ...
      ///     <indexes of paths stored in the shared data Map key column in a combined list of paths serialized in all buckets in
      ///     ObjectSharedDataStructure stream>
  ...
  SerializationObjectSharedData(SerializationVersion serialization_version_, const DataTypePtr &dynamic_type_,
 ...
 private:
  ...
  struct SubstreamsCacheStructureElement : public ISerialization::ISubstreamsCacheElement {
    explicit SubstreamsCacheStructureElement(std::shared_ptr<StructureGranules> structure_granules_)
        : structure_granules(structure_granules_) {}
  ...
  static DeserializeBinaryBulkStatePtr deserializeStructureStatePrefix(DeserializeBinaryBulkSettings &settings,
                                                                       SubstreamsDeserializeStatesCache *cache);

  /// Deserialize data from ObjectSharedDataStructure stream with specified offset/limit.
  static std::shared_ptr<StructureGranules> deserializeStructure(size_t rows_offset, size_t limit, DeserializeBinaryBulkSettings &settings,
  ...
  static void deserializeStructureGranulePrefix(ReadBuffer &buf, StructureGranule &structure_granule,
  ...
  struct SubstreamsCachePathsInfosElement : public ISubstreamsCacheElement {
    explicit SubstreamsCachePathsInfosElement(std::shared_ptr<PathsInfosGranules> paths_infos_granules_)
        : paths_infos_granules(paths_infos_granules_) {}
  ...
  static std::shared_ptr<PathsInfosGranules> deserializePathsInfos(
      ...
      DeserializeBinaryBulkSettings &settings, SubstreamsCache *cache);
  ...
  struct SubstreamsCachePathsDataElement : public ISubstreamsCacheElement {
    explicit SubstreamsCachePathsDataElement(std::shared_ptr<PathsDataGranules> paths_data_granules_)
        : paths_data_granules(paths_data_granules_) {}
  ...
  static std::shared_ptr<PathsDataGranules> deserializePathsData(
      ...
      const SerializationObjectSharedData::DeserializeBinaryBulkStateObjectSharedDataStructure &structure_state,
      DeserializeBinaryBulkSettings &settings, const DataTypePtr &dynamic_type, const SerializationPtr &dynamic_serialization,
      SubstreamsCache *cache);
