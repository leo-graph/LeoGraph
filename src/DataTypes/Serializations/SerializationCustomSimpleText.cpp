...
String serializeToString(const SerializationCustomSimpleText& domain, const IColumn& column, size_t row_num,
...
bool tryDeserializeFromString(const SerializationCustomSimpleText& domain, IColumn& column, const String& s,
                              const FormatSettings& settings) {
  ReadBufferFromString istr(s);
...
SerializationCustomSimpleText::SerializationCustomSimpleText(const SerializationPtr& nested_) : SerializationWrapper(nested_) {}

bool SerializationCustomSimpleText::tryDeserializeText(DB::IColumn& column, DB::ReadBuffer& istr, const DB::FormatSettings& settings,
                                                       bool whole) const {
  try {
...
void SerializationCustomSimpleText::serializeTextEscaped(const IColumn& column, size_t row_num, WriteBuffer& ostr,
...
void SerializationCustomSimpleText::serializeTextQuoted(const IColumn& column, size_t row_num, WriteBuffer& ostr,
                                                        const FormatSettings& settings) const {
...
bool SerializationCustomSimpleText::tryDeserializeTextQuoted(IColumn& column, ReadBuffer& istr, const FormatSettings& settings) const {
  String str;
  if (!tryReadQuotedString(str, istr)) return false;
  return tryDeserializeFromString(*this, column, str, settings);
}

void SerializationCustomSimpleText::serializeTextCSV(const IColumn& column, size_t row_num, WriteBuffer& ostr,
                                                     const FormatSettings& settings) const {
...
void SerializationCustomSimpleText::serializeTextJSON(const IColumn& column, size_t row_num, WriteBuffer& ostr,
                                                      const FormatSettings& settings) const {
...
bool SerializationCustomSimpleText::tryDeserializeTextJSON(IColumn& column, ReadBuffer& istr, const FormatSettings& settings) const {
  String str;
  if (!tryReadJSONStringInto(str, istr, settings.json)) return false;
  return tryDeserializeFromString(*this, column, str, settings);
}

void SerializationCustomSimpleText::serializeTextXML(const IColumn& column, size_t row_num, WriteBuffer& ostr,
                                                     const FormatSettings& settings) const {
  writeXMLStringForTextElement(serializeToString(*this, column, row_num, settings), ostr);
}

void SerializationCustomSimpleText::serializeTextMarkdown(const IColumn& column, size_t row_num, WriteBuffer& ostr,
                                                          const FormatSettings& settings) const {
