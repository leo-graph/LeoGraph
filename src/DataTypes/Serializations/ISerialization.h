...
[[noreturn]] void throwInvalidSerializationState(const ISerialization *serialization, const std::type_info &expected,
...
class ISerialization : private boost::noncopyable, public std::enable_shared_from_this<ISerialization> {
 public:
   ...
   *  or serializeBinaryBulkWithMultipleStreams, deserializeBinaryBulkWithMultipleStreams, enumerateStreams methods (for cases with multiple
   * streams).
   *
  ...
  virtual void serializeBinaryBulkStatePrefix(const IColumn & /*column*/, SerializeBinaryBulkSettings & /*settings*/,
  ...
  virtual void deserializeBinaryBulkStatePrefix(DeserializeBinaryBulkSettings & /*settings*/, DeserializeBinaryBulkStatePtr & /*state*/,
   ...
   */
  virtual void serializeBinaryBulkWithMultipleStreams(const IColumn &column, size_t offset, size_t limit,
  ...
  virtual void deserializeBinaryBulkWithMultipleStreams(ColumnPtr &column, size_t rows_offset, size_t limit,
  ...
  /// If rows_offset is not 0, the deserialization process will skip the first rows_offset rows.
  virtual void deserializeBinaryBulk(IColumn &column, ReadBuffer &istr, size_t rows_offset, size_t limit, double avg_value_size_hint) const;
  ...
  virtual void serializeTextJSONPretty(const IColumn &column, size_t row_num, WriteBuffer &ostr, const FormatSettings &settings,
                                       size_t /*indent*/) const {
  ...
  static String getFileNameForRenamedColumnStream(const NameAndTypePair &column_from, const NameAndTypePair &column_to,
  ...
  static void addColumnWithNumReadRowsToSubstreamsCache(SubstreamsCache *cache, const SubstreamPath &path, ColumnPtr column,
                                                        size_t num_read_rows);
  static std::optional<std::pair<ColumnPtr, size_t>> getColumnWithNumReadRowsFromSubstreamsCache(SubstreamsCache *cache,
                                                                                                 const SubstreamPath &path);
  static void addElementToSubstreamsCache(SubstreamsCache *cache, const SubstreamPath &path,
  ...
  static void addToSubstreamsDeserializeStatesCache(SubstreamsDeserializeStatesCache *cache, const SubstreamPath &path,
                                                    DeserializeBinaryBulkStatePtr state);
  static DeserializeBinaryBulkStatePtr getFromSubstreamsDeserializeStatesCache(SubstreamsDeserializeStatesCache *cache,
                                                                               const SubstreamPath &path);
  ...
  static bool tryToChangeStreamFileNameSettingsForNotFoundStream(const SubstreamPath &substream_path,
  ...
  static bool insertDataFromSubstreamsCacheIfAny(SubstreamsCache *cache, const DeserializeBinaryBulkSettings &settings,
                                                 ColumnPtr &result_column);
  /// Perform insertion from column found in substreams cache.
  static void insertDataFromCachedColumn(const DeserializeBinaryBulkSettings &settings, ColumnPtr &result_column,
                                         const ColumnPtr &cached_column, size_t num_read_rows, SubstreamsCache *cache,
                                         bool update_cache_after_insert = false);
 ...
 protected:
  ...
  [[noreturn]] void throwUnexpectedDataAfterParsedValue(IColumn &column, ReadBuffer &istr, const FormatSettings &,
...
State *ISerialization::checkAndGetState(const StatePtr &state, const ISerialization *serialization) {
  if (!state) throwEmptySerializationState(serialization);
