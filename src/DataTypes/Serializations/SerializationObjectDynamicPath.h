...
/// For example, if we have type JSON(a.b UInt32, b.c String) and data {"a" : {"b" : 42}, "b" : {"c" : "Hello}, "c" : {"d" : [1, 2, 3]}, "d"
/// : 42} this class will be responsible for reading dynamic paths 'c.d' and 'd' as subcolumns. Typed paths 'a.b' and 'b.c' are serialized
/// in SerializationObjectTypedPath.
class SerializationObjectDynamicPath final : public SerializationWrapper {
 public:
  SerializationObjectDynamicPath(const SerializationPtr& nested_, const String& path_, const String& path_subcolumn_,
