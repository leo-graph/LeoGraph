...
/// `deserialize` method will return a `ColumnBLOB` with the same BLOB as input. Deserialization and decompression of the BLOB will be done
/// later by `UnmarshallBlocksTransform`.
