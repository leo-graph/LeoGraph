...
class SerializationObject : public ISerialization {
 public:
  ...
  SerializationObject(const std::unordered_map<String, DataTypePtr> &typed_paths_types_,
 ...
 private:
  ...
  struct DeserializeBinaryBulkStateObjectStructure : public ISerialization::DeserializeBinaryBulkState {
    ...
    DeserializeBinaryBulkStatePtr clone() const override { return std::make_shared<DeserializeBinaryBulkStateObjectStructure>(*this); }
  };

  static DeserializeBinaryBulkStatePtr deserializeObjectStructureStatePrefix(DeserializeBinaryBulkSettings &settings,
