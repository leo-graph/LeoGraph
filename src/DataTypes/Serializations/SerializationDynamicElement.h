...
class SerializationDynamicElement final : public SerializationWrapper {
 ...
 public:
  SerializationDynamicElement(const SerializationPtr& nested_, const SerializationPtr& shared_variant_serialization_,
                              const String& dynamic_element_name_, const String& nested_subcolumn_, bool is_null_map_subcolumn_ = false)
