...
class SerializationJSON : public SerializationObject {
 public:
  SerializationJSON(const std::unordered_map<String, DataTypePtr>& typed_paths_types_,
 ...
 private:
  void serializeTextImpl(const IColumn& column, size_t row_num, WriteBuffer& ostr, const FormatSettings& settings, bool pretty = false,
