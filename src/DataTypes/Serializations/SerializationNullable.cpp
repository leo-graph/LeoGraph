...
void SerializationNullable::enumerateStreams(EnumerateStreamsSettings &settings, const StreamCallback &callback,
...
void SerializationNullable::serializeBinaryBulkStatePrefix(const IColumn &column, SerializeBinaryBulkSettings &settings,
...
void SerializationNullable::serializeBinaryBulkStateSuffix(SerializeBinaryBulkSettings &settings,
                                                           SerializeBinaryBulkStatePtr &state) const {
  settings.path.push_back(Substream::NullableElements);
...
void SerializationNullable::deserializeBinaryBulkStatePrefix(DeserializeBinaryBulkSettings &settings, DeserializeBinaryBulkStatePtr &state,
...
void SerializationNullable::serializeBinaryBulkWithMultipleStreams(const IColumn &column, size_t offset, size_t limit,
...
void SerializationNullable::deserializeBinaryBulkWithMultipleStreams(ColumnPtr &column, size_t rows_offset, size_t limit,
  ...
  if (!use_default_null_map) {
    ...
    if (insertDataFromSubstreamsCacheIfAny(cache, settings, col.getNullMapColumnPtr())) {
      ...
      addColumnWithNumReadRowsToSubstreamsCache(cache, settings.path, col.getNullMapColumnPtr(),
                                                col.getNullMapColumnPtr()->size() - prev_size);
    }
    settings.path.pop_back();
  }
  ...
  if (use_default_null_map) col.getNullMapData().resize_fill(col.getNestedColumn().size());
  ...
  if (null_map->size() != nested_column->size())
    throw Exception(
        ...
        "column size = {})",
        null_map->size(), nested_column->size());
}
...
void SerializationNullable::serializeBinary(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                            const FormatSettings &settings) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);

  bool is_null = col.isNullAt(row_num);
  writeBinary(is_null, ostr);
  if (!is_null) nested->serializeBinary(col.getNestedColumn(), row_num, ostr, settings);
}
...
void SerializationNullable::serializeForHashCalculation(const IColumn &column, size_t row_num, WriteBuffer &ostr) const {
  ...
  bool is_null = col.isNullAt(row_num);
  writeBinary(is_null, ostr);
  if (!is_null) nested->serializeForHashCalculation(col.getNestedColumn(), row_num, ostr);
}
...
ReturnType safeAppendToNullMap(ColumnNullable &column, bool is_null) {
  try {
    ...
    if constexpr (std::is_same_v<ReturnType, void>) throw;
...
static ReturnType deserializeImpl(IColumn &column, ReadBuffer &buf, CheckForNull &&check_for_null, DeserializeNested &&deserialize_nested,
                                  bool &is_null) {
...
void SerializationNullable::deserializeBinary(IColumn &column, ReadBuffer &istr, const FormatSettings &settings) const {
  ...
  auto deserialize_nested = [this, &settings](IColumn &nested_column, ReadBuffer &buf) {
    nested->deserializeBinary(nested_column, buf, settings);
  };
  deserializeImpl(col.getNestedColumn(), istr, check_for_null, deserialize_nested, is_null);
  safeAppendToNullMap<void>(col, is_null);
}

void SerializationNullable::serializeTextEscaped(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                                 const FormatSettings &settings) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);
...
void SerializationNullable::serializeTextRaw(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                             const FormatSettings &settings) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);
...
ReturnType deserializeTextEscapedAndRawImpl(IColumn &column, ReadBuffer &istr, const FormatSettings &settings,
                                            const SerializationPtr &nested_serialization, bool &is_null) {
  ...
  auto deserialize_nested_with_check = [&deserialize_nested, &nested_serialization, &settings, &null_representation, &istr](
                                           IColumn &nested_column, ReadBuffer &buf_) {
    auto &buf = assert_cast<PeekableReadBuffer &>(buf_);
    auto *pos = buf.position();
    if constexpr (throw_exception)
    ...
    if (likely(!buf.hasUnreadData())) return ReturnType(true);
    ...
    if constexpr (!throw_exception) return ReturnType(false);

    if (null_representation.contains('\t') || null_representation.contains('\n'))
      throw DB::Exception(ErrorCodes::CANNOT_READ_ALL_DATA,
                          "TSV custom null representation "
    ...
    throw DB::Exception(ErrorCodes::CANNOT_READ_ALL_DATA,
                        ...
                        std::string(pos, buf.buffer().end()), std::string(istr.position(), std::min(size_t(10), istr.available())),
...
bool SerializationNullable::tryDeserializeTextEscaped(IColumn &column, ReadBuffer &istr, const FormatSettings &settings) const {
  ColumnNullable &col = assert_cast<ColumnNullable &>(column);
  bool is_null;
  return deserializeTextEscapedAndRawImpl<bool, true>(col.getNestedColumn(), istr, settings, nested, is_null) &&
         safeAppendToNullMap<bool>(col, is_null);
}

bool SerializationNullable::deserializeNullAsDefaultOrNestedTextEscaped(IColumn &nested_column, ReadBuffer &istr,
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextEscaped(IColumn &nested_column, ReadBuffer &istr,
                                                                           const FormatSettings &settings,
                                                                           const SerializationPtr &nested_serialization) {
  bool is_null;
...
bool SerializationNullable::tryDeserializeTextRaw(IColumn &column, ReadBuffer &istr, const FormatSettings &settings) const {
  ColumnNullable &col = assert_cast<ColumnNullable &>(column);
  bool is_null;
  return deserializeTextEscapedAndRawImpl<bool, false>(col.getNestedColumn(), istr, settings, nested, is_null) &&
         safeAppendToNullMap<bool>(col, is_null);
}

bool SerializationNullable::deserializeNullAsDefaultOrNestedTextRaw(IColumn &nested_column, ReadBuffer &istr,
                                                                    const FormatSettings &settings,
                                                                    const SerializationPtr &nested_serialization) {
  bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextRaw(IColumn &nested_column, ReadBuffer &istr,
                                                                       const FormatSettings &settings,
                                                                       const SerializationPtr &nested_serialization) {
  bool is_null;
...
void SerializationNullable::serializeTextQuoted(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                                const FormatSettings &settings) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);
...
void SerializationNullable::serializeNullQuoted(DB::WriteBuffer &ostr) { writeCString("NULL", ostr); }

bool SerializationNullable::tryDeserializeNullQuoted(DB::ReadBuffer &istr) { return checkStringCaseInsensitive("NULL", istr); }

template <typename ReturnType>
ReturnType deserializeTextQuotedImpl(IColumn &column, ReadBuffer &istr, const FormatSettings &settings, const SerializationPtr &nested,
                                     bool &is_null) {
  static constexpr bool throw_exception = std::is_same_v<ReturnType, void>;

  auto deserialize_nested = [&nested, &settings](IColumn &nested_column, ReadBuffer &buf) {
    if constexpr (!throw_exception) return nested->tryDeserializeTextQuoted(nested_column, buf, settings);
  ...
  if (istr.available() >= 4) {
    auto check_for_null = [](ReadBuffer &buf) {
      auto *pos = buf.position();
      if (checkStringCaseInsensitive("NULL", buf)) return true;
      buf.position() = pos;
      return false;
    };
    return deserializeImpl<ReturnType>(column, istr, check_for_null, deserialize_nested, is_null);
  ...
  auto deserialize_nested_with_check = [&deserialize_nested](IColumn &nested_column, ReadBuffer &buf_) {
    ...
    throw DB::Exception(ErrorCodes::CANNOT_READ_ALL_DATA, "Error while parsing Nullable: got an unquoted string {} instead of a number",
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedTextQuoted(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                       const DB::FormatSettings &settings,
                                                                       const DB::SerializationPtr &nested_serialization) {
  bool is_null;
  deserializeTextQuotedImpl<void>(nested_column, istr, settings, nested_serialization, is_null);
  return !is_null;
}

bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextQuoted(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                          const DB::FormatSettings &settings,
                                                                          const DB::SerializationPtr &nested_serialization) {
  bool is_null;
...
template <typename ReturnType>
ReturnType deserializeWholeTextImpl(IColumn &column, ReadBuffer &istr, const FormatSettings &settings, const SerializationPtr &nested,
                                    bool &is_null) {
  static constexpr bool throw_exception = std::is_same_v<ReturnType, void>;
  ...
  auto check_for_null = [](ReadBuffer &buf_) {
    ...
    if (checkStringCaseInsensitive("NULL", buf) && buf.eof()) return true;

    buf.rollbackToCheckpoint();
    if (checkStringCaseInsensitive("ᴺᵁᴸᴸ", buf) && buf.eof()) return true;
  ...
  auto deserialize_nested = [&nested, &settings](IColumn &nested_column, ReadBuffer &buf_) {
    auto &buf = assert_cast<PeekableReadBuffer &>(buf_);
    if constexpr (!throw_exception) return nested->tryDeserializeWholeText(nested_column, buf, settings);
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedWholeText(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                      const DB::FormatSettings &settings,
                                                                      const DB::SerializationPtr &nested_serialization) {
  bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedWholeText(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                         const DB::FormatSettings &settings,
                                                                         const DB::SerializationPtr &nested_serialization) {
  bool is_null;
...
void SerializationNullable::serializeTextCSV(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                             const FormatSettings &settings) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);
...
template <typename ReturnType>
ReturnType deserializeTextCSVImpl(IColumn &column, ReadBuffer &istr, const FormatSettings &settings,
                                  const SerializationPtr &nested_serialization, bool &is_null) {
  static constexpr bool throw_exception = std::is_same_v<ReturnType, void>;

  auto deserialize_nested = [&nested_serialization, &settings](IColumn &nested_column, ReadBuffer &buf) {
    if constexpr (!throw_exception) return nested_serialization->tryDeserializeTextCSV(nested_column, buf, settings);
  ...
  auto deserialize_nested_with_check = [&deserialize_nested, &nested_serialization, &settings, &null_representation, &istr](
    ...
    if (null_representation.contains(settings.csv.delimiter) || null_representation.contains('\r') || null_representation.contains('\n'))
      throw DB::Exception(ErrorCodes::CANNOT_READ_ALL_DATA,
                          "CSV custom null representation containing "
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedTextCSV(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                    const DB::FormatSettings &settings,
                                                                    const DB::SerializationPtr &nested_serialization) {
  bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextCSV(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                       const DB::FormatSettings &settings,
                                                                       const DB::SerializationPtr &nested_serialization) {
  bool is_null;
...
bool SerializationNullable::tryDeserializeNullText(DB::ReadBuffer &istr) {
  if (checkCharCaseInsensitive('N', istr)) return checkStringCaseInsensitive("ULL", istr);
  return checkStringCaseInsensitive("ᴺᵁᴸᴸ", istr);
}

void SerializationNullable::serializeTextJSON(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                              const FormatSettings &settings) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);
...
void SerializationNullable::serializeTextJSONPretty(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                                    const FormatSettings &settings, size_t indent) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);
...
void SerializationNullable::serializeNullJSON(DB::WriteBuffer &ostr) { writeCString("null", ostr); }

bool SerializationNullable::tryDeserializeNullJSON(DB::ReadBuffer &istr) { return checkString("null", istr); }

template <typename ReturnType>
ReturnType deserializeTextJSONImpl(IColumn &column, ReadBuffer &istr, const FormatSettings &settings, const SerializationPtr &nested,
                                   bool &is_null) {
  auto check_for_null = [](ReadBuffer &buf) { return checkStringByFirstCharacterAndAssertTheRest("null", buf); };
  auto deserialize_nested = [&nested, &settings](IColumn &nested_column, ReadBuffer &buf) {
    if constexpr (std::is_same_v<ReturnType, bool>) return nested->tryDeserializeTextJSON(nested_column, buf, settings);
...
bool SerializationNullable::deserializeNullAsDefaultOrNestedTextJSON(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                     const DB::FormatSettings &settings,
                                                                     const DB::SerializationPtr &nested_serialization) {
  bool is_null;
...
bool SerializationNullable::tryDeserializeNullAsDefaultOrNestedTextJSON(DB::IColumn &nested_column, DB::ReadBuffer &istr,
                                                                        const DB::FormatSettings &settings,
                                                                        const DB::SerializationPtr &nested_serialization) {
  bool is_null;
...
void SerializationNullable::serializeTextXML(const IColumn &column, size_t row_num, WriteBuffer &ostr,
                                             const FormatSettings &settings) const {
  const ColumnNullable &col = assert_cast<const ColumnNullable &>(column);
...
void SerializationNullable::serializeNullXML(DB::WriteBuffer &ostr) { writeCString("\\N", ostr); }
