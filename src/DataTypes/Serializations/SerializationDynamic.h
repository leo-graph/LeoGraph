...
class SerializationDynamic : public ISerialization {
 public:
  explicit SerializationDynamic(size_t max_dynamic_types_ = DataTypeDynamic::DEFAULT_MAX_DYNAMIC_TYPES,
                                const SerializationInfoSettings& serialization_info_settings_ = {})
      : max_dynamic_types(max_dynamic_types_), serialization_info_settings(serialization_info_settings_) {}
  ...
  static DeserializeBinaryBulkStatePtr deserializeDynamicStructureStatePrefix(DeserializeBinaryBulkSettings& settings,
  ...
  void serializeBinaryBulkWithMultipleStreamsAndCountTotalSizeOfVariants(const IColumn& column, size_t offset, size_t limit,
  ...
  static void serializeVariantForHashCalculation(const IColumn& column, const SerializationPtr& serialization, const DataTypePtr& type,
