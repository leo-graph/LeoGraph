...
SerializationNamed::SerializationNamed(const SerializationPtr &nested_, const String &name_, SubstreamType substream_type_)
    : SerializationWrapper(nested_), name(name_), substream_type(substream_type_) {
...
void SerializationNamed::enumerateStreams(EnumerateStreamsSettings &settings, const StreamCallback &callback,
...
void SerializationNamed::serializeBinaryBulkStatePrefix(const IColumn &column, SerializeBinaryBulkSettings &settings,
...
void SerializationNamed::serializeBinaryBulkStateSuffix(SerializeBinaryBulkSettings &settings, SerializeBinaryBulkStatePtr &state) const {
  addToPath(settings.path);
  nested_serialization->serializeBinaryBulkStateSuffix(settings, state);
  settings.path.pop_back();
}

void SerializationNamed::deserializeBinaryBulkStatePrefix(DeserializeBinaryBulkSettings &settings, DeserializeBinaryBulkStatePtr &state,
...
void SerializationNamed::serializeBinaryBulkWithMultipleStreams(const IColumn &column, size_t offset, size_t limit,
...
void SerializationNamed::deserializeBinaryBulkWithMultipleStreams(ColumnPtr &column, size_t rows_offset, size_t limit,
...
SerializationPtr removeNamedSerialization(const SerializationPtr &serialization) {
  if (const auto *named = typeid_cast<const SerializationNamed *>(serialization.get())) return named->getNested();
