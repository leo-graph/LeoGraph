...
static inline DataTypePtr toNativeDataType() {
  if constexpr (std::is_same_v<ToType, Int8> || std::is_same_v<ToType, UInt8> || std::is_same_v<ToType, Int16> ||
                std::is_same_v<ToType, UInt16> || std::is_same_v<ToType, Int32> || std::is_same_v<ToType, UInt32> ||
                std::is_same_v<ToType, Int64> || std::is_same_v<ToType, UInt64> || std::is_same_v<ToType, Int128> ||
                std::is_same_v<ToType, UInt128> || std::is_same_v<ToType, Int256> || std::is_same_v<ToType, UInt256> ||
