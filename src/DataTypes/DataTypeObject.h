...
class DataTypeObject : public IDataType {
 public:
  ...
  static constexpr const char *SPECIAL_SUBCOLUMN_NAME_FOR_DISTINCT_PATHS_CALCULATION =
      "__special_subcolumn_name_for_distinct_paths_calculation";

  explicit DataTypeObject(const SchemaFormat &schema_format_, std::unordered_map<String, DataTypePtr> typed_paths_ = {},
