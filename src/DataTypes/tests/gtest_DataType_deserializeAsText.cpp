...
INSTANTIATE_TEST_SUITE_P(ParseDecimal, ParseDataTypeTest,
                         ::testing::ValuesIn(std::initializer_list<ParseDataTypeTestCase>{
                             {"Decimal(8, 0)",
                              {"0", "5", "8", "-5", "-8", "12345678", "-12345678"},

                              std::initializer_list<Field>{DecimalField<Decimal32>(0, 0), DecimalField<Decimal32>(5, 0),
                                                           DecimalField<Decimal32>(8, 0), DecimalField<Decimal32>(-5, 0),
                                                           DecimalField<Decimal32>(-8, 0), DecimalField<Decimal32>(12345678, 0),
