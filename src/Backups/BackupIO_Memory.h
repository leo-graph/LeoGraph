...
class BackupReaderMemory : public BackupReaderDefault {
 public:
  BackupReaderMemory(std::shared_ptr<const BackupInMemory> backup_in_memory_, const ReadSettings& read_settings_,
...
class BackupWriterMemory : public BackupWriterDefault {
 public:
  BackupWriterMemory(std::shared_ptr<BackupInMemory> backup_in_memory_, const ReadSettings& read_settings_,
                     const WriteSettings& write_settings_);
