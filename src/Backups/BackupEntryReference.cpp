...
BackupEntryReference::BackupEntryReference(std::string reference_target_) : reference_target(std::move(reference_target_)) {}

bool BackupEntryReference::isReference() const { return true; }

String BackupEntryReference::getReferenceTarget() const { return reference_target; }

UInt64 BackupEntryReference::getSize() const { return 0; }
