...
BackupCoordinationLocal::BackupCoordinationLocal(const BackupSettings& backup_settings_, bool allow_concurrent_backup_,
    ...
    : log(getLogger("BackupCoordinationLocal")),
      ...
      file_infos(BackupCoordinationFileInfos::Config{!backup_settings_.deduplicate_files, backup_settings_.data_file_name_generator,
                                                     *backup_settings_.data_file_name_prefix_length}) {}

BackupCoordinationLocal::~BackupCoordinationLocal() = default;

ZooKeeperRetriesInfo BackupCoordinationLocal::getOnClusterInitializationKeeperRetriesInfo() const { return {}; }

void BackupCoordinationLocal::addReplicatedPartNames(const String& table_zk_path, const String& table_name_for_logs,
...
void BackupCoordinationLocal::addReplicatedMutations(const String& table_zk_path, const String& table_name_for_logs,
...
std::vector<IBackupCoordination::MutationInfo> BackupCoordinationLocal::getReplicatedMutations(const String& table_zk_path,
...
void BackupCoordinationLocal::addReplicatedAccessFilePath(const String& access_zk_path, AccessEntityType access_entity_type,
...
void BackupCoordinationLocal::addReplicatedSQLObjectsDir(const String& loader_zk_path, UserDefinedSQLObjectType object_type,
...
void BackupCoordinationLocal::addKeeperMapTable(const String& table_zookeeper_root_path, const String& table_id,
