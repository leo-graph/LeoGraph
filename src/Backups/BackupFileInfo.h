...
struct BackupFileInfo {
  ...
  /// Name of the data file. An empty string means there is no data file (that can happen if the file is empty or was taken from the base
  /// backup as a whole). This field is set during backup coordination (see the class BackupCoordinationFileInfos).
