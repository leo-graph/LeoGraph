...
class WithRetries {
 public:
  ...
  WithRetries(LoggerPtr log, zkutil::GetZooKeeper get_zookeeper_, const BackupKeeperSettings& settings,
              QueryStatusPtr process_list_element_, RenewerCallback callback = {});
