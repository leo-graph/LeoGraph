...
class BackupEntryWithChecksumCalculation : public IBackupEntry {
 ...
 private:
  ...
  std::pair<std::optional<UInt128>, std::optional<UInt128>> calculateOneOrTwoChecksums(UInt64 limit, std::optional<UInt64> second_limit,
  ...
  std::pair<std::optional<UInt128>, std::optional<UInt128>> getPrecalculatedChecksumIfFull(UInt64 limit,
                                                                                           std::optional<UInt64> second_limit) const;
  ...
  std::pair<std::optional<UInt128>, std::optional<UInt128>> calculateChecksumFromReading(UInt64 limit, std::optional<UInt64> second_limit,
                                                                                         const ReadSettings& read_settings) const;

  /// Calculates one or two checksums for method FromRemotePath.
  std::pair<std::optional<UInt128>, std::optional<UInt128>> calculateChecksumFromRemotePath(UInt64 limit,
                                                                                            std::optional<UInt64> second_limit) const;
