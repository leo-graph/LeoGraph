...
class LimitTransform final : public IProcessor {
 ...
 public:
  LimitTransform(SharedHeader header_, UInt64 limit_, UInt64 offset_, size_t num_streams = 1, bool always_read_till_end_ = false,
                 bool with_ties_ = false, SortDescription description_ = {}, RuntimeDataflowStatisticsCacheUpdaterPtr updater_ = nullptr);
