 ...
 *     total_compressed_size - total compressed bytes size of the column, calculated as the sum of total_uncompressed_size of the column
 * from all row groups total_uncompressed_size - total uncompressed bytes size of the column, calculated as the sum of total_compressed_size
 * of the column from all row groups space_saved - percent of space saved by compression, calculated as (1 -
 * total_compressed_size/total_uncompressed_size). encodings - the list of encodings used for this column row_groups - the list of row
 * groups metadata with the next structure: num_columns - the number of columns in the row group num_rows - the number of rows in the row
 * group total_uncompressed_size - total bytes size of the row group total_compressed_size - total compressed bytes size of the row group
