...
class Prefetcher {
 ...
 public:
  ...
  std::vector<PrefetchHandle> splitRange(PrefetchHandle request,
 ...
 private:
  ...
  void pickRangesAndCreateTaskIfNotExists(RequestState *, const PrefetchHandle &, bool splitting, size_t start_offset, size_t end_offset,
