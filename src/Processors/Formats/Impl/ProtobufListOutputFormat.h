...
class ProtobufListOutputFormat final : public IRowOutputFormat {
 public:
  ProtobufListOutputFormat(WriteBuffer &out_, SharedHeader header_, const ProtobufSchemaInfo &schema_info_,
                           bool defaults_for_nullable_google_wrappers_, const String &google_protos_path);
