...
RawBLOBRowOutputFormat::RawBLOBRowOutputFormat(WriteBuffer &out_, SharedHeader header_) : IRowOutputFormat(header_, out_) {}
...
void registerOutputFormatRawBLOB(FormatFactory &factory) {
  factory.registerOutputFormat(
      "RawBLOB", [](WriteBuffer &buf, const Block &sample, const FormatSettings &, FormatFilterInfoPtr /*format_filter_info*/) {
