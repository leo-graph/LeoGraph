...
JSONCompactRowOutputFormat::JSONCompactRowOutputFormat(WriteBuffer& out_, SharedHeader header, const FormatSettings& settings_,
                                                       bool yield_strings_)
...
void JSONCompactRowOutputFormat::writeFieldDelimiter() { JSONUtils::writeFieldCompactDelimiter(*ostr); }

void JSONCompactRowOutputFormat::writeRowStartDelimiter() { JSONUtils::writeCompactArrayStart(*ostr, 2); }
...
void JSONCompactRowOutputFormat::writeAfterTotals() { JSONUtils::writeCompactArrayEnd(*ostr); }
...
void registerOutputFormatJSONCompact(FormatFactory& factory) {
  factory.registerOutputFormat("JSONCompact", [](WriteBuffer& buf, const Block& sample, const FormatSettings& format_settings,
  ...
  factory.registerOutputFormat("JSONCompactStrings", [](WriteBuffer& buf, const Block& sample, const FormatSettings& format_settings,
                                                        FormatFilterInfoPtr /*format_filter_info*/) {
