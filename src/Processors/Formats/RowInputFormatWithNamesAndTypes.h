...
class RowInputFormatWithNamesAndTypes : public RowInputFormatWithDiagnosticInfo {
 protected:
   ...
   */
  RowInputFormatWithNamesAndTypes(SharedHeader header_, ReadBuffer &in_, const Params &params_, bool is_binary_, bool with_names_,
                                  bool with_types_, const FormatSettings &format_settings_,
                                  std::unique_ptr<FormatReaderImpl> format_reader_, bool try_detect_header_,
...
class FormatWithNamesAndTypesReader {
 public:
  explicit FormatWithNamesAndTypesReader(ReadBuffer &in_, const FormatSettings &format_settings_)
  ...
  virtual bool readField(IColumn &column, const DataTypePtr &type, const SerializationPtr &serialization, bool is_last_file_column,
  ...
  virtual void skipRow() { throw Exception(ErrorCodes::NOT_IMPLEMENTED, "Method skipRow is not implemented for format reader"); }
...
class FormatWithNamesAndTypesSchemaReader : public IRowSchemaReader {
 public:
  FormatWithNamesAndTypesSchemaReader(ReadBuffer &in, const FormatSettings &format_settings_, bool with_names_, bool with_types_,
                                      FormatWithNamesAndTypesReader *format_reader_, DataTypePtr default_type_ = nullptr,
