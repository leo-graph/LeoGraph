...
class ReplacingSortedAlgorithm final : public IMergingAlgorithmWithSharedChunks {
 public:
  ReplacingSortedAlgorithm(SharedHeader header, size_t num_inputs, SortDescription description_, const String& is_deleted_column,
                           ...
                           bool use_average_block_sizes = false, bool cleanup = false, bool enable_vertical_final_ = false);
