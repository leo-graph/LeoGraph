...
class GraphiteRollupSortedAlgorithm final : public IMergingAlgorithmWithSharedChunks {
 public:
  GraphiteRollupSortedAlgorithm(SharedHeader header, size_t num_inputs, SortDescription description_, size_t max_block_size_rows_,
                                size_t max_block_size_bytes_, std::optional<size_t> max_dynamic_subcolumns_, Graphite::Params params_,
  ...
  class GraphiteRollupMergedData : public MergedData {
   public:
    ...
    void startNextGroup(const ColumnRawPtrs& raw_columns, size_t row, Graphite::RollupRule next_rule, ColumnsDefinition& def);
