...
ArrayJoinTransform::ArrayJoinTransform(SharedHeader header_, ArrayJoinActionPtr array_join_, bool /*on_totals_*/)
...
bool ArrayJoinTransform::canGenerate() { return result_iterator && result_iterator->hasNext(); }

Chunk ArrayJoinTransform::generate() {
  if (!canGenerate()) throw Exception(ErrorCodes::LOGICAL_ERROR, "Can't generate chunk in ArrayJoinTransform");
