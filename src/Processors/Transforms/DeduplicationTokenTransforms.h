...
class AddDeduplicationInfoTransform : public ISimpleTransform {
 ...
 public:
  ...
  AddDeduplicationInfoTransform(InsertDependenciesBuilderConstPtr insert_dependencies_, StorageIDMaybeEmpty root_view_id_,
                                std::string user_token_, InsertDeduplicationVersions unification_stage_, SharedHeader header_);
