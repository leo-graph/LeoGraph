...
class DistinctSortedTransform : public ISimpleTransform {
 public:
  ...
  DistinctSortedTransform(SharedHeader header, const SortDescription& sort_description, const SizeLimits& set_size_limits_,
                          UInt64 limit_hint_, const Names& column_names);
 ...
 private:
  ...
  bool buildFilter(Method& method, const ColumnRawPtrs& key_columns, const ColumnRawPtrs& clearing_hint_columns, IColumn::Filter& filter,
                   size_t rows, ClearableSetVariants& variants) const;
