...
class FractionalLimitTransform final : public IProcessor {
 ...
 public:
  FractionalLimitTransform(SharedHeader header_, Float64 limit_fraction_, Float64 offset_fraction_, UInt64 offset_ = 0,
                           size_t num_streams = 1, bool with_ties_ = false, SortDescription description_ = {});
