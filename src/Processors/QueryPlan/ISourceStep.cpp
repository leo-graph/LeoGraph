...
ISourceStep::ISourceStep(SharedHeader output_header_) { output_header = std::move(output_header_); }
...
void ISourceStep::describePipeline(FormatSettings& settings) const { IQueryPlanStep::describePipeline(processors, settings); }
