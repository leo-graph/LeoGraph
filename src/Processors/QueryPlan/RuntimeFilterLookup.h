...
class IRuntimeFilter {
 ...
 protected:
  IRuntimeFilter(size_t filters_to_merge_, const DataTypePtr& filter_column_target_type_, Float64 pass_ratio_threshold_for_disabling_,
...
class RuntimeFilterBase : public IRuntimeFilter {
 public:
  RuntimeFilterBase(size_t filters_to_merge_, const DataTypePtr& filter_column_target_type_, Float64 pass_ratio_threshold_for_disabling_,
                    UInt64 blocks_to_skip_before_reenabling_, UInt64 bytes_limit_, UInt64 exact_values_limit_)
      : IRuntimeFilter(filters_to_merge_, filter_column_target_type_, pass_ratio_threshold_for_disabling_,
                       blocks_to_skip_before_reenabling_),
        argument_can_have_nulls(hasNullable(filter_column_target_type) || WhichDataType(filter_column_target_type).isDynamic()),
...
class ExactContainsRuntimeFilter : public RuntimeFilterBase<false> {
 ...
 public:
  ExactContainsRuntimeFilter(size_t filters_to_merge_, const DataTypePtr& filter_column_target_type_,
                             Float64 pass_ratio_threshold_for_disabling_, UInt64 blocks_to_skip_before_reenabling_, UInt64 bytes_limit_,
...
class ExactNotContainsRuntimeFilter : public RuntimeFilterBase<true> {
 public:
  ExactNotContainsRuntimeFilter(size_t filters_to_merge_, const DataTypePtr& filter_column_target_type_,
                                Float64 pass_ratio_threshold_for_disabling_, UInt64 blocks_to_skip_before_reenabling_, UInt64 bytes_limit_,
                                UInt64 exact_values_limit_)
      : RuntimeFilterBase(filters_to_merge_, filter_column_target_type_, pass_ratio_threshold_for_disabling_,
                          blocks_to_skip_before_reenabling_, bytes_limit_, exact_values_limit_) {}
...
class ApproximateRuntimeFilter : public RuntimeFilterBase<false> {
 ...
 public:
  ...
  ApproximateRuntimeFilter(size_t filters_to_merge_, const DataTypePtr& filter_column_target_type_,
                           Float64 pass_ratio_threshold_for_disabling_, UInt64 blocks_to_skip_before_reenabling_, UInt64 bytes_limit_,
                           UInt64 exact_values_limit_, UInt64 bloom_filter_hash_functions_, Float64 max_ratio_of_set_bits_in_bloom_filter_);
