...
class CreatingSetStep : public ITransformingStep {
 public:
  CreatingSetStep(const SharedHeader &input_header_, SetAndKeyPtr set_and_key_, SizeLimits network_transfer_limits_,
...
class DelayedCreatingSetsStep final : public IQueryPlanStep {
 public:
  DelayedCreatingSetsStep(SharedHeader input_header, PreparedSets::Subqueries subqueries_, SizeLimits network_transfer_limits_,
                          PreparedSetsCachePtr prepared_sets_cache_);
