...
void NegativeOffsetStep::describeActions(JSONBuilder::JSONMap &map) const { map.add("Negative Offset", offset); }

void NegativeOffsetStep::serialize(Serialization &ctx) const { writeVarUInt(offset, ctx.out); }
