...
class JoinStep : public IQueryPlanStep {
 public:
  JoinStep(const SharedHeader &left_header_, const SharedHeader &right_header_, JoinPtr join_, size_t max_block_size_,
           size_t min_block_size_rows_, size_t min_block_size_bytes_, size_t max_streams_, NameSet required_output_,
           bool keep_left_read_in_order_, bool use_new_analyzer_, bool use_join_disjunctions_push_down_ = false);
