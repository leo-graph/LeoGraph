...
class DescriptionHolder : public IDescriptionHolder {
 public:
  ...
  void setStepDescription(IQueryPlanStep& step) const override { step.step_description = description; }
...
[[nodiscard]] FilterResult filterResultForNotMatchedRows(const ActionsDAG& filter_dag, const String& filter_column_name,
                                                         const Block& input_stream_header, bool allow_unknown_function_arguments = false);
