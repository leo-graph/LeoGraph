...
class IQueryPlanStep {
 public:
  ...
  ALWAYS_INLINE void setStepDescription(const char (&description)[size]) {
    step_description = std::string_view(description, size - 1);
  }
  ...
  enum class RemovedUnusedColumns { None, OutputOnly, OutputAndInput };
