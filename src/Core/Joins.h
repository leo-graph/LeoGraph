...
constexpr ASOFJoinInequality reverseASOFJoinInequality(ASOFJoinInequality inequality) {
  if (inequality == ASOFJoinInequality::Less) return ASOFJoinInequality::Greater;
  if (inequality == ASOFJoinInequality::Greater) return ASOFJoinInequality::Less;
  if (inequality == ASOFJoinInequality::LessOrEquals) return ASOFJoinInequality::GreaterOrEquals;
  if (inequality == ASOFJoinInequality::GreaterOrEquals) return ASOFJoinInequality::LessOrEquals;
...
enum class JoinTableSide : uint8_t { Left, Right };
