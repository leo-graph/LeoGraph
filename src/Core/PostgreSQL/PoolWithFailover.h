...
class PoolWithFailover {
 public:
  ...
  PoolWithFailover(const ReplicasConfigurationByPriority& configurations_by_priority, size_t pool_size, size_t pool_wait_timeout,
                   size_t max_tries_, bool auto_close_connection_, size_t connection_attempt_timeout_, bool bg_reconnect_ = false);

  explicit PoolWithFailover(const DB::StoragePostgreSQL::Configuration& configuration, size_t pool_size, size_t pool_wait_timeout,
                            size_t max_tries_, bool auto_close_connection_, size_t connection_attempt_timeout_, bool bg_reconnect_ = false);
