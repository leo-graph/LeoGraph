...
class YTsaurusClient : private boost::noncopyable {
 ...
 private:
  ...
  ReadBufferPtr createQueryRWBuffer(const URI& uri, const ReadWriteBufferFromHTTP::OutStreamCallback& out_callback,
...
class YTsaurusTableLock {
 public:
  ...
  String getNodePath() const { return node_cypress_path; }
  ~YTsaurusTableLock();
