...
struct YTsaurusReadTableQuery : public IYTsaurusHeavyQuery {
  ...
  String getQueryName() const override { return "read_table"; }

  String getHTTPMethod() const override { return Poco::Net::HTTPRequest::HTTP_GET; }

  QueryParameters getQueryParameters() const override { return {{.name = "path", .value = cypress_path}}; }
  String cypress_path;
};
...
struct YTsaurusGetQuery : public IYTsaurusQuery {
  ...
  String getQueryName() const override { return "get"; }
...
struct YTsaurusSelectRowsQuery : public IYTsaurusHeavyQuery {
  ...
  String getQueryName() const override { return "select_rows"; }

  String getHTTPMethod() const override { return Poco::Net::HTTPRequest::HTTP_GET; }

  String constructQuery() const { return fmt::format("{} from [{}]", column_names_str, table_path); }

  QueryParameters getQueryParameters() const override { return {{.name = "query", .value = constructQuery()}}; }
  String table_path;
...
struct YTsaurusLookupRows : public IYTsaurusHeavyQuery {
  ...
  String getQueryName() const override { return "lookup_rows"; }

  String getHTTPMethod() const override { return Poco::Net::HTTPRequest::HTTP_PUT; }
...
struct YTsaurusStartTxQuery : public IYTsaurusQuery {
  ...
  String getQueryName() const override { return "start_tx"; }

  String getHTTPMethod() const override { return Poco::Net::HTTPRequest::HTTP_POST; }

  QueryParameters getQueryParameters() const override { return {{.name = "timeout", .value = std::to_string(timeout)}}; }
...
struct YTsaurusCommitTxQuery : public IYTsaurusQuery {
  explicit YTsaurusCommitTxQuery(const String& transaction_id_) : transaction_id(transaction_id_) {}

  String getQueryName() const override { return "commit_tx"; }

  String getHTTPMethod() const override { return Poco::Net::HTTPRequest::HTTP_POST; }

  QueryParameters getQueryParameters() const override { return {{.name = "transaction_id", .value = transaction_id}}; }
...
struct YTsaurusLockQuery : public IYTsaurusQuery {
  explicit YTsaurusLockQuery(const String& path_, const String& transaction_id_) : path(path_), transaction_id(transaction_id_) {}

  String getQueryName() const override { return "lock"; }
