...
constexpr auto getEnumValues() {
  ...
  size_t index = 0;
  for (auto value : magic_enum::enum_values<Type>()) enum_values[index++] = std::pair{magic_enum::enum_name(value), value};
  return enum_values;
}
...
IMPLEMENT_SETTING_MULTI_ENUM(JoinOrderAlgorithm, ErrorCodes::BAD_ARGUMENTS,
                             {{"greedy", JoinOrderAlgorithm::GREEDY}, {"dpsize", JoinOrderAlgorithm::DPSIZE}})
...
IMPLEMENT_SETTING_ENUM(IntervalOutputFormat, ErrorCodes::BAD_ARGUMENTS,
                       {{"kusto", FormatSettings::IntervalOutputFormat::Kusto}, {"numeric", FormatSettings::IntervalOutputFormat::Numeric}})
...
IMPLEMENT_SETTING_ENUM(SetOperationMode, ErrorCodes::UNKNOWN_UNION,
                       {{"", SetOperationMode::Unspecified}, {"ALL", SetOperationMode::ALL}, {"DISTINCT", SetOperationMode::DISTINCT}})
...
IMPLEMENT_SETTING_ENUM(UpdateParallelMode, ErrorCodes::BAD_ARGUMENTS,
                       {{"sync", UpdateParallelMode::SYNC}, {"async", UpdateParallelMode::ASYNC}, {"auto", UpdateParallelMode::AUTO}})
...
IMPLEMENT_SETTING_ENUM(ObjectStorageQueueMode, ErrorCodes::BAD_ARGUMENTS,
                       {{"ordered", ObjectStorageQueueMode::ORDERED}, {"unordered", ObjectStorageQueueMode::UNORDERED}})
...
IMPLEMENT_SETTING_ENUM(SchemaInferenceMode, ErrorCodes::BAD_ARGUMENTS,
                       {{"default", SchemaInferenceMode::DEFAULT}, {"union", SchemaInferenceMode::UNION}})
...
IMPLEMENT_SETTING_ENUM(SQLSecurityType, ErrorCodes::BAD_ARGUMENTS,
                       {{"DEFINER", SQLSecurityType::DEFINER}, {"INVOKER", SQLSecurityType::INVOKER}, {"NONE", SQLSecurityType::NONE}})

IMPLEMENT_SETTING_ENUM(GroupArrayActionWhenLimitReached, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(MergeSelectorAlgorithm, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(FileCachePolicy, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(VectorSearchFilterStrategy, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(GeoToH3ArgumentOrder, ErrorCodes::BAD_ARGUMENTS,
                       {{"lat_lon", GeoToH3ArgumentOrder::LAT_LON}, {"lon_lat", GeoToH3ArgumentOrder::LON_LAT}})

IMPLEMENT_SETTING_ENUM(MergeTreeSerializationInfoVersion, ErrorCodes::BAD_ARGUMENTS,
                       {{"basic", MergeTreeSerializationInfoVersion::BASIC}, {"with_types", MergeTreeSerializationInfoVersion::WITH_TYPES}})

IMPLEMENT_SETTING_ENUM(MergeTreeStringSerializationVersion, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(MergeTreeNullableSerializationVersion, ErrorCodes::BAD_ARGUMENTS,
                       {{"basic", MergeTreeNullableSerializationVersion::BASIC},
                        {"allow_sparse", MergeTreeNullableSerializationVersion::ALLOW_SPARSE}})

IMPLEMENT_SETTING_ENUM(MergeTreeObjectSerializationVersion, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(MergeTreeObjectSharedDataSerializationVersion, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(MergeTreeDynamicSerializationVersion, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(SearchOrphanedPartsDisks, ErrorCodes::BAD_ARGUMENTS,
                       {{"any", SearchOrphanedPartsDisks::ANY},
                        {"local", SearchOrphanedPartsDisks::LOCAL},
                        {"none", SearchOrphanedPartsDisks::NONE}})

IMPLEMENT_SETTING_ENUM(DecorrelationJoinKind, ErrorCodes::BAD_ARGUMENTS,
                       {{"left", DecorrelationJoinKind::LEFT}, {"right", DecorrelationJoinKind::RIGHT}})

IMPLEMENT_SETTING_ENUM(IcebergMetadataLogLevel, ErrorCodes::BAD_ARGUMENTS,
...
IMPLEMENT_SETTING_ENUM(ObjectStorageGranularityLevel, ErrorCodes::BAD_ARGUMENTS,
                       {{"file", ObjectStorageGranularityLevel::FILE}, {"bucket", ObjectStorageGranularityLevel::BUCKET}})

IMPLEMENT_SETTING_ENUM(ArrowFlightDescriptorType, ErrorCodes::BAD_ARGUMENTS,
                       {{"path", ArrowFlightDescriptorType::Path}, {"command", ArrowFlightDescriptorType::Command}})
