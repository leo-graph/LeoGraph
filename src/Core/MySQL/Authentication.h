...
class IPlugin {
 public:
  ...
  virtual void authenticate(const String& user_name, Session& session, std::optional<String> auth_response,
...
class Native41 : public IPlugin {
 public:
  ...
  void authenticate(const String& user_name, Session& session, std::optional<String> auth_response,
                    std::shared_ptr<PacketEndpoint> packet_endpoint, bool /* is_secure_connection */,
