...
enum StatusFlags { SERVER_SESSION_STATE_CHANGED = 0x4000 };
...
class OKPacket : public IMySQLWritePacket, public IMySQLReadPacket {
 ...
 public:
  ...
  OKPacket(uint8_t header_, uint32_t capabilities_, uint64_t affected_rows_, uint32_t status_flags_, int16_t warnings_,
