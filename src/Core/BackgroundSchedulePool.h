...
class BackgroundSchedulePool : public std::enable_shared_from_this<BackgroundSchedulePool>, private boost::noncopyable {
 public:
  ...
  static BackgroundSchedulePoolPtr create(size_t size, size_t max_parallel_tasks_per_type, CurrentMetrics::Metric tasks_metric,
                                          CurrentMetrics::Metric size_metric, ThreadName thread_name);
 ...
 private:
  ...
  BackgroundSchedulePool(size_t size_, size_t max_parallel_tasks_per_type_, CurrentMetrics::Metric tasks_metric_,
  ...
  Threads threads;
  /// Tasks from tasks_groups are removed while executing, hold list of running tasks separately, for better introspection via
...
class BackgroundSchedulePoolTaskInfo : public std::enable_shared_from_this<BackgroundSchedulePoolTaskInfo>, private boost::noncopyable {
 ...
 private:
  ...
  BackgroundSchedulePoolTaskInfo(BackgroundSchedulePoolWeakPtr pool_, const StorageID& storage_, const std::string& log_name_,
