...
struct SortColumnDescription {
  ...
  explicit SortColumnDescription(std::string alias_, std::string column_name_, int direction_ = 1, int nulls_direction_ = 1,
  ...
  explicit SortColumnDescription(std::string column_name_, int direction_ = 1, int nulls_direction_ = 1,
                                 const std::shared_ptr<Collator> &collator_ = nullptr, bool with_fill_ = false,
                                 const FillColumnDescription &fill_description_ = {})
      : column_name(std::move(column_name_)),
        direction(direction_),
