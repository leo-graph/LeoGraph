...
class CancelRequest : public FirstMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::CANCEL_REQUEST; }
};
...
class ErrorOrNoticeResponse : BackendMessage {
 ...
 public:
  ErrorOrNoticeResponse(const Severity& severity_, const String& sql_state_, const String& message_)
      : severity(severity_), sql_state(sql_state_), message(message_) {}
  ...
  Int32 size() const override {
    ...
    return static_cast<Int32>(4 + (1 + enum_to_string[severity].size() + 1) + (1 + sql_state.size() + 1) + (1 + message.size() + 1) + 1);
  }

  MessageType getMessageType() const override {
    if (isErrorOrNotice() == 'E') return MessageType::ERROR_RESPONSE;
...
class ReadyForQuery : BackendMessage {
 public:
  ...
  Int32 size() const override { return 4 + 1; }

  MessageType getMessageType() const override { return MessageType::READY_FOR_QUERY; }
};

class Terminate : FrontMessage {
 public:
  void deserialize(ReadBuffer& in) override { in.ignore(4); }

  MessageType getMessageType() const override { return MessageType::TERMINATE; }
};
 ...
 public:
  ...
  void deserialize(ReadBuffer& in) override {
    ...
    while (ps > 0) {
      ...
      if (payload_size < 0) {
        throw Exception(ErrorCodes::UNKNOWN_PACKET_FROM_CLIENT, "Size of payload is larger than one declared in the message of type {}.",
  ...
  MessageType getMessageType() const override { return MessageType::STARTUP_MESSAGE; }
};
...
class AuthenticationCleartextPassword : public Messaging::BackendMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::AUTHENTICATION_CLEARTEXT_PASSWORD; }
};
...
class AuthenticationSASL : public Messaging::BackendMessage {
 public:
  ...
  Int32 size() const override { return 4 + 4 + supported_method.size() + 1 + 1; }

  MessageType getMessageType() const override { return MessageType::AUTHENTICATION_SASL; }
};
...
class SASLInitialResponse : public Messaging::FrontMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::SASL_INITIAL_RESPONSE; }
};
...
class AuthenticationSASLContinue : public Messaging::BackendMessage {
 public:
  ...
  explicit AuthenticationSASLContinue(const String& data_) : data(data_) {}
  ...
  Int32 size() const override { return 4 + 4 + static_cast<Int32>(data.size()); }

  MessageType getMessageType() const override { return MessageType::AUTHENTICATION_SASL_CONTINUE; }
};
...
class SASLResponse : public Messaging::FrontMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::SASL_RESPONSE; }
};
...
class AuthenticationOk : BackendMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::AUTHENTICATION_OK; }
};
...
class PasswordMessage : FrontMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::PASSWORD_MESSAGE; }
};
...
class ParameterStatus : BackendMessage {
 ...
 public:
  ParameterStatus(String name_, String value_) : name(name_), value(value_) {}
  ...
  Int32 size() const override { return static_cast<Int32>(4 + name.size() + 1 + value.size() + 1); }

  MessageType getMessageType() const override { return MessageType::PARAMETER_STATUS; }
};
...
class BackendKeyData : BackendMessage {
 ...
 public:
  BackendKeyData(Int32 process_id_, Int32 secret_key_) : process_id(process_id_), secret_key(secret_key_) {}
  ...
  Int32 size() const override { return 4 + 4 + 4; }

  MessageType getMessageType() const override { return MessageType::BACKEND_KEY_DATA; }
};
...
class Query : FrontMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::QUERY; }
};
...
class ParseQuery : FrontMessage {
 public:
  ...
  void deserialize(ReadBuffer& in) override {
    ...
    Int32 oid_param;
    for (int i = 0; i < num_params; ++i) readBinaryBigEndian(oid_param, in);
  }
...
class BindQuery : FrontMessage {
 public:
  ...
  void deserialize(ReadBuffer& in) override {
    ...
    for (Int16 i = 0; i < num_format_params_result; ++i) readBinaryBigEndian(format_param_result, in);
  }
...
class EmptyQueryResponse : public BackendMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::EMPTY_QUERY_RESPONSE; }
};
...
class FieldDescription : ISerializable {
 ...
 public:
  FieldDescription(const String& name_, const DataTypePtr& data_type, FormatCode format_code_ = FormatCode::TEXT)
      : name(name_), type_spec(convertDataTypeToPostgresColumnTypeSpec(data_type)), format_code(format_code_) {}
...
class RowDescription : BackendMessage {
 ...
 public:
  ...
  void serialize(WriteBuffer& out) const override {
    ...
    for (const FieldDescription& field : fields_descr) field.serialize(out);
  }

  Int32 size() const override {
    Int32 sz = 4 + 2;  // size of message + number of fields
    for (const FieldDescription& field : fields_descr) sz += field.size();
    return sz;
  }

  MessageType getMessageType() const override { return MessageType::ROW_DESCRIPTION; }
};
...
class StringField : public ISerializable {
 ...
 public:
  ...
  void serialize(WriteBuffer& out) const override { writeString(str, out); }

  Int32 size() const override { return static_cast<Int32>(str.size()); }
};
...
class NullField : public ISerializable {
 public:
  ...
  Int32 size() const override { return -1; }
};
...
class DataRow : BackendMessage {
 ...
 public:
  ...
  Int32 size() const override {
    ...
    for (const std::shared_ptr<ISerializable>& field : row) sz += 4 + (field->size() > 0 ? field->size() : 0);
    return sz;
  }

  MessageType getMessageType() const override { return MessageType::DATA_ROW; }
};
...
class CopyDataQuery : FrontMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::COPY_DATA; }
};
...
class CopyInResponse : public BackendMessage {
 public:
  ...
  Int32 size() const override { return 4 + 1 + 2; }

  MessageType getMessageType() const override { return MessageType::COPY_IN_RESPONSE; }
};
...
class CopyOutResponse : public BackendMessage {
 ...
 public:
  explicit CopyOutResponse(int num_columns_ = 1) : num_columns(num_columns_) {}
  ...
  void serialize(WriteBuffer& out) const override {
    ...
    for (int i = 0; i < num_columns; ++i) writeBinaryBigEndian(static_cast<Int16>(FormatCode::TEXT), out);
  }

  Int32 size() const override { return 4 + 1 + 2 + 2 * num_columns; }

  MessageType getMessageType() const override { return MessageType::COPY_OUT_RESPONSE; }
};
...
class CopyDone : FrontMessage {
 public:
  ...
  MessageType getMessageType() const override { return MessageType::COPY_DONE; }
};
...
class CopyOutData : public BackendMessage {
 ...
 public:
  explicit CopyOutData(std::vector<char> data_) : data(data_) {}
  ...
  Int32 size() const override { return 4 + static_cast<Int32>(data.size()); }
...
class CommandComplete : BackendMessage {
 ...
 private:
  String enum_to_string[18] = {"BEGIN",      "COMMIT",        "INSERT",      "DELETE",   "UPDATE",       "SELECT",
                               "MOVE",       "FETCH",         "COPY",        "PREPARE",  "CREATE TABLE", "CREATE DATABASE",
                               "DROP TABLE", "DROP DATABASE", "ALTER TABLE", "TRUNCATE", "USE",          "SET"};
 ...
 public:
  CommandComplete(Command cmd_, Int32 rows_count_) {
    ...
    bool include_row_count = (cmd_ == Command::INSERT || cmd_ == Command::DELETE || cmd_ == Command::UPDATE || cmd_ == Command::SELECT ||
                              cmd_ == Command::MOVE || cmd_ == Command::FETCH || cmd_ == Command::COPY);

    if (include_row_count) {
      String add = " ";
      if (cmd_ == Command::INSERT) add = " 0 ";  // OID (always 0 for ClickHouse tables)
  ...
  Int32 size() const override { return static_cast<Int32>(4 + value.size() + 1); }

  MessageType getMessageType() const override { return MessageType::COMMAND_COMPLETE; }
  ...
  static Command classifyQuery(const String& query) {
    ...
    static const size_t MAX_PATTERN_LEN = []() {
      size_t max_len = 0;
      for (const auto& [pattern, _] : query_patterns) max_len = std::max(pattern.size(), max_len);
      return max_len;
    }();
    ...
    for (const auto& [pattern, command] : query_patterns) {
      if (prefix.starts_with(pattern)) return command;
    }
...
class AuthenticationMethod {
 protected:
  static void setPassword(const String& user_name, const String& password, Session& session, const Poco::Net::SocketAddress& address) {
    session.authenticate(user_name, password, address);
  }

 public:
  virtual void authenticate(const String& user_name, Session& session, Messaging::MessageTransport& mt,
...
class NoPasswordAuth : public AuthenticationMethod {
 public:
  void authenticate(const String& user_name, Session& session, [[maybe_unused]] Messaging::MessageTransport& mt,
...
class CleartextPasswordAuth : public AuthenticationMethod {
 public:
  void authenticate(const String& user_name, Session& session, Messaging::MessageTransport& mt,
                    const Poco::Net::SocketAddress& address) override {
    ...
    if (type == Messaging::FrontMessageType::PASSWORD_MESSAGE) {
      ...
      throw Exception(ErrorCodes::UNEXPECTED_PACKET_FROM_CLIENT, "Client sent wrong message or closed the connection. Message byte was {}.",
...
class ScrambleSHA256Auth : public AuthenticationMethod {
  static size_t findPatternPosition(const String& key, const String& pattern) {
    ...
    if (pos == key.size()) throw Exception(ErrorCodes::BAD_ARGUMENTS, "Client response should contain nonce");
  ...
  static String parseClientNonce(const String& key) { return parseResponse(key, "r="); }

  static String parseProof(const String& key) { return parseResponse(key, "p="); }

  static String parseUsername(const String& key) { return parseResponse(key, "n="); }

  static size_t findProofPosition(const String& key) { return findPatternPosition(key, "p="); }
 ...
 public:
  ...
  AuthenticationType getType() const override { return AuthenticationType::SCRAM_SHA256_PASSWORD; }
};
...
class AuthenticationManager {
 ...
 public:
  ...
  void authenticate(const String& user_name, Session& session, Messaging::MessageTransport& mt, const Poco::Net::SocketAddress& address) {
    try {
      ...
      mt.send(Messaging::ErrorOrNoticeResponse(Messaging::ErrorOrNoticeResponse::ERROR, "28P01", "Invalid user or password"), true);
...
class PreparedStatemetsManager {
 public:
  explicit PreparedStatemetsManager(std::optional<size_t> limit_statements_) : limit_statements(limit_statements_) {}
  ...
  String getStatement(ASTExecute* execute) { return getStatement(execute->function_name, execute->arguments); }

  void deleteStatement(ASTDeallocate* query) {
    auto it = statements.find(query->function_name);
    if (it == statements.end()) throw Exception(ErrorCodes::BAD_ARGUMENTS, "Unknown statement");

    statements.erase(it);
  }

  void attachBindQuery(std::unique_ptr<PostgreSQLProtocol::Messaging::BindQuery> query) {
    if (bind_query) throw Exception(ErrorCodes::UNEXPECTED_PACKET_FROM_CLIENT, "Query is already binded");
