...
struct MonitorCommand : public IFourLetterCommand {
  explicit MonitorCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct StatResetCommand : public IFourLetterCommand {
  explicit StatResetCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct NopCommand : public IFourLetterCommand {
  explicit NopCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct ConfCommand : public IFourLetterCommand {
  explicit ConfCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct ConsCommand : public IFourLetterCommand {
  explicit ConsCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct RestConnStatsCommand : public IFourLetterCommand {
  explicit RestConnStatsCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct ServerStatCommand : public IFourLetterCommand {
  explicit ServerStatCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct StatCommand : public IFourLetterCommand {
  explicit StatCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct BriefWatchCommand : public IFourLetterCommand {
  explicit BriefWatchCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct WatchCommand : public IFourLetterCommand {
  explicit WatchCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct WatchByPathCommand : public IFourLetterCommand {
  explicit WatchByPathCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct DumpCommand : public IFourLetterCommand {
  explicit DumpCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct EnviCommand : public IFourLetterCommand {
  explicit EnviCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct DataSizeCommand : public IFourLetterCommand {
  explicit DataSizeCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct IsReadOnlyCommand : public IFourLetterCommand {
  explicit IsReadOnlyCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct RecoveryCommand : public IFourLetterCommand {
  explicit RecoveryCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct ApiVersionCommand : public IFourLetterCommand {
  explicit ApiVersionCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct CreateSnapshotCommand : public IFourLetterCommand {
  explicit CreateSnapshotCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct LogInfoCommand : public IFourLetterCommand {
  explicit LogInfoCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct RequestLeaderCommand : public IFourLetterCommand {
  explicit RequestLeaderCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct RecalculateCommand : public IFourLetterCommand {
  explicit RecalculateCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct CleanResourcesCommand : public IFourLetterCommand {
  explicit CleanResourcesCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct FeatureFlagsCommand : public IFourLetterCommand {
  explicit FeatureFlagsCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct YieldLeadershipCommand : public IFourLetterCommand {
  explicit YieldLeadershipCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct JemallocDumpStats : public IFourLetterCommand {
  explicit JemallocDumpStats(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct JemallocFlushProfile : public IFourLetterCommand {
  explicit JemallocFlushProfile(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct JemallocEnableProfile : public IFourLetterCommand {
  explicit JemallocEnableProfile(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct JemallocDisableProfile : public IFourLetterCommand {
  explicit JemallocDisableProfile(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct ProfileEventsCommand : public IFourLetterCommand {
  explicit ProfileEventsCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct ToggleRequestLogging : public IFourLetterCommand {
  explicit ToggleRequestLogging(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
...
struct ReconfigureCommand : public IFourLetterCommand {
  explicit ReconfigureCommand(KeeperDispatcher &keeper_dispatcher_) : IFourLetterCommand(keeper_dispatcher_) {}
