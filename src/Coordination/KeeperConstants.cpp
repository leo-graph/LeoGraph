...
#define M(NAME) NAME,
extern const std::vector<Event> keeper_profile_events{APPLY_FOR_KEEPER_PROFILE_EVENTS(M)};
#undef M
}  // namespace ProfileEvents
...
#define M(NAME) NAME,
extern const std::vector<Metric> keeper_metrics{APPLY_FOR_KEEPER_METRICS(M)};
#undef M
}  // namespace CurrentMetrics
