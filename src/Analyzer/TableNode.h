...
class TableNode : public IQueryTreeNode {
 public:
  ...
  /// Get storage lock
  const TableLockHolder& getStorageLock() const { return storage_lock; }

  /// Get temporary table name
  const std::string& getTemporaryTableName() const { return temporary_table_name; }

  /// Set temporary table name
  void setTemporaryTableName(std::string temporary_table_name_value) { temporary_table_name = std::move(temporary_table_name_value); }
