...
class SourceNode final : public IQueryTreeNode {
 public:
  ...
  QueryTreeNodePtr cloneImpl() const override { return std::make_shared<SourceNode>(); }

  ASTPtr toASTImpl(const ConvertToASTOptions & /* options */) const override { return nullptr; }
};
