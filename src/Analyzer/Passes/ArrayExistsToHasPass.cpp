...
class RewriteArrayExistsToHasVisitor : public InDepthQueryTreeVisitorWithContext<RewriteArrayExistsToHasVisitor> {
 public:
  ...
  void enterImpl(QueryTreeNodePtr& node) {
    ...
    if (filter_lhs_argument_node_type == QueryTreeNodeType::COLUMN && filter_rhs_argument_node_type == QueryTreeNodeType::CONSTANT &&
    ...
    } else if (filter_lhs_argument_node_type == QueryTreeNodeType::CONSTANT && filter_rhs_argument_node_type == QueryTreeNodeType::COLUMN &&
