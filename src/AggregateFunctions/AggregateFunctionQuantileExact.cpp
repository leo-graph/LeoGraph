...
using FuncQuantileExact = AggregateFunctionQuantile<Value, QuantileExact<Value>, NameQuantileExact, void, void, false, false>;
template <typename Value, bool _>
using FuncQuantilesExact = AggregateFunctionQuantile<Value, QuantileExact<Value>, NameQuantilesExact, void, void, true, false>;
...
quantileExact(level)(expr)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Quantile of the specified level. For numeric data types the output format will be the same as the input format.",
      {"(U)Int*", "Float*", "Decimal*", "Date", "DateTime"}};
  FunctionDocumentation::Examples examples = {{"Computing exact quantile",
                                               R"(
