...
class AggregateFunctionThrow final : public IAggregateFunctionDataHelper<AggregateFunctionThrowData, AggregateFunctionThrow> {
 ...
 public:
  AggregateFunctionThrow(const DataTypes &argument_types_, const Array &parameters_, Float64 throw_probability_)
      : IAggregateFunctionDataHelper(argument_types_, parameters_, createResultType()), throw_probability(throw_probability_) {}

  String getName() const override { return "aggThrow"; }

  static DataTypePtr createResultType() { return std::make_shared<DataTypeUInt8>(); }
  ...
  void insertResultInto(AggregateDataPtr __restrict, IColumn &to, Arena *) const override { to.insertDefault(); }
};
...
aggThrow(throw_prob)
  ...
  FunctionDocumentation::Arguments arguments_aggThrow = {{"throw_prob", "Probability to throw on creation.", {"Float64"}}};
  FunctionDocumentation::ReturnedValue returned_value_aggThrow = {
      "Returns an exception: `Code: 503. DB::Exception: Aggregate function aggThrow has thrown exception successfully`.", {}};
  FunctionDocumentation::Examples examples_aggThrow = {{"Usage example",
                                                        R"(
...
Code: 503. DB::Exception: Aggregate function aggThrow has thrown exception successfully: While executing AggregatingTransform. (AGGREGATE_FUNCTION_THROW)
  ...
  FunctionDocumentation documentation_aggThrow = {description_aggThrow,    syntax_aggThrow,   arguments_aggThrow,     {},
                                                  returned_value_aggThrow, examples_aggThrow, introduced_in_aggThrow, category_aggThrow};
                           ...
                           {[](const std::string &name, const DataTypes &argument_types, const Array &parameters, const Settings *) {
                              ...
                              if (parameters.size() == 1)
                                ...
                                throw Exception(ErrorCodes::TOO_MANY_ARGUMENTS_FOR_FUNCTION,
                                                "Aggregate function {} cannot have more than one parameter", name);
