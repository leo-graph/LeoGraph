...
template <typename T>
using AggregateFunctionThirdMoment = AggregateFunctionVarianceSimple<StatFuncOneArg<T, 3>>;
...
skewSamp(expr)
  ...
  FunctionDocumentation::Arguments arguments_skewSamp = {{"expr", "An expression returning a number.", {"Expression"}}};
  FunctionDocumentation::ReturnedValue returned_value_skewSamp = {
      "Returns the skewness of the given distribution. If `n <= 1` (`n` is the size of the sample), then the function returns `nan`.",
      {"Float64"}};
  FunctionDocumentation::Examples examples_skewSamp = {{"Symmetric distribution",
                                                        R"(
...
└────────────────────┘
  ...
  FunctionDocumentation documentation_skewSamp = {description_skewSamp,    syntax_skewSamp,   arguments_skewSamp,     parameters_skewSamp,
                                                  returned_value_skewSamp, examples_skewSamp, introduced_in_skewSamp, category_skewSamp};

  factory.registerFunction(
      "skewSamp",
      {createAggregateFunctionStatisticsUnary<AggregateFunctionThirdMoment, StatisticsFunctionKind::skewSamp>, documentation_skewSamp});
...
skewPop(expr)
  ...
  FunctionDocumentation::Arguments arguments_skewPop = {{"expr", "An expression returning a number.", {"Expression"}}};
  FunctionDocumentation::ReturnedValue returned_value_skewPop = {"Returns the skewness of the given distribution.", {"Float64"}};
  FunctionDocumentation::Examples examples_skewPop = {{"Symmetric distribution",
                                                       R"(
...
└────────────────────┘
  ...
  FunctionDocumentation documentation_skewPop = {description_skewPop,    syntax_skewPop,   arguments_skewPop,     parameters_skewPop,
                                                 returned_value_skewPop, examples_skewPop, introduced_in_skewPop, category_skewPop};

  factory.registerFunction(
      "skewPop",
      {createAggregateFunctionStatisticsUnary<AggregateFunctionThirdMoment, StatisticsFunctionKind::skewPop>, documentation_skewPop});
}
