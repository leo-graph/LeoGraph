...
studentTTest([confidence_level])(sample_data, sample_index)
  ...
  FunctionDocumentation::Arguments arguments_studentTTest = {{"sample_data", "Sample data.", {"Integer", "Float", "Decimal"}},
  ...
  FunctionDocumentation::ReturnedValue returned_value_studentTTest = {
      ...
      "p-value, [calculated confidence-interval-low], [calculated confidence-interval-high].",
      {"Tuple(Float64, Float64)", "Tuple(Float64, Float64, Float64, Float64)"}};
  FunctionDocumentation::Examples examples_studentTTest = {{"Basic usage",
                                                            R"(
...
└───────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_studentTTest = {description_studentTTest,   syntax_studentTTest,         arguments_studentTTest,
                                                      parameters_studentTTest,    returned_value_studentTTest, examples_studentTTest,
                                                      introduced_in_studentTTest, category_studentTTest};
