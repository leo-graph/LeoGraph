...
struct AggregateFunctionTimeseriesChangesTraits {
  ...
  static String getName() { return is_resets ? "timeSeriesResetsToGrid" : "timeSeriesChangesToGrid"; }
...
class AggregateFunctionTimeseriesChanges final
 ...
 private:
  void fillResultValue(const DequeWithMemoryTracking<std::pair<TimestampType, ValueType>> &samples_in_window, ValueType &result,
                       UInt8 &null) const {
