...
Decimal64 normalizeParameter(const std::string &function_name, const std::string &parameter_name, const Field &parameter_field,
                             UInt32 target_scale) {
  ...
  if (parameter_field.getType() == Field::Types::Decimal64) {
    ...
    if (tryReadDecimalText(buf, value, 20, scale))
      ...
      throw Exception(ErrorCodes::BAD_ARGUMENTS, "Cannot parse {} parameter for aggregate function {}", parameter_name, function_name);
  } else {
    throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of {} parameter for aggregate function {}",
...
template <bool is_rate_or_resets, bool is_predict, bool array_arguments, typename ValueType,
          template <bool, typename, typename, typename, bool> class FunctionTraits, template <typename> class Function>
AggregateFunctionPtr createWithValueType(const std::string &name, const DataTypes &argument_types, const Array &parameters) {
  const auto &timestamp_type =
      array_arguments ? typeid_cast<const DataTypeArray *>(argument_types[0].get())->getNestedType() : argument_types[0];
...
template <bool is_rate_or_resets, bool is_predict, template <bool, typename, typename, typename, bool> class FunctionTraits,
          template <typename> class Function>
AggregateFunctionPtr createAggregateFunctionTimeseries(const std::string &name, const DataTypes &argument_types, const Array &parameters,
  ...
  const auto &value_type =
      array_arguments ? typeid_cast<const DataTypeArray *>(argument_types[1].get())->getNestedType() : argument_types[1];
...
timeSeriesRateToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
  ...
  FunctionDocumentation::Parameters parameters_timeSeriesRateToGrid = {
      ...
      {"staleness",
       "Specifies the maximum staleness in seconds of the considered samples. The staleness window is a left-open and right-closed "
       "interval.",
       {"UInt32"}}};
  FunctionDocumentation::Arguments arguments_timeSeriesRateToGrid = {
      {"timestamp",
       "Timestamp of the sample. Can be individual values or arrays.",
       {"UInt32", "DateTime", "Array(UInt32)", "Array(DateTime)"}},
      {"value",
       "Value of the time series corresponding to the timestamp. Can be individual values or arrays.",
       {"Float*", "Array(Float*)"}}};
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesRateToGrid = {
      "Returns rate values on the specified grid. The returned array contains one value for each time grid point. The value is NULL if "
      "there are not enough samples within the window to calculate the rate value for a particular grid point.",
      {"Array(Nullable(Float64))"}};
  FunctionDocumentation::Examples examples_timeSeriesRateToGrid = {{"Basic usage with individual timestamp-value pairs",
                                                                    R"(
WITH
...
└─────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesRateToGrid = {description_timeSeriesRateToGrid,    syntax_timeSeriesRateToGrid,
                                                              arguments_timeSeriesRateToGrid,      parameters_timeSeriesRateToGrid,
                                                              returned_value_timeSeriesRateToGrid, examples_timeSeriesRateToGrid,
                                                              introduced_in_timeSeriesRateToGrid,  category_timeSeriesRateToGrid};

  factory.registerFunction("timeSeriesRateToGrid",
                           {createAggregateFunctionTimeseries<true, false, AggregateFunctionTimeseriesExtrapolatedValueTraits,
...
timeSeriesDeltaToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
  ...
  FunctionDocumentation::Arguments arguments_timeSeriesDeltaToGrid = {
      ...
      {"value",
       "Value of the time series corresponding to the timestamp. Can be individual values or arrays.",
       {"Float*", "Array(Float*)"}}};
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesDeltaToGrid = {
      "Returns delta values on the specified grid. The returned array contains one value for each time grid point. The value is NULL if "
      "there are not enough samples within the window to calculate the delta value for a particular grid point.",
      {"Array(Nullable(Float64))"}};
  FunctionDocumentation::Examples examples_timeSeriesDeltaToGrid = {{"Basic usage with individual timestamp-value pairs",
                                                                     R"(
WITH
    -- NOTE: the gap between 140 and 190 is to show how values are filled for ts = 150, 165, 180 according to window parameter
    [110, 120, 130, 140, 190, 200, 210, 220, 230]::Array(DateTime) AS timestamps,
...
└─────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesDeltaToGrid = {description_timeSeriesDeltaToGrid,    syntax_timeSeriesDeltaToGrid,
                                                               arguments_timeSeriesDeltaToGrid,      parameters_timeSeriesDeltaToGrid,
                                                               returned_value_timeSeriesDeltaToGrid, examples_timeSeriesDeltaToGrid,
                                                               introduced_in_timeSeriesDeltaToGrid,  category_timeSeriesDeltaToGrid};

  factory.registerFunction("timeSeriesDeltaToGrid",
                           {createAggregateFunctionTimeseries<false, false, AggregateFunctionTimeseriesExtrapolatedValueTraits,
                                                              AggregateFunctionTimeseriesExtrapolatedValue>,
...
timeSeriesInstantRateToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
  ...
  FunctionDocumentation::Arguments arguments_timeSeriesInstantRateToGrid = {
      ...
      {"value",
       "Value of the time series corresponding to the timestamp. Can be individual values or arrays.",
       {"Float*", "Array(Float*)"}}};
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesInstantRateToGrid = {
      "Returns irate values on the specified grid. The returned array contains one value for each time grid point. The value is NULL if "
      "there are not enough samples within the window to calculate the instant rate value for a particular grid point.",
      {"Array(Nullable(Float64))"}};
  FunctionDocumentation::Examples examples_timeSeriesInstantRateToGrid = {{"Basic usage with individual timestamp-value pairs",
                                                                           R"(
WITH
    -- NOTE: the gap between 140 and 190 is to show how values are filled for ts = 150, 165, 180 according to window parameter
    [110, 120, 130, 140, 190, 200, 210, 220, 230]::Array(DateTime) AS timestamps,
...
└────────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesInstantRateToGrid = {
      description_timeSeriesInstantRateToGrid,   syntax_timeSeriesInstantRateToGrid,         arguments_timeSeriesInstantRateToGrid,
      parameters_timeSeriesInstantRateToGrid,    returned_value_timeSeriesInstantRateToGrid, examples_timeSeriesInstantRateToGrid,
  ...
  factory.registerFunction("timeSeriesInstantRateToGrid",
                           {createAggregateFunctionTimeseries<true, false, AggregateFunctionTimeseriesInstantValueTraits,
                                                              AggregateFunctionTimeseriesInstantValue>,
...
timeSeriesInstantDeltaToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
  ...
  FunctionDocumentation::Arguments arguments_timeSeriesInstantDeltaToGrid = {
      ...
      {"value",
       "Value of the time series corresponding to the timestamp. Can be individual values or arrays.",
       {"Float*", "Array(Float*)"}}};
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesInstantDeltaToGrid = {
      "Returns idelta values on the specified grid. The returned array contains one value for each time grid point. The value is NULL if "
      "there are not enough samples within the window to calculate the instant delta value for a particular grid point.",
      {"Array(Nullable(Float64))"}};
  FunctionDocumentation::Examples examples_timeSeriesInstantDeltaToGrid = {{"Basic usage with individual timestamp-value pairs",
                                                                            R"(
WITH
    -- NOTE: the gap between 140 and 190 is to show how values are filled for ts = 150, 165, 180 according to window parameter
    [110, 120, 130, 140, 190, 200, 210, 220, 230]::Array(DateTime) AS timestamps,
...
└─────────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesInstantDeltaToGrid = {
      description_timeSeriesInstantDeltaToGrid,   syntax_timeSeriesInstantDeltaToGrid,         arguments_timeSeriesInstantDeltaToGrid,
      parameters_timeSeriesInstantDeltaToGrid,    returned_value_timeSeriesInstantDeltaToGrid, examples_timeSeriesInstantDeltaToGrid,
      introduced_in_timeSeriesInstantDeltaToGrid, category_timeSeriesInstantDeltaToGrid};

  factory.registerFunction("timeSeriesInstantDeltaToGrid",
                           {createAggregateFunctionTimeseries<false, false, AggregateFunctionTimeseriesInstantValueTraits,
                                                              AggregateFunctionTimeseriesInstantValue>,
...
timeSeriesDerivToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
  ...
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesDerivToGrid = {
      "`deriv` values on the specified grid as an `Array(Nullable(Float64))`. The returned array contains one value for each time grid "
      "point. The value is NULL if there are not enough samples within the window to calculate the derivative value for a particular grid "
      "point.",
      {}};
...
└───────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesDerivToGrid = {description_timeSeriesDerivToGrid,    syntax_timeSeriesDerivToGrid,
                                                               arguments_timeSeriesDerivToGrid,      parameters_timeSeriesDerivToGrid,
                                                               returned_value_timeSeriesDerivToGrid, examples_timeSeriesDerivToGrid,
                                                               introduced_in_timeSeriesDerivToGrid,  category_timeSeriesDerivToGrid};

  factory.registerFunction("timeSeriesDerivToGrid",
                           {createAggregateFunctionTimeseries<false, false, AggregateFunctionTimeseriesLinearRegressionTraits,
                                                              AggregateFunctionTimeseriesLinearRegression>,
...
timeSeriesPredictLinearToGrid(start_timestamp, end_timestamp, grid_step, staleness, predict_offset)(timestamp, value)
  ...
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesPredictLinearToGrid = {
      "`predict_linear` values on the specified grid as an `Array(Nullable(Float64))`. The returned array contains one value for each time "
      "grid point. The value is NULL if there are not enough samples within the window to calculate the rate value for a particular grid "
      "point.",
      {}};
...
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesPredictLinearToGrid = {
      description_timeSeriesPredictLinearToGrid,   syntax_timeSeriesPredictLinearToGrid,         arguments_timeSeriesPredictLinearToGrid,
      parameters_timeSeriesPredictLinearToGrid,    returned_value_timeSeriesPredictLinearToGrid, examples_timeSeriesPredictLinearToGrid,
      introduced_in_timeSeriesPredictLinearToGrid, category_timeSeriesPredictLinearToGrid};

  factory.registerFunction("timeSeriesPredictLinearToGrid",
                           {createAggregateFunctionTimeseries<false, true, AggregateFunctionTimeseriesLinearRegressionTraits,
                                                              AggregateFunctionTimeseriesLinearRegression>,
...
timeSeriesChangesToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
  ...
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesChangesToGrid = {
      "`changes` values on the specified grid as an `Array(Nullable(Float64))`. The returned array contains one value for each time grid "
...
└───────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesChangesToGrid = {description_timeSeriesChangesToGrid,    syntax_timeSeriesChangesToGrid,
                                                                 arguments_timeSeriesChangesToGrid,      parameters_timeSeriesChangesToGrid,
                                                                 returned_value_timeSeriesChangesToGrid, examples_timeSeriesChangesToGrid,
...
timeSeriesResetsToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
  ...
  FunctionDocumentation::Arguments arguments_timeSeriesResetsToGrid = {
      {"timestamp", "Timestamp of the sample. Can be individual values or arrays.", {}},
      {"value", "Value of the time series corresponding to the timestamp. Can be individual values or arrays.", {}}};
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesResetsToGrid = {
      "`resets` values on the specified grid as an `Array(Nullable(Float64))`. The returned array contains one value for each time grid "
...
└──────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesResetsToGrid = {description_timeSeriesResetsToGrid,    syntax_timeSeriesResetsToGrid,
                                                                ...
                                                                returned_value_timeSeriesResetsToGrid, examples_timeSeriesResetsToGrid,
                                                                introduced_in_timeSeriesResetsToGrid,  category_timeSeriesResetsToGrid};
...
timeSeriesResampleToGridWithStaleness(start_timestamp, end_timestamp, grid_step, staleness_window)(timestamp, value)
  ...
  FunctionDocumentation::Arguments arguments_timeSeriesResampleToGridWithStaleness = {
      ...
      {"value",
       "Value of the time series corresponding to the timestamp. Can be individual values or arrays.",
       {"Float*", "Array(Float*)"}}};
  FunctionDocumentation::ReturnedValue returned_value_timeSeriesResampleToGridWithStaleness = {
      "Returns time series values re-sampled to the specified grid. The returned array contains one value for each time grid point. The "
      "value is NULL if there is no sample for a particular grid point.",
      {"Array(Nullable(Float64))"}};
  FunctionDocumentation::Examples examples_timeSeriesResampleToGridWithStaleness = {{"Basic usage with individual timestamp-value pairs",
                                                                                     R"(
WITH
...
└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_timeSeriesResampleToGridWithStaleness = {
      description_timeSeriesResampleToGridWithStaleness,    syntax_timeSeriesResampleToGridWithStaleness,
      arguments_timeSeriesResampleToGridWithStaleness,      parameters_timeSeriesResampleToGridWithStaleness,
      returned_value_timeSeriesResampleToGridWithStaleness, examples_timeSeriesResampleToGridWithStaleness,
  ...
  factory.registerFunction("timeSeriesResampleToGridWithStaleness",
                           {createAggregateFunctionTimeseries<false, false, AggregateFunctionTimeseriesToGridSparseTraits,
                                                              AggregateFunctionTimeseriesToGridSparse>,
