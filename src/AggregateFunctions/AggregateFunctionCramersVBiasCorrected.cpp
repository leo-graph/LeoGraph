...
struct CramersVBiasCorrectedData : CrossTabData {
  static const char *getName() { return "cramersVBiasCorrected"; }
...
The function can be heavily biased, so this version of Cramer's V uses the [bias correction](https://en.wikipedia.org/wiki/Cram%C3%A9r%27s_V#Bias_correction).
  ...
  FunctionDocumentation::Arguments arguments = {{"column1", "First column to be compared.", {"Any"}},
  ...
  FunctionDocumentation::Examples examples = {{"Comparison with regular cramersV",
                                               R"(
SELECT
    cramersV(a, b),
