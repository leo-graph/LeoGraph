...
DataTypePtr IAggregateFunction::getNormalizedStateType() const {
  ...
  for (const auto& arg : argument_types) normalized_argument_types.emplace_back(arg->getNormalizedType());
...
bool IAggregateFunction::haveEqualArgumentTypes(const IAggregateFunction& rhs) const {
  return std::equal(argument_types.begin(), argument_types.end(), rhs.argument_types.begin(), rhs.argument_types.end(),
...
void IAggregateFunction::parallelizeMergePrepare(AggregateDataPtrs& /*places*/, ThreadPool& /*thread_pool*/,
...
void IAggregateFunction::merge(AggregateDataPtr __restrict /*place*/, ConstAggregateDataPtr /*rhs*/, ThreadPool& /*thread_pool*/,
...
void IAggregateFunction::predictValues(ConstAggregateDataPtr __restrict /* place */, IColumn& /*to*/,
                                       const ColumnsWithTypeAndName& /*arguments*/, size_t /*offset*/, size_t /*limit*/,
...
void IAggregateFunction::compileAdd(llvm::IRBuilderBase& /*builder*/, llvm::Value* /*aggregate_data_ptr*/,
                                    const ValuesWithType& /*arguments*/) const {
  throw Exception(ErrorCodes::NOT_IMPLEMENTED, "{} is not JIT-compilable", getName());
}

void IAggregateFunction::compileMerge(llvm::IRBuilderBase& /*builder*/, llvm::Value* /*aggregate_data_dst_ptr*/,
