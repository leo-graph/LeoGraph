...
using AggregateFunctionCovar = AggregateFunctionVarianceSimple<StatFuncTwoArg<T1, T2, CovarMoments>>;
...
:::
  ...
  FunctionDocumentation::Arguments covarSamp_arguments = {{"x", "First variable.", {"(U)Int*", "Float*", "Decimal"}},
                                                          {"y", "Second variable.", {"(U)Int*", "Float*", "Decimal"}}};
  FunctionDocumentation::Parameters covarSamp_parameters = {};
  FunctionDocumentation::ReturnedValue covarSamp_returned_value = {
      "Returns the sample covariance between `x` and `y`. For `n <= 1`, `nan` is returned.", {"Float64"}};
  FunctionDocumentation::Examples covarSamp_examples = {{"Basic sample covariance calculation",
                                                         R"(
...
└─────────────────────────────┘
  ...
  FunctionDocumentation covarSamp_documentation = {covarSamp_description,   covarSamp_syntax,         covarSamp_arguments,
                                                   covarSamp_parameters,    covarSamp_returned_value, covarSamp_examples,
                                                   covarSamp_introduced_in, covarSamp_category};
...
:::
  ...
  FunctionDocumentation::Arguments covarPop_arguments = {{"x", "First variable.", {"(U)Int*", "Float*", "Decimal"}},
                                                         {"y", "Second variable.", {"(U)Int*", "Float*", "Decimal"}}};
  ...
  FunctionDocumentation::Examples covarPop_examples = {{"Basic population covariance calculation",
                                                        R"(
DROP TABLE IF EXISTS series;
CREATE TABLE series(i UInt32, x_value Float64, y_value Float64) ENGINE = Memory;
INSERT INTO series(i, x_value, y_value) VALUES (1, 5.6, -4.4),(2, -9.6, 3),(3, -1.3, -4),(4, 5.3, 9.7),(5, 4.4, 0.037),(6, -8.6, -7.8),(7, 5.1, 9.3),(8, 7.9, -3.6),(9, -8.2, 0.62),(10, -3, 7.3);
...
└────────────────────────────┘
  ...
  FunctionDocumentation covarPop_documentation = {covarPop_description,    covarPop_syntax,   covarPop_arguments,     covarPop_parameters,
                                                  covarPop_returned_value, covarPop_examples, covarPop_introduced_in, covarPop_category};
