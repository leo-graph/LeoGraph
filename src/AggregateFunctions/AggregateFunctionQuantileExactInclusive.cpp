...
using FuncQuantileExactInclusive =
    AggregateFunctionQuantile<Value, QuantileExactInclusive<Value>, NameQuantileExactInclusive, void, Float64, false, false>;
template <typename Value, bool _>
using FuncQuantilesExactInclusive =
    AggregateFunctionQuantile<Value, QuantileExactInclusive<Value>, NameQuantilesExactInclusive, void, Float64, true, false>;
...
quantileExactInclusive(level)(expr)
  ...
  FunctionDocumentation::Parameters parameters = {{"level",
                                                   "Level of quantile. Constant floating-point number from 0 to 1 (inclusive). We "
  ...
  FunctionDocumentation::Examples examples = {{"Computing exact inclusive quantile",
                                               R"(
...
quantilesExactInclusive(level1, level2, ...)(expr)
  ...
  FunctionDocumentation::Parameters parameters_quantiles = {
      {"level",
       "Levels of quantiles. Constant floating-point numbers from 0 to 1 (inclusive). We recommend using `level` values in the range of "
       "`[0.01, 0.99]`.",
       {"Float*"}}};
  ...
  FunctionDocumentation::Examples examples_quantiles = {{"Computing multiple exact inclusive quantiles",
                                                         R"(
...
└──────────────────────────────────────────────────────────────────────────┘
  ...
  factory.registerFunction(NameQuantilesExactInclusive::name,
                           {createAggregateFunctionQuantile<FuncQuantilesExactInclusive>, documentation_quantiles, properties});
}
