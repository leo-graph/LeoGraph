...
class IAggregateFunctionCombinator {
 public:
   ...
   * If arguments are not suitable for combined function, throw an exception.
   */
  virtual Array transformParameters(const Array& parameters) const { return parameters; }
   ...
   */
  virtual AggregateFunctionPtr transformAggregateFunction(const AggregateFunctionPtr& nested_function,
