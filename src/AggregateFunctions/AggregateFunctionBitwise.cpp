...
struct AggregateFunctionGroupBitOrData {
  ...
  static llvm::Value *compileUpdate(llvm::IRBuilderBase &builder, llvm::Value *lhs, llvm::Value *rhs) { return builder.CreateOr(lhs, rhs); }
...
groupBitOr(expr)
  ...
  FunctionDocumentation::Arguments arguments_or = {{"expr", "Expression of `(U)Int*` type.", {"(U)Int*"}}};
  ...
  FunctionDocumentation::Examples examples_or = {{"Bitwise OR example",
                                                  R"(
...
groupBitAnd(expr)
  ...
  FunctionDocumentation::Arguments arguments = {{"expr", "Expression of `(U)Int*` type.", {"(U)Int*"}}};
  FunctionDocumentation::Parameters parameters = {};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a value of `(U)Int*` type.", {"(U)Int*"}};
  FunctionDocumentation::Examples examples = {{"Bitwise AND example",
                                               R"(
CREATE TABLE t (num UInt32) ENGINE = Memory;
INSERT INTO t VALUES (44), (28), (13), (85);
...
groupBitXor(expr)
  ...
  FunctionDocumentation::Arguments arguments_xor = {{"expr", "Expression of `(U)Int*` type.", {"(U)Int*"}}};
  ...
  FunctionDocumentation::Examples examples_xor = {{"Bitwise XOR example",
                                                   R"(
CREATE TABLE t (num UInt32) ENGINE = Memory;
INSERT INTO t VALUES (44), (28), (13), (85);
