...
using FuncQuantileTDigestWeighted = AggregateFunctionQuantile<Value, QuantileTDigest<Value>, NameQuantileTDigestWeighted, UInt64,
                                                              std::conditional_t<float_return, Float32, void>, false, false>;
template <typename Value, bool float_return>
using FuncQuantilesTDigestWeighted = AggregateFunctionQuantile<Value, QuantileTDigest<Value>, NameQuantilesTDigestWeighted, UInt64,
                                                               std::conditional_t<float_return, Float32, void>, true, false>;
...
quantileTDigestWeighted(level)(expr, weight)
  ...
  FunctionDocumentation::Examples examples = {{"Computing weighted quantile with t-digest",
                                               R"(
...
└────────────────────────────────────┘
  ...
  factory.registerFunction(NameQuantileTDigestWeighted::name,
                           {createAggregateFunctionQuantile<FuncQuantileTDigestWeighted>, documentation});
...
quantilesTDigestWeighted(level1, level2, ...)(expr, weight)
  ...
  FunctionDocumentation::Examples examples_quantiles = {{"Computing multiple weighted quantiles with t-digest",
                                                         R"(
...
└───────────────────────────────────────────────────────┘
  ...
  factory.registerFunction(NameQuantilesTDigestWeighted::name,
                           {createAggregateFunctionQuantile<FuncQuantilesTDigestWeighted>, documentation_quantiles, properties});
