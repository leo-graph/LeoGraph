...
using FuncQuantileExactExclusive =
    AggregateFunctionQuantile<Value, QuantileExactExclusive<Value>, NameQuantileExactExclusive, void, Float64, false, false>;
template <typename Value, bool _>
using FuncQuantilesExactExclusive =
    AggregateFunctionQuantile<Value, QuantileExactExclusive<Value>, NameQuantilesExactExclusive, void, Float64, true, false>;
...
quantileExactExclusive(level)(expr)
  ...
  FunctionDocumentation::Parameters parameters = {{"level",
                                                   "Level of quantile. Constant floating-point number from 0 to 1 (exclusive). We "
                                                   "recommend using a `level` value in the range of `(0.01, 0.99)`.",
                                                   {"Float*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the quantile of the specified level.", {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Computing exact exclusive quantile",
                                               R"(
...
quantilesExactExclusive(level1, level2, ...)(expr)
  ...
  FunctionDocumentation::Parameters parameters_quantiles = {
      {"level",
       "Levels of quantiles. Constant floating-point numbers from 0 to 1 (exclusive). We recommend using `level` values in the range of "
       "`(0.01, 0.99)`.",
       {"Float*"}}};
  ...
  FunctionDocumentation::Examples examples_quantiles = {{"Computing multiple exact exclusive quantiles",
                                                         R"(
...
└──────────────────────────────────────────────────────────────────────────┘
  ...
  factory.registerFunction(NameQuantilesExactExclusive::name,
                           {createAggregateFunctionQuantile<FuncQuantilesExactExclusive>, documentation_quantiles, properties});
}
