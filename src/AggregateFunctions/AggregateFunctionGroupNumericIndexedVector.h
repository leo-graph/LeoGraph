...
class AggregateFunctionNumericIndexedVector final
    : public IAggregateFunctionDataHelper<AggregateFunctionGroupNumericIndexedVectorData<VectorImpl>,
 ...
 public:
  ...
  explicit AggregateFunctionNumericIndexedVector(const DataTypes &types, const Array &params, IArgs &&...args)
      : IAggregateFunctionDataHelper<AggregateFunctionGroupNumericIndexedVectorData<VectorImpl>,
  ...
  void add(AggregateDataPtr __restrict place, const IColumn **columns, size_t row_num, Arena *) const override {
    ...
    if (!data_lhs.init) {
      data_lhs.init = true;
      std::apply(
          [&data_lhs](auto &&...unpacked_args) { data_lhs.vector.initialize(std::forward<decltype(unpacked_args)>(unpacked_args)...); },
          init_args_tuple);
    }
