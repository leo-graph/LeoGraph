 ...
 *  - ......
 *
 *  `VectorImpl` is the implementation of vector, including how to store and implement the operations provided above on this storage. For
 * one of the specific implementations, see the `BSINumericIndexedVector`.
 */
