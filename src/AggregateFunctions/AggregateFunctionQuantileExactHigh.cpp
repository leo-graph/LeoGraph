...
using FuncQuantileExactHigh = AggregateFunctionQuantile<Value, QuantileExactHigh<Value>, NameQuantileExactHigh, void, void, false, false>;
template <typename Value, bool _>
using FuncQuantilesExactHigh = AggregateFunctionQuantile<Value, QuantileExactHigh<Value>, NameQuantilesExactHigh, void, void, true, false>;
...
quantileExactHigh(level)(expr)
  ...
  FunctionDocumentation::Examples examples = {{"Computing exact high quantile",
                                               R"(
