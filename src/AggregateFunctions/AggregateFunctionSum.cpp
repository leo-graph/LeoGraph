...
sum(num)
  ...
  FunctionDocumentation::Arguments arguments = {{"num", "Column of numeric values.", {"(U)Int*", "Float*", "Decimal*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the sum of the values.", {"(U)Int*", "Float*", "Decimal*"}};
  FunctionDocumentation::Examples examples = {{"Computing sum of employee salaries",
                                               R"(
...
└─────────────┘
  ...
  factory.registerFunction("sum", {createAggregateFunctionSum<AggregateFunctionSumSimple>, documentation},
...
sumWithOverflow(num)
  ...
  FunctionDocumentation::Arguments arguments_overflow = {{"num", "Column of numeric values.", {"(U)Int*", "Float*", "Decimal*"}}};
  FunctionDocumentation::ReturnedValue returned_value_overflow = {"The sum of the values.", {"(U)Int*", "Float*", "Decimal*"}};
  FunctionDocumentation::Examples examples_overflow = {{"Demonstrating overflow behavior with UInt16",
                                                        R"(
CREATE TABLE employees
(
    id UInt32,
...
└─────────────┴──────────┴─────────────────────────┴──────────────────────┘
  ...
  FunctionDocumentation documentation_overflow = {description_overflow,    syntax_overflow,   arguments_overflow,     {},
                                                  returned_value_overflow, examples_overflow, introduced_in_overflow, category_overflow};
...
sumKahan(x)
  ...
  FunctionDocumentation::Arguments arguments_kahan = {{"x", "Input value.", {"Integer", "Float", "Decimal"}}};
  FunctionDocumentation::ReturnedValue returned_value_kahan = {"Returns the sum of numbers.", {"(U)Int*", "Float*", "Decimal"}};
  FunctionDocumentation::Examples examples_kahan = {{"Demonstrating precision improvement with Kahan summation",
                                                     R"(
...
└────────────────────┴───────────────┘
  ...
  FunctionDocumentation documentation_kahan = {description_kahan,    syntax_kahan,   arguments_kahan,     {},
                                               returned_value_kahan, examples_kahan, introduced_in_kahan, category_kahan};
