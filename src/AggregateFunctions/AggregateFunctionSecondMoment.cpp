...
template <typename T>
using AggregateFunctionSecondMoment = AggregateFunctionVarianceSimple<StatFuncOneArg<T, 2>>;
...
varSamp(x)
  ...
  FunctionDocumentation::Examples examples_varSamp = {{"Computing sample variance",
                                                       R"(
...
└──────────┘
  ...
  FunctionDocumentation documentation_varSamp = {description_varSamp,    syntax_varSamp,   arguments_varSamp,     {},
                                                 returned_value_varSamp, examples_varSamp, introduced_in_varSamp, category_varSamp};

  factory.registerFunction(
      "varSamp",
      {createAggregateFunctionStatisticsUnary<AggregateFunctionSecondMoment, StatisticsFunctionKind::varSamp>, documentation_varSamp});
...
varPop(x)
  ...
  FunctionDocumentation::Examples examples_varPop = {{"Computing population variance",
                                                      R"(
DROP TABLE IF EXISTS test_data;
CREATE TABLE test_data
(
...
└─────────┘
  ...
  FunctionDocumentation documentation_varPop = {description_varPop,    syntax_varPop,   arguments_varPop,     {},
                                                returned_value_varPop, examples_varPop, introduced_in_varPop, category_varPop};
...
stddevSamp(x)
  ...
  FunctionDocumentation::Examples examples_stddevSamp = {{"Computing sample standard deviation",
                                                          R"(
DROP TABLE IF EXISTS test_data;
CREATE TABLE test_data
(
...
└────────────────────────┘
  ...
  FunctionDocumentation documentation_stddevSamp = {
      description_stddevSamp,    syntax_stddevSamp,   arguments_stddevSamp,     {},
      returned_value_stddevSamp, examples_stddevSamp, introduced_in_stddevSamp, category_stddevSamp};

  factory.registerFunction("stddevSamp",
                           {createAggregateFunctionStatisticsUnary<AggregateFunctionSecondMoment, StatisticsFunctionKind::stddevSamp>,
                            documentation_stddevSamp});
...
stddevPop(x)
  ...
  FunctionDocumentation::Examples examples_stddevPop = {{"Computing population standard deviation",
                                                         R"(
...
└───────────────────┘
  ...
  FunctionDocumentation documentation_stddevPop = {
      description_stddevPop,    syntax_stddevPop,   arguments_stddevPop,     {},
      returned_value_stddevPop, examples_stddevPop, introduced_in_stddevPop, category_stddevPop};

  factory.registerFunction(
      "stddevPop",
      {createAggregateFunctionStatisticsUnary<AggregateFunctionSecondMoment, StatisticsFunctionKind::stddevPop>, documentation_stddevPop});
