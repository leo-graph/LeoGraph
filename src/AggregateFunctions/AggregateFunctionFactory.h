...
struct AggregateFunctionWithProperties {
  ...
  AggregateFunctionWithProperties(Creator creator_, FunctionDocumentation documentation_,
                                  AggregateFunctionProperties properties_ = {})  /// NOLINT
...
class AggregateFunctionFactory final : private boost::noncopyable, public IFactoryWithAliases<AggregateFunctionWithProperties> {
 public:
  ...
  AggregateFunctionPtr get(const String &name, NullsAction action, const DataTypes &argument_types, const Array &parameters,
 ...
 private:
  AggregateFunctionPtr getImpl(const String &name, NullsAction action, const DataTypes &argument_types, const Array &parameters,
                               AggregateFunctionProperties &out_properties, bool has_null_arguments) const;
