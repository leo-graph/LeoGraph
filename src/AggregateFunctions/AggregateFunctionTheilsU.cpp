...
struct TheilsUData : CrossTabData {
  static const char *getName() { return "theilsU"; }
...
theilsU(column1, column2)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a value between -1 and 1.", {"Float64"}};
