...
class AggregationFunctionDeltaSum final
 ...
 public:
  ...
  AggregationFunctionDeltaSum() : IAggregateFunctionDataHelper<AggregationFunctionDeltaSumData<T>, AggregationFunctionDeltaSum<T>>{} {}
...
AggregateFunctionPtr createAggregateFunctionDeltaSum(const String &name, const DataTypes &arguments, const Array &params,
                                                     const Settings *) {
  ...
  if (isInteger(data_type) || isFloat(data_type))
    return AggregateFunctionPtr(createWithNumericType<AggregationFunctionDeltaSum>(*data_type, arguments, params));
...
- [`runningDifference`](/sql-reference/functions/other-functions#runningDifference)
  ...
  FunctionDocumentation::Arguments arguments = {{"x1[, x2, ...]", "One or more input values.", {"Integer", "Float"}}};
  FunctionDocumentation::Parameters parameters = {};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a gained arithmetic difference of the input values.",
                                                         {"(U)Int*", "Float*"}};
  FunctionDocumentation::Examples examples = {{"Basic usage with positive differences",
                                               R"(
