...
struct AggregateFunctionAnyHeavyData {
 ...
 public:
  ...
  void addManyDefaults(const IColumn &column, size_t length, Arena *arena) {
    for (size_t i = 0; i < length; ++i) add(column, 0, arena);
  }
...
anyHeavy(column)
  ...
  FunctionDocumentation::Arguments arguments_anyHeavy = {{"column", "The column name.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_anyHeavy = {"Returns a frequently occurring value. The result is nondeterministic.",
                                                                  {"Any"}};
  FunctionDocumentation::Examples examples_anyHeavy = {{"Usage example",
                                                        R"(
...
└───────┘
  ...
  FunctionDocumentation documentation_anyHeavy = {description_anyHeavy,    syntax_anyHeavy,   arguments_anyHeavy,     {},
                                                  returned_value_anyHeavy, examples_anyHeavy, introduced_in_anyHeavy, category_anyHeavy};
