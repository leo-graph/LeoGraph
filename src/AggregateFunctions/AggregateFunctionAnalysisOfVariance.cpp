...
class AggregateFunctionAnalysisOfVariance final
    : public IAggregateFunctionDataHelper<AggregateFunctionAnalysisOfVarianceData, AggregateFunctionAnalysisOfVariance> {
 public:
...
AggregateFunctionPtr createAggregateFunctionAnalysisOfVariance(const std::string &name, const DataTypes &arguments, const Array &parameters,
                                                               const Settings *) {
...
analysisOfVariance(val, group_no)
  ...
  FunctionDocumentation::ReturnedValue returned_value_analysisOfVariance = {"Returns a tuple with the F-statistic and p-value.",
                                                                            {"Tuple(Float64, Float64)"}};
  FunctionDocumentation::Examples examples_analysisOfVariance = {{"Basic usage",
                                                                  R"(
...
└───────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_analysisOfVariance = {
      description_analysisOfVariance,    syntax_analysisOfVariance,   arguments_analysisOfVariance,     {},
      returned_value_analysisOfVariance, examples_analysisOfVariance, introduced_in_analysisOfVariance, category_analysisOfVariance};

  AggregateFunctionProperties properties = {.is_order_dependent = false};
  factory.registerFunction("analysisOfVariance", {createAggregateFunctionAnalysisOfVariance, documentation_analysisOfVariance, properties},
