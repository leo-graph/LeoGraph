...
using FuncQuantileTimingWeighted =
    AggregateFunctionQuantile<Value, QuantileTiming<Value>, NameQuantileTimingWeighted, UInt64, Float32, false, false>;
template <typename Value, bool _>
using FuncQuantilesTimingWeighted =
    AggregateFunctionQuantile<Value, QuantileTiming<Value>, NameQuantilesTimingWeighted, UInt64, Float32, true, false>;
...
quantileTimingWeighted(level)(expr, weight)
  ...
  FunctionDocumentation::Examples examples = {{"Computing weighted timing quantile",
                                               R"(
...
quantilesTimingWeighted(level1, level2, ...)(expr, weight)
  ...
  FunctionDocumentation::Examples examples_quantiles = {{"Computing multiple weighted timing quantiles",
                                                         R"(
...
└───────────────────────────────────────────────────────────┘
  ...
  factory.registerFunction(NameQuantilesTimingWeighted::name,
                           {createAggregateFunctionQuantile<FuncQuantilesTimingWeighted>, documentation_quantiles, properties});
