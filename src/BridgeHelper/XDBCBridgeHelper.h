...
class XDBCBridgeHelper : public IXDBCBridgeHelper {
 public:
  ...
  XDBCBridgeHelper(ContextPtr context_, Poco::Timespan http_timeout_, const std::string& connection_string_, bool use_connection_pooling_)
 ...
 protected:
  ...
  void startBridge(std::unique_ptr<ShellCommand> cmd) const override { ShellCommandsHolder::instance().addCommand(std::move(cmd)); }
...
struct JDBCBridgeMixin {
  ...
  static String configPrefix() { return "jdbc_bridge"; }

  static String serviceAlias() { return "clickhouse-jdbc-bridge"; }

  static String getName() { return "JDBC"; }

  static std::optional<AccessTypeObjects::Source> getSourceAccessObject() { return AccessTypeObjects::Source::JDBC; }

  static bool startBridgeManually() { return true; }
};

struct ODBCBridgeMixin {
  static constexpr auto DEFAULT_PORT = 9018;

  static String configPrefix() { return "odbc_bridge"; }

  static String serviceAlias() { return "clickhouse-odbc-bridge"; }

  static String getName() { return "ODBC"; }

  static std::optional<AccessTypeObjects::Source> getSourceAccessObject() { return AccessTypeObjects::Source::ODBC; }

  static bool startBridgeManually() { return false; }
};
