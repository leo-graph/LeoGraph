...
const ASTSelectWithUnionQuery &TableFunctionView::getSelectQuery() const { return *create.select; }

std::vector<size_t> TableFunctionView::skipAnalysisForArguments(const QueryTreeNodePtr &, ContextPtr) const { return {0}; }
...
StoragePtr TableFunctionView::executeImpl(const ASTPtr & /*ast_function*/, ContextPtr context, const std::string &table_name,
...
void registerTableFunctionView(TableFunctionFactory &factory) { factory.registerFunction<TableFunctionView>({}, {.allow_readonly = true}); }
