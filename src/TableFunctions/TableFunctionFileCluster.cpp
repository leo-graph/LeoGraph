...
StoragePtr TableFunctionFileCluster::getStorage(const String& /*source*/, const String& /*format_*/, const ColumnsDescription& columns,
  ...
  if (context->getClientInfo().query_kind == ClientInfo::QueryKind::SECONDARY_QUERY) {
    ...
    StorageFile::CommonArguments args{WithContext(context),
    ...
    storage = std::make_shared<StorageFileCluster>(context, cluster_name, filename, format, compression_method,
                                                   StorageID(getDatabaseName(), table_name), columns, ConstraintsDescription{});
  }
