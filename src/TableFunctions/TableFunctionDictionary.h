...
class TableFunctionDictionary final : public ITableFunction {
 public:
  ...
  StoragePtr executeImpl(const ASTPtr& ast_function, ContextPtr context, const std::string& table_name, ColumnsDescription,
                         bool is_insert_query) const override;

  const char* getStorageEngineName() const override { return "Dictionary"; }
