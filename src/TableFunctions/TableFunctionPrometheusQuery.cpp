...
template <bool over_range>
ColumnsDescription TableFunctionPrometheusQuery<over_range>::getActualTableStructure(ContextPtr /* context */,
...
template <bool over_range>
StoragePtr TableFunctionPrometheusQuery<over_range>::executeImpl(const ASTPtr & /* ast_function */, ContextPtr context,
