...
String BoolType::typeName(const bool, const bool) const { return "Bool"; }

String BoolType::MySQLtypeName(RandomGenerator &, const bool) const { return "BOOL"; }

String BoolType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "BOOLEAN"; }

String BoolType::SQLitetypeName(RandomGenerator &, const bool) const { return "INTEGER"; }

SQLType *BoolType::typeDeepCopy() const { return new BoolType(); }

String BoolType::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return rg.nextBool() ? "TRUE" : "FALSE"; }
...
String IntType::typeName(const bool, const bool) const { return fmt::format("{}Int{}", is_unsigned ? "U" : "", size); }
...
String IntType::SQLitetypeName(RandomGenerator &, const bool) const { return "INTEGER"; }

SQLType *IntType::typeDeepCopy() const { return new IntType(size, is_unsigned); }
...
String FloatType::typeName(const bool, const bool) const { return fmt::format("{}Float{}", size == 16 ? "B" : "", size); }

String FloatType::MySQLtypeName(RandomGenerator &, const bool) const { return (size == 32) ? "FLOAT" : "DOUBLE"; }

String FloatType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return (size == 32) ? "REAL" : "DOUBLE PRECISION"; }

String FloatType::SQLitetypeName(RandomGenerator &, const bool) const { return "REAL"; }

SQLType *FloatType::typeDeepCopy() const { return new FloatType(size); }

String FloatType::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return nextFloatingPoint(rg, true); }
...
String DateType::typeName(const bool, const bool) const { return fmt::format("Date{}", extended ? "32" : ""); }

String DateType::MySQLtypeName(RandomGenerator &, const bool) const { return "DATE"; }

String DateType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "DATE"; }

String DateType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *DateType::typeDeepCopy() const { return new DateType(extended); }
...
String TimeType::MySQLtypeName(RandomGenerator &, const bool) const { return "TIME"; }

String TimeType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TIME"; }

String TimeType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *TimeType::typeDeepCopy() const { return new TimeType(extended, precision); }
...
String DateTimeType::MySQLtypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "DATETIME" : "TIMESTAMP"; }

String DateTimeType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TIMESTAMP"; }

String DateTimeType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *DateTimeType::typeDeepCopy() const { return new DateTimeType(extended, precision, timezone); }
...
String DecimalType::PostgreSQLtypeName(RandomGenerator &rg, const bool escape) const { return MySQLtypeName(rg, escape); }

String DecimalType::SQLitetypeName(RandomGenerator &rg, const bool escape) const { return MySQLtypeName(rg, escape); }

SQLType *DecimalType::typeDeepCopy() const { return new DecimalType(short_notation, precision, scale); }
...
String DecimalType::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return appendDecimalValue(rg, true, this); }
...
String StringType::SQLitetypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

SQLType *StringType::typeDeepCopy() const { return new StringType(precision); }
...
String UUIDType::typeName(const bool, const bool) const { return "UUID"; }

String UUIDType::MySQLtypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

String UUIDType::PostgreSQLtypeName(RandomGenerator &, const bool escape) const { return typeName(escape, false); }

String UUIDType::SQLitetypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

SQLType *UUIDType::typeDeepCopy() const { return new UUIDType(); }

String UUIDType::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return "'" + rg.nextUUID() + "'"; }
...
String EnumType::MySQLtypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

String EnumType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String EnumType::SQLitetypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

SQLType *EnumType::typeDeepCopy() const { return new EnumType(size, values); }

String EnumType::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return rg.pickRandomly(values).val; }

String EnumType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t, const uint32_t) const {
  return appendRandomRawValue(rg, gen);
}

String IPv4Type::typeName(const bool, const bool) const { return "IPv4"; }

String IPv4Type::MySQLtypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

String IPv4Type::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String IPv4Type::SQLitetypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

SQLType *IPv4Type::typeDeepCopy() const { return new IPv4Type(); }

String IPv4Type::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return "'" + rg.nextIPv4() + "'"; }
...
String IPv6Type::typeName(const bool, const bool) const { return "IPv6"; }

String IPv6Type::MySQLtypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

String IPv6Type::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String IPv6Type::SQLitetypeName(RandomGenerator &rg, const bool) const { return rg.nextBool() ? "BLOB" : "TEXT"; }

SQLType *IPv6Type::typeDeepCopy() const { return new IPv6Type(); }

String IPv6Type::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return "'" + rg.nextIPv6() + "'"; }
...
String DynamicType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String DynamicType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String DynamicType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *DynamicType::typeDeepCopy() const { return new DynamicType(ntypes); }
...
String DynamicType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                      const uint32_t max_nested_rows) const {
  uint32_t col_counter = 0;
  const uint64_t type_mask_backup = gen.next_type_mask;
...
String JSONType::MySQLtypeName(RandomGenerator &, const bool) const { return "JSON"; }

String JSONType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "JSON"; }

String JSONType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }
...
String Nullable::MySQLtypeName(RandomGenerator &rg, const bool escape) const { return subtype->MySQLtypeName(rg, escape); }

String Nullable::PostgreSQLtypeName(RandomGenerator &rg, const bool escape) const { return subtype->PostgreSQLtypeName(rg, escape); }

String Nullable::SQLitetypeName(RandomGenerator &rg, const bool escape) const { return subtype->SQLitetypeName(rg, escape); }

SQLType *Nullable::typeDeepCopy() const { return new Nullable(subtype->typeDeepCopy()); }
...
String Nullable::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                   const uint32_t max_nested_rows) const {
...
String LowCardinality::MySQLtypeName(RandomGenerator &rg, const bool escape) const { return subtype->MySQLtypeName(rg, escape); }

String LowCardinality::PostgreSQLtypeName(RandomGenerator &rg, const bool escape) const { return subtype->PostgreSQLtypeName(rg, escape); }

String LowCardinality::SQLitetypeName(RandomGenerator &rg, const bool escape) const { return subtype->SQLitetypeName(rg, escape); }

SQLType *LowCardinality::typeDeepCopy() const { return new LowCardinality(subtype->typeDeepCopy()); }
...
String LowCardinality::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                         const uint32_t max_nested_rows) const {
  return subtype->insertNumberEntry(rg, gen, max_strlen, max_nested_rows);
}

String GeoType::typeName(const bool, const bool) const { return GeoTypes_Name(geotype); }

String GeoType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String GeoType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String GeoType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *GeoType::typeDeepCopy() const { return new GeoType(geotype); }

String GeoType::appendRandomRawValue(RandomGenerator &rg, StatementGenerator &) const { return strAppendGeoValue(rg, geotype); }
...
String ArrayType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT []"; }
...
String ArrayType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *ArrayType::typeDeepCopy() const { return new ArrayType(subtype->typeDeepCopy()); }
...
String ArrayType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                    const uint32_t max_nested_rows) const {
  String ret = "[";
...
String MapType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String MapType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String MapType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *MapType::typeDeepCopy() const { return new MapType(key->typeDeepCopy(), value->typeDeepCopy()); }
...
String MapType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                  const uint32_t max_nested_rows) const {
  String ret = "map(";
  std::uniform_int_distribution<uint64_t> rows_dist(gen.fc.min_nested_rows, max_nested_rows);
  const uint64_t limit = rows_dist(rg.generator);
...
String TupleType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String TupleType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String TupleType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }
...
String TupleType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                    const uint32_t max_nested_rows) const {
  if (nullable && rg.nextMediumNumber() < 21) {
    return "NULL";
  }
...
String VariantType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String VariantType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String VariantType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }
...
String VariantType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                      const uint32_t max_nested_rows) const {
...
String QBitType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String QBitType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String QBitType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

SQLType *QBitType::typeDeepCopy() const { return new QBitType(subtype->typeDeepCopy(), dimension); }
...
String QBitType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                   const uint32_t max_nested_rows) const {
  String ret = "[";
  for (uint64_t i = 0; i < dimension; i++) {
    if (i != 0) {
...
QBitType::~QBitType() { delete subtype; }
...
String AggregateFunctionType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String AggregateFunctionType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String AggregateFunctionType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }
...
String AggregateFunctionType::insertNumberEntry(RandomGenerator &rg, StatementGenerator &gen, const uint32_t max_strlen,
                                                const uint32_t max_nested_rows) const {
  String ret = SQLFunc_Name(aggregate).substr(4);
...
String NestedType::MySQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String NestedType::PostgreSQLtypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String NestedType::SQLitetypeName(RandomGenerator &, const bool) const { return "TEXT"; }

String NestedType::appendRandomRawValue(RandomGenerator &, StatementGenerator &) const { return "TEXT"; }
...
SQLType *StatementGenerator::randomDecimalType(RandomGenerator &rg, const uint64_t allowed_types, BottomTypeName *tp) const {
  ...
  if (rg.nextBool()) {
    std::uniform_int_distribution<uint32_t> dec_range(
        1, static_cast<uint32_t>((allowed_types & set_no_decimal_limit) ? DecimalN::DecimalPrecision_MAX
...
SQLType *StatementGenerator::bottomType(RandomGenerator &rg, const uint64_t allowed_types, const bool low_card, BottomTypeName *tp) {
  ...
  if (nopt < (int_type + 1)) {
    ...
    res = randomDecimalType(rg, allowed_types, tp);
             ...
             nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type + 1)) {
    if (tp) {
      tp->set_boolean(true);
    }
    res = new BoolType();
  ...
  } else if (uuid_type && nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                                  enum_type + uuid_type + 1)) {
    if (tp) {
      tp->set_uuid(true);
    }
    res = new UUIDType();
  } else if (ipv4_type && nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                                  enum_type + uuid_type + ipv4_type + 1)) {
    if (tp) {
      tp->set_ipv4(true);
    }
    res = new IPv4Type();
  } else if (ipv6_type && nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                                  enum_type + uuid_type + ipv4_type + ipv6_type + 1)) {
    if (tp) {
      tp->set_ipv6(true);
    }
    res = new IPv6Type();
  } else if (j_type && nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                               enum_type + uuid_type + ipv4_type + ipv6_type + j_type + 1)) {
    String desc;
  ...
  } else if (dynamic_type && nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                                     enum_type + uuid_type + ipv4_type + ipv6_type + j_type + dynamic_type + 1)) {
  ...
  } else if (time_type && nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                                  enum_type + uuid_type + ipv4_type + ipv6_type + j_type + dynamic_type + time_type + 1)) {
    TimeTp *tt = tp ? tp->mutable_times() : nullptr;

    res = randomTimeType(rg, low_card ? (allowed_types & ~(allow_time64)) : allowed_types, tt);
  } else if (qbit_type && nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                                  enum_type + uuid_type + ipv4_type + ipv6_type + j_type + dynamic_type + time_type + qbit_type + 1)) {
    SQLType *sub;
    FloatingPoints nflo;
    ...
    res = new QBitType(sub, dimension);
             ...
             nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type + enum_type +
                     uuid_type + ipv4_type + ipv6_type + j_type + dynamic_type + time_type + qbit_type + geo_type + 1)) {
    ...
    res = new GeoType(gt);
  } else if ((aggr_type || simple_aggr_type) &&
             nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type + enum_type +
                     uuid_type + ipv4_type + ipv6_type + j_type + dynamic_type + time_type + qbit_type + geo_type + aggr_type +
                     simple_aggr_type + 1)) {
    uint32_t col_counter = 0;
    std::vector<SQLType *> subtypes;
    AggregateFunction *af = tp ? tp->mutable_aggr() : nullptr;
    const bool simple = nopt < (int_type + floating_point_type + date_type + datetime_type + string_type + decimal_type + bool_type +
                                enum_type + uuid_type + ipv4_type + ipv6_type + j_type + dynamic_type + time_type + qbit_type + geo_type +
                                aggr_type + simple_aggr_type + 1);
    static const std::vector<SQLFunc> available_aggrs = {SQLFunc::FUNCany,
                                                         SQLFunc::FUNCanyLast,
                                                         SQLFunc::FUNCavg,
                                                         SQLFunc::FUNCcount,
    ...
    if (aggr != SQLFunc::FUNCcount) {
      this->depth++;
      subtypes.emplace_back(this->randomNextType(rg, this->next_type_mask & ~(allow_nested), col_counter, tp ? af->add_types() : nullptr));
      this->depth--;
    }
    if (tp) {
...
SQLType *StatementGenerator::randomNextType(RandomGenerator &rg, const uint64_t allowed_types, uint32_t &col_counter, TopTypeName *tp) {
  ...
  const uint32_t map_type =
      10 * static_cast<uint32_t>((allowed_types & allow_map) != 0 && this->depth < this->fc.max_depth && this->width < this->fc.max_width);
  ...
  const uint32_t nested_type = 10 * static_cast<uint32_t>((allowed_types & allow_nested) != 0 && this->depth < this->fc.max_depth &&
  ...
  if (non_nullable_type && nopt < (non_nullable_type + 1)) {
    ...
    /// Nullable
    const bool lcard = (allowed_types & allow_low_cardinality) != 0 && rg.nextMediumNumber() < 18;
    SQLType *res = new Nullable(bottomType(rg, allowed_types & ~(allow_dynamic | allow_aggregate), lcard,
    ...
    this->depth++;
    SQLType *k =
        this->randomNextType(rg, this->next_type_mask & ~(allow_nullable | allow_nested), col_counter, mt ? mt->mutable_key() : nullptr);
    this->width++;
    ...
    for (uint32_t i = 0; i < ncols; i++) {
      ...
      SQLType *k = this->randomNextType(rg, this->next_type_mask & ~(allow_nested), col_counter, tcd ? tcd->mutable_type_name() : ttn);
    ...
    return new VariantType(subtypes);
             ...
             nopt < (nullable_type + non_nullable_type + array_type + map_type + tuple_type + variant_type + nested_type + 1)) {
    /// Nested
    ...
    for (uint32_t i = 0; i < ncols; i++) {
      ...
      SQLType *k = this->randomNextType(rg, this->next_type_mask & ~(allow_nested), col_counter, tcd ? tcd->mutable_type_name() : nullptr);
  ...
  if (rg.nextSmallNumber() < 3) {
    switch (rg.randomInt<uint32_t>(0, 3)) {
      ...
      case 2:
        ...
        ret += rg.nextBool() ? "-" : "";
        for (uint32_t j = 0; j < std::max(1u, left); j++) ret += '9';
        ret += '.';
        for (uint32_t j = 0; j < std::max(1u, right); j++) ret += '9';
        break;
      case 3:
        /// Smallest non-zero: 0.00...01 (or 1.0 when scale == 0)
        ret += rg.nextBool() ? "-" : "";
        ret += "0.";
        for (uint32_t j = 0; j + 1 < std::max(1u, right); j++) ret += '0';
        ret += '1';
        break;
      default:
        UNREACHABLE();
...
static String nextGeoRing(RandomGenerator &rg, const uint32_t npoints) {
  ...
  for (uint32_t i = 0; i < npoints; i++) {
    ...
    if (i == 0) first_point = pt;
    ret += pt;
  }
  if (npoints > 0) ret += ", " + first_point;  /// Close the ring
  ret += "]";
  return ret;
}
