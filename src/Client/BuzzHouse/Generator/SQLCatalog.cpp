...
const std::vector<std::vector<OutFormat>> outFormats = {
    ...
    {OutFormat::OUT_JSON, OutFormat::OUT_JSONColumns, OutFormat::OUT_JSONColumnsWithMetadata, OutFormat::OUT_JSONCompact,
     OutFormat::OUT_JSONCompactColumns, OutFormat::OUT_JSONCompactEachRow, OutFormat::OUT_JSONCompactEachRowWithNames,
     OutFormat::OUT_JSONCompactEachRowWithNamesAndTypes, OutFormat::OUT_JSONCompactStringsEachRow,
     OutFormat::OUT_JSONCompactStringsEachRowWithNames, OutFormat::OUT_JSONCompactStringsEachRowWithNamesAndTypes,
     OutFormat::OUT_JSONEachRow, OutFormat::OUT_JSONLines, OutFormat::OUT_JSONObjectEachRow, OutFormat::OUT_JSONStringsEachRow},
    ...
    {OutFormat::OUT_TabSeparated, OutFormat::OUT_TabSeparatedRaw, OutFormat::OUT_TabSeparatedRawWithNames,
     OutFormat::OUT_TabSeparatedRawWithNamesAndTypes, OutFormat::OUT_TabSeparatedWithNames, OutFormat::OUT_TabSeparatedWithNamesAndTypes},
    {OutFormat::OUT_TSKV},
...
const std::vector<std::vector<InOutFormat>> inOutFormats = {
    ...
    {InOutFormat::INOUT_JSON, InOutFormat::INOUT_JSONColumns, InOutFormat::INOUT_JSONColumnsWithMetadata, InOutFormat::INOUT_JSONCompact,
     InOutFormat::INOUT_JSONCompactColumns, InOutFormat::INOUT_JSONCompactEachRow, InOutFormat::INOUT_JSONCompactEachRowWithNames,
     InOutFormat::INOUT_JSONCompactEachRowWithNamesAndTypes, InOutFormat::INOUT_JSONCompactStringsEachRow,
     InOutFormat::INOUT_JSONCompactStringsEachRowWithNames, InOutFormat::INOUT_JSONCompactStringsEachRowWithNamesAndTypes,
     InOutFormat::INOUT_JSONEachRow, InOutFormat::INOUT_JSONLines, InOutFormat::INOUT_JSONObjectEachRow,
    ...
    {InOutFormat::INOUT_TabSeparated, InOutFormat::INOUT_TabSeparatedRaw, InOutFormat::INOUT_TabSeparatedRawWithNames,
     InOutFormat::INOUT_TabSeparatedRawWithNamesAndTypes, InOutFormat::INOUT_TabSeparatedWithNames,
     InOutFormat::INOUT_TabSeparatedWithNamesAndTypes},
    {InOutFormat::INOUT_Template},
    {InOutFormat::INOUT_TSKV},
    {InOutFormat::INOUT_Values}};

bool SQLColumn::canBeInserted() const { return !dmod.has_value() || dmod.value() == DModifier::DEF_DEFAULT; }

String SQLColumn::getColumnName() const { return "c" + std::to_string(cname); }

void SQLDatabase::setRandomDatabase(RandomGenerator& rg, SQLDatabase& d) { d.random_engine = rg.nextMediumNumber() < 4; }

void SQLDatabase::setName(Database* db, const uint32_t name) { db->set_database("d" + std::to_string(name)); }

bool SQLDatabase::isAtomicDatabase() const { return deng == DatabaseEngineValues::DAtomic; }

bool SQLDatabase::isMemoryDatabase() const { return deng == DatabaseEngineValues::DMemory; }

bool SQLDatabase::isReplicatedDatabase() const { return deng == DatabaseEngineValues::DReplicated; }

bool SQLDatabase::isSharedDatabase() const { return deng == DatabaseEngineValues::DShared; }

bool SQLDatabase::isBackupDatabase() const { return deng == DatabaseEngineValues::DBackup; }

bool SQLDatabase::isOrdinaryDatabase() const { return deng == DatabaseEngineValues::DOrdinary; }

bool SQLDatabase::isDataLakeCatalogDatabase() const { return deng == DatabaseEngineValues::DDataLakeCatalog; }

bool SQLDatabase::isReplicatedOrSharedDatabase() const { return isReplicatedDatabase() || isSharedDatabase(); }

const std::optional<String>& SQLDatabase::getCluster() const { return cluster; }

bool SQLDatabase::isAttached() const { return attached == DetachStatus::ATTACHED; }

bool SQLDatabase::isDettached() const { return attached != DetachStatus::ATTACHED; }

void SQLDatabase::setName(Database* db) const { SQLDatabase::setName(db, dname); }

String SQLDatabase::getName() const { return "d" + std::to_string(dname); }
...
bool SQLBase::isMergeTreeFamily() const { return teng >= TableEngineValues::MergeTree && teng <= TableEngineValues::GraphiteMergeTree; }

bool SQLBase::isLogFamily() const { return teng >= TableEngineValues::StripeLog && teng <= TableEngineValues::TinyLog; }
...
bool SQLBase::isReplicatedOrSharedMergeTree() const { return isReplicatedMergeTree() || isSharedMergeTree(); }

bool SQLBase::isShared() const { return toption.has_value() && toption.value() == TableEngineOption::TShared; }

bool SQLBase::isFileEngine() const { return teng == TableEngineValues::File; }

bool SQLBase::isJoinEngine() const { return teng == TableEngineValues::Join; }

bool SQLBase::isNullEngine() const { return teng == TableEngineValues::Null; }

bool SQLBase::isSetEngine() const { return teng == TableEngineValues::Set; }

bool SQLBase::isBufferEngine() const { return teng == TableEngineValues::Buffer; }

bool SQLBase::isRocksEngine() const { return teng == TableEngineValues::EmbeddedRocksDB; }

bool SQLBase::isMemoryEngine() const { return teng == TableEngineValues::Memory; }
...
bool SQLBase::isSQLiteEngine() const { return teng == TableEngineValues::SQLite; }

bool SQLBase::isMongoDBEngine() const { return teng == TableEngineValues::MongoDB; }

bool SQLBase::isRedisEngine() const { return teng == TableEngineValues::Redis; }

bool SQLBase::isS3Engine() const { return teng == TableEngineValues::S3; }

bool SQLBase::isS3QueueEngine() const { return teng == TableEngineValues::S3Queue; }

bool SQLBase::isAnyS3Engine() const { return isS3Engine() || isS3QueueEngine(); }

bool SQLBase::isAzureEngine() const { return teng == TableEngineValues::AzureBlobStorage; }

bool SQLBase::isAzureQueueEngine() const { return teng == TableEngineValues::AzureQueue; }

bool SQLBase::isAnyAzureEngine() const { return isAzureEngine() || isAzureQueueEngine(); }

bool SQLBase::isAnyQueueEngine() const { return isS3QueueEngine() || isAzureQueueEngine(); }

bool SQLBase::isHudiEngine() const { return teng == TableEngineValues::Hudi; }

bool SQLBase::isDeltaLakeS3Engine() const { return teng == TableEngineValues::DeltaLakeS3; }

bool SQLBase::isDeltaLakeAzureEngine() const { return teng == TableEngineValues::DeltaLakeAzure; }

bool SQLBase::isDeltaLakeLocalEngine() const { return teng == TableEngineValues::DeltaLakeLocal; }

bool SQLBase::isAnyDeltaLakeEngine() const { return teng >= TableEngineValues::DeltaLakeS3 && teng <= TableEngineValues::DeltaLakeLocal; }

bool SQLBase::isIcebergS3Engine() const { return teng == TableEngineValues::IcebergS3; }

bool SQLBase::isIcebergAzureEngine() const { return teng == TableEngineValues::IcebergAzure; }

bool SQLBase::isIcebergLocalEngine() const { return teng == TableEngineValues::IcebergLocal; }

bool SQLBase::isAnyIcebergEngine() const { return teng >= TableEngineValues::IcebergS3 && teng <= TableEngineValues::IcebergLocal; }

bool SQLBase::isOnS3() const { return isIcebergS3Engine() || isDeltaLakeS3Engine() || isAnyS3Engine(); }

bool SQLBase::isOnAzure() const { return isIcebergAzureEngine() || isDeltaLakeAzureEngine() || isAnyAzureEngine(); }

bool SQLBase::isOnLocal() const { return isIcebergLocalEngine() || isDeltaLakeLocalEngine(); }

bool SQLBase::isMergeEngine() const { return teng == TableEngineValues::Merge; }

bool SQLBase::isDistributedEngine() const { return teng == TableEngineValues::Distributed; }

bool SQLBase::isDictionaryEngine() const { return teng == TableEngineValues::Dictionary; }

bool SQLBase::isGenerateRandomEngine() const { return teng == TableEngineValues::GenerateRandom; }

bool SQLBase::isURLEngine() const { return teng == TableEngineValues::URL; }

bool SQLBase::isKeeperMapEngine() const { return teng == TableEngineValues::KeeperMap; }

bool SQLBase::isExternalDistributedEngine() const { return teng == TableEngineValues::ExternalDistributed; }

bool SQLBase::isMaterializedPostgreSQLEngine() const { return teng == TableEngineValues::MaterializedPostgreSQL; }

bool SQLBase::isArrowFlightEngine() const { return teng == TableEngineValues::ArrowFlight; }

bool SQLBase::isAliasEngine() const { return teng == TableEngineValues::Alias; }

bool SQLBase::isKafkaEngine() const { return teng == TableEngineValues::Kafka; }
...
bool SQLBase::hasMySQLPeer() const { return peer_table == PeerTableDatabase::MySQL; }

bool SQLBase::hasPostgreSQLPeer() const { return peer_table == PeerTableDatabase::PostgreSQL; }

bool SQLBase::hasSQLitePeer() const { return peer_table == PeerTableDatabase::SQLite; }

bool SQLBase::hasClickHousePeer() const { return peer_table == PeerTableDatabase::ClickHouse; }

const std::optional<String>& SQLBase::getCluster() const { return cluster; }

bool SQLBase::isAttached() const { return (!db || db->isAttached()) && attached == DetachStatus::ATTACHED; }

bool SQLBase::isDettached() const { return (db && db->attached != DetachStatus::ATTACHED) || attached != DetachStatus::ATTACHED; }

String SQLBase::getDatabaseName() const { return "d" + (db ? std::to_string(db->dname) : "efault"); }
...
void SQLBase::setTablePath(RandomGenerator& rg, const FuzzConfig& fc, const bool has_dolor) {
  chassert(!bucket_path.has_value() && !file_format.has_value() && !file_comp.has_value() && !partition_strategy.has_value() &&
  ...
  if (isAnyIcebergEngine() || isAnyDeltaLakeEngine() || isAnyS3Engine() || isAnyAzureEngine()) {
    ...
    if (isAnyIcebergEngine() || isAnyDeltaLakeEngine()) {
      ...
      if (catalog == LakeCatalog::None) {
        /// DeltaLake tables on Spark must be on the `spark_catalog` :(
        next_bucket_path = fmt::format("{}{}{}{}t{}{}", isOnLocal() ? fc.lakes_path.generic_string() : "", isOnLocal() ? "/" : "",
                                       (integration == IntegrationCall::Dolor) ? getSparkCatalogName() : "",
                                       (integration == IntegrationCall::Dolor) ? "/test/" : "", tname, rg.nextBool() ? "/" : "");
        ...
        next_bucket_path = fmt::format("http://{}:{}/{}/t{}{}", fc.minio_server.value().server_hostname, fc.minio_server.value().port,
                                       cat->warehouse, tname, rg.nextBool() ? "/" : "");
      }
    } else {
...
String SQLBase::getTablePath(RandomGenerator& rg, const FuzzConfig& fc, const bool allow_not_deterministic) const {
  if ((isAnyS3Engine() || isAnyAzureEngine()) && allow_not_deterministic && rg.nextSmallNumber() < 8) {
    ...
    if (partition_pos != std::string::npos && rg.nextMediumNumber() < 81) {
      res.replace(partition_pos, PARTITION_STR.length(),
...
LakeCatalog SQLBase::getLakeCatalog() const { return db ? db->catalog : LakeCatalog::None; }

LakeStorage SQLBase::getPossibleLakeStorage() const { return db ? db->storage : LakeStorage::All; }

LakeFormat SQLBase::getPossibleLakeFormat() const { return db ? db->format : LakeFormat::All; }

void SQLBase::setName(ExprSchemaTable* est, const String& prefix, const bool setdbname, std::shared_ptr<SQLDatabase> database,
                      const uint32_t name) {
  String res;
...
void SQLBase::setName(ExprSchemaTable* est, const bool setdbname) const { SQLBase::setName(est, this->prefix, setdbname, db, tname); }
...
bool SQLTable::hasVersionColumn() const { return teng == TableEngineValues::VersionedCollapsingMergeTree; }
...
bool SQLView::supportsFinal() const { return !this->is_materialized; }

bool SQLDictionary::supportsFinal() const { return false; }

const std::optional<String>& SQLFunction::getCluster() const { return cluster; }

void SQLFunction::setName(Function* f) const { f->set_function("f" + std::to_string(fname)); }
