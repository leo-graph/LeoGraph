...
UHugeInt UHugeInt::operator/(const UHugeInt& rhs) const { return divide(*this, rhs); }

UHugeInt UHugeInt::operator%(const UHugeInt& rhs) const { return modulo(*this, rhs); }
...
UHugeInt UHugeInt::operator-() const { return negateInPlace(*this); }
...
bool UHugeInt::operator!() const { return *this == UHugeInt(0); }

UHugeInt::operator bool() const { return *this != UHugeInt(0); }
