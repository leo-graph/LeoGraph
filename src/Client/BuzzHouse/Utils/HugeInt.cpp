...
int sign(HugeInt n) { return ((n > HugeInt(0)) - (n < HugeInt(0))); }
...
HugeInt HugeInt::operator/(const HugeInt& rhs) const { return divide(*this, rhs); }

HugeInt HugeInt::operator%(const HugeInt& rhs) const { return modulo(*this, rhs); }
...
bool HugeInt::operator!() const { return *this == HugeInt(0); }

HugeInt::operator bool() const { return *this != HugeInt(0); }
