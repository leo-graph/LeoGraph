...
enum EncryptionMethod { AES_128_GCM_SIV, AES_256_GCM_SIV, MAX_ENCRYPTION_METHOD };
 ...
 public:
  ...
  class Configuration {
   ...
   private:
    ...
    static void loadImpl(const Poco::Util::AbstractConfiguration& config, const String& config_prefix, EncryptionMethod method,
