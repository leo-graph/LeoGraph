...
CompressionCodecNone::CompressionCodecNone() { setCodecDescription("NONE"); }

uint8_t CompressionCodecNone::getMethodByte() const { return static_cast<uint8_t>(CompressionMethodByte::NONE); }

void CompressionCodecNone::updateHash(SipHash& hash) const { getCodecDesc()->updateTreeHash(hash, /*ignore_aliases=*/true); }
