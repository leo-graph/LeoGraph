...
class FunctionDynamicType : public IFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors mandatory_args{{"dynamic", isDynamic, nullptr, "Dynamic"}};
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &result_type, size_t input_rows_count) const override {
    ...
    if (!dynamic_column)
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "First argument for function {} must be Dynamic, got {} instead", getName(),
...
class FunctionIsDynamicElementInSharedData : public IFunction {
 public:
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &result_type, size_t input_rows_count) const override {
    ...
    for (size_t i = 0; i != input_rows_count; ++i) res_data.push_back(local_discriminators[i] == shared_variant_local_discr);
...
stored in that row of the Dynamic column (e.g., 'Int64', 'String', 'Array(Int64)').
  ...
  FunctionDocumentation::Arguments dynamicType_arguments = {{"dynamic", "Dynamic column to inspect.", {"Dynamic"}}};
  ...
  FunctionDocumentation::Examples dynamicType_examples = {{"Inspecting types in Dynamic column",
                                                           R"(
...
└───────────────┴────────────────┘
  ...
  FunctionDocumentation dynamicType_documentation = {
      dynamicType_description,    dynamicType_syntax,   dynamicType_arguments,     {},
      dynamicType_returned_value, dynamicType_examples, dynamicType_introduced_in, dynamicType_category};
...
instead of being separated into individual typed subcolumns. This function identifies which rows are stored in this shared format.
  ...
  FunctionDocumentation::Arguments isDynamicElementInSharedData_arguments = {{"dynamic", "Dynamic column to inspect.", {"Dynamic"}}};
...
└───────────────┴─────────────────────────────────┘
  ...
  FunctionDocumentation isDynamicElementInSharedData_documentation = {
      isDynamicElementInSharedData_description,    isDynamicElementInSharedData_syntax,
      isDynamicElementInSharedData_arguments,      {},
      isDynamicElementInSharedData_returned_value, isDynamicElementInSharedData_examples,
      isDynamicElementInSharedData_introduced_in,  isDynamicElementInSharedData_category};
