...
class FunctionDefaultValueOfArgumentType : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionDefaultValueOfArgumentType>(); }
...
Does not include default values for custom columns set by the user.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns `0` for numbers, an empty string for strings or `NULL` for Nullable types.", {"UInt8", "String", "NULL"}};
