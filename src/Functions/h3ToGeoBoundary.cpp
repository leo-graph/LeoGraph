 ...
 public:
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (size_t row = 0; row < input_rows_count; ++row) {
      ...
      if (err) throw Exception(ErrorCodes::INCORRECT_DATA, "Incorrect H3 index: {}, error: {}", h3index, err);
...
Returns array of pairs `(lat, lon)`, which corresponds to the boundary of the provided H3 index.
  ...
  FunctionDocumentation::Arguments arguments = {{"h3Index", "H3 index.", {"UInt64"}}};
  ...
  FunctionDocumentation::Examples examples = {{"Get boundary coordinates for an H3 index",
