...
class FunctionPolygonsUnion : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionPolygonsUnion>(); }
...
Calculates the union of polygons.
  ...
  FunctionDocumentation::ReturnedValue returned_value_cartesian = {"Returns the union of the polygons as a MultiPolygon.",
                                                                   {"MultiPolygon"}};
...
Calculates a union (OR) of polygons.
  ...
  FunctionDocumentation::Arguments arguments_spherical = {{"polygon1", "The first Polygon.", {"Polygon"}},
                                                          {"polygon2", "The second Polygon.", {"Polygon"}}};
  FunctionDocumentation::ReturnedValue returned_value_spherical = {"Returns the union of the polygons as a MultiPolygon.",
                                                                   {"MultiPolygon"}};
