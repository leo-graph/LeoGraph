...
Hypot avoids problems that occur when squaring very large or very small numbers.
  ...
  FunctionDocumentation::Arguments arguments = {{"x", "The first cathetus of a right-angle triangle.", {"(U)Int*", "Float*", "Decimal*"}},
  ...
  FunctionDocumentation::Examples examples = {{"Basic usage", "SELECT hypot(1, 1)", "1.4142135623730951"}};
