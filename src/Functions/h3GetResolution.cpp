...
Returns the resolution of the [H3](#h3-index) index.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the resolution of the H3 index with range `[0, 15]`.", {"UInt8"}};
  FunctionDocumentation::Examples examples = {{"Get resolution of an H3 index", "SELECT h3GetResolution(617420388352917503) AS res",
                                               R"(
┌─res─┐
│   9 │
└─────┘
