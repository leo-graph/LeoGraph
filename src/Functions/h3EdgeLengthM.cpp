...
Calculates the average length of an [H3](https://h3geo.org/docs/core-library/h3Indexing/) hexagon edge in meters.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the average edge length of an [H3](#h3-index) hexagon in meters.",
                                                         {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Get edge length for maximum resolution", "SELECT h3EdgeLengthM(15) AS edgeLengthM",
                                               R"(
┌─edgeLengthM─┐
│ 0.509713273 │
└─────────────┘
