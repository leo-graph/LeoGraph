 ...
 public:
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    ...
    if (!WhichDataType(arg).isUInt16())
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of argument {} of function {}. Must be UInt16", arg->getName(),
                      2, getName());
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (size_t row = 0; row < input_rows_count; ++row) {
      ...
      if (err) throw Exception(ErrorCodes::INCORRECT_DATA, "Incorrect arguments h3Index: {}, k: {}, error: {}", origin_hindex, k, err);
...
The ring is hollow when k > 0.
  ...
  FunctionDocumentation::Arguments arguments = {{"index", "Hexagon index number that represents the origin.", {"UInt64"}},
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      ...
      {"Array(UInt64)"}};
  FunctionDocumentation::Examples examples = {{"Get hexagonal ring of distance 1",
