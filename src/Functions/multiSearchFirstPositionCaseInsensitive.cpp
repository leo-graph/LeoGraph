...
Like [multiSearchFirstPosition](#multiSearchFirstPosition) but ignores case.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns the leftmost offset in a `haystack` string which matches any of multiple `needle` strings. Returns `0`, if there was no "
      "match.",
      {"UInt64"}};
  FunctionDocumentation::Examples examples = {{"Case insensitive first position",
