...
class FunctionGetMacro : public IFunction {
 ...
 public:
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName& arguments, const DataTypePtr& result_type, size_t input_rows_count) const override {
    ...
    if (!arg_string) throw Exception(ErrorCodes::ILLEGAL_COLUMN, "The argument of function {} must be constant String", getName());
...
If the function is executed in the context of a distributed table, it generates a normal column with values relevant to each shard.
  ...
  FunctionDocumentation::Arguments arguments = {{"name", "The name of the macro to retrieve.", {"const String"}}};
