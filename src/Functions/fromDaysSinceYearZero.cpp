 ...
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors args{
        {"days", static_cast<FunctionArgumentDescriptor::TypeValidator>(&isNativeInteger), nullptr, "Integer"}};
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (!success) throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal column while execute function {}", getName());
  ...
  void execute(const ColVecType &col, ResCol &result_column, size_t rows_count) const {
    ...
    for (size_t i = 0; i < rows_count; ++i) {
      ...
      if (value < 0) throw Exception(ErrorCodes::ARGUMENT_OUT_OF_BOUND, "Expected a non-negative integer, got: {}", std::to_string(value));
...
fromDaysSinceYearZero(days)
  ...
  FunctionDocumentation::Arguments arguments_fromDaysSinceYearZero = {{"days", "The number of days passed since year zero.", {"UInt32"}}};
  FunctionDocumentation::ReturnedValue returned_value_fromDaysSinceYearZero = {
      "Returns the date corresponding to the number of days passed since year zero.", {"Date"}};
  FunctionDocumentation::Examples examples_fromDaysSinceYearZero = {{"Convert days since year zero to dates", R"(
SELECT
...
└────────────┴────────────┘
  ...
  FunctionDocumentation documentation_fromDaysSinceYearZero = {description_fromDaysSinceYearZero,    syntax_fromDaysSinceYearZero,
                                                               arguments_fromDaysSinceYearZero,      {},
                                                               returned_value_fromDaysSinceYearZero, examples_fromDaysSinceYearZero,
                                                               introduced_in_fromDaysSinceYearZero,  category_fromDaysSinceYearZero};
...
fromDaysSinceYearZero32(days)
  ...
  FunctionDocumentation::Arguments arguments_fromDaysSinceYearZero32 = {{"days", "The number of days passed since year zero.", {"UInt32"}}};
  FunctionDocumentation::ReturnedValue returned_value_fromDaysSinceYearZero32 = {
      "Returns the date corresponding to the number of days passed since year zero.", {"Date32"}};
  FunctionDocumentation::Examples examples_fromDaysSinceYearZero32 = {{"Convert days since year zero to dates", R"(
SELECT
...
└────────────┴────────────┘
  ...
  FunctionDocumentation documentation_fromDaysSinceYearZero32 = {description_fromDaysSinceYearZero32,    syntax_fromDaysSinceYearZero32,
                                                                 arguments_fromDaysSinceYearZero32,      {},
                                                                 returned_value_fromDaysSinceYearZero32, examples_fromDaysSinceYearZero32,
                                                                 introduced_in_fromDaysSinceYearZero32,  category_fromDaysSinceYearZero32};
