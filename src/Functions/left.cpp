...
Returns a substring of string `s` with a specified `offset` starting from the left.
  ...
  FunctionDocumentation::Arguments arguments = {{"s", "The string to calculate a substring from.", {"String", "FixedString"}},
...
- An empty string if `length` is `0`.
                                                         ...
                                                         {"String"}};
  FunctionDocumentation::Examples examples = {{"Positive offset", "SELECT left('Hello World', 5)", "Hello"},
...
- An empty string if `length` is 0.
                                                              ...
                                                              {"String"}};
  FunctionDocumentation::Examples examples_utf8 = {{"Positive offset", "SELECT leftUTF8('Привет', 4)", "Прив"},
