...
Returns the origin and destination hexagon indexes from the given unidirectional edge H3Index.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns a tuple containing the origin and destination hexagon indices from the unidirectional edge, or `(0,0)` if the input is not "
      "valid.",
      {"Tuple(UInt64, UInt64)"}};
  FunctionDocumentation::Examples examples = {{"Get origin and destination indices from a unidirectional edge",
