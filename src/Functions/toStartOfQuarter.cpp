...
toStartOfQuarter(value)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the first day of the quarter for the given date or date with time.",
                                                         {"Date"}};
  FunctionDocumentation::Examples examples = {{"Round down to the first day of the quarter", R"(
