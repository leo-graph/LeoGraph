...
toRelativeYearNum(date)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the number of years from a fixed reference point in the past.",
                                                         {"UInt16"}};
  FunctionDocumentation::Examples examples = {{"Get relative year numbers", R"(
