...
class FunctionGenerateUUIDv4 : public TargetSpecific::Default::FunctionGenerateUUIDv4 {
 public:
  explicit FunctionGenerateUUIDv4(ContextPtr context) : selector(context) {
    selector.registerImplementation<TargetArch::Default, TargetSpecific::Default::FunctionGenerateUUIDv4>();

#if USE_MULTITARGET_CODE
    selector.registerImplementation<TargetArch::x86_64_v3, TargetSpecific::x86_64_v3::FunctionGenerateUUIDv4>();
#endif
  }
  ...
  static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionGenerateUUIDv4>(context); }
...
REGISTER_FUNCTION(GenerateUUIDv4) {
  ...
  FunctionDocumentation::Description description =
      R"(Generates a [version 4](https://tools.ietf.org/html/rfc4122#section-4.4) [UUID](../data-types/uuid.md).)";
  FunctionDocumentation::Syntax syntax = "generateUUIDv4([expr])";
  FunctionDocumentation::Arguments arguments = {
      {"expr",
       "Optional. An arbitrary expression used to bypass [common subexpression "
       ...
       "query. The value of the expression has no effect on the returned UUID."}};
