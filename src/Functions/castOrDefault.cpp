...
class FunctionCastOrDefault final : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionCastOrDefault>(context); }
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    if (arguments_size != 2 && arguments_size != 3)
      throw Exception(ErrorCodes::NUMBER_OF_ARGUMENTS_DOESNT_MATCH, "Function {} expected 2 or 3 arguments. Actual {}", getName(),
                      arguments_size);
    ...
    if (!type_column_typed)
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Second argument to {} must be a constant string describing type. Actual {}",
                      getName(), arguments[1].type->getName());

    DataTypePtr result_type = DataTypeFactory::instance().get(type_column_typed->getValue<String>());

    if (keep_nullable && arguments.front().type->isNullable()) result_type = makeNullable(result_type);
    ...
    if (arguments.size() == 3) {
      ...
      if (!result_type->equals(*default_value_type)) {
        throw Exception(ErrorCodes::BAD_ARGUMENTS, "Default value type should be same as cast type. Expected {}. Actual {}",
                        result_type->getName(), default_value_type->getName());
      }
    }
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &return_type, size_t) const override {
    ...
    if (result->isNullable()) result_nullable = assert_cast<ColumnNullable *>(&*result);
    ...
    for (size_t i = 0; i < null_map_data_size; ++i) {
      ...
      if (!is_current_index_null) continue;
...
class FunctionCastOrDefaultTyped final : public IFunction {
 ...
 private:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    if (isDecimal(type) || isDateTime64(type)) {
      ...
      if (!scale_argument_type.isNativeUInt()) {
        throw Exception(ErrorCodes::BAD_ARGUMENTS, "Function {} decimal scale should have native UInt type. Actual {}", getName(),
    ...
    if (isDateTimeOrDateTime64(type)) {
      if (additional_argument_index < arguments.size()) {
        time_zone =
            extractTimeZoneNameFromColumn(arguments[additional_argument_index].column.get(), arguments[additional_argument_index].name);
        ++additional_argument_index;
      }
    }
    ...
    ColumnWithTypeAndName type_argument = {DataTypeString().createColumnConst(1, cast_type->getName()), std::make_shared<DataTypeString>(),
                                           ""};
    ...
    if (additional_argument_index < arguments.size()) throw Exception(ErrorCodes::BAD_ARGUMENTS, "{} wrong arguments size", getName());
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &result_type, size_t input_rows_size) const override {
    ...
    ColumnWithTypeAndName second_argument = {DataTypeString().createColumnConst(arguments.begin()->column->size(), result_type->getName()),
    ...
    if (default_column_argument < arguments.size()) arguments_with_cast_type.emplace_back(arguments[default_column_argument]);
...
If no default value is provided, the default value of the target type is used.
  ...
  FunctionDocumentation::ReturnedValue accurateCastOrDefault_returned_value = {
      "Returns the converted value with the target data type, or the default value if conversion is not possible.", {"Any"}};
  FunctionDocumentation::Examples accurateCastOrDefault_examples = {{"Successful conversion",
                                                                     R"(
...
└────────────────────────────────────────┘
  ...
  FunctionDocumentation accurateCastOrDefault_documentation = {accurateCastOrDefault_description,    accurateCastOrDefault_syntax,
                                                               accurateCastOrDefault_arguments,      {},
                                                               accurateCastOrDefault_returned_value, accurateCastOrDefault_examples,
                                                               accurateCastOrDefault_introduced_in,  accurateCastOrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toUInt8OrDefault_returned_value = {
  ...
  FunctionDocumentation toUInt8OrDefault_documentation = {
      toUInt8OrDefault_description,    toUInt8OrDefault_syntax,   toUInt8OrDefault_arguments,     {},
      toUInt8OrDefault_returned_value, toUInt8OrDefault_examples, toUInt8OrDefault_introduced_in, toUInt8OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toUInt16OrDefault_returned_value = {
  ...
  FunctionDocumentation toUInt16OrDefault_documentation = {
      toUInt16OrDefault_description,    toUInt16OrDefault_syntax,   toUInt16OrDefault_arguments,     {},
      toUInt16OrDefault_returned_value, toUInt16OrDefault_examples, toUInt16OrDefault_introduced_in, toUInt16OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toUInt32OrDefault_returned_value = {
  ...
  FunctionDocumentation toUInt32OrDefault_documentation = {
      toUInt32OrDefault_description,    toUInt32OrDefault_syntax,   toUInt32OrDefault_arguments,     {},
      toUInt32OrDefault_returned_value, toUInt32OrDefault_examples, toUInt32OrDefault_introduced_in, toUInt32OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toUInt64OrDefault_returned_value = {
  ...
  FunctionDocumentation toUInt64OrDefault_documentation = {
      toUInt64OrDefault_description,    toUInt64OrDefault_syntax,   toUInt64OrDefault_arguments,     {},
      toUInt64OrDefault_returned_value, toUInt64OrDefault_examples, toUInt64OrDefault_introduced_in, toUInt64OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toUInt128OrDefault_returned_value = {
  ...
  FunctionDocumentation toUInt128OrDefault_documentation = {
      toUInt128OrDefault_description,    toUInt128OrDefault_syntax,   toUInt128OrDefault_arguments,     {},
      toUInt128OrDefault_returned_value, toUInt128OrDefault_examples, toUInt128OrDefault_introduced_in, toUInt128OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toUInt256OrDefault_returned_value = {
  ...
  FunctionDocumentation toUInt256OrDefault_documentation = {
      toUInt256OrDefault_description,    toUInt256OrDefault_syntax,   toUInt256OrDefault_arguments,     {},
      toUInt256OrDefault_returned_value, toUInt256OrDefault_examples, toUInt256OrDefault_introduced_in, toUInt256OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toInt8OrDefault_returned_value = {
  ...
  FunctionDocumentation toInt8OrDefault_documentation = {
      toInt8OrDefault_description,    toInt8OrDefault_syntax,   toInt8OrDefault_arguments,     {},
      toInt8OrDefault_returned_value, toInt8OrDefault_examples, toInt8OrDefault_introduced_in, toInt8OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toInt16OrDefault_returned_value = {
  ...
  FunctionDocumentation toInt16OrDefault_documentation = {
      toInt16OrDefault_description,    toInt16OrDefault_syntax,   toInt16OrDefault_arguments,     {},
      toInt16OrDefault_returned_value, toInt16OrDefault_examples, toInt16OrDefault_introduced_in, toInt16OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toInt32OrDefault_returned_value = {
  ...
  FunctionDocumentation toInt32OrDefault_documentation = {
      toInt32OrDefault_description,    toInt32OrDefault_syntax,   toInt32OrDefault_arguments,     {},
      toInt32OrDefault_returned_value, toInt32OrDefault_examples, toInt32OrDefault_introduced_in, toInt32OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toInt64OrDefault_returned_value = {
  ...
  FunctionDocumentation toInt64OrDefault_documentation = {
      toInt64OrDefault_description,    toInt64OrDefault_syntax,   toInt64OrDefault_arguments,     {},
      toInt64OrDefault_returned_value, toInt64OrDefault_examples, toInt64OrDefault_introduced_in, toInt64OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toInt128OrDefault_returned_value = {
  ...
  FunctionDocumentation toInt128OrDefault_documentation = {
      toInt128OrDefault_description,    toInt128OrDefault_syntax,   toInt128OrDefault_arguments,     {},
      toInt128OrDefault_returned_value, toInt128OrDefault_examples, toInt128OrDefault_introduced_in, toInt128OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toInt256OrDefault_returned_value = {
  ...
  FunctionDocumentation toInt256OrDefault_documentation = {
      toInt256OrDefault_description,    toInt256OrDefault_syntax,   toInt256OrDefault_arguments,     {},
      toInt256OrDefault_returned_value, toInt256OrDefault_examples, toInt256OrDefault_introduced_in, toInt256OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toFloat32OrDefault_returned_value = {
  ...
  FunctionDocumentation toFloat32OrDefault_documentation = {
      toFloat32OrDefault_description,    toFloat32OrDefault_syntax,   toFloat32OrDefault_arguments,     {},
      toFloat32OrDefault_returned_value, toFloat32OrDefault_examples, toFloat32OrDefault_introduced_in, toFloat32OrDefault_category};
...
If no `default` value is passed then `0` is returned in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toFloat64OrDefault_returned_value = {
  ...
  FunctionDocumentation toFloat64OrDefault_documentation = {
      toFloat64OrDefault_description,    toFloat64OrDefault_syntax,   toFloat64OrDefault_arguments,     {},
      toFloat64OrDefault_returned_value, toFloat64OrDefault_examples, toFloat64OrDefault_introduced_in, toFloat64OrDefault_category};
...
Like [toDate](#toDate) but if unsuccessful, returns a default value which is either the second argument (if specified), or otherwise the lower boundary of [Date](../data-types/date.md).
  ...
  FunctionDocumentation::ReturnedValue toDateOrDefault_returned_value = {
  ...
  FunctionDocumentation toDateOrDefault_documentation = {
      toDateOrDefault_description,    toDateOrDefault_syntax,   toDateOrDefault_arguments,     {},
      toDateOrDefault_returned_value, toDateOrDefault_examples, toDateOrDefault_introduced_in, toDateOrDefault_category};
...
Converts the argument to the [Date32](../data-types/date32.md) data type. If the value is outside the range, `toDate32OrDefault` returns the lower border value supported by [Date32](../data-types/date32.md). If the argument has [Date](../data-types/date.md) type, it's borders are taken into account. Returns default value if an invalid argument is received.
  ...
  FunctionDocumentation::ReturnedValue toDate32OrDefault_returned_value = {
  ...
  FunctionDocumentation toDate32OrDefault_documentation = {
      toDate32OrDefault_description,    toDate32OrDefault_syntax,   toDate32OrDefault_arguments,     {},
      toDate32OrDefault_returned_value, toDate32OrDefault_examples, toDate32OrDefault_introduced_in, toDate32OrDefault_category};
...
Like [toDateTime](#toDateTime) but if unsuccessful, returns a default value which is either the third argument (if specified), or otherwise the lower boundary of [DateTime](../data-types/datetime.md).
  ...
  FunctionDocumentation::ReturnedValue toDateTimeOrDefault_returned_value = {
  ...
  FunctionDocumentation toDateTimeOrDefault_documentation = {
      toDateTimeOrDefault_description,    toDateTimeOrDefault_syntax,   toDateTimeOrDefault_arguments,     {},
      toDateTimeOrDefault_returned_value, toDateTimeOrDefault_examples, toDateTimeOrDefault_introduced_in, toDateTimeOrDefault_category};
  factory.registerFunction(
      "toDateTimeOrDefault",
      [](ContextPtr context) {
...
or the provided default if an invalid argument is received.
  ...
  FunctionDocumentation::ReturnedValue toDateTime64OrDefault_returned_value = {
      "Value of type DateTime64 if successful, otherwise returns the default value if passed or 1970-01-01 00:00:00.000 if not.",
      {"DateTime64"}};
  FunctionDocumentation::Examples toDateTime64OrDefault_examples = {
      ...
      {"Failed conversion", "SELECT toDateTime64OrDefault('1976-10-18 00:00:00 30', 3, 'UTC', toDateTime64('2001-01-01 00:00:00.00',3))",
  ...
  FunctionDocumentation toDateTime64OrDefault_documentation = {toDateTime64OrDefault_description,    toDateTime64OrDefault_syntax,
                                                               toDateTime64OrDefault_arguments,      {},
                                                               toDateTime64OrDefault_returned_value, toDateTime64OrDefault_examples,
                                                               toDateTime64OrDefault_introduced_in,  toDateTime64OrDefault_category};
...
Like [`toDecimal32`](#toDecimal32), this function converts an input value to a value of type [Decimal(9, S)](../data-types/decimal.md) but returns the default value in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toDecimal32OrDefault_returned_value = {
  ...
  FunctionDocumentation toDecimal32OrDefault_documentation = {toDecimal32OrDefault_description,    toDecimal32OrDefault_syntax,
                                                              toDecimal32OrDefault_arguments,      {},
                                                              toDecimal32OrDefault_returned_value, toDecimal32OrDefault_examples,
                                                              toDecimal32OrDefault_introduced_in,  toDecimal32OrDefault_category};
...
Like [`toDecimal64`](#toDecimal64), this function converts an input value to a value of type [Decimal(18, S)](../data-types/decimal.md) but returns the default value in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toDecimal64OrDefault_returned_value = {
  ...
  FunctionDocumentation toDecimal64OrDefault_documentation = {toDecimal64OrDefault_description,    toDecimal64OrDefault_syntax,
                                                              toDecimal64OrDefault_arguments,      {},
                                                              toDecimal64OrDefault_returned_value, toDecimal64OrDefault_examples,
                                                              toDecimal64OrDefault_introduced_in,  toDecimal64OrDefault_category};
...
Like [`toDecimal128`](#toDecimal128), this function converts an input value to a value of type [Decimal(38, S)](../data-types/decimal.md) but returns the default value in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toDecimal128OrDefault_returned_value = {
  ...
  FunctionDocumentation toDecimal128OrDefault_documentation = {toDecimal128OrDefault_description,    toDecimal128OrDefault_syntax,
                                                               toDecimal128OrDefault_arguments,      {},
                                                               toDecimal128OrDefault_returned_value, toDecimal128OrDefault_examples,
                                                               toDecimal128OrDefault_introduced_in,  toDecimal128OrDefault_category};
...
Like [`toDecimal256`](#toDecimal256), this function converts an input value to a value of type [Decimal(76, S)](../data-types/decimal.md) but returns the default value in case of an error.
  ...
  FunctionDocumentation::ReturnedValue toDecimal256OrDefault_returned_value = {
  ...
  FunctionDocumentation toDecimal256OrDefault_documentation = {toDecimal256OrDefault_description,    toDecimal256OrDefault_syntax,
                                                               toDecimal256OrDefault_arguments,      {},
                                                               toDecimal256OrDefault_returned_value, toDecimal256OrDefault_examples,
                                                               toDecimal256OrDefault_introduced_in,  toDecimal256OrDefault_category};
...
If the string cannot be converted to a valid UUID, the function returns the provided default UUID value.
  ...
  FunctionDocumentation::Examples toUUIDOrDefault_examples = {{"Successful conversion returns the parsed UUID",
                                                               R"(
...
└───────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation toUUIDOrDefault_documentation = {
      toUUIDOrDefault_description,    toUUIDOrDefault_syntax,   toUUIDOrDefault_arguments,     {},
      toUUIDOrDefault_returned_value, toUUIDOrDefault_examples, toUUIDOrDefault_introduced_in, toUUIDOrDefault_category};
...
If the IPv4 address has an invalid format, it returns `0.0.0.0` (0 IPv4), or the provided IPv4 default.
  ...
  FunctionDocumentation::ReturnedValue toIPv4OrDefault_returned_value = {
      "Returns a string converted to the current IPv4 address, or the default value if conversion fails.", {"IPv4"}};
  FunctionDocumentation::Examples toIPv4OrDefault_examples = {{"Valid and invalid IPv4 strings",
                                                               R"(
WITH
...
└───────────────┴───────────────┴──────────────────┘
  ...
  FunctionDocumentation toIPv4OrDefault_documentation = {
      toIPv4OrDefault_description,    toIPv4OrDefault_syntax,   toIPv4OrDefault_arguments,     {},
      toIPv4OrDefault_returned_value, toIPv4OrDefault_examples, toIPv4OrDefault_introduced_in, toIPv4OrDefault_category};
...
If the IPv6 address has an invalid format, it returns `::` (0 IPv6) or the provided IPv6 default.
  ...
  FunctionDocumentation::ReturnedValue toIPv6OrDefault_returned_value = {
      "Returns the IPv6 address, otherwise `::` or the provided optional default if argument `string` has an invalid format.", {"IPv6"}};
  FunctionDocumentation::Examples toIPv6OrDefault_examples = {{"Valid and invalid IPv6 strings",
                                                               R"(
WITH
...
└────────────────────────────────────────┴───────────────┴──────────────────┘
  ...
  FunctionDocumentation toIPv6OrDefault_documentation = {
      toIPv6OrDefault_description,    toIPv6OrDefault_syntax,   toIPv6OrDefault_arguments,     {},
      toIPv6OrDefault_returned_value, toIPv6OrDefault_examples, toIPv6OrDefault_introduced_in, toIPv6OrDefault_category};
