...
REGISTER_FUNCTION(BitTest) {
  FunctionDocumentation::Description description =
      "Takes any number and converts it into [binary form](https://en.wikipedia.org/wiki/Binary_number), then returns the value of the bit "
      "at a specified position. Counting is done right-to-left, starting at 0.";
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the value of the bit at position `i` in the binary representation of `a`",
                                                         {"UInt8"}};
