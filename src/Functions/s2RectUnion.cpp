...
class FunctionS2RectUnion : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionS2RectUnion>(); }
...
Returns the smallest S2 latitude-longitude rectangle that contains the union of two input rectangles. Each rectangle is represented by a pair of S2 cell identifiers for its low and high corners.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a tuple (s2RectLow, s2RectHigh) representing the union rectangle.",
                                                         {"Tuple(UInt64, UInt64)"}};
  FunctionDocumentation::Examples examples = {
      {"Basic usage", "SELECT s2RectUnion(5765131099823669248, 5765131099956887552, 5765131100074868736, 5765131100088901632)", ""}};
