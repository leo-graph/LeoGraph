...
enum class HasAnyAllTokensMode : uint8_t { Any, All };
...
class ExecutableFunctionHasAnyAllTokens : public IExecutableFunction {
 public:
  ...
  explicit ExecutableFunctionHasAnyAllTokens(std::shared_ptr<const ITokenizer> tokenizer_, const TokensWithPosition &search_tokens_)
      : tokenizer(std::move(tokenizer_)), search_tokens(std::move(search_tokens_)) {}
...
class FunctionBaseHasAnyAllTokens : public IFunctionBase {
 public:
  ...
  FunctionBaseHasAnyAllTokens(std::shared_ptr<const ITokenizer> tokenizer_, TokensWithPosition search_tokens_, DataTypes argument_types_,
