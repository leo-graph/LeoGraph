...
class FunctionHilbertDecode : public FunctionSpaceFillingCurveDecode<2, 0, 32> {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionHilbertDecode>(); }
...
hilbertDecode(tuple_size, code)
  ...
  FunctionDocumentation::Examples examples = {{"Simple mode", "SELECT hilbertDecode(2, 31)", R"(["3", "4"])"},
                                              {"Single argument", R"(
