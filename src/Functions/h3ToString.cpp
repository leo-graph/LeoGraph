...
Converts the `H3Index` representation of the index to the string representation.
  ...
  FunctionDocumentation::Arguments arguments = {{"index", "H3 index number.", {"UInt64"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the string representation of the H3 index.", {"String"}};
  FunctionDocumentation::Examples examples = {{"Convert H3 index to string", "SELECT h3ToString(617420388352917503) AS h3_string",
                                               R"(
┌─h3_string───────┐
│ 89184926cdbffff │
└─────────────────┘
