...
struct NameBitBoolMaskAnd {
  static constexpr auto name = "__bitBoolMaskAnd";
};
using FunctionBitBoolMaskAnd = BinaryArithmeticOverloadResolver<BitBoolMaskAndImpl, NameBitBoolMaskAnd>;

}  // namespace

REGISTER_FUNCTION(BitBoolMaskAnd) { factory.registerFunction<FunctionBitBoolMaskAnd>(FunctionDocumentation::INTERNAL_FUNCTION_DOCS); }
