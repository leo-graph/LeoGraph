...
class FunctionVisibleWidth : public IFunction {
 ...
 public:
  ...
  static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionVisibleWidth>(context); }
...
`NULL` is represented as a string corresponding to `NULL` in Pretty formats.
  ...
  FunctionDocumentation::Arguments arguments = {{"x", "A value of any data type.", {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the approximate width of the value when displayed in text format.",
                                                         {"UInt64"}};
  FunctionDocumentation::Examples examples = {{"Calculate visible width of NULL",
                                               R"(
