...
class IUserDefinedSQLObjectsStorage {
 public:
  ...
  virtual bool storeObject(const ContextPtr& current_context, UserDefinedSQLObjectType object_type, const String& object_name,
  ...
  virtual bool removeObject(const ContextPtr& current_context, UserDefinedSQLObjectType object_type, const String& object_name,
