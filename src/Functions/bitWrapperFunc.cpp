...
struct NameBitWrapperFunc {
  static constexpr auto name = "__bitWrapperFunc";
};
...
template <>
struct FunctionUnaryArithmeticMonotonicity<NameBitWrapperFunc> {
  static bool has() { return false; }
  static IFunction::Monotonicity get(const IDataType &, const Field &, const Field &) { return {}; }
};

REGISTER_FUNCTION(BitWrapperFunc) { factory.registerFunction<FunctionBitWrapperFunc>(FunctionDocumentation::INTERNAL_FUNCTION_DOCS); }
}  // namespace DB
