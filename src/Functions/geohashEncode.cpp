...
class FunctionGeohashEncode : public IFunction {
 ...
 private:
  void vector(const IColumn *lon_column, const IColumn *lat_column, const IColumn *precision_column, ColumnPtr &result,
...
:::
  ...
  FunctionDocumentation::Examples examples = {{"Basic usage with default precision",
