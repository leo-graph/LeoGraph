...
:::
  ...
  FunctionDocumentation::Examples examples = {
      {"Usage example", "SELECT initcap('building for fast')",
       R"(
┌─initcap('building for fast')─┐
│ Building For Fast            │
└──────────────────────────────┘
        )"},
      {"Example of known behavior for words containing apostrophes or capital letters", "SELECT initcap('John''s cat won''t eat.');",
       R"(
┌─initcap('Joh⋯n\'t eat.')─┐
