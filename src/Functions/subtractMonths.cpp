...
subtractMonths(datetime, num)
  ...
  FunctionDocumentation::Arguments arguments = {{"datetime",
                                                 "Date or date with time to subtract specified number of months from.",
                                                 {"Date", "Date32", "DateTime", "DateTime64", "String"}},
                                                {"num", "Number of months to subtract.", {"(U)Int*", "Float*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `datetime` minus `num` months",
                                                         {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples = {{"Subtract months from different date types", R"(
WITH
