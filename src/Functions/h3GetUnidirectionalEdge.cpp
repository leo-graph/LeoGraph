...
Returns a unidirectional edge H3 index for two adjacent H3 cell indices (origin and destination).
  ...
  FunctionDocumentation::Arguments arguments = {{"origin", "The origin H3 cell index.", {"UInt64"}},
  ...
  FunctionDocumentation::Examples examples = {
      {"Basic usage", "SELECT h3GetUnidirectionalEdge(599686042433355775, 599686030622195711)", "1248204388774707199"}};
