...
If this assumption is violated, no exception is thrown and the result is undefined.
  ...
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT endsWithUTF8('данных', 'ых');",
                                               R"(
...
If this assumption is violated, no exception is thrown and the result is undefined.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `1` if `s` ends with case-insensitive `suffix`, otherwise `0`.",
                                                         {"UInt8"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT endsWithCaseInsensitiveUTF8('данных', 'ых');",
                                               R"(
