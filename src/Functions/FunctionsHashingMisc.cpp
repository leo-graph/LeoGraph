...
:::
  ...
  FunctionDocumentation::Arguments sipHash64_arguments = {{"arg1[, arg2, ...]", "A variable number of input arguments.", {"Any"}}};
...
└──────────────────────┴────────┘
  ...
  FunctionDocumentation sipHash64_documentation = {
      sipHash64_description,    sipHash64_syntax,   sipHash64_arguments,     {},
      sipHash64_returned_value, sipHash64_examples, sipHash64_introduced_in, sipHash64_category};
...
Like [`sipHash64`](#sipHash64) but additionally takes an explicit key argument instead of using a fixed key.
  ...
  FunctionDocumentation::Examples sipHash64Keyed_examples = {
      {"Usage example",
       "SELECT sipHash64Keyed((506097522914230528, 1084818905618843912), array('e','x','a'), 'mple', 10, toDateTime('2019-06-15 "
       "23:00:00')) AS SipHash, toTypeName(SipHash) AS type;",
       R"(
┌─────────────SipHash─┬─type───┐
...
└─────────────────────┴────────┘
  ...
  FunctionDocumentation sipHash64Keyed_documentation = {
      sipHash64Keyed_description,    sipHash64Keyed_syntax,   sipHash64Keyed_arguments,     {},
      sipHash64Keyed_returned_value, sipHash64Keyed_examples, sipHash64Keyed_introduced_in, sipHash64Keyed_category};
...
:::
  ...
  FunctionDocumentation::Examples sipHash128_examples = {{"Usage example", "SELECT hex(sipHash128('foo', '\\x01', 3));",
                                                          R"(
...
└──────────────────────────────────┘
  ...
  FunctionDocumentation sipHash128_documentation = {
      sipHash128_description,    sipHash128_syntax,   sipHash128_arguments,     {},
      sipHash128_returned_value, sipHash128_examples, sipHash128_introduced_in, sipHash128_category};
...
:::
  ...
  FunctionDocumentation::Arguments sipHash128Keyed_arguments = {
      ...
      {"arg1[, arg2, ...]", "A variable number of input arguments for which to compute the hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue sipHash128Keyed_returned_value = {
      "A 128-bit `SipHash` hash value of type [FixedString(16)](../data-types/fixedstring.md).", {"FixedString(16)"}};
  FunctionDocumentation::Examples sipHash128Keyed_examples = {
      {"Usage example", "SELECT hex(sipHash128Keyed((506097522914230528, 1084818905618843912),'foo', '\\x01', 3));",
       R"(
...
└───────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation sipHash128Keyed_documentation = {
      sipHash128Keyed_description,    sipHash128Keyed_syntax,   sipHash128Keyed_arguments,     {},
      sipHash128Keyed_returned_value, sipHash128Keyed_examples, sipHash128Keyed_introduced_in, sipHash128Keyed_category};
...
Like [`sipHash128`](/sql-reference/functions/hash-functions#sipHash128) but implements the 128-bit algorithm from the original authors of SipHash.
  ...
  FunctionDocumentation::Arguments sipHash128Ref_arguments = {
      {"arg1[, arg2, ...]", "A variable number of input arguments for which to compute the hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue sipHash128Ref_returned_value = {
      "Returns the computed 128-bit `SipHash` hash value of the input arguments.", {"FixedString(16)"}};
  FunctionDocumentation::Examples sipHash128Ref_examples = {{"Usage example", "SELECT hex(sipHash128Reference('foo', '\x01', 3));",
                                                             R"(
...
└────────────────────────────────────────┘
  ...
  FunctionDocumentation sipHash128Ref_documentation = {
      sipHash128Ref_description,    sipHash128Ref_syntax,   sipHash128Ref_arguments,     {},
      sipHash128Ref_returned_value, sipHash128Ref_examples, sipHash128Ref_introduced_in, sipHash128Ref_category};
...
Same as [`sipHash128Reference`](#sipHash128Reference) but additionally takes an explicit key argument instead of using a fixed key.
  ...
  FunctionDocumentation::Arguments sipHash128RefKeyed_arguments = {
      ...
      {"arg1[, arg2, ...]", "A variable number of input arguments for which to compute the hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue sipHash128RefKeyed_returned_value = {
      "Returns the computed 128-bit `SipHash` hash value of the input arguments.", {"FixedString(16)"}};
  FunctionDocumentation::Examples sipHash128RefKeyed_examples = {{"Usage example", "SELECT hex(sipHash128Reference('foo', '\x01', 3));",
                                                                  R"(
┌─hex(sipHash128Reference('foo', '', 3))─┐
│ 4D1BE1A22D7F5933C0873E1698426260       │
└────────────────────────────────────────┘
  ...
  FunctionDocumentation sipHash128RefKeyed_documentation = {
      sipHash128RefKeyed_description,    sipHash128RefKeyed_syntax,   sipHash128RefKeyed_arguments,     {},
      sipHash128RefKeyed_returned_value, sipHash128RefKeyed_examples, sipHash128RefKeyed_introduced_in, sipHash128RefKeyed_category};
...
└──────────────────────────┘
  ...
  FunctionDocumentation cityHash64_documentation = {
      cityHash64_description,    cityHash64_syntax,   cityHash64_arguments,     {},
      cityHash64_returned_value, cityHash64_examples, cityHash64_introduced_in, cityHash64_category};
...
:::
  ...
  FunctionDocumentation::Arguments farmFingerprint64_arguments = {
      {"arg1[, arg2, ...]", "A variable number of input arguments for which to compute the hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue farmFingerprint64_returned_value = {"Returns the computed hash value of the input arguments.",
                                                                           {"UInt64"}};
  FunctionDocumentation::Examples farmFingerprint64_examples = {
      {"Usage example",
       "SELECT farmFingerprint64(array('e','x','a'), 'mple', 10, toDateTime('2019-06-15 23:00:00')) AS FarmFingerprint, "
       "toTypeName(FarmFingerprint) AS type;",
       R"(
...
└─────────────────────┴────────┘
  ...
  FunctionDocumentation farmFingerprint64_documentation = {
      farmFingerprint64_description,    farmFingerprint64_syntax,   farmFingerprint64_arguments,     {},
      farmFingerprint64_returned_value, farmFingerprint64_examples, farmFingerprint64_introduced_in, farmFingerprint64_category};
...
└──────────────────────┴────────┘
  ...
  FunctionDocumentation farmHash64_documentation = {
      farmHash64_description,    farmHash64_syntax,   farmHash64_arguments,     {},
      farmHash64_returned_value, farmHash64_examples, farmHash64_introduced_in, farmHash64_category};
...
:::
  ...
  FunctionDocumentation::Examples metroHash64_examples = {{"Usage example",
                                                           R"(
...
└──────────────────────┴────────┘
  ...
  FunctionDocumentation metroHash64_documentation = {
      metroHash64_description,    metroHash64_syntax,   metroHash64_arguments,     {},
      metroHash64_returned_value, metroHash64_examples, metroHash64_introduced_in, metroHash64_category};
...
|`URLHash(url, N)` | Calculates a hash from a string up to the N level in the URL hierarchy, without one of the trailing symbols `/`,`?` or `#` at the end, if present. Levels are the same as in `URLHierarchy`.|
  ...
  FunctionDocumentation::Arguments URLHash_arguments = {{"url", "URL string to hash.", {"String"}},
  ...
  FunctionDocumentation::Examples URLHash_examples = {{"Usage example", "SELECT URLHash('https://www.clickhouse.com')",
                                                       R"(
...
└──────────────────────────┘
  ...
  FunctionDocumentation URLHash_documentation = {URLHash_description,    URLHash_syntax,   URLHash_arguments,     {},
                                                 URLHash_returned_value, URLHash_examples, URLHash_introduced_in, URLHash_category};
...
:::
  ...
  FunctionDocumentation::Arguments javaHash_arguments = {{"arg", "Input value to hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue javaHash_returned_value = {"Returns the computed hash of `arg`", {"Int32"}};
  FunctionDocumentation::Examples javaHash_examples = {{"Usage example 1",
                                                        R"(
...
└───────────────────────────┘
  ...
  FunctionDocumentation javaHash_documentation = {javaHash_description,    javaHash_syntax,   javaHash_arguments,     {},
                                                  javaHash_returned_value, javaHash_examples, javaHash_introduced_in, javaHash_category};
...
Calculates [JavaHash](http://hg.openjdk.java.net/jdk8u/jdk8u/jdk/file/478a4add975b/src/share/classes/java/lang/String.java#l1452) from a string, assuming it contains bytes representing a string in UTF-16LE encoding.
  ...
  FunctionDocumentation::Arguments javaHashUTF16LE_arguments = {{"arg", "A string in UTF-16LE encoding.", {"String"}}};
  FunctionDocumentation::ReturnedValue javaHashUTF16LE_returned_value = {"Returns the computed hash of the UTF-16LE encoded string.",
                                                                         {"Int32"}};
  FunctionDocumentation::Examples javaHashUTF16LE_examples = {{"Usage example",
...
└──────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation javaHashUTF16LE_documentation = {
      javaHashUTF16LE_description,    javaHashUTF16LE_syntax,   javaHashUTF16LE_arguments,     {},
      javaHashUTF16LE_returned_value, javaHashUTF16LE_examples, javaHashUTF16LE_introduced_in, javaHashUTF16LE_category};
...
:::
  ...
  FunctionDocumentation::Arguments hiveHash_arguments = {{"arg", "Input string to hash.", {"String"}}};
  FunctionDocumentation::ReturnedValue hiveHash_returned_value = {R"(Returns the computed "hive hash" of the input string.)", {"Int32"}};
  FunctionDocumentation::Examples hiveHash_examples = {{"Usage example", "SELECT hiveHash('Hello, world!');",
                                                        R"(
...
└───────────────────────────┘
  ...
  FunctionDocumentation hiveHash_documentation = {hiveHash_description,    hiveHash_syntax,   hiveHash_arguments,     {},
                                                  hiveHash_returned_value, hiveHash_examples, hiveHash_introduced_in, hiveHash_category};
...
For the 64-bit version see [`xxHash64`](#xxHash64)
  ...
  FunctionDocumentation::Arguments xxHash32_arguments = {{"arg", "Input string to hash.", {"String"}}};
  FunctionDocumentation::ReturnedValue xxHash32_returned_value = {"Returns the computed 32-bit hash of the input string.", {"UInt32"}};
  FunctionDocumentation::Examples xxHash32_examples = {{"Usage example", "SELECT xxHash32('Hello, world!');",
                                                        R"(
...
└───────────────────────────┘
  ...
  FunctionDocumentation xxHash32_documentation = {xxHash32_description,    xxHash32_syntax,   xxHash32_arguments,     {},
                                                  xxHash32_returned_value, xxHash32_examples, xxHash32_introduced_in, xxHash32_category};
...
For the 32-bit version see [`xxHash32`](#xxHash32)
  ...
  FunctionDocumentation::Arguments xxHash64_arguments = {{"arg", "Input string to hash.", {"String"}}};
  FunctionDocumentation::ReturnedValue xxHash64_returned_value = {"Returns the computed 64-bit hash of the input string.", {"UInt64"}};
  FunctionDocumentation::Examples xxHash64_examples = {{"Usage example", "SELECT xxHash64('Hello, world!');",
                                                        R"(
...
└───────────────────────────┘
  ...
  FunctionDocumentation xxHash64_documentation = {xxHash64_description,    xxHash64_syntax,   xxHash64_arguments,     {},
                                                  xxHash64_returned_value, xxHash64_examples, xxHash64_introduced_in, xxHash64_category};
  ...
  FunctionDocumentation xxh3_documentation = {xxh3_description,    xxh3_syntax,  xxh3_argument,      {},
                                              xxh3_returned_value, xxh3_example, xxh3_introduced_in, xxh3_category};
  ...
  FunctionDocumentation xxh3_128_documentation = {xxh3_128_description,    xxh3_128_syntax,  xxh3_128_argument,      {},
                                                  xxh3_128_returned_value, xxh3_128_example, xxh3_128_introduced_in, xxh3_128_category};
  factory.registerFunction<FunctionXXH3_128>(xxh3_128_documentation);

  FunctionDocumentation::Description wyHash64_description =
  ...
  FunctionDocumentation wyHash64_documentation = {wyHash64_description,    wyHash64_syntax,  wyHash64_argument,      {},
                                                  wyHash64_returned_value, wyHash64_example, wyHash64_introduced_in, wyHash64_category};
...
For some data types calculated value of hash function may be the same for the same values even if types of arguments differ (integers of different size, named and unnamed Tuple with the same data, Map and the corresponding Array(Tuple(key, value)) type with the same data).
  ...
  FunctionDocumentation::ReturnedValue halfMD5_returned_value = {
      "Returns the computed half MD5 hash of the given input params returned as a `UInt64` in big-endian byte order.", {"UInt64"}};
  FunctionDocumentation::Examples halfMD5_examples = {{"Usage example",
                                                       R"(
...
└───────────────────────────────────┘
  ...
  FunctionDocumentation halfMD5_documentation = {halfMD5_description,    halfMD5_syntax,   halfMD5_arguments,     {},
                                                 halfMD5_returned_value, halfMD5_examples, halfMD5_introduced_in, halfMD5_category};
