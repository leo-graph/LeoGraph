...
REGISTER_FUNCTION(CountSubstrings) {
  ...
  FunctionDocumentation::Arguments arguments = {
      {"haystack",
       "String in which the search is performed. [String](../../sql-reference/data-types/string.md) or "
       "[Enum](../../sql-reference/data-types/enum.md)."},
      {"needle", "Substring to be searched. [String](../../sql-reference/data-types/string.md)."},
      {"start_pos",
       "Position (1-based) in `haystack` at which the search starts. [UInt](../../sql-reference/data-types/int-uint.md). Optional."}};
  FunctionDocumentation::ReturnedValue returned_value = {"The number of occurrences.", {"UInt64"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT countSubstrings('aaaa', 'aa');",
                                               R"(
┌─countSubstrings('aaaa', 'aa')─┐
│                             2 │
└───────────────────────────────┘
        )"},
                                              {"With start_pos argument", "SELECT countSubstrings('abc___abc', 'abc', 4);",
                                               R"(
