 ...
 public:
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    ...
    if (!arg_ipv6 && !(arg_string && arg_string->getN() == IPV6_BINARY_LENGTH))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of argument of function {}, expected IPv6 or FixedString({})",
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (!col_ipv6 && !(col_string && col_string->getN() == IPV6_BINARY_LENGTH))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT,
                      "Illegal column {} of argument of function {}, expected IPv6 or FixedString({})", arguments[0].name, getName(),
                      IPV6_BINARY_LENGTH);
 ...
 public:
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    if (!checkAndGetDataType<DataTypeIPv6>(arguments[0].get())) {
      ...
      if (!ptr || ptr->getN() != IPV6_BINARY_LENGTH)
        throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of argument 1 of function {}, expected FixedString({})",
                        arguments[0]->getName(), getName(), toString(IPV6_BINARY_LENGTH));
    }

    if (!WhichDataType(arguments[1]).isUInt8())
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of argument 2 of function {}", arguments[1]->getName(),
                      getName());

    if (!WhichDataType(arguments[2]).isUInt8())
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of argument 3 of function {}", arguments[2]->getName(),
                      getName());
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (col_in_str && col_in_str->getN() != IPV6_BINARY_LENGTH)
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT,
                      "Illegal type {} of column {} argument of function {}, expected FixedString({})", col_type_name.type->getName(),
                      col_in_str->getName(), getName(), toString(IPV6_BINARY_LENGTH));
...
class FunctionIPv6StringToNum : public IFunction {
 public:
  static constexpr auto name =
      exception_mode == IPStringToNumExceptionMode::Throw
          ? "IPv6StringToNum"
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t /*input_rows_count*/) const override {
    ...
    if constexpr (exception_mode == IPStringToNumExceptionMode::Throw) {
      if (cast_ipv4_ipv6_default_on_conversion_error) {
        ...
        if (null_map && !result->isNullable()) return ColumnNullable::create(result, null_map_column);
        return result;
      }
    }

    auto result = convertToIPv6<exception_mode, ColumnFixedString>(column, null_map);
    if (null_map && !result->isNullable()) return ColumnNullable::create(IColumn::mutate(result), IColumn::mutate(null_map_column));
    return result;
  }
 ...
 public:
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &ret_type, size_t input_rows_count) const override {
    switch (arguments[0].type->getTypeId()) {
      case TypeIndex::IPv4:
        return executeTyped<IPv4>(arguments, ret_type, input_rows_count);
      case TypeIndex::UInt8:
        return executeTyped<UInt8>(arguments, ret_type, input_rows_count);
      case TypeIndex::UInt16:
        return executeTyped<UInt16>(arguments, ret_type, input_rows_count);
      case TypeIndex::UInt32:
        return executeTyped<UInt32>(arguments, ret_type, input_rows_count);
      default:
        break;
    }

    throw Exception(ErrorCodes::ILLEGAL_COLUMN, "Illegal column {} of argument of function {}, expected IPv4 or UInt8 or UInt16 or UInt32",
...
class FunctionIPv4ToIPv6 : public IFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    ...
    if (dt_uint32) return std::make_shared<DataTypeFixedString>(16);
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (const auto *col_in = checkAndGetColumn<ColumnIPv4>(&*column)) {
      ...
      for (size_t i = 0; i < input_rows_count; ++i) mapIPv4ToIPv6(vec_in[i], reinterpret_cast<UInt8 *>(&vec_res[i].toUnderType()));
...
struct ParseMACImpl {
  ...
  static UInt64 parse(const char *pos) {
    return (static_cast<UInt64>(unhex(pos[0])) << 44) | (static_cast<UInt64>(unhex(pos[1])) << 40) |
           (static_cast<UInt64>(unhex(pos[3])) << 36) | (static_cast<UInt64>(unhex(pos[4])) << 32) |
           (static_cast<UInt64>(unhex(pos[6])) << 28) | (static_cast<UInt64>(unhex(pos[7])) << 24) |
           (static_cast<UInt64>(unhex(pos[9])) << 20) | (static_cast<UInt64>(unhex(pos[10])) << 16) |
           (static_cast<UInt64>(unhex(pos[12])) << 12) | (static_cast<UInt64>(unhex(pos[13])) << 8) |
           (static_cast<UInt64>(unhex(pos[15])) << 4) | (static_cast<UInt64>(unhex(pos[16])));
  }
...
struct ParseOUIImpl {
   ...
   */
  static UInt64 parse(const char *pos) {
    return (static_cast<UInt64>(unhex(pos[0])) << 20) | (static_cast<UInt64>(unhex(pos[1])) << 16) |
           (static_cast<UInt64>(unhex(pos[3])) << 12) | (static_cast<UInt64>(unhex(pos[4])) << 8) |
           (static_cast<UInt64>(unhex(pos[6])) << 4) | (static_cast<UInt64>(unhex(pos[7])));
  }
 ...
 public:
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    ...
    if (!ipv6 && !(str && str->getN() == IPV6_BINARY_LENGTH))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT,
                      "Illegal type {} of first argument of function {}, expected IPv6 or FixedString({})", arguments[0]->getName(),
                      getName(), IPV6_BINARY_LENGTH);

    const DataTypePtr &second_argument = arguments[1];
    if (!isUInt8(second_argument))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of second argument of function {}, expected UInt8",
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (col_const_ip_in)
      ...
      get_ip_data = [col_str_in](size_t i) {
        return reinterpret_cast<const char *>(&col_str_in->getChars().data()[i * IPV6_BINARY_LENGTH]);
      };
    else
      throw Exception(ErrorCodes::ILLEGAL_COLUMN, "Illegal column {} of argument of function {}", arguments[0].column->getName(),
                      getName());
    ...
    for (size_t i = 0; i < input_rows_count; ++i) {
      ...
      applyCIDRMask(get_ip_data(i), reinterpret_cast<char *>(&vec_res_lower_range[i]), reinterpret_cast<char *>(&vec_res_upper_range[i]),
                    cidr);
    }
...
class FunctionIPv4CIDRToRange : public IFunction {
 private:
  static std::pair<UInt32, UInt32> applyCIDRMask(UInt32 src, UInt8 bits_to_keep) {
    if (bits_to_keep >= 8 * sizeof(UInt32)) return {src, src};
    if (bits_to_keep == 0) return {static_cast<UInt32>(0), static_cast<UInt32>(-1)};
  ...
  ColumnPtr executeTyped(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const {
    ...
    for (size_t i = 0; i < input_rows_count; ++i) {
      ArgType ip = col_const_ip_in ? col_const_ip_in->template getValue<ArgType>() : col_ip_in->getData()[i];
 ...
 public:
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (size_t i = 0; i < input_rows_count; ++i) {
      ...
      vec_res[i] = parseIPv4whole(reinterpret_cast<const char *>(&vec_src[prev_offset]),
                                  reinterpret_cast<const char *>(&vec_src[new_offset]), reinterpret_cast<unsigned char *>(&result));
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (size_t i = 0; i < input_rows_count; ++i) {
      ...
      vec_res[i] = parseIPv6Whole(reinterpret_cast<const char *>(&vec_src[prev_offset]),
                                  reinterpret_cast<const char *>(&vec_src[new_offset]), reinterpret_cast<unsigned char *>(buffer));
      prev_offset = new_offset;
    }
...
Returns a string containing the address of the specified number of bytes removed in text format.
  ...
  FunctionDocumentation::Arguments arguments_cutipv6 = {{"x", "IPv6 address in binary format.", {"FixedString(16)", "IPv6"}},
                                                        {"bytesToCutForIPv6", "Number of bytes to cut for IPv6.", {"UInt8"}},
                                                        {"bytesToCutForIPv4", "Number of bytes to cut for IPv4.", {"UInt8"}}};
  FunctionDocumentation::ReturnedValue returned_value_cutipv6 = {
      "Returns a string containing the IPv6 address in text format with specified bytes removed.", {"String"}};
  FunctionDocumentation::Examples examples_cutipv6 = {{"Usage example", R"(
WITH
...
└─────────────────────────────────────┴─────────────────────┘
  ...
  FunctionDocumentation documentation_cutipv6 = {description_cutipv6,    syntax_cutipv6,   arguments_cutipv6,     {},
                                                 returned_value_cutipv6, examples_cutipv6, introduced_in_cutipv6, category_cutipv6};
...
Interprets a (big endian) 32-bit number as an IPv4 address, which is then interpreted as the corresponding IPv6 address in `FixedString(16)` format.
  ...
  FunctionDocumentation::Arguments arguments_ipv4toipv6 = {{"x", "IPv4 address.", {"UInt32"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv4toipv6 = {"Returns an IPv6 address in binary format.", {"FixedString(16)"}};
  FunctionDocumentation::Examples examples_ipv4toipv6 = {{"Usage example", R"(
...
└────────────────────┘
  ...
  FunctionDocumentation documentation_ipv4toipv6 = {
      description_ipv4toipv6,    syntax_ipv4toipv6,   arguments_ipv4toipv6,     {},
      returned_value_ipv4toipv6, examples_ipv4toipv6, introduced_in_ipv4toipv6, category_ipv4toipv6};
...
Returns the corresponding MAC address in format `AA:BB:CC:DD:EE:FF` (colon-separated numbers in hexadecimal form) as string.
  ...
  FunctionDocumentation::Arguments arguments_macnumtostring = {{"num", "UInt64 number.", {"UInt64"}}};
  ...
  FunctionDocumentation::Examples examples_macnumtostring = {{"Usage example",
                                                              R"(
...
└───────────────────┘
  ...
  FunctionDocumentation documentation_macnumtostring = {
      description_macnumtostring,    syntax_macnumtostring,   arguments_macnumtostring,     {},
      returned_value_macnumtostring, examples_macnumtostring, introduced_in_macnumtostring, category_macnumtostring};
...
The inverse function of MACNumToString. If the MAC address has an invalid format, it returns 0.
  ...
  FunctionDocumentation::Arguments arguments_macstringtonum = {{"s", "MAC address string.", {"String"}}};
  FunctionDocumentation::Examples examples_macstringtonum = {{"Usage example",
                                                              R"(
...
1108152157446
  ...
  FunctionDocumentation documentation_macstringtonum = {
      description_macstringtonum,    syntax_macstringtonum,   arguments_macstringtonum,     {},
      returned_value_macstringtonum, examples_macstringtonum, introduced_in_macstringtonum, category_macstringtonum};
...
Given a MAC address in format AA:BB:CC:DD:EE:FF (colon-separated numbers in hexadecimal form), returns the first three octets as a UInt64 number. If the MAC address has an invalid format, it returns 0.
  ...
  FunctionDocumentation::Arguments arguments_macstringtooui = {{"s", "MAC address string.", {"String"}}};
  FunctionDocumentation::Examples examples_macstringtooui = {{"Usage example",
                                                              R"(
...
20566
  ...
  FunctionDocumentation documentation_macstringtooui = {
      description_macstringtooui,    syntax_macstringtooui,   arguments_macstringtooui,     {},
      returned_value_macstringtooui, examples_macstringtooui, introduced_in_macstringtooui, category_macstringtooui};
...
For the IPv4 version see [`IPv4CIDRToRange`](#IPv4CIDRToRange).
  ...
  FunctionDocumentation::Arguments arguments_ipv6cidr = {{"ipv6", "IPv6 address.", {"IPv6", "String"}}, {"cidr", "CIDR value.", {"UInt8"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv6cidr = {"Returns a tuple with two IPv6 addresses representing the subnet range.",
                                                                  {"Tuple(IPv6, IPv6)"}};
  FunctionDocumentation::Examples examples_ipv6cidr = {{"Usage example", R"(
...
└────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_ipv6cidr = {description_ipv6cidr,    syntax_ipv6cidr,   arguments_ipv6cidr,  {},
                                                  returned_value_ipv6cidr, examples_ipv6cidr, introduced_ipv6cidr, category_ipv6cidr};
...
For the IPv6 version see [`IPv6CIDRToRange`](#IPv4CIDRToRange).
  ...
  FunctionDocumentation::Arguments arguments_ipv4cidr = {{"ipv4", "IPv4 address.", {"IPv4", "String"}}, {"cidr", "CIDR value.", {"UInt8"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv4cidr = {"Returns a tuple with two IPv4 addresses representing the subnet range.",
                                                                  {"Tuple(IPv4, IPv4)"}};
  FunctionDocumentation::Examples examples_ipv4cidr = {{"Usage example", R"(
...
└────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_ipv4cidr = {description_ipv4cidr,    syntax_ipv4cidr,   arguments_ipv4cidr,  {},
                                                  returned_value_ipv4cidr, examples_ipv4cidr, introduced_ipv4cidr, category_ipv4cidr};
...
For the IPv6 version see [`isIPv6String`](#isIPv6String).
  ...
  FunctionDocumentation::Arguments arguments_isipv4 = {{"string", "IP address string to check.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_isipv4 = {"Returns `1` if `string` is IPv4 address, otherwise `0`.", {"UInt8"}};
  FunctionDocumentation::Examples examples_isipv4 = {{"Usage example",
                                                      R"(
...
└──────────────────┴────────────────────┘
  ...
  FunctionDocumentation documentation_isipv4 = {description_isipv4,    syntax_isipv4,   arguments_isipv4,  {},
                                                returned_value_isipv4, examples_isipv4, introduced_isipv4, category_isipv4};
...
For the IPv4 version see [`isIPv4String`](#isIPv4String).
  ...
  FunctionDocumentation::Arguments arguments_isipv6 = {{"string", "IP address string to check.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_isipv6 = {"Returns `1` if `string` is IPv6 address, otherwise `0`.", {"UInt8"}};
  FunctionDocumentation::Examples examples_isipv6 = {{"Usage example",
                                                      R"(
...
└──────────────────┴────────────────────┘
  ...
  FunctionDocumentation documentation_isipv6 = {description_isipv6,    syntax_isipv6,   arguments_isipv6,  {},
                                                returned_value_isipv6, examples_isipv6, introduced_isipv6, category_isipv6};
...
Interprets the input using big-endian byte ordering.
  ...
  FunctionDocumentation::Arguments arguments_ipv4numtostring = {{"num", "IPv4 address as UInt32 number.", {"UInt32"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv4numtostring = {
      "Returns a number representing the MAC address, or `0` if the format is invalid.", {"String"}};
  FunctionDocumentation::Examples example_ipv4numtostring = {{"Usage example", "IPv4NumToString(3232235521)", "192.168.0.1"}};
  ...
  FunctionDocumentation documentation_ipv4numtostring = {
      description_ipv4numtostring,    syntax_ipv4numtostring,  arguments_ipv4numtostring,     {},
      returned_value_ipv4numtostring, example_ipv4numtostring, introduced_in_ipv4numtostring, category_ipv4numtostring};
...
similar to [`IPv4NumToString`](#IPv4NumToString) but using `xxx` instead of the last octet.
  ...
  FunctionDocumentation::ReturnedValue returned_value_ipv4numtostringclassc = {
...
└────────────────┴───────┘
  ...
  FunctionDocumentation documentation_ipv4numtostringclassc = {description_ipv4numtostringclassc,    syntax_ipv4numtostringclassc,
                                                               arguments_ipv4numtostringclassc,      {},
                                                               returned_value_ipv4numtostringclassc, examples_ipv4numtostringclassc,
                                                               introduced_in_ipv4numtostringclassc,  category_ipv4numtostringclassc};
...
If the IPv4 address has an invalid format, an exception is thrown.
  ...
  FunctionDocumentation::Arguments arguments_ipv4stringtonum = {{"string", "IPv4 address string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv4stringtonum = {"Returns theIPv4 address.", {"UInt32"}};
  FunctionDocumentation::Examples examples_ipv4stringtonum = {{"Usage example", "IPv4StringToNum('192.168.0.1')", "3232235521"}};
  ...
  FunctionDocumentation documentation_ipv4stringtonum = {
      description_ipv4stringtonum,    syntax_ipv4stringtonum,   arguments_ipv4stringtonum,     {},
      returned_value_ipv4stringtonum, examples_ipv4stringtonum, introduced_in_ipv4stringtonum, category_ipv4stringtonum};
...
Converts an IPv4 address string in dotted decimal notation (A.B.C.D format) to its corresponding 32-bit integer representation but if the IPv4 address has an invalid format, it returns `0`.
  ...
  FunctionDocumentation::Arguments arguments_ipv4stringtonumordefault = {{"string", "IPv4 address string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv4stringtonumordefault = {"Returns the IPv4 address, or `0` if invalid.",
                                                                                  {"UInt32"}};
  FunctionDocumentation::Examples examples_ipv4stringtonumordefault = {{"Example with an invalid address", R"(
SELECT
...
└────────────┴─────────┘
  ...
  FunctionDocumentation documentation_ipv4stringtonumordefault = {
      description_ipv4stringtonumordefault,    syntax_ipv4stringtonumordefault,
      arguments_ipv4stringtonumordefault,      {},
      returned_value_ipv4stringtonumordefault, examples_ipv4stringtonumordefault,
      introduced_in_ipv4stringtonumordefault,  category_ipv4stringtonumordefault};
...
Converts a 32-bit integer to its IPv4 address string representation in dotted decimal notation (A.B.C.D format) but if the IPv4 address has an invalid format, it returns `NULL`.
  ...
  FunctionDocumentation::Arguments arguments_ipv4stringtonumornull = {{"string", "IPv4 address string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv4stringtonumornull = {"Returns the IPv4 address, or `NULL` if invalid.",
                                                                               {"Nullable(UInt32)"}};
  FunctionDocumentation::Examples examples_ipv4stringtonumornull = {{"Example with an invalid address",
                                                                     R"(
SELECT
...
└────────────┴─────────┘
  ...
  FunctionDocumentation documentation_ipv4stringtonumornull = {description_ipv4stringtonumornull,    syntax_ipv4stringtonumornull,
                                                               arguments_ipv4stringtonumornull,      {},
                                                               returned_value_ipv4stringtonumornull, examples_ipv4stringtonumornull,
                                                               introduced_in_ipv4stringtonumornull,  category_ipv4stringtonumornull};
...
IPv4-mapped IPv6 addresses are displayed in the format `::ffff:111.222.33.44`.
  ...
  FunctionDocumentation::Arguments arguments_ipv6numtostring = {{"x", "IPv6 address in binary format.", {"FixedString(16)", "IPv6"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv6numtostring = {"Returns the IPv6 address string in text format.", {"String"}};
  FunctionDocumentation::Examples examples_ipv6numtostring = {{"Usage example",
                                                               R"(
...
└────────────────────────────┴────────┘
  ...
  FunctionDocumentation documentation_ipv6numtostring = {
      description_ipv6numtostring,    syntax_ipv6numtostring,   arguments_ipv6numtostring,     {},
      returned_value_ipv6numtostring, examples_ipv6numtostring, introduced_in_ipv6numtostring, category_ipv6numtostring};
...
HEX can be uppercase or lowercase.
  ...
  FunctionDocumentation::Arguments arguments_ipv6stringtonum = {{"string", "IPv6 address string.", {"String"}}};
  ...
  FunctionDocumentation::Examples examples_ipv6stringtonum = {{"Basic example",
                                                               R"(
...
└────────────┴──────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_ipv6stringtonum = {
      description_ipv6stringtonum,    syntax_ipv6stringtonum,   arguments_ipv6stringtonum,     {},
      returned_value_ipv6stringtonum, examples_ipv6stringtonum, introduced_in_ipv6stringtonum, category_ipv6stringtonum};
...
If the IPv6 address has an invalid format, it returns the default value `::`.
  ...
  FunctionDocumentation::Arguments arguments_ipv6stringtonumordefault = {{"string", "IPv6 address string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv6stringtonumordefault = {
      "IPv6 address in binary format, or zero-filled FixedString(16) if invalid.", {"FixedString(16)"}};
  FunctionDocumentation::Examples examples_ipv6stringtonumordefault = {{"Basic example with invalid address", R"(
SELECT
...
└─────────────┴─────────┘
  ...
  FunctionDocumentation documentation_ipv6stringtonumordefault = {
      description_ipv6stringtonumordefault,    syntax_ipv6stringtonumordefault,
      arguments_ipv6stringtonumordefault,      {},
      returned_value_ipv6stringtonumordefault, examples_ipv6stringtonumordefault,
      introduced_in_ipv6stringtonumordefault,  category_ipv6stringtonumordefault};
...
If the IPv6 address has an invalid format, it returns `NULL`.
  ...
  FunctionDocumentation::Arguments arguments_ipv6stringtonumornull = {{"string", "IPv6 address string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_ipv6stringtonumornull = {
      "Returns IPv6 address in binary format, or `NULL` if invalid.", {"Nullable(FixedString(16))"}};
  FunctionDocumentation::Examples examples_ipv6stringtonumornull = {{"Basic example with invalid address",
                                                                     R"(
SELECT
...
└─────────────┴─────────┘
  ...
  FunctionDocumentation documentation_ipv6stringtonumornull = {description_ipv6stringtonumornull,    syntax_ipv6stringtonumornull,
                                                               arguments_ipv6stringtonumornull,      {},
                                                               returned_value_ipv6stringtonumornull, examples_ipv6stringtonumornull,
                                                               introduced_in_ipv6stringtonumornull,  category_ipv6stringtonumornull};
