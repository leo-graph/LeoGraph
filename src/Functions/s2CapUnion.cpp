...
class FunctionS2CapUnion : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionS2CapUnion>(); }
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors mandatory_args{{"center1", &isUInt64, nullptr, "UInt64"},
...
Returns the smallest cap that contains both of the input S2 caps. A cap represents a portion of the sphere that has been cut off by a plane, defined by a center point and a radius in degrees.
  ...
  FunctionDocumentation::Arguments arguments = {{"center1", "S2 cell identifier of the first cap center.", {"UInt64"}},
  ...
  FunctionDocumentation::Examples examples = {
      {"Basic usage", "SELECT s2CapUnion(1157339245694594829, 1.0, 1157347770437378819, 1.0)", "(1157339245694594829,1.0049841409301968)"}};
