...
class FunctionCountMatches : public IFunction {
 ...
 public:
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &result_type, size_t input_rows_count) const override {
    ...
    if (col_pattern_const == nullptr) throw Exception(ErrorCodes::ILLEGAL_COLUMN, "Pattern argument is not const");

    const OptimizedRegularExpression re = Regexps::createRegexp</*is_like*/ false, /*no_capture*/ true, CountMatchesBase::case_insensitive>(
        col_pattern_const->getValue<String>());
...
:::
  ...
  FunctionDocumentation::Arguments arguments_case_sensitive = {{"haystack", "The string to search in.", {"String"}},
                                                               {"pattern", "Regular expression pattern.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_case_sensitive = {"Returns the number of matches found.", {"UInt64"}};
  FunctionDocumentation::Examples examples_case_sensitive = {{"Count digit sequences",
...
└─────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_case_sensitive = {
      description_case_sensitive,    syntax_case_sensitive,   arguments_case_sensitive,     {},
      returned_value_case_sensitive, examples_case_sensitive, introduced_in_case_sensitive, category_case_sensitive};
...
Like [`countMatches`](#countMatches) but performs case-insensitive matching.
  ...
  FunctionDocumentation::Arguments arguments_case_insensitive = {{"haystack", "The string to search in.", {"String"}},
  ...
  FunctionDocumentation::Examples examples_case_insensitive = {{"Case insensitive count",
...
└───────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_case_insensitive = {
      description_case_insensitive,    syntax_case_insensitive,   arguments_case_insensitive,     {},
      returned_value_case_insensitive, examples_case_insensitive, introduced_in_case_insensitive, category_case_insensitive};
