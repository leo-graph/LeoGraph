...
Encodes a string using [Base32](https://datatracker.ietf.org/doc/html/rfc4648#section-6).
  ...
  FunctionDocumentation::Arguments arguments = {{"plaintext", "Plaintext to encode.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a string containing the encoded value of the argument.",
                                                         {"String", "FixedString"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT base32Encode('Encoded')",
                                               R"(
