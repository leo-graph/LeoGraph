...
struct Impl {
  ...
  static void vector(const ColumnString::Chars &data, const ColumnString::Offsets &offsets, ColumnString::Chars &res_data,
    ...
    for (size_t i = 0; i < input_rows_count; ++i) {
      ...
      normalizeQueryToPODArray(reinterpret_cast<const char *>(&data[prev_src_offset]),
                               reinterpret_cast<const char *>(&data[curr_src_offset]), res_data, keep_names);
...
Replaces literals, sequences of literals and complex aliases (containing whitespace, more than two digits or at least 36 bytes long such as UUIDs) with placeholder `?`.
  ...
  FunctionDocumentation::Arguments normalizeQuery_arguments = {{"x", "Sequence of characters.", {"String"}}};
  FunctionDocumentation::ReturnedValue normalizeQuery_returned_value = {"Returns the given sequence of characters with placeholders.",
                                                                        {"String"}};
  FunctionDocumentation::Examples normalizeQuery_examples = {{"Usage example",
                                                              R"(
...
└──────────┘
  ...
  FunctionDocumentation normalizeQuery_documentation = {
      normalizeQuery_description,    normalizeQuery_syntax,   normalizeQuery_arguments,     {},
      normalizeQuery_returned_value, normalizeQuery_examples, normalizeQuery_introduced_in, normalizeQuery_category};
...
This helps better analyze complex query logs.
  ...
  FunctionDocumentation::Arguments normalizeQueryKeepNames_arguments = {{"x", "Sequence of characters.", {"String"}}};
  FunctionDocumentation::ReturnedValue normalizeQueryKeepNames_returned_value = {
      "Returns the given sequence of characters with placeholders.", {"String"}};
  FunctionDocumentation::Examples normalizeQueryKeepNames_examples = {{"Usage example",
                                                                       R"(
...
└───────────────────────────────────────────────┴────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation normalizeQueryKeepNames_documentation = {normalizeQueryKeepNames_description,    normalizeQueryKeepNames_syntax,
                                                                 normalizeQueryKeepNames_arguments,      {},
                                                                 normalizeQueryKeepNames_returned_value, normalizeQueryKeepNames_examples,
                                                                 normalizeQueryKeepNames_introduced_in,  normalizeQueryKeepNames_category};
