  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (!column)
      throw Exception(ErrorCodes::ILLEGAL_COLUMN, "Illegal type {} of argument {} of function {}. Must be UInt8",
                      arguments[0].column->getName(), 1, getName());
...
Returns average hexagon area in square kilometers at the given [H3](#h3-index) resolution.
  ...
  FunctionDocumentation::Syntax syntax = "h3HexAreaKm2(resolution)";
  ...
  FunctionDocumentation::Examples examples = {{"Get hexagon area at resolution 13", "SELECT h3HexAreaKm2(13) AS area",
                                               R"(
┌──────area─┐
│ 0.0000439 │
└───────────┘
