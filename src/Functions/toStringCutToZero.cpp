...
This function is useful for processing C-style strings or binary data where null bytes mark the end of meaningful content.
  ...
  FunctionDocumentation::Arguments arguments = {{"s", "String or FixedString to process.", {"String", "FixedString"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a String containing the characters before the first null byte.",
                                                         {"String"}};
