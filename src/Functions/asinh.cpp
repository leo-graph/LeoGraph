...
Returns the inverse hyperbolic sine.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the angle, in radians. Values from the interval: `-∞ < asinh(x) < +∞`.",
                                                         {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Basic usage", "SELECT asinh(0)", "0"}};
