...
The returned value is always smaller than the total free space ([`filesystemUnreserved`](../../sql-reference/functions/other-functions.md#filesystemUnreserved)) because some space is reserved for the operating system.
  ...
  FunctionDocumentation::Arguments arguments_filesystemAvailable = {
      {"disk_name",
       "Optional. The disk name to find the amount of free space for. If omitted, uses the default disk.",
       {"String", "FixedString"}}};
  FunctionDocumentation::ReturnedValue returned_value_filesystemAvailable = {"Returns the amount of remaining space available in bytes.",
                                                                             {"UInt64"}};
  FunctionDocumentation::Examples examples_filesystemAvailable = {{"Usage example",
                                                                   R"(
...
└─────────────────┘
  ...
  FunctionDocumentation documentation_filesystemAvailable = {
      description_filesystemAvailable,    syntax_filesystemAvailable,   arguments_filesystemAvailable,     {},
      returned_value_filesystemAvailable, examples_filesystemAvailable, introduced_in_filesystemAvailable, category_filesystemAvailable};

  factory.registerFunction(
      "filesystemAvailable", [](ContextPtr ctx) { return FilesystemImpl::create(ctx, "filesystemAvailable", filesystemAvailable); },
      documentation_filesystemAvailable);
...
Needs the [path](../../operations/server-configuration-parameters/settings.md#path) to the data directory to be configured.
  ...
  FunctionDocumentation::Examples examples_filesystemCapacity = {{"Usage example",
                                                                  R"(
...
└───────────┘
  ...
  FunctionDocumentation documentation_filesystemCapacity = {
      description_filesystemCapacity,    syntax_filesystemCapacity,   arguments_filesystemCapacity,     {},
      returned_value_filesystemCapacity, examples_filesystemCapacity, introduced_in_filesystemCapacity, category_filesystemCapacity};

  factory.registerFunction(
      "filesystemCapacity", [](ContextPtr ctx) { return FilesystemImpl::create(ctx, "filesystemCapacity", filesystemCapacity); },
      documentation_filesystemCapacity);
...
See also [`filesystemAvailable`](#filesystemAvailable).
  ...
  FunctionDocumentation::Arguments arguments_filesystemUnreserved = {
      {"disk_name",
       "Optional. The disk name for which to find the total amount of free space. If omitted, uses the default disk.",
       {"String", "FixedString"}}};
  FunctionDocumentation::ReturnedValue returned_value_filesystemUnreserved = {"Returns the amount of free space in bytes.", {"UInt64"}};
  FunctionDocumentation::Examples examples_filesystemUnreserved = {{"Usage example",
                                                                    R"(
...
└────────────┘
  ...
  FunctionDocumentation documentation_filesystemUnreserved = {description_filesystemUnreserved,    syntax_filesystemUnreserved,
                                                              arguments_filesystemUnreserved,      {},
                                                              returned_value_filesystemUnreserved, examples_filesystemUnreserved,
                                                              introduced_in_filesystemUnreserved,  category_filesystemUnreserved};

  factory.registerFunction(
      "filesystemUnreserved", [](ContextPtr ctx) { return FilesystemImpl::create(ctx, "filesystemUnreserved", filesystemUnreserved); },
      documentation_filesystemUnreserved);
}
