...
toStartOfSecond(datetime[, timezone])
  ...
  FunctionDocumentation::Arguments arguments = {
      ...
      {"timezone",
       "Optional. Timezone for the returned value. If not specified, the function uses the timezone of the `value` parameter.",
       {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the input value without sub-seconds.", {"DateTime64"}};
