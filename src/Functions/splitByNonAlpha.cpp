...
class SplitByNonAlphaImpl {
 ...
 public:
  ...
  bool get(Pos &token_begin, Pos &token_end) {
    /// Skip garbage
    while (pos < end && (isWhitespaceASCII(*pos) || isPunctuationASCII(*pos))) ++pos;
...
:::
  ...
  FunctionDocumentation::Examples examples = {{"Usage example", R"(SELECT splitByNonAlpha('user@domain.com');)",
                                               R"(
['user','domain','com']
        )"}};
