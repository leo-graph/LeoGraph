...
:::
  ...
  FunctionDocumentation::ReturnedValue murmurHash2_32_returned_value = {"Returns the computed hash value of the input arguments.",
                                                                        {"UInt32"}};
  FunctionDocumentation::Examples murmurHash2_32_examples = {
      {"Usage example",
       "SELECT murmurHash2_32(array('e','x','a'), 'mple', 10, toDateTime('2019-06-15 23:00:00')) AS MurmurHash2, toTypeName(MurmurHash2) "
       "AS type;",
       R"(
┌─MurmurHash2─┬─type───┐
│  3681770635 │ UInt32 │
└─────────────┴────────┘
  ...
  FunctionDocumentation murmurHash2_32_documentation = {
      murmurHash2_32_description,    murmurHash2_32_syntax,   murmurHash2_32_arguments,     {},
      murmurHash2_32_returned_value, murmurHash2_32_examples, murmurHash2_32_introduced_in, murmurHash2_32_category};
...
:::
  ...
  FunctionDocumentation::Examples murmurHash2_64_examples = {
      {"Usage example",
       "SELECT murmurHash2_64(array('e','x','a'), 'mple', 10, toDateTime('2019-06-15 23:00:00')) AS MurmurHash2, toTypeName(MurmurHash2) "
       "AS type;",
       R"(
┌──────────MurmurHash2─┬─type───┐
...
└──────────────────────┴────────┘
  ...
  FunctionDocumentation murmurHash2_64_documentation = {
      murmurHash2_64_description,    murmurHash2_64_syntax,   murmurHash2_64_arguments,     {},
      murmurHash2_64_returned_value, murmurHash2_64_examples, murmurHash2_64_introduced_in, murmurHash2_64_category};
...
:::
  ...
  FunctionDocumentation::Arguments murmurHash3_32_arguments = {
      {"arg1[, arg2, ...]", "A variable number of input arguments for which to compute the hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue murmurHash3_32_returned_value = {"Returns the computed hash value of the input arguments.",
                                                                        {"UInt32"}};
  FunctionDocumentation::Examples murmurHash3_32_examples = {
      {"Usage example",
       "SELECT murmurHash3_32(array('e','x','a'), 'mple', 10, toDateTime('2019-06-15 23:00:00')) AS MurmurHash3, toTypeName(MurmurHash3) "
       "AS type;",
       R"(
┌─MurmurHash3─┬─type───┐
│     2152717 │ UInt32 │
└─────────────┴────────┘
  ...
  FunctionDocumentation murmurHash3_32_documentation = {
      murmurHash3_32_description,    murmurHash3_32_syntax,   murmurHash3_32_arguments,     {},
      murmurHash3_32_returned_value, murmurHash3_32_examples, murmurHash3_32_introduced_in, murmurHash3_32_category};
...
:::
  ...
  FunctionDocumentation::Arguments murmurHash3_64_arguments = {
      {"arg1[, arg2, ...]", "A variable number of input arguments for which to compute the hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue murmurHash3_64_returned_value = {"Returns the computed hash value of the input arguments.",
                                                                        {"UInt64"}};
  FunctionDocumentation::Examples murmurHash3_64_examples = {
      {"Usage example",
       "SELECT murmurHash3_64(array('e','x','a'), 'mple', 10, toDateTime('2019-06-15 23:00:00')) AS MurmurHash3, toTypeName(MurmurHash3) "
       "AS type;",
       R"(
┌──────────MurmurHash3─┬─type───┐
│ 11832096901709403633 │ UInt64 │
└──────────────────────┴────────┘
  ...
  FunctionDocumentation murmurHash3_64_documentation = {
      murmurHash3_64_description,    murmurHash3_64_syntax,   murmurHash3_64_arguments,     {},
      murmurHash3_64_returned_value, murmurHash3_64_examples, murmurHash3_64_introduced_in, murmurHash3_64_category};
...
Computes the 128-bit [MurmurHash3](https://github.com/aappleby/smhasher) hash of the input value.
  ...
  FunctionDocumentation::Arguments murmurHash3_128_arguments = {
      {"arg1[, arg2, ...]", "A variable number of input arguments for which to compute the hash.", {"Any"}}};
  FunctionDocumentation::ReturnedValue murmurHash3_128_returned_value = {
      "Returns the computed 128-bit `MurmurHash3` hash value of the input arguments.", {"FixedString(16)"}};
  FunctionDocumentation::Examples murmurHash3_128_examples = {{"Usage example", "SELECT hex(murmurHash3_128('foo', 'foo', 'foo'));",
                                                               R"(
...
└───────────────────────────────────────────┘
  ...
  FunctionDocumentation murmurHash3_128_documentation = {
      murmurHash3_128_description,    murmurHash3_128_syntax,   murmurHash3_128_arguments,     {},
      murmurHash3_128_returned_value, murmurHash3_128_examples, murmurHash3_128_introduced_in, murmurHash3_128_category};
...
It is portable between Clang and GCC builds.
  ...
  FunctionDocumentation::ReturnedValue gccMurmurHash_returned_value = {"Returns the calculated hash value of the input arguments.",
                                                                       {"UInt64"}};
  FunctionDocumentation::Examples gccMurmurHash_examples = {{"Usage example",
                                                             R"(
SELECT
...
└──────────────────────┴─────────────────────┘
  ...
  FunctionDocumentation gccMurmurHash_documentation = {
      gccMurmurHash_description,    gccMurmurHash_syntax,   gccMurmurHash_arguments,     {},
      gccMurmurHash_returned_value, gccMurmurHash_examples, gccMurmurHash_introduced_in, gccMurmurHash_category};
...
Calculates the 32-bit [MurmurHash2](https://github.com/aappleby/smhasher) hash of the input value using the same seed as used by [Kafka](https://github.com/apache/kafka/blob/461c5cfe056db0951d9b74f5adc45973670404d7/clients/src/main/java/org/apache/kafka/common/utils/Utils.java#L482) and without the highest bit to be compatible with [Default Partitioner](https://github.com/apache/kafka/blob/139f7709bd3f5926901a21e55043388728ccca78/clients/src/main/java/org/apache/kafka/clients/producer/internals/BuiltInPartitioner.java#L328).
  ...
  FunctionDocumentation::ReturnedValue kafkaMurmurHash_returned_value = {"Returns the calculated hash value of the input arguments.",
                                                                         {"UInt32"}};
  FunctionDocumentation::Examples kafkaMurmurHash_examples = {{"Usage example",
                                                               R"(
SELECT
...
└────────────┴──────────┘
  ...
  FunctionDocumentation kafkaMurmurHash_documentation = {
      kafkaMurmurHash_description,    kafkaMurmurHash_syntax,   kafkaMurmurHash_arguments,     {},
      kafkaMurmurHash_returned_value, kafkaMurmurHash_examples, kafkaMurmurHash_introduced_in, kafkaMurmurHash_category};
