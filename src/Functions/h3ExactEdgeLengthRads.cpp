...
Returns the exact edge length of the unidirectional edge represented by the input [H3](#h3-index) in radians.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the exact length of the H3 edge in radians.", {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Get exact edge length in radians",
