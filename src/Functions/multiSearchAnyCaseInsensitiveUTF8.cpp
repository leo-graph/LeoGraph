...
Like [multiSearchAnyUTF8](#multiSearchAnyUTF8) but ignores case.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns `1`, if there was at least one case-insensitive match, otherwise `0`, if there was not at least one case-insensitive match.",
      {"UInt8"}};
  FunctionDocumentation::Examples examples = {{"Given a UTF-8 string 'Здравствуйте', check if character 'з' (lowercase) is present",
