...
addYears(datetime, num)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `datetime` plus `num` years",
                                                         {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples = {{"Add years to different date types", R"(
WITH
