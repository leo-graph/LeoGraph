...
toRelativeMonthNum(date)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the number of months from a fixed reference point in the past.",
                                                         {"UInt32"}};
  FunctionDocumentation::Examples examples = {{"Get relative month numbers", R"(
