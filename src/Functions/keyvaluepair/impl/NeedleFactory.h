...
class NeedleFactory {
 public:
  static SearchSymbols getWaitKeyNeedles(const Configuration& extractor_configuration) {
    const auto& [key_value_delimiter, quoting_character, pair_delimiters, _] = extractor_configuration;
  ...
  static SearchSymbols getReadKeyNeedles(const Configuration& extractor_configuration) {
    const auto& [key_value_delimiter, quoting_character, pair_delimiters, unexpected_quoting_character_strategy] = extractor_configuration;
