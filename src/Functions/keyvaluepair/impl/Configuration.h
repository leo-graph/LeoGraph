...
class Configuration {
 public:
  enum class UnexpectedQuotingCharacterStrategy { INVALID, ACCEPT, PROMOTE };
 ...
 private:
  ...
  Configuration(char key_value_delimiter_, char quoting_character_, std::vector<char> pair_delimiters_,
