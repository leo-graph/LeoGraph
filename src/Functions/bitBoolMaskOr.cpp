...
struct NameBitBoolMaskOr {
  static constexpr auto name = "__bitBoolMaskOr";
};
using FunctionBitBoolMaskOr = BinaryArithmeticOverloadResolver<BitBoolMaskOrImpl, NameBitBoolMaskOr>;

}  // namespace

REGISTER_FUNCTION(BitBoolMaskOr) { factory.registerFunction<FunctionBitBoolMaskOr>(FunctionDocumentation::INTERNAL_FUNCTION_DOCS); }
