...
size_t checkAndGetTuplesSize(const DataTypePtr &lhs_type, const DataTypePtr &rhs_type, const String &function_name = {}) {
  ...
  if (left_types.size() != right_types.size())
    throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Expected tuples of the same size as arguments{}, got {} and {}",
...
struct MinusName {
  static constexpr auto name = "minus";
};
struct MultiplyName {
...
struct ModuloName {
  static constexpr auto name = "modulo";
};
struct IntDivName {
  static constexpr auto name = "intDiv";
};
struct IntDivOrZeroName {
  static constexpr auto name = "intDivOrZero";
};

struct L1Label {
  static constexpr auto name = "1";
};
struct L2Label {
  static constexpr auto name = "2";
};
struct L2SquaredLabel {
  static constexpr auto name = "2Squared";
};
struct LinfLabel {
  static constexpr auto name = "inf";
};
struct LpLabel {
  static constexpr auto name = "p";
};
...
class FunctionTupleOperator : public ITupleFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors mandatory_args{{"left_tuple", &isTuple, nullptr, "Tuple"}, {"right_tuple", &isTuple, nullptr, "Tuple"}};
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (tuple_size == 0) return ColumnTuple::create(input_rows_count);
...
class FunctionTupleNegate : public ITupleFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors mandatory_args{{"tuple", &isTuple, nullptr, "Tuple"}};
    ...
    if (arguments[0].column) cur_elements = getTupleElements(*arguments[0].column);
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (size_t i = 0; i < tuple_size; ++i) {
      ...
      auto elem_negate = negate->build(ColumnsWithTypeAndName{cur});
      columns[i] =
          elem_negate->execute({cur}, elem_negate->getResultType(), input_rows_count, /* dry_run = */ false)->convertToFullColumnIfConst();
    }
...
class FunctionTupleOperatorByNumber : public ITupleFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors mandatory_args{{"tuple", &isTuple, nullptr, "Tuple"}, {"value", nullptr, nullptr, "Any"}};
...
class FunctionDotProduct : public ITupleFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    if (arguments[0].column) left_elements = getTupleElements(*arguments[0].column);
    if (arguments[1].column) right_elements = getTupleElements(*arguments[1].column);

    if (left_types.size() != right_types.size())
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Expected tuples of the same size as arguments of function {}. Got {} and {}",
                      getName(), arguments[0].type->getName(), arguments[1].type->getName());

    size_t tuple_size = left_types.size();
    if (tuple_size == 0) return std::make_shared<DataTypeUInt8>();
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    size_t tuple_size = left_elements.size();
    if (tuple_size == 0) return DataTypeUInt8().createColumnConstWithDefaultValue(input_rows_count);
...
class FunctionDateOrDateTimeOperationTupleOfIntervals : public ITupleFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr context_) { return std::make_shared<FunctionDateOrDateTimeOperationTupleOfIntervals>(context_); }
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    Columns cur_elements;
    if (arguments[1].column) cur_elements = getTupleElements(*arguments[1].column);

    size_t tuple_size = cur_types.size();
    if (tuple_size == 0) return arguments[0].type;
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    size_t tuple_size = cur_elements.size();
    if (tuple_size == 0) return arguments[0].column;
...
struct FunctionTupleOperationInterval : public ITupleFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr context_) { return std::make_shared<FunctionTupleOperationInterval>(context_); }
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    if (!isTuple(arguments[0]) && !isInterval(arguments[0]))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of first argument of function {}, must be Tuple or Interval",
                      arguments[0]->getName(), getName());

    if (!isInterval(arguments[1]))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of second argument of function {}, must be Interval",
      ...
      for (const auto &type : cur_types)
        if (!isInterval(type))
          throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT,
                          "Illegal type {} of Tuple element of first argument of function {}, must be Interval", type->getName(),
                          getName());
    ...
    if (!types.empty()) {
      ...
      if (!interval_last->equals(*interval_new)) types.push_back(arguments[1]);
    }
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (first_interval) {
      ...
      for (size_t i = 0; i < tuple_size; ++i) tuple_columns[i] = cur_elements[i];
    } else
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of first argument of function {}, must be Tuple or Interval",
...
class FunctionLNorm<L2Label> : public FunctionL2SquaredNorm {
 ...
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    if (!cur_tuple)
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Argument 0 of function {} should be tuple, got {}", getName(),
...
class FunctionLNorm<LpLabel> : public ITupleFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors mandatory_args{{"tuple", &isTuple, nullptr, "Tuple"}, {"p", nullptr, nullptr, "Any"}};
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (!isColumnConst(*p_column.column) && p_column.column->size() != 1)
      throw Exception(ErrorCodes::ILLEGAL_COLUMN, "Second argument for function {} must be either constant Float64 or constant UInt",
                      getName());
    ...
    if (p < 1 || p >= HUGE_VAL)
      throw Exception(ErrorCodes::ARGUMENT_OUT_OF_BOUND, "Second argument for function {} must be not less than one and not be an infinity",
                      getName());
    ...
    ColumnWithTypeAndName inv_p_column{
        DataTypeFloat64().createColumnConst(input_rows_count, 1 / p), std::make_shared<DataTypeFloat64>(), {}};
...
class FunctionLDistance : public ITupleFunction {
 public:
  ...
  ColumnNumbers getArgumentsThatAreAlwaysConstant() const override {
    return FuncLabel::name[0] == 'p' ? ColumnNumbers{2} : ColumnNumbers{};
  }
...
class FunctionCosineDistance : public ITupleFunction {
 public:
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    size_t tuple_size = checkAndGetTuplesSize(arguments[0].type, arguments[1].type, getName());
    if (tuple_size == 0)
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Result of function {} is undefined for empty tuples", getName());
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (return_type->isNullable()) return return_type->createColumnConstWithDefaultValue(input_rows_count);

    FunctionDotProduct dot(context);
    ColumnWithTypeAndName dot_result{dot.executeImpl(arguments, DataTypePtr(), input_rows_count), dot.getReturnTypeImpl(arguments), {}};

    FunctionL2Norm norm(context);
    ColumnWithTypeAndName first_norm{
        norm.executeImpl({arguments[0]}, DataTypePtr(), input_rows_count), norm.getReturnTypeImpl({arguments[0]}), {}};
    ColumnWithTypeAndName second_norm{
        norm.executeImpl({arguments[1]}, DataTypePtr(), input_rows_count), norm.getReturnTypeImpl({arguments[1]}), {}};

    auto minus = FunctionFactory::instance().get("minus", context);
    auto multiply = FunctionFactory::instance().get("multiply", context);
    auto divide = FunctionFactory::instance().get("divide", context);

    ColumnWithTypeAndName one{DataTypeUInt8().createColumnConst(input_rows_count, 1), std::make_shared<DataTypeUInt8>(), {}};
    ...
    multiply_result.column =
        multiply_elem->execute({first_norm, second_norm}, multiply_result.type, input_rows_count, /* dry_run = */ false);
    ...
    divide_result.column = divide_elem->execute({dot_result, multiply_result}, divide_result.type, input_rows_count, /* dry_run = */ false);
...
class TupleOrArrayFunction : public IFunction {
 public:
  ...
  explicit TupleOrArrayFunction(ContextPtr context_)
      : IFunction(), tuple_function(Traits::CreateTupleFunction(context_)), array_function(Traits::CreateArrayFunction(context_)) {}
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    if constexpr (IsTransposedTrait<Traits>::value) {
      if (arguments.size() < 2)
        throw Exception(ErrorCodes::TOO_FEW_ARGUMENTS_FOR_FUNCTION, "Function {} requires at least 2 arguments, got {}", getName(),
                        arguments.size());
    }
    ...
    if constexpr (IsTransposedTrait<Traits>::value) {
      if (!is_array_or_qbit)
        throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Function {} requires Array, QBit, or FixedString as first argument, got {}",
...
Calculates the sum of corresponding elements of two tuples of the same size.
  ...
  FunctionDocumentation::Arguments arguments_tuplePlus = {{"t1", "First tuple.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}},
                                                          {"t2", "Second tuple.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}}};
  FunctionDocumentation::ReturnedValue returned_value_tuplePlus = {
      "Returns a tuple containing the sums of corresponding input tuple arguments.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  FunctionDocumentation::Examples examples_tuplePlus = {{"Basic usage", "SELECT tuplePlus((1, 2), (2, 3))", "(3, 5)"}};
  ...
  FunctionDocumentation documentation_tuplePlus = {
      description_tuplePlus,    syntax_tuplePlus,   arguments_tuplePlus,     {},
      returned_value_tuplePlus, examples_tuplePlus, introduced_in_tuplePlus, category_tuplePlus};
...
Calculates the difference between corresponding elements of two tuples of the same size.
  ...
  FunctionDocumentation::Arguments arguments_tupleMinus = {{"t1", "First tuple.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}},
                                                           {"t2", "Second tuple.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}}};
  FunctionDocumentation::ReturnedValue returned_value_tupleMinus = {"Returns a tuple containing the results  of the subtractions.",
                                                                    {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  FunctionDocumentation::Examples examples_tupleMinus = {{"Basic usage", "SELECT tupleMinus((1, 2), (2, 3))", "(-1, -1)"}};
  ...
  FunctionDocumentation documentation_tupleMinus = {
      description_tupleMinus,    syntax_tupleMinus,   arguments_tupleMinus,     {},
      returned_value_tupleMinus, examples_tupleMinus, introduced_in_tupleMinus, category_tupleMinus};
...
Calculates the multiplication of corresponding elements of two tuples of the same size.
  ...
  FunctionDocumentation::Arguments arguments_tupleMultiply = {
      ...
      {"t2", "Second tuple.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}}};
  FunctionDocumentation::ReturnedValue returned_value_tupleMultiply = {"Returns a tuple with the results of the multiplications.",
                                                                       {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  FunctionDocumentation::Examples examples_tupleMultiply = {{"Basic usage", "SELECT tupleMultiply((1, 2), (2, 3))", "(2, 6)"}};
  ...
  FunctionDocumentation documentation_tupleMultiply = {
      description_tupleMultiply,    syntax_tupleMultiply,   arguments_tupleMultiply,     {},
      returned_value_tupleMultiply, examples_tupleMultiply, introduced_in_tupleMultiply, category_tupleMultiply};
...
:::
  ...
  FunctionDocumentation::Arguments arguments_tupleDivide = {{"t1", "First tuple.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}},
                                                            {"t2", "Second tuple.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}}};
  FunctionDocumentation::ReturnedValue returned_value_tupleDivide = {"Returns tuple with the result of division.",
                                                                     {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  ...
  FunctionDocumentation documentation_tupleDivide = {
      description_tupleDivide,    syntax_tupleDivide,   arguments_tupleDivide,     {},
      returned_value_tupleDivide, examples_tupleDivide, introduced_in_tupleDivide, category_tupleDivide};
...
Returns a tuple of the remainders (moduli) of division operations of two tuples.
  ...
  FunctionDocumentation::ReturnedValue returned_value_tupleModulo = {
      "Returns tuple of the remainders of division. An error is thrown for division by zero.",
      {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  FunctionDocumentation::Examples examples_tupleModulo = {{"Basic usage", "SELECT tupleModulo((15, 10, 5), (5, 3, 2))", "(0, 1, 1)"}};
  ...
  FunctionDocumentation documentation_tupleModulo = {
      description_tupleModulo,    syntax_tupleModulo,   arguments_tupleModulo,     {},
      returned_value_tupleModulo, examples_tupleModulo, introduced_in_tupleModulo, category_tupleModulo};
...
Division by 0 causes an error to be thrown.
  ...
  FunctionDocumentation::ReturnedValue returned_value_tupleIntDiv = {"Returns a tuple of the quotients.",
                                                                     {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  ...
  FunctionDocumentation documentation_tupleIntDiv = {
      description_tupleIntDiv,    syntax_tupleIntDiv,   arguments_tupleIntDiv,     {},
      returned_value_tupleIntDiv, examples_tupleIntDiv, introduced_in_tupleIntDiv, category_tupleIntDiv};
...
If either tuple contains non-integer elements then the result is calculated by rounding to the nearest integer for each non-integer numerator or divisor.
  ...
  FunctionDocumentation::Arguments arguments_tupleIntDivOrZero = {
      {"tuple_num", "Tuple of numerator values.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}},
      {"tuple_div", "Tuple of divisor values.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}}};
  FunctionDocumentation::ReturnedValue returned_value_tupleIntDivOrZero = {
      "Returns tuple of the quotients. Returns 0 for quotients where the divisor is 0.",
      {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  ...
  FunctionDocumentation documentation_tupleIntDivOrZero = {
      description_tupleIntDivOrZero,    syntax_tupleIntDivOrZero,   arguments_tupleIntDivOrZero,     {},
      returned_value_tupleIntDivOrZero, examples_tupleIntDivOrZero, introduced_in_tupleIntDivOrZero, category_tupleIntDivOrZero};
...
Calculates the negation of the tuple elements.
  ...
  FunctionDocumentation::ReturnedValue returned_value_tupleNegate = {"Returns a tuple with the result of negation.",
                                                                     {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  FunctionDocumentation::Examples examples_tupleNegate = {{"Basic usage", "SELECT tupleNegate((1, 2))", "(-1, -2)"}};
  ...
  FunctionDocumentation documentation_tupleNegate = {
      description_tupleNegate,    syntax_tupleNegate,   arguments_tupleNegate,     {},
      returned_value_tupleNegate, examples_tupleNegate, introduced_in_tupleNegate, category_tupleNegate};
...
addTupleOfIntervals(datetime, intervals)
  ...
  FunctionDocumentation::ReturnedValue returned_value_addTupleOfIntervals = {"Returns `date` with added `intervals`",
                                                                             {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples_addTupleOfIntervals = {{"Add tuple of intervals to date", R"(
...
└──────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_addTupleOfIntervals = {
      description_addTupleOfIntervals,    syntax_addTupleOfIntervals,   arguments_addTupleOfIntervals,     {},
      returned_value_addTupleOfIntervals, examples_addTupleOfIntervals, introduced_in_addTupleOfIntervals, category_addTupleOfIntervals};
...
subtractTupleOfIntervals(datetime, intervals)
  ...
  FunctionDocumentation::ReturnedValue returned_value_subtractTupleOfIntervals = {"Returns `date` with subtracted `intervals`",
                                                                                  {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples_subtractTupleOfIntervals = {{"Subtract tuple of intervals from date",
                                                                        R"(
...
└──────────────────────────┘
  ...
  FunctionDocumentation documentation_subtractTupleOfIntervals = {
      description_subtractTupleOfIntervals,    syntax_subtractTupleOfIntervals,
      arguments_subtractTupleOfIntervals,      {},
      returned_value_subtractTupleOfIntervals, examples_subtractTupleOfIntervals,
      introduced_in_subtractTupleOfIntervals,  category_subtractTupleOfIntervals};
...
addInterval(interval_1, interval_2)
  ...
  FunctionDocumentation::Examples examples_addInterval = {{"Add intervals", R"(
...
└─────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_addInterval = {
      description_addInterval,    syntax_addInterval,   arguments_addInterval,     {},
      returned_value_addInterval, examples_addInterval, introduced_in_addInterval, category_addInterval};
...
subtractInterval(interval_1, interval_2)
  ...
  FunctionDocumentation::Examples examples_subtractInterval = {{"Subtract intervals", R"(
...
└──────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_subtractInterval = {
      description_subtractInterval,    syntax_subtractInterval,   arguments_subtractInterval,     {},
      returned_value_subtractInterval, examples_subtractInterval, introduced_in_subtractInterval, category_subtractInterval};
...
Returns a tuple with all elements multiplied by a number.
  ...
  FunctionDocumentation::ReturnedValue returned_value_tupleMultiplyByNumber = {"Returns a tuple with multiplied elements.",
                                                                               {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  ...
  FunctionDocumentation documentation_tupleMultiplyByNumber = {description_tupleMultiplyByNumber,    syntax_tupleMultiplyByNumber,
                                                               arguments_tupleMultiplyByNumber,      {},
                                                               returned_value_tupleMultiplyByNumber, examples_tupleMultiplyByNumber,
                                                               introduced_in_tupleMultiplyByNumber,  category_tupleMultiplyByNumber};
...
:::
  ...
  FunctionDocumentation::ReturnedValue returned_value_tupleDivideByNumber = {"Returns a tuple with divided elements.",
                                                                             {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  FunctionDocumentation::Examples examples_tupleDivideByNumber = {{"Basic usage", "SELECT tupleDivideByNumber((1, 2), 0.5)", "(2, 4)"}};
  ...
  FunctionDocumentation documentation_tupleDivideByNumber = {
      description_tupleDivideByNumber,    syntax_tupleDivideByNumber,   arguments_tupleDivideByNumber,     {},
      returned_value_tupleDivideByNumber, examples_tupleDivideByNumber, introduced_in_tupleDivideByNumber, category_tupleDivideByNumber};
...
Returns a tuple of the moduli (remainders) of division operations of a tuple and a given divisor.
  ...
  FunctionDocumentation::ReturnedValue returned_value_tupleModuloByNumber = {
      "Returns tuple of the remainders of division. An error is thrown for division by zero.",
      {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  ...
  FunctionDocumentation documentation_tupleModuloByNumber = {
      description_tupleModuloByNumber,    syntax_tupleModuloByNumber,   arguments_tupleModuloByNumber,     {},
      returned_value_tupleModuloByNumber, examples_tupleModuloByNumber, introduced_in_tupleModuloByNumber, category_tupleModuloByNumber};
...
An error will be thrown for division by 0.
  ...
  FunctionDocumentation::Arguments arguments_tupleIntDivByNumber = {
      {"tuple_num", "Tuple of numerator values.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}},
      {"div", "The divisor value.", {"(U)Int*", "Float*", "Decimal"}}};
  FunctionDocumentation::ReturnedValue returned_value_tupleIntDivByNumber = {"Returns a tuple of the quotients.",
                                                                             {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  ...
  FunctionDocumentation documentation_tupleIntDivByNumber = {
      description_tupleIntDivByNumber,    syntax_tupleIntDivByNumber,   arguments_tupleIntDivByNumber,     {},
      returned_value_tupleIntDivByNumber, examples_tupleIntDivByNumber, introduced_in_tupleIntDivByNumber, category_tupleIntDivByNumber};
...
If either the tuple or div contain non-integer elements then the result is calculated by rounding to the nearest integer for each non-integer numerator or divisor.
  ...
  FunctionDocumentation::Arguments arguments_tupleIntDivOrZeroByNumber = {
      {"tuple_num", "Tuple of numerator values.", {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}},
      {"div", "The divisor value.", {"(U)Int*", "Float*", "Decimal"}}};
  FunctionDocumentation::ReturnedValue returned_value_tupleIntDivOrZeroByNumber = {
      "Returns a tuple of the quotients with `0` for quotients where the divisor is `0`.",
      {"Tuple((U)Int*)", "Tuple(Float*)", "Tuple(Decimal)"}};
  ...
  FunctionDocumentation documentation_tupleIntDivOrZeroByNumber = {
      ...
      arguments_tupleIntDivOrZeroByNumber,      {},
      returned_value_tupleIntDivOrZeroByNumber, examples_tupleIntDivOrZeroByNumber,
      introduced_in_tupleIntDivOrZeroByNumber,  category_tupleIntDivOrZeroByNumber};
...
Returns the sum of the products of the corresponding elements.
  ...
  FunctionDocumentation::ReturnedValue returned_value_dotProduct = {"Returns the dot product of the two vectors.",
                                                                    {"(U)Int*", "Float*", "Decimal"}};
  FunctionDocumentation::Examples examples_dotProduct = {{"Basic usage", "SELECT dotProduct((1, 2), (3, 4))", "11"}};
  ...
  FunctionDocumentation documentation_dotProduct = {
      description_dotProduct,    syntax_dotProduct,   arguments_dotProduct,     {},
      returned_value_dotProduct, examples_dotProduct, introduced_in_dotProduct, category_dotProduct};
...
Calculates the sum of absolute elements of a vector.
  ...
  FunctionDocumentation::Arguments arguments_l1_norm = {{"vector", "Vector or tuple of numeric values.", {"Array(T)", "Tuple(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_l1_norm = {
      "Returns the L1-norm or [taxicab geometry](https://en.wikipedia.org/wiki/Taxicab_geometry) distance.",
      {"UInt*", "Float*", "Decimal"}};
  FunctionDocumentation::Examples examples_l1_norm = {{"Basic usage",
                                                       R"(
SELECT L1Norm((1, 2))
            )",
                                                       R"(
...
└────────────────┘
  ...
  FunctionDocumentation documentation_l1_norm = {description_l1_norm,    syntax_l1_norm,   arguments_l1_norm,     {},
                                                 returned_value_l1_norm, examples_l1_norm, introduced_in_l1_norm, category_l1_norm};
...
Calculates the square root of the sum of the squares of the vector elements.
  ...
  FunctionDocumentation::Arguments arguments_l2_norm = {{"vector", "Vector or tuple of numeric values.", {"Tuple(T)", "Array(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_l2_norm = {
      "Returns the L2-norm or [Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance).", {"UInt*", "Float*"}};
  FunctionDocumentation::Examples examples_l2_norm = {{"Basic usage",
                                                       R"(
SELECT L2Norm((1, 2))
            )",
                                                       R"(
...
└──────────────────┘
  ...
  FunctionDocumentation documentation_l2_norm = {description_l2_norm,    syntax_l2_norm,   arguments_l2_norm,     {},
                                                 returned_value_l2_norm, examples_l2_norm, introduced_in_l2_norm, category_l2_norm};
...
Calculates the square root of the sum of the squares of the vector elements (the [`L2Norm`](#L2Norm)) squared.
  ...
  FunctionDocumentation::Arguments arguments_l2_squared_norm = {{"vector", "Vector or tuple of numeric values.", {"Array(T)", "Tuple(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_l2_squared_norm = {"Returns the L2-norm squared.", {"UInt*", "Float*", "Decimal"}};
  FunctionDocumentation::Examples examples_l2_squared_norm = {{"Basic usage",
                                                               R"(
...
└───────────────────────┘
  ...
  FunctionDocumentation documentation_l2_squared_norm = {
      description_l2_squared_norm,    syntax_l2_squared_norm,   arguments_l2_squared_norm,     {},
      returned_value_l2_squared_norm, examples_l2_squared_norm, introduced_in_l2_squared_norm, category_l2_squared_norm};
...
Calculates the maximum of absolute elements of a vector.
  ...
  FunctionDocumentation::Arguments arguments_linf_norm = {{"vector", "Vector or tuple of numeric values.", {"Array(T)", "Tuple(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_linf_norm = {"Returns the Linf-norm or the maximum absolute value.", {"Float64"}};
  FunctionDocumentation::Examples examples_linf_norm = {{"Basic usage",
                                                         R"(
SELECT LinfNorm((1, -2))
            )",
                                                         R"(
...
└───────────────────┘
  ...
  FunctionDocumentation documentation_linf_norm = {
      description_linf_norm,    syntax_linf_norm,   arguments_linf_norm,     {},
      returned_value_linf_norm, examples_linf_norm, introduced_in_linf_norm, category_linf_norm};
...
- When p=∞, it's equivalent to LinfNorm (maximum norm).
  ...
  FunctionDocumentation::ReturnedValue returned_value_lp_norm = {
      "Returns the [Lp-norm](https://en.wikipedia.org/wiki/Norm_(mathematics)#p-norm).", {"Float64"}};
  FunctionDocumentation::Examples examples_lp_norm = {{"Basic usage",
                                                       R"(
SELECT LpNorm((1, -2), 2)
            )",
                                                       R"(
...
└────────────────────┘
  ...
  FunctionDocumentation documentation_lp_norm = {description_lp_norm,    syntax_lp_norm,   arguments_lp_norm,     {},
                                                 returned_value_lp_norm, examples_lp_norm, introduced_in_lp_norm, category_lp_norm};
...
Calculates the distance between two points (the elements of the vectors are the coordinates) in `L1` space (1-norm ([taxicab geometry](https://en.wikipedia.org/wiki/Taxicab_geometry) distance)).
  ...
  FunctionDocumentation::Arguments arguments_l1_distance = {{"vector1", "First vector.", {"Tuple(T)", "Array(T)"}},
  ...
  FunctionDocumentation::Examples examples_l1_distance = {{"Basic usage",
                                                           R"(
...
└────────────────────────────┘
  ...
  FunctionDocumentation documentation_l1_distance = {
      description_l1_distance,    syntax_l1_distance,   arguments_l1_distance,     {},
      returned_value_l1_distance, examples_l1_distance, introduced_in_l1_distance, category_l1_distance};
...
Calculates the distance between two points (the elements of the vectors are the coordinates) in Euclidean space ([Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance)).
  ...
  FunctionDocumentation::Arguments arguments_l2_distance = {{"vector1", "First vector.", {"Tuple(T)", "Array(T)"}},
                                                            {"vector2", "Second vector.", {"Tuple(T)", "Array(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_l2_distance = {"Returns the 2-norm distance.", {"Float64"}};
  FunctionDocumentation::Examples examples_l2_distance = {{"Basic usage",
                                                           R"(
...
└────────────────────────────┘
  ...
  FunctionDocumentation documentation_l2_distance = {
      description_l2_distance,    syntax_l2_distance,   arguments_l2_distance,     {},
      returned_value_l2_distance, examples_l2_distance, introduced_in_l2_distance, category_l2_distance};
...
Calculates the sum of the squares of the difference between the corresponding elements of two vectors.
  ...
  FunctionDocumentation::Arguments arguments_l2_squared_distance = {{"vector1", "First vector.", {"Tuple(T)", "Array(T)"}},
                                                                    {"vector2", "Second vector.", {"Tuple(T)", "Array(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_l2_squared_distance = {
      "Returns the sum of the squares of the difference between the corresponding elements of two vectors.", {"Float64"}};
  FunctionDocumentation::Examples examples_l2_squared_distance = {{"Basic usage",
                                                                   R"(
...
└──────────────────────────┘
  ...
  FunctionDocumentation documentation_l2_squared_distance = {
      description_l2_squared_distance,    syntax_l2_squared_distance,   arguments_l2_squared_distance,     {},
      returned_value_l2_squared_distance, examples_l2_squared_distance, introduced_in_l2_squared_distance, category_l2_squared_distance};
...
Calculates the distance between two points (the elements of the vectors are the coordinates) in `L_{inf}` space ([maximum norm](https://en.wikipedia.org/wiki/Norm_(mathematics)#Maximum_norm_(special_case_of:_infinity_norm,_uniform_norm,_or_supremum_norm))).
  ...
  FunctionDocumentation::Arguments arguments_linf_distance = {{"vector1", "First vector.", {"Tuple(T)", "Array(T)"}},
                                                              {"vector2", "Second vector.", {"Tuple(T)", "Array(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_linf_distance = {"Returns the Infinity-norm distance.", {"Float64"}};
  FunctionDocumentation::Examples examples_linf_distance = {{"Basic usage",
                                                             R"(
...
└──────────────────────────────┘
  ...
  FunctionDocumentation documentation_linf_distance = {
      description_linf_distance,    syntax_linf_distance,   arguments_linf_distance,     {},
      returned_value_linf_distance, examples_linf_distance, introduced_in_linf_distance, category_linf_distance};
...
Calculates the distance between two points (the elements of the vectors are the coordinates) in `Lp` space ([p-norm distance](https://en.wikipedia.org/wiki/Norm_(mathematics)#p-norm)).
  ...
  FunctionDocumentation::Examples examples_lp_distance = {{"Basic usage",
                                                           R"(
...
└───────────────────────────────┘
  ...
  FunctionDocumentation documentation_lp_distance = {
      description_lp_distance,    syntax_lp_distance,   arguments_lp_distance,     {},
      returned_value_lp_distance, examples_lp_distance, introduced_in_lp_distance, category_lp_distance};
...
Calculates the [cosine distance](https://en.wikipedia.org/wiki/Cosine_similarity#Cosine_distance) between two vectors (the elements of the tuples are the coordinates). The smaller the returned value is, the more similar are the vectors.
  ...
  FunctionDocumentation::Arguments arguments_cosine_distance = {{"vector1", "First tuple.", {"Tuple(T)", "Array(T)"}},
                                                                {"vector2", "Second tuple.", {"Tuple(T)", "Array(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_cosine_distance = {
      "Returns the cosine of the angle between two vectors subtracted from one.", {"Float64"}};
  FunctionDocumentation::Examples examples_cosine_distance = {{"Basic usage",
                                                               R"(
...
└────────────────────────────────┘
  ...
  FunctionDocumentation documentation_cosine_distance = {
      description_cosine_distance,    syntax_cosine_distance,   arguments_cosine_distance,     {},
      returned_value_cosine_distance, examples_cosine_distance, introduced_in_cosine_distance, category_cosine_distance};
...
Calculates the approximate distance between two points (the values of the vectors are the coordinates) in Euclidean space ([Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance)).
  ...
  FunctionDocumentation::Arguments arguments_l2_distance_transposed = {
      ...
      {"p",
       ...
       "controls the precision-speed trade-off. Using fewer bits results in faster I/O and calculations with reduced accuracy, while using "
       "more bits increases accuracy at the cost of performance.",
       {"UInt"}}};
  ...
  FunctionDocumentation::Examples examples_l2_distance_transposed = {{"Basic usage",
                                                                      R"(
...
└──────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_l2_distance_transposed = {description_l2_distance_transposed,    syntax_l2_distance_transposed,
                                                                arguments_l2_distance_transposed,      {},
                                                                returned_value_l2_distance_transposed, examples_l2_distance_transposed,
                                                                introduced_in_l2_distance_transposed,  category_l2_distance_transposed};
...
Calculates the approximate [cosine distance](https://en.wikipedia.org/wiki/Cosine_similarity#Cosine_distance) between two points (the values of the vectors are the coordinates). The smaller the returned value is, the more similar are the vectors.
  ...
  FunctionDocumentation::Examples examples_cosine_distance_transposed = {{"Basic usage",
                                                                          R"(
CREATE TABLE qbit (id UInt32, vec QBit(Float64, 2)) ENGINE = Memory;
INSERT INTO qbit VALUES (1, [0, 1]);
...
└──────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_cosine_distance_transposed = {
      description_cosine_distance_transposed,    syntax_cosine_distance_transposed,
      arguments_cosine_distance_transposed,      {},
      returned_value_cosine_distance_transposed, examples_cosine_distance_transposed,
      introduced_in_cosine_distance_transposed,  category_cosine_distance_transposed};
...
Calculates the unit vector of a given vector (the elements of the tuple are the coordinates) in `L1` space ([taxicab geometry](https://en.wikipedia.org/wiki/Taxicab_geometry)).
  ...
  FunctionDocumentation::Arguments arguments_l1_normalize = {{"tuple", "A tuple of numeric values.", {"Tuple(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_l1_normalize = {"Returns the unit vector.", {"Tuple(Float64)"}};
  FunctionDocumentation::Examples examples_l1_normalize = {{"Basic usage",
                                                            R"(
...
└─────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_l1_normalize = {
      description_l1_normalize,    syntax_l1_normalize,   arguments_l1_normalize,     {},
      returned_value_l1_normalize, examples_l1_normalize, introduced_in_l1_normalize, category_l1_normalize};
...
Calculates the unit vector of a given vector (the elements of the tuple are the coordinates) in Euclidean space (using [Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance)).
  ...
  FunctionDocumentation::Arguments arguments_l2_normalize = {{"tuple", "A tuple of numeric values.", {"Tuple(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_l2_normalize = {"Returns the unit vector.", {"Tuple(Float64)"}};
  FunctionDocumentation::Examples examples_l2_normalize = {{"Basic usage",
                                                            R"(
...
└─────────────────────┘
  ...
  FunctionDocumentation documentation_l2_normalize = {
      description_l2_normalize,    syntax_l2_normalize,   arguments_l2_normalize,     {},
      returned_value_l2_normalize, examples_l2_normalize, introduced_in_l2_normalize, category_l2_normalize};
...
Calculates the unit vector of a given vector (the elements of the tuple are the coordinates) in `L_{inf}` space (using [maximum norm](https://en.wikipedia.org/wiki/Norm_(mathematics)#Maximum_norm_(special_case_of:_infinity_norm,_uniform_norm,_or_supremum_norm))).
  ...
  FunctionDocumentation::Arguments arguments_linf_normalize = {{"tuple", "A tuple of numeric values.", {"Tuple(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_linf_normalize = {"Returns the unit vector.", {"Tuple(Float64)"}};
  FunctionDocumentation::Examples examples_linf_normalize = {{"Basic usage",
                                                              R"(
...
└───────────────────────┘
  ...
  FunctionDocumentation documentation_linf_normalize = {
      description_linf_normalize,    syntax_linf_normalize,   arguments_linf_normalize,     {},
      returned_value_linf_normalize, examples_linf_normalize, introduced_in_linf_normalize, category_linf_normalize};
...
Calculates the unit vector of a given vector (the elements of the tuple are the coordinates) in `Lp` space (using [p-norm](https://en.wikipedia.org/wiki/Norm_(mathematics)#p-norm)).
    ...
    FunctionDocumentation::Examples examples_lp_normalize = {{"Usage example",
                                                              R"(
...
└─────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_lp_normalize = {
        description_lp_normalize,    syntax_lp_normalize,   arguments_lp_normalize,     {},
        returned_value_lp_normalize, examples_lp_normalize, introduced_in_lp_normalize, category_lp_normalize};
