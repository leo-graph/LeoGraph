...
Converts an ASCII string to lowercase.
  ...
  FunctionDocumentation::Arguments arguments = {{"s", "A string to convert to lowercase.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a lowercase string from `s`.", {"String"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT lower('CLICKHOUSE')",
                                               R"(
┌─lower('CLICKHOUSE')─┐
│ clickhouse          │
└─────────────────────┘
