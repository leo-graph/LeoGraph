...
class OpenSSLProvider {
 public:
  ...
  OpenSSLProvider() : ctx_template(EVP_MD_CTX_new(), &EVP_MD_CTX_free) {
    ...
    if (!ctx_template) throw Exception(ErrorCodes::OPENSSL_ERROR, "EVP_MD_CTX_new failed: {}", getOpenSSLErrors());
  ...
  void apply(const char *begin, size_t size, unsigned char *out_char_data) {
    if (!ctx_template) throw Exception(ErrorCodes::LOGICAL_ERROR, "No context provided");
...
struct SHA512Impl {
  ...
  static constexpr bool available_in_fips_mode = true;
  enum { length = SHA512_DIGEST_LENGTH };
};
...
struct RIPEMD160Impl {
  ...
  static constexpr bool available_in_fips_mode = false;
  enum { length = RIPEMD160_DIGEST_LENGTH };
};
#endif
...
class GenericProvider {
 public:
  ...
  void apply(const char *begin, size_t size, unsigned char *out_char_data) { Impl::apply(begin, size, out_char_data); }
};
...
struct ImplBLAKE3 {
  ...
  static void apply(const char *begin, size_t size, unsigned char *out_char_data) {
    ...
    llvm::BLAKE3 hasher;
    if (size > 0) hasher.update(llvm::StringRef(begin, size));
    hasher.final(result);
  }
};
...
struct Keccak256Impl {
  ...
  static void apply(const char *begin, size_t size, unsigned char *out_char_data) {
    sha3_HashBuffer(256, SHA3_FLAGS_KECCAK, begin, static_cast<unsigned>(size), out_char_data,
                    static_cast<unsigned>(Keccak256Impl::length));
  }
};
#endif
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (const ColumnString *col_from = checkAndGetColumn<ColumnString>(arguments[0].column.get())) {
      ...
      for (size_t i = 0; i < input_rows_count; ++i) {
        hasher.apply(reinterpret_cast<const char *>(&data[current_offset]), offsets[i] - current_offset,
    ...
    if (const ColumnFixedString *col_from_fix = checkAndGetColumn<ColumnFixedString>(arguments[0].column.get())) {
      ...
      chars_to.resize(input_rows_count * Impl::length);
      for (size_t i = 0; i < input_rows_count; ++i) {
        hasher.apply(reinterpret_cast<const char *>(&data[i * length]), length, reinterpret_cast<uint8_t *>(&chars_to[i * Impl::length]));
      }
      return col_to;
    }
    ...
    if (const ColumnIPv6 *col_from_ip = checkAndGetColumn<ColumnIPv6>(arguments[0].column.get())) {
      ...
      chars_to.resize(input_rows_count * Impl::length);
      for (size_t i = 0; i < input_rows_count; ++i) {
        hasher.apply(reinterpret_cast<const char *>(&data[i]), length, reinterpret_cast<uint8_t *>(&chars_to[i * Impl::length]));
      }
      return col_to;
    }
...
#  if USE_SSL
  ...
  FunctionDocumentation::Arguments arguments_RIPEMD160 = {{"s", "The input string to hash.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_RIPEMD160 = {
      "Returns the RIPEMD160 hash of the given input string as a fixed-length string.", {"FixedString(20)"}};
  FunctionDocumentation::Examples example_RIPEMD160 = {{"Usage example",
                                                        R"(
...
└───────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_RIPEMD160 = {
      description_RIPEMD160,    syntax_RIPEMD160,  arguments_RIPEMD160,     {},
      returned_value_RIPEMD160, example_RIPEMD160, introduced_in_RIPEMD160, category_RIPEMD160};
...
Calculates the MD4 hash of the given string.
  ...
  FunctionDocumentation::Arguments arguments_MD4 = {{"s", "The input string to hash.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_MD4 = {"Returns the MD4 hash of the given input string as a fixed-length string.",
                                                             {"FixedString(16)"}};
  FunctionDocumentation::Examples example_MD4 = {{"Usage example",
                                                  R"(
SELECT HEX(MD4('abc'));
        )",
                                                  R"(
...
└──────────────────────────────────┘
  ...
  FunctionDocumentation documentation_MD4 = {description_MD4,    syntax_MD4,  arguments_MD4,     {},
                                             returned_value_MD4, example_MD4, introduced_in_MD4, category_MD4};
...
Calculates the MD5 hash of the given string.
  ...
  FunctionDocumentation::ReturnedValue returned_value_MD5 = {"Returns the MD5 hash of the given input string as a fixed-length string.",
                                                             {"FixedString(16)"}};
  FunctionDocumentation::Examples example_MD5 = {{"Usage example",
                                                  R"(
SELECT HEX(MD5('abc'));
        )",
                                                  R"(
...
└──────────────────────────────────┘
  ...
  FunctionDocumentation documentation_MD5 = {description_MD5,    syntax_MD5,  arguments_MD5,     {},
                                             returned_value_MD5, example_MD5, introduced_in_MD5, category_MD5};
...
Calculates the SHA1 hash of the given string.
  ...
  FunctionDocumentation::ReturnedValue returned_value_SHA1 = {"Returns the SHA1 hash of the given input string as a fixed-length string.",
                                                              {"FixedString(20)"}};
  FunctionDocumentation::Examples example_SHA1 = {{"Usage example",
                                                   R"(
SELECT HEX(SHA1('abc'));
        )",
                                                   R"(
...
└──────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_SHA1 = {description_SHA1,    syntax_SHA1,  arguments_SHA1,     {},
                                              returned_value_SHA1, example_SHA1, introduced_in_SHA1, category_SHA1};
...
Calculates the SHA224 hash of the given string.
  ...
  FunctionDocumentation::Arguments arguments_SHA224 = {{"s", "The input value to hash.", {"String"}}};
  ...
  FunctionDocumentation::Examples example_SHA224 = {{"Usage example",
                                                     R"(
...
└──────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_SHA224 = {description_SHA224,    syntax_SHA224,  arguments_SHA224,     {},
                                                returned_value_SHA224, example_SHA224, introduced_in_SHA224, category_SHA224};
...
Calculates the SHA256 hash of the given string.
  ...
  FunctionDocumentation::Arguments arguments_SHA256 = {{"s", "The input string to hash.", {"String"}}};
  ...
  FunctionDocumentation::Examples example_SHA256 = {{"Usage example",
                                                     R"(
...
└──────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_SHA256 = {description_SHA256,    syntax_SHA256,  arguments_SHA256,     {},
                                                returned_value_SHA256, example_SHA256, introduced_in_SHA256, category_SHA256};
...
Calculates the SHA384 hash of the given string.
  ...
  FunctionDocumentation::Arguments arguments_SHA384 = {{"s", "The input string to hash.", {"String"}}};
  ...
  FunctionDocumentation::Examples examples_SHA384 = {{"Usage example", "SELECT HEX(SHA384('abc'));",
                                                      R"(
┌─hex(SHA384('abc'))───────────────────────────────────────────────────────────────────────────────┐
...
└──────────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_SHA384 = {description_SHA384,    syntax_SHA384,   arguments_SHA384,     {},
                                                returned_value_SHA384, examples_SHA384, introduced_in_SHA384, category_SHA384};
...
Calculates the SHA512 hash of the given string.
  ...
  FunctionDocumentation::Arguments arguments_SHA512 = {{"s", "The input string to hash", {"String"}}};
  ...
  FunctionDocumentation::Examples example_SHA512 = {{"Usage example",
                                                     R"(
...
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_SHA512 = {description_SHA512,    syntax_SHA512,  arguments_SHA512,     {},
                                                returned_value_SHA512, example_SHA512, introduced_in_SHA512, category_SHA512};
...
Calculates the SHA512_256 hash of the given string.
  ...
  FunctionDocumentation::Arguments arguments_SHA512_256 = {{"s", "The input string to hash.", {"String"}}};
  ...
  FunctionDocumentation::Examples example_SHA512_256 = {{"Usage example",
                                                         R"(
...
└──────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_SHA512_256 = {
      description_SHA512_256,    syntax_SHA512_256,  arguments_SHA512_256,     {},
      returned_value_SHA512_256, example_SHA512_256, introduced_in_SHA512_256, category_SHA512_256};
...
It returns a BLAKE3 hash as a byte array with type FixedString(32).
  ...
  FunctionDocumentation::Arguments arguments_BLAKE3 = {{"message", "The input string to hash.", {"String"}}};
  ...
  FunctionDocumentation::Examples example_BLAKE3 = {{"hash",
                                                     R"(
...
└──────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_BLAKE3 = {description_BLAKE3,    syntax_BLAKE3,  arguments_BLAKE3,     {},
                                                returned_value_BLAKE3, example_BLAKE3, introduced_in_BLAKE3, category_BLAKE3};
...
This hash function is widely used in blockchain applications, particularly Ethereum.
  ...
  FunctionDocumentation::Arguments arguments_keccak256 = {{"message", "The input string to hash.", {"String"}}};
  ...
  FunctionDocumentation::Examples example_keccak256 = {{"Usage example",
                                                        R"(
...
└──────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_keccak256 = {
      description_keccak256,    syntax_keccak256,  arguments_keccak256,     {},
      returned_value_keccak256, example_keccak256, introduced_in_keccak256, category_keccak256};
