...
subtractSeconds(datetime, num)
  ...
  FunctionDocumentation::Arguments arguments = {{"datetime",
                                                 "Date or date with time to subtract specified number of seconds from.",
  ...
  FunctionDocumentation::Examples examples = {{"Subtract seconds from different date types", R"(
WITH
