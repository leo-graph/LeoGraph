...
fromModifiedJulianDay(day)
  ...
  FunctionDocumentation::Examples examples_fromModifiedJulianDay = {{"Convert Modified Julian Day to date", R"(
...
└──────────────────────────────┘
  ...
  FunctionDocumentation documentation_fromModifiedJulianDay = {description_fromModifiedJulianDay,    syntax_fromModifiedJulianDay,
                                                               arguments_fromModifiedJulianDay,      {},
                                                               returned_value_fromModifiedJulianDay, examples_fromModifiedJulianDay,
                                                               introduced_in_fromModifiedJulianDay,  category_fromModifiedJulianDay};
...
fromModifiedJulianDayOrNull(day)
  ...
  FunctionDocumentation::ReturnedValue returned_value_fromModifiedJulianDayOrNull = {
      "Returns date in text form for valid `day` argument, otherwise `null`.", {"Nullable(String)"}};
  FunctionDocumentation::Examples examples_fromModifiedJulianDayOrNull = {{"Convert Modified Julian Day to date with null handling", R"(
...
└──────────────────────────┘
  ...
  FunctionDocumentation documentation_fromModifiedJulianDayOrNull = {
      description_fromModifiedJulianDayOrNull,    syntax_fromModifiedJulianDayOrNull,
      arguments_fromModifiedJulianDayOrNull,      {},
      returned_value_fromModifiedJulianDayOrNull, examples_fromModifiedJulianDayOrNull,
      introduced_in_fromModifiedJulianDayOrNull,  category_fromModifiedJulianDayOrNull};

  factory.registerFunction<FromModifiedJulianDayOverloadResolver<NameFromModifiedJulianDayOrNull, true>>(
      documentation_fromModifiedJulianDayOrNull);
}
}  // namespace DB
