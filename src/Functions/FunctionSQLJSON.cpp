...
If the value does not exist, `0` will be returned.
    ...
    FunctionDocumentation::Arguments arguments = {{"json", "A string with valid JSON.", {"String"}},
                                                  {"path", "A string representing the path.", {"String"}}};
    FunctionDocumentation::ReturnedValue returned_value = {"Returns `1` if the value exists in the JSON document, otherwise `0`.",
                                                           {"UInt8"}};
