...
toTimeWithFixedDate(date[, timezone])
  ...
  FunctionDocumentation::Arguments arguments = {{"date", "Date to convert to a time.", {"Date", "DateTime", "DateTime64"}},
                                                {"timezone", "Optional. Timezone for the returned value.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns the time component of a date or date with time in the form of an offset to a fixed point in time (selected as 1970-01-02, "
      "currently).",
      {"DateTime"}};
  FunctionDocumentation::Examples examples = {{"Calculate the time difference between two dates", R"(
