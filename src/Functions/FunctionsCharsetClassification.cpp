...
Float64 naiveBayes(const FrequencyHolder::EncodingMap& standard, const ModelMap& model, Float64 max_result) {
  Float64 res = 0;
...
template <typename ModelMap>
void calculateStats(const UInt8* data, const size_t size, ModelMap& model) {
  UInt16 hash = 0;
...
Detects the character set of a non-UTF8-encoded input string.
  ...
  FunctionDocumentation::Arguments arguments_charset = {{"s", "The text to analyze.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_charset = {"Returns a string containing the code of the detected character set",
                                                                 {"String"}};
  ...
  FunctionDocumentation documentation_charset = {description_charset,    syntax_charset,   arguments_charset,     {},
                                                 returned_value_charset, examples_charset, introduced_in_charset, category_charset};
...
Prefer this version when your character set is UTF-16 or UTF-32.
  ...
  FunctionDocumentation::Arguments arguments_unknown = {{"s", "The text to analyze.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_unknown = {
  ...
  FunctionDocumentation documentation_unknown = {description_unknown,    syntax_unknown,   arguments_unknown,     {},
                                                 returned_value_unknown, examples_unknown, introduced_in_unknown, category_unknown};
