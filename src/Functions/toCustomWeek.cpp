...
toWeek(datetime[, mode[, time_zone]])
  ...
  FunctionDocumentation::Examples examples_toWeek = {{"Get week numbers with different modes", R"(
...
└────────────┴───────┴───────┴───────┘
  ...
  FunctionDocumentation documentation_toWeek = {description_toWeek,    syntax_toWeek,   arguments_toWeek,     {},
                                                returned_value_toWeek, examples_toWeek, introduced_in_toWeek, category_toWeek};
...
toYearWeek(datetime[, mode[, timezone]])
  ...
  FunctionDocumentation::ReturnedValue returned_value_toYearWeek = {"Returns year and week number as a combined integer value.",
                                                                    {"UInt32"}};
  FunctionDocumentation::Examples examples_toYearWeek = {{"Get year-week combinations with different modes", R"(
...
└────────────┴───────────┴───────────┴───────────┴───────────────┘
  ...
  FunctionDocumentation documentation_toYearWeek = {
      description_toYearWeek,    syntax_toYearWeek,   arguments_toYearWeek,     {},
      returned_value_toYearWeek, examples_toYearWeek, introduced_in_toYearWeek, category_toYearWeek};
...
toStartOfWeek(datetime[, mode[, timezone]])
  ...
  FunctionDocumentation::ReturnedValue returned_value_to_start_of_week = {
      "Returns the date of the nearest Sunday or Monday on, or prior to, the given date, depending on the mode",
      {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples_to_start_of_week = {{"Round down to the nearest Sunday or Monday", R"(
    SELECT
  ...
  FunctionDocumentation documentation_to_start_of_week = {
      description_to_start_of_week,    syntax_to_start_of_week,   arguments_to_start_of_week,     {},
      returned_value_to_start_of_week, examples_to_start_of_week, introduced_in_to_start_of_week, category_to_start_of_week};
...
:::
  ...
  FunctionDocumentation::ReturnedValue returned_value_to_last_day_of_week = {
      "Returns the date of the nearest Saturday or Sunday, on or after the given date, depending on the mode",
      {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples_to_last_day_of_week = {{"Round up to the nearest Saturday or Sunday", R"(
SELECT
...
toLastDayOfWeek(toDate('2023-04-23'), 1):                2023-04-23
  ...
  FunctionDocumentation documentation_to_last_day_of_week = {
      description_to_last_day_of_week,    syntax_to_last_day_of_week,   arguments_to_last_day_of_week,     {},
      returned_value_to_last_day_of_week, examples_to_last_day_of_week, introduced_in_to_last_day_of_week, category_to_last_day_of_week};
