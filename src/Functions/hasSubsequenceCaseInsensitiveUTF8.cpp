...
using FunctionHasSubsequenceCaseInsensitiveUTF8 =
    HasSubsequenceImpl<NameHasSubsequenceCaseInsensitiveUTF8, HasSubsequenceCaseInsensitiveUTF8>;
}  // namespace
...
REGISTER_FUNCTION(hasSubsequenceCaseInsensitiveUTF8) {
  ...
  FunctionDocumentation::Arguments arguments = {{"haystack", "UTF8-encoded string in which the search is performed.", {"String"}},
  ...
  FunctionDocumentation::Examples examples = {
      {"Usage example", "SELECT hasSubsequenceCaseInsensitiveUTF8('ClickHouse - столбцовая система управления базами данных', 'СИСТЕМА');",
       R"(
