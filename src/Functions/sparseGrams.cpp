...
Uses `CRC32` as a hash function.
  ...
  FunctionDocumentation::Examples examples_sparse = {{"Usage example", "SELECT sparseGrams('alice', 3)",
                                                      R"(
┌─sparseGrams('alice', 3)────────────┐
│ ['ali','lic','lice','ice']         │
└────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_sparse = {description_sparse,    syntax_sparse,   arguments_sparse, {},
                                                returned_value_sparse, examples_sparse, introduced_in,    category};
...
Uses `CRC32` as a hash function.
  ...
  FunctionDocumentation::Examples examples_sparse_utf8 = {{"Usage example", "SELECT sparseGramsUTF8('алиса', 3)",
                                                           R"(
┌─sparseGramsUTF8('алиса', 3)─┐
│ ['али','лис','иса']         │
└─────────────────────────────┘
        )"}};
  FunctionDocumentation documentation_sparse_utf8 = {description_sparse_utf8,    syntax_sparse_utf8,   arguments_sparse, {},
                                                     returned_value_sparse_utf8, examples_sparse_utf8, introduced_in,    category};
