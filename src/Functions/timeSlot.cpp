...
timeSlot(time[, time_zone])
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the time rounded to the start of a half-an-hour length interval.",
                                                         {"DateTime"}};
  FunctionDocumentation::Examples examples = {{"Round time to half-hour interval", R"(
