 ...
 public:
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (size_t row = 0; row < input_rows_count; ++row) {
      ...
      if (size < 0)
        throw Exception(ErrorCodes::INCORRECT_DATA, "Line cannot be computed between start H3 index {} and end H3 index {}", start, end);
...
Returns the line of [H3](#h3-index) indices between the two provided indices.
  ...
  FunctionDocumentation::Arguments arguments = {{"start", "Hexagon index number that represents the starting point.", {"UInt64"}},
  ...
  FunctionDocumentation::Examples examples = {{"Get line of H3 indices between two points",
