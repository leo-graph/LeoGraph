...
subtractWeeks(datetime, num)
  ...
  FunctionDocumentation::Arguments arguments = {{"datetime",
                                                 "Date or date with time to subtract specified number of weeks from.",
                                                 {"Date", "Date32", "DateTime", "DateTime64", "String"}},
                                                {"num", "Number of weeks to subtract.", {"(U)Int*", "Float*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `datetime` minus `num` weeks",
                                                         {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples = {{"Subtract weeks from different date types", R"(
WITH
