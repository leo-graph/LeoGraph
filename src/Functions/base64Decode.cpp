...
using Base64DecodeImpl =
    BaseXXDecode<Base64DecodeTraits<Base64Variant::Normal>, NameBase64Decode, BaseXXDecodeErrorHandling::ThrowException>;
...
Throws an exception in case of error.
  ...
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT base64Decode('Y2xpY2tob3VzZQ==')",
                                               R"(
