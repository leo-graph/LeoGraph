...
addMonths(datetime, num)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `datetime` plus `num` months",
                                                         {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples = {{"Add months to different date types", R"(
WITH
