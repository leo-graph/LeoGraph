...
Returns the query string and fragment identifier of a URL.
  ...
  FunctionDocumentation::Arguments arguments_queryStringAndFragment = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_queryStringAndFragment = {
      "Returns the query string and fragment identifier of the URL.", {"String"}};
  FunctionDocumentation::Examples examples_queryStringAndFragment = {{"Usage example",
                                                                      R"(
...
└───────────────────────────────┘
  ...
  FunctionDocumentation documentation_queryStringAndFragment = {description_queryStringAndFragment,    syntax_queryStringAndFragment,
                                                                arguments_queryStringAndFragment,      {},
                                                                returned_value_queryStringAndFragment, examples_queryStringAndFragment,
                                                                introduced_in_queryStringAndFragment,  category_queryStringAndFragment};
