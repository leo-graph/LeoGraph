...
The values are not decoded.
  ...
  FunctionDocumentation::Arguments arguments_extractURLParameterNames = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_extractURLParameterNames = {
      "Returns an array of name strings corresponding to the names of URL parameters.", {"Array(String)"}};
  FunctionDocumentation::Examples examples_extractURLParameterNames = {{"Usage example",
                                                                        R"(
...
└──────────────────────────┘
  ...
  FunctionDocumentation documentation_extractURLParameterNames = {
      description_extractURLParameterNames,    syntax_extractURLParameterNames,
      arguments_extractURLParameterNames,      {},
      returned_value_extractURLParameterNames, examples_extractURLParameterNames,
      introduced_in_extractURLParameterNames,  category_extractURLParameterNames};
