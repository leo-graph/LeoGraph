  ...
  static void execute(Pos data, size_t size, Pos &res_data, size_t &res_size) {
    ...
    if (end != (pos = find_first_symbols<'/'>(pos, end))) {
      if (pos != data) {
        ...
        if (pos != data + protocol_length + 1) return;
      }

      if (end - pos < 2 || *(pos) != '/' || *(pos + 1) != '/') return;
...
Removes the leading `www.`, if present, from the URL's domain.
  ...
  FunctionDocumentation::Arguments arguments_cutWWW = {{"url", "URL.", {"String"}}};
  ...
  FunctionDocumentation::Examples examples_cutWWW = {{"Usage example",
                                                      R"(
...
└────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_cutWWW = {description_cutWWW,    syntax_cutWWW,   arguments_cutWWW,     {},
                                                returned_value_cutWWW, examples_cutWWW, introduced_in_cutWWW, category_cutWWW};
