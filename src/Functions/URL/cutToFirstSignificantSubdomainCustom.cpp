...
struct CutToFirstSignificantSubdomainCustom {
  ...
  static void execute(FirstSignificantSubdomainCustomLookup& tld_lookup, const Pos data, const size_t size, Pos& res_data,
                      size_t& res_size) {
    res_data = data;
    res_size = 0;
...
struct NameCutToFirstSignificantSubdomainCustom {
  static constexpr auto name = "cutToFirstSignificantSubdomainCustom";
};
using FunctionCutToFirstSignificantSubdomainCustom =
    FunctionCutToFirstSignificantSubdomainCustomImpl<CutToFirstSignificantSubdomainCustom<true, false>,
                                                     NameCutToFirstSignificantSubdomainCustom>;

struct NameCutToFirstSignificantSubdomainCustomWithWWW {
  static constexpr auto name = "cutToFirstSignificantSubdomainCustomWithWWW";
};
using FunctionCutToFirstSignificantSubdomainCustomWithWWW =
    FunctionCutToFirstSignificantSubdomainCustomImpl<CutToFirstSignificantSubdomainCustom<false, false>,
                                                     NameCutToFirstSignificantSubdomainCustomWithWWW>;

struct NameCutToFirstSignificantSubdomainCustomRFC {
  static constexpr auto name = "cutToFirstSignificantSubdomainCustomRFC";
};
using FunctionCutToFirstSignificantSubdomainCustomRFC =
    FunctionCutToFirstSignificantSubdomainCustomImpl<CutToFirstSignificantSubdomainCustom<true, true>,
                                                     NameCutToFirstSignificantSubdomainCustomRFC>;

struct NameCutToFirstSignificantSubdomainCustomWithWWWRFC {
  static constexpr auto name = "cutToFirstSignificantSubdomainCustomWithWWWRFC";
};
using FunctionCutToFirstSignificantSubdomainCustomWithWWWRFC =
    FunctionCutToFirstSignificantSubdomainCustomImpl<CutToFirstSignificantSubdomainCustom<false, true>,
                                                     NameCutToFirstSignificantSubdomainCustomWithWWWRFC>;
...
```
  ...
  FunctionDocumentation cutToFirstSignificantSubdomainCustom_documentation = {
      cutToFirstSignificantSubdomainCustom_description,    cutToFirstSignificantSubdomainCustom_syntax,
      cutToFirstSignificantSubdomainCustom_arguments,      {},
      cutToFirstSignificantSubdomainCustom_returned_value, cutToFirstSignificantSubdomainCustom_examples,
      cutToFirstSignificantSubdomainCustom_introduced_in,  cutToFirstSignificantSubdomainCustom_category};
...
<top_level_domains_lists>
  ...
  FunctionDocumentation::Syntax cutToFirstSignificantSubdomainCustomWithWWW_syntax =
  ...
  FunctionDocumentation::Examples cutToFirstSignificantSubdomainCustomWithWWW_examples = {{"Usage example",
                                                                                           R"(
...
└──────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation cutToFirstSignificantSubdomainCustomWithWWW_documentation = {
      cutToFirstSignificantSubdomainCustomWithWWW_description,    cutToFirstSignificantSubdomainCustomWithWWW_syntax,
      cutToFirstSignificantSubdomainCustomWithWWW_arguments,      {},
      cutToFirstSignificantSubdomainCustomWithWWW_returned_value, cutToFirstSignificantSubdomainCustomWithWWW_examples,
      cutToFirstSignificantSubdomainCustomWithWWW_introduced_in,  cutToFirstSignificantSubdomainCustomWithWWW_category};
...
```
  ...
  FunctionDocumentation::Syntax cutToFirstSignificantSubdomainCustomRFC_syntax =
  ...
  FunctionDocumentation::ReturnedValue cutToFirstSignificantSubdomainCustomRFC_returned_value = {
      "Returns the part of the domain that includes top-level subdomains up to the first significant subdomain.", {"String"}};
  FunctionDocumentation::Examples cutToFirstSignificantSubdomainCustomRFC_examples = {{"Usage example",
                                                                                       R"(
...
└──────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation cutToFirstSignificantSubdomainCustomRFC_documentation = {
      cutToFirstSignificantSubdomainCustomRFC_description,    cutToFirstSignificantSubdomainCustomRFC_syntax,
      cutToFirstSignificantSubdomainCustomRFC_arguments,      {},
      cutToFirstSignificantSubdomainCustomRFC_returned_value, cutToFirstSignificantSubdomainCustomRFC_examples,
...
<top_level_domains_lists>
  ...
  FunctionDocumentation::Syntax cutToFirstSignificantSubdomainCustomWithWWWRFC_syntax =
  ...
  FunctionDocumentation cutToFirstSignificantSubdomainCustomWithWWWRFC_documentation = {
      cutToFirstSignificantSubdomainCustomWithWWWRFC_description,    cutToFirstSignificantSubdomainCustomWithWWWRFC_syntax,
      cutToFirstSignificantSubdomainCustomWithWWWRFC_arguments,      {},
      cutToFirstSignificantSubdomainCustomWithWWWRFC_returned_value, cutToFirstSignificantSubdomainCustomWithWWWRFC_examples,
      cutToFirstSignificantSubdomainCustomWithWWWRFC_introduced_in,  cutToFirstSignificantSubdomainCustomWithWWWRFC_category};

  factory.registerFunction<FunctionCutToFirstSignificantSubdomainCustomWithWWWRFC>(
      cutToFirstSignificantSubdomainCustomWithWWWRFC_documentation);
}
