...
enum URLCodeStrategy { encode, decode };
...
struct NameEncodeURLComponent {
  static constexpr auto name = "encodeURLComponent";
};
struct NameDecodeURLFormComponent {
  static constexpr auto name = "decodeURLFormComponent";
};
struct NameEncodeURLFormComponent {
  static constexpr auto name = "encodeURLFormComponent";
};
...
Takes a URL-encoded string as input and decodes it back to its original, readable form.
  ...
  FunctionDocumentation::Arguments arguments_decodeURLComponent = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_decodeURLComponent = {"Returns the decoded URL.", {"String"}};
  FunctionDocumentation::Examples examples_decodeURLComponent = {{"Usage example",
                                                                  R"(
...
└────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_decodeURLComponent = {
      description_decodeURLComponent,    syntax_decodeURLComponent,   arguments_decodeURLComponent,     {},
      returned_value_decodeURLComponent, examples_decodeURLComponent, introduced_in_decodeURLComponent, category_decodeURLComponent};
...
Takes a regular string and converts it into a URL-encoded (percent-encoded) format where special characters are replaced with their percent-encoded equivalents.
  ...
  FunctionDocumentation::Arguments arguments_encodeURLComponent = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_encodeURLComponent = {"Returns the encoded URL.", {"String"}};
  FunctionDocumentation::Examples examples_encodeURLComponent = {{"Usage example",
                                                                  R"(
...
└──────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_encodeURLComponent = {
      description_encodeURLComponent,    syntax_encodeURLComponent,   arguments_encodeURLComponent,     {},
      returned_value_encodeURLComponent, examples_encodeURLComponent, introduced_in_encodeURLComponent, category_encodeURLComponent};
...
Decodes URL-encoded strings using form encoding rules ([RFC-1866](https://www.rfc-editor.org/rfc/rfc1866.html)), where `+` signs are converted to spaces and percent-encoded characters are decoded.
  ...
  FunctionDocumentation::Arguments arguments_decodeURLFormComponent = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_decodeURLFormComponent = {"Returns the decoded URL.", {"String"}};
  FunctionDocumentation::Examples examples_decodeURLFormComponent = {{"Usage example",
                                                                      R"(
...
└───────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_decodeURLFormComponent = {description_decodeURLFormComponent,    syntax_decodeURLFormComponent,
                                                                arguments_decodeURLFormComponent,      {},
                                                                returned_value_decodeURLFormComponent, examples_decodeURLFormComponent,
                                                                introduced_in_decodeURLFormComponent,  category_decodeURLFormComponent};
...
Encodes strings using form encoding rules ([RFC-1866](https://www.rfc-editor.org/rfc/rfc1866.html)), where spaces are converted to + signs and special characters are percent-encoded.
  ...
  FunctionDocumentation::Arguments arguments_encodeURLFormComponent = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_encodeURLFormComponent = {"Returns the encoded URL.", {"String"}};
  FunctionDocumentation::Examples examples_encodeURLFormComponent = {{"Usage example",
                                                                      R"(
...
└───────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_encodeURLFormComponent = {description_encodeURLFormComponent,    syntax_encodeURLFormComponent,
                                                                arguments_encodeURLFormComponent,      {},
                                                                returned_value_encodeURLFormComponent, examples_encodeURLFormComponent,
                                                                introduced_in_encodeURLFormComponent,  category_encodeURLFormComponent};
