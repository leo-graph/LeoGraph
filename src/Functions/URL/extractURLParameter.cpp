...
struct ExtractURLParameterImpl {
  static void vector(const ColumnString::Chars &data, const ColumnString::Offsets &offsets, std::string pattern,
...
The function assumes that the parameter in the `url` parameter is encoded in the same way as in the `name` argument.
  ...
  FunctionDocumentation::Arguments arguments_extractURLParameter = {{"url", "URL.", {"String"}}, {"name", "Parameter name.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_extractURLParameter = {
      "Returns the value of the URL parameter with the specified name.", {"String"}};
  FunctionDocumentation::Examples examples_extractURLParameter = {{"Usage example",
                                                                   R"(
...
└──────────────────────────┘
  ...
  FunctionDocumentation documentation_extractURLParameter = {
      description_extractURLParameter,    syntax_extractURLParameter,   arguments_extractURLParameter,     {},
      returned_value_extractURLParameter, examples_extractURLParameter, introduced_in_extractURLParameter, category_extractURLParameter};
