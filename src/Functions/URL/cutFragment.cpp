...
Removes the fragment identifier, including the number sign, from a URL.
  ...
  FunctionDocumentation::Arguments arguments_cutFragment = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_cutFragment = {"Returns the URL with fragment identifier removed.", {"String"}};
  FunctionDocumentation::Examples examples_cutFragment = {{"Usage example",
                                                           R"(
...
└────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_cutFragment = {
      description_cutFragment,    syntax_cutFragment,   arguments_cutFragment,     {},
      returned_value_cutFragment, examples_cutFragment, introduced_in_cutFragment, category_cutFragment};
