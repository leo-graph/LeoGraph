...
using FunctionCutToFirstSignificantSubdomain =
    FunctionStringToString<ExtractSubstringImpl<CutToFirstSignificantSubdomain<true, false>>, NameCutToFirstSignificantSubdomain>;

struct NameCutToFirstSignificantSubdomainWithWWW {
  static constexpr auto name = "cutToFirstSignificantSubdomainWithWWW";
};
using FunctionCutToFirstSignificantSubdomainWithWWW =
    FunctionStringToString<ExtractSubstringImpl<CutToFirstSignificantSubdomain<false, false>>, NameCutToFirstSignificantSubdomainWithWWW>;

struct NameCutToFirstSignificantSubdomainRFC {
  static constexpr auto name = "cutToFirstSignificantSubdomainRFC";
};
using FunctionCutToFirstSignificantSubdomainRFC =
    FunctionStringToString<ExtractSubstringImpl<CutToFirstSignificantSubdomain<true, true>>, NameCutToFirstSignificantSubdomainRFC>;

struct NameCutToFirstSignificantSubdomainWithWWWRFC {
  static constexpr auto name = "cutToFirstSignificantSubdomainWithWWWRFC";
};
using FunctionCutToFirstSignificantSubdomainWithWWWRFC =
    FunctionStringToString<ExtractSubstringImpl<CutToFirstSignificantSubdomain<false, true>>, NameCutToFirstSignificantSubdomainWithWWWRFC>;
...
Returns the part of the domain that includes top-level subdomains up to the [first significant subdomain](/sql-reference/functions/url-functions#firstSignificantSubdomain).
  ...
  FunctionDocumentation::Arguments cutToFirstSignificantSubdomain_arguments = {{"url", "URL or domain string to process.", {"String"}}};
  FunctionDocumentation::ReturnedValue cutToFirstSignificantSubdomain_returned_value = {
      "Returns the part of the domain that includes top-level subdomains up to the first significant subdomain if possible, otherwise "
      "returns an empty string.",
      {"String"}};
  FunctionDocumentation::Examples cutToFirstSignificantSubdomain_examples = {{"Usage example",
                                                                              R"(
SELECT
...
└───────────────────────────────────────────────────────────────────┴──────────────────────────────────────────┴──────────────────────────────────────┘
  ...
  FunctionDocumentation cutToFirstSignificantSubdomain_documentation = {
      cutToFirstSignificantSubdomain_description,    cutToFirstSignificantSubdomain_syntax,
      cutToFirstSignificantSubdomain_arguments,      {},
      cutToFirstSignificantSubdomain_returned_value, cutToFirstSignificantSubdomain_examples,
      cutToFirstSignificantSubdomain_introduced_in,  cutToFirstSignificantSubdomain_category};
...
Similar to [`cutToFirstSignificantSubdomain`](#cutToFirstSignificantSubdomain) but preserves the 'www.' prefix if present.
  ...
  FunctionDocumentation::ReturnedValue cutToFirstSignificantSubdomainWithWWW_returned_value = {
      "Returns the part of the domain that includes top-level subdomains up to the first significant subdomain (with www) if possible, "
      "otherwise returns an empty string.",
      {"String"}};
  FunctionDocumentation::Examples cutToFirstSignificantSubdomainWithWWW_examples = {{"Usage example",
                                                                                     R"(
SELECT
...
└──────────────────────────────────────────────────────────────────────────┴─────────────────────────────────────────────────┴─────────────────────────────────────────────┘
  ...
  FunctionDocumentation cutToFirstSignificantSubdomainWithWWW_documentation = {
      cutToFirstSignificantSubdomainWithWWW_description,    cutToFirstSignificantSubdomainWithWWW_syntax,
      cutToFirstSignificantSubdomainWithWWW_arguments,      {},
      cutToFirstSignificantSubdomainWithWWW_returned_value, cutToFirstSignificantSubdomainWithWWW_examples,
      cutToFirstSignificantSubdomainWithWWW_introduced_in,  cutToFirstSignificantSubdomainWithWWW_category};
...
Returns the part of the domain that includes top-level subdomains up to the ["first significant subdomain"](/sql-reference/functions/url-functions#firstSignificantSubdomain). Similar to [`cutToFirstSignificantSubdomain`](#cutToFirstSignificantSubdomain) but conforms to [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986).
  ...
  FunctionDocumentation::ReturnedValue cutToFirstSignificantSubdomainRFC_returned_value = {
      ...
      "returns an empty string.",
      {"String"}};
  FunctionDocumentation::Examples cutToFirstSignificantSubdomainRFC_examples = {{"Usage example",
                                                                                 R"(
SELECT
...
└─────────────────────────────────────────────────────────────────────────┴────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation cutToFirstSignificantSubdomainRFC_documentation = {
      cutToFirstSignificantSubdomainRFC_description,    cutToFirstSignificantSubdomainRFC_syntax,
      cutToFirstSignificantSubdomainRFC_arguments,      {},
      cutToFirstSignificantSubdomainRFC_returned_value, cutToFirstSignificantSubdomainRFC_examples,
      cutToFirstSignificantSubdomainRFC_introduced_in,  cutToFirstSignificantSubdomainRFC_category};
...
Returns the part of the domain that includes top-level subdomains up to the "first significant subdomain", without stripping 'www'. Similar to [`cutToFirstSignificantSubdomainWithWWW`](#cutToFirstSignificantSubdomainWithWWW) but conforms to [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986).
  ...
  FunctionDocumentation::ReturnedValue cutToFirstSignificantSubdomainWithWWWRFC_returned_value = {
      ...
      "otherwise returns an empty string",
      {"String"}};
  FunctionDocumentation::Examples cutToFirstSignificantSubdomainWithWWWRFC_examples = {{"Usage example",
                                                                                        R"(
SELECT
...
└───────────────────────────────────────────────────────────────────────────────────────┴──────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation cutToFirstSignificantSubdomainWithWWWRFC_documentation = {
      cutToFirstSignificantSubdomainWithWWWRFC_description,    cutToFirstSignificantSubdomainWithWWWRFC_syntax,
      cutToFirstSignificantSubdomainWithWWWRFC_arguments,      {},
      cutToFirstSignificantSubdomainWithWWWRFC_returned_value, cutToFirstSignificantSubdomainWithWWWRFC_examples,
      cutToFirstSignificantSubdomainWithWWWRFC_introduced_in,  cutToFirstSignificantSubdomainWithWWWRFC_category};
