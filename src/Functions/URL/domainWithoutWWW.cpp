...
struct NameDomainWithoutWWWRFC {
  static constexpr auto name = "domainWithoutWWWRFC";
};
...
Returns the domain of a URL without leading `www.` if present.
  ...
  FunctionDocumentation::Arguments arguments_domainWithoutWWW = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_domainWithoutWWW = {
      "Returns the domain name if the input string can be parsed as a URL (without leading `www.`), otherwise an empty string.",
      {"String"}};
  FunctionDocumentation::Examples examples_domainWithoutWWW = {{"Usage example",
                                                                R"(
...
└─────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_domainWithoutWWW = {
      description_domainWithoutWWW,    syntax_domainWithoutWWW,   arguments_domainWithoutWWW,     {},
      returned_value_domainWithoutWWW, examples_domainWithoutWWW, introduced_in_domainWithoutWWW, category_domainWithoutWWW};
...
Returns the domain without leading `www.` if present. Similar to [`domainWithoutWWW`](#domainWithoutWWW) but conforms to [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986).
  ...
  FunctionDocumentation::Arguments arguments_domainWithoutWWWRFC = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_domainWithoutWWWRFC = {
      "Returns the domain name if the input string can be parsed as a URL (without leading `www.`), otherwise an empty string.",
      {"String"}};
  FunctionDocumentation::Examples examples_domainWithoutWWWRFC = {{"Usage example",
                                                                   R"(
SELECT
...
└─────────────────────────────────────────────────────────────────────────────────────────┴────────────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_domainWithoutWWWRFC = {
      description_domainWithoutWWWRFC,    syntax_domainWithoutWWWRFC,   arguments_domainWithoutWWWRFC,     {},
      returned_value_domainWithoutWWWRFC, examples_domainWithoutWWWRFC, introduced_in_domainWithoutWWWRFC, category_domainWithoutWWWRFC};
