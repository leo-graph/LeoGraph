...
Examples of typical returned values: http, https, ftp, mailto, tel, magnet.
  ...
  FunctionDocumentation::Arguments arguments_protocol = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_protocol = {
      "Returns the protocol of the URL, or an empty string if it cannot be determined.", {"String"}};
  FunctionDocumentation::Examples examples_protocol = {{"Usage example",
                                                        R"(
...
└─────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_protocol = {description_protocol,    syntax_protocol,   arguments_protocol,     {},
                                                  returned_value_protocol, examples_protocol, introduced_in_protocol, category_protocol};
