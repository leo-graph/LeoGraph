...
The same as [`path`](#path), but includes the query string and fragment of the URL.
  ...
  FunctionDocumentation::Arguments arguments_pathFull = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_pathFull = {"Returns the path of the URL including query string and fragment.",
                                                                  {"String"}};
  FunctionDocumentation::Examples examples_pathFull = {{"Usage example",
                                                        R"(
...
└──────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_pathFull = {description_pathFull,    syntax_pathFull,   arguments_pathFull,     {},
                                                  returned_value_pathFull, examples_pathFull, introduced_in_pathFull, category_pathFull};
