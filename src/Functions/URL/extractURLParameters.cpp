...
The values are not decoded.
  ...
  FunctionDocumentation::Arguments arguments_extractURLParameters = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_extractURLParameters = {
      "Returns an array of `name=value` strings corresponding to the URL parameters.", {"Array(String)"}};
  FunctionDocumentation::Examples examples_extractURLParameters = {{"Usage example",
                                                                    R"(
...
└───────────────────────────────────┘
  ...
  FunctionDocumentation documentation_extractURLParameters = {description_extractURLParameters,    syntax_extractURLParameters,
                                                              arguments_extractURLParameters,      {},
                                                              returned_value_extractURLParameters, examples_extractURLParameters,
                                                              introduced_in_extractURLParameters,  category_extractURLParameters};
