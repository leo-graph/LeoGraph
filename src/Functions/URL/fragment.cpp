...
Returns the fragment identifier without the initial hash symbol.
  ...
  FunctionDocumentation::Arguments arguments_fragment = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_fragment = {"Returns the fragment identifier without the initial hash symbol.",
                                                                  {"String"}};
  FunctionDocumentation::Examples examples_fragment = {{"Usage example",
                                                        R"(
...
└───────────────────────────────┘
  ...
  FunctionDocumentation documentation_fragment = {description_fragment,    syntax_fragment,   arguments_fragment,     {},
                                                  returned_value_fragment, examples_fragment, introduced_in_fragment, category_fragment};
