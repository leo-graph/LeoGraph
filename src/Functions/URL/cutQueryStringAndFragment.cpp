...
Removes the query string and fragment identifier, including the question mark and number sign, from a URL.
  ...
  FunctionDocumentation::Arguments arguments_cutQueryStringAndFragment = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_cutQueryStringAndFragment = {
      "Returns the URL with query string and fragment identifier removed.", {"String"}};
  FunctionDocumentation::Examples examples_cutQueryStringAndFragment = {{"Usage example",
                                                                         R"(
...
└─────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_cutQueryStringAndFragment = {
      description_cutQueryStringAndFragment,    syntax_cutQueryStringAndFragment,
      arguments_cutQueryStringAndFragment,      {},
      returned_value_cutQueryStringAndFragment, examples_cutQueryStringAndFragment,
      introduced_in_cutQueryStringAndFragment,  category_cutQueryStringAndFragment};
