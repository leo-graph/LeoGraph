...
struct NameDomainRFC {
  static constexpr auto name = "domainRFC";
};
...
The URL can be specified with or without a protocol.
  ...
  FunctionDocumentation::Arguments arguments_domain = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_domain = {
      "Returns the host name if the input string can be parsed as a URL, otherwise an empty string.", {"String"}};
  FunctionDocumentation::Examples examples_domain = {{"Usage example",
                                                      R"(
...
└────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_domain = {description_domain,    syntax_domain,   arguments_domain,     {},
                                                returned_value_domain, examples_domain, introduced_in_domain, category_domain};
...
Similar to [`domain`](#domain), but [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986) conformant.
  ...
  FunctionDocumentation::Arguments arguments_domainRFC = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_domainRFC = {
      "Returns the host name if the input string can be parsed as a URL, otherwise an empty string.", {"String"}};
  FunctionDocumentation::Examples examples_domainRFC = {{"Usage example",
                                                         R"(
SELECT
...
└───────────────────────────────────────────────────────────────────────────┴──────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_domainRFC = {
      description_domainRFC,    syntax_domainRFC,   arguments_domainRFC,     {},
      returned_value_domainRFC, examples_domainRFC, introduced_in_domainRFC, category_domainRFC};
