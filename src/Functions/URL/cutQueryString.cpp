...
Removes the query string, including the question mark from a URL.
  ...
  FunctionDocumentation::Arguments arguments_cutQueryString = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_cutQueryString = {"Returns the URL with query string removed.", {"String"}};
  FunctionDocumentation::Examples examples_cutQueryString = {{"Usage example",
                                                              R"(
...
└──────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_cutQueryString = {
      description_cutQueryString,    syntax_cutQueryString,   arguments_cutQueryString,     {},
      returned_value_cutQueryString, examples_cutQueryString, introduced_in_cutQueryString, category_cutQueryString};
