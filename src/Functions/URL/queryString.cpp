...
Returns the query string of a URL without the initial question mark, `#` and everything after `#`.
  ...
  FunctionDocumentation::Arguments arguments_queryString = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_queryString = {
      "Returns the query string of the URL without the initial question mark and fragment.", {"String"}};
  FunctionDocumentation::Examples examples_queryString = {{"Usage example",
                                                           R"(
...
└──────────────────────────┘
  ...
  FunctionDocumentation documentation_queryString = {
      description_queryString,    syntax_queryString,   arguments_queryString,     {},
      returned_value_queryString, examples_queryString, introduced_in_queryString, category_queryString};
