...
Returns the path without query string from a URL.
  ...
  FunctionDocumentation::Arguments arguments_path = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_path = {"Returns the path of the URL without query string.", {"String"}};
  FunctionDocumentation::Examples examples_path = {{"Usage example",
                                                    R"(
...
└──────────────────────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_path = {description_path,    syntax_path,   arguments_path,     {},
                                              returned_value_path, examples_path, introduced_in_path, category_path};
