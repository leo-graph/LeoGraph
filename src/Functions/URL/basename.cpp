...
struct NameBasename {
  static constexpr auto name = "basename";
};
...
This function is often used to extract the filename from a path.
  ...
  FunctionDocumentation::Arguments arguments = {{"expr", "A string expression. Backslashes must be escaped.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns the tail of the input string after its last slash or backslash. If the input string ends with a slash or backslash, the "
      "function returns an empty string. Returns the original string if there are no slashes or backslashes.",
      {"String"}};
  FunctionDocumentation::Examples examples = {{"Extract filename from Unix path",
                                               R"(
