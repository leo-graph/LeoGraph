...
struct ExtractTopLevelDomain {
  ...
  static void execute(Pos data, size_t size, Pos& res_data, size_t& res_size) {
    ...
    if (!host.empty()) {
      if (host[host.size() - 1] == '.') host.remove_suffix(1);
      ...
      if (isNumericASCII(last_dot[1])) return;
...
struct NameTopLevelDomainRFC {
  static constexpr auto name = "topLevelDomainRFC";
};
...
:::
  ...
  FunctionDocumentation::Arguments arguments_topLevelDomain = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_topLevelDomain = {
      "Returns the domain name if the input string can be parsed as a URL. Otherwise, an empty string.", {"String"}};
  FunctionDocumentation::Examples examples_topLevelDomain = {{"Usage example",
                                                              R"(
...
└────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_topLevelDomain = {
      description_topLevelDomain,    syntax_topLevelDomain,   arguments_topLevelDomain,     {},
      returned_value_topLevelDomain, examples_topLevelDomain, introduced_in_topLevelDomain, category_topLevelDomain};
...
Similar to [`topLevelDomain`](#topLevelDomain), but conforms to [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986).
  ...
  FunctionDocumentation::Arguments arguments_topLevelDomainRFC = {{"url", "URL.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_topLevelDomainRFC = {
      "Domain name if the input string can be parsed as a URL. Otherwise, an empty string.", {"String"}};
  FunctionDocumentation::Examples examples_topLevelDomainRFC = {{"Usage example",
                                                                 R"(
...
└────────────────────────────────────────────────┴───────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_topLevelDomainRFC = {
      description_topLevelDomainRFC,    syntax_topLevelDomainRFC,   arguments_topLevelDomainRFC,     {},
      returned_value_topLevelDomainRFC, examples_topLevelDomainRFC, introduced_in_topLevelDomainRFC, category_topLevelDomainRFC};
