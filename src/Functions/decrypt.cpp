...
- aes-128-cfb, aes-128-cfb1, aes-128-cfb8
  ...
  FunctionDocumentation::Arguments arguments = {
      ...
      {"aad",
       "Additional authenticated data. Won't decrypt if this value is incorrect. Works only in `-gcm` modes, for others throws an "
       "exception.",
       {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns decrypted plaintext.", {"String"}};
  FunctionDocumentation::Examples examples = {{"Correctly decrypting encrypted data",
                                               R"(
