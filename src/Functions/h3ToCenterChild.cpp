...
This function finds the center child of an H3 index at a specified finer resolution. The resolution must be greater than the resolution of the input index.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the H3 index of the center child at the specified resolution.",
                                                         {"UInt64"}};
  FunctionDocumentation::Examples examples = {{"Get center child at resolution 1",
