...
enum class Component { Year, Month, Day, Hour, Minute, Second };
...
class FunctionChangeDate : public IFunction {
 public:
  ...
  static FunctionPtr create(const char *name, Component component) { return std::make_shared<FunctionChangeDate>(name, component); }
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors args{
        {"date_or_datetime", static_cast<FunctionArgumentDescriptor::TypeValidator>(&isDateOrDate32OrDateTimeOrDateTime64), nullptr,
    ...
    if (component == Component::Hour || component == Component::Minute || component == Component::Second) {
      if (isDate(input_type)) return std::make_shared<DataTypeDateTime>();
      if (isDate32(input_type)) return std::make_shared<DataTypeDateTime64>(DataTypeDateTime64::default_scale);
    }
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &result_type, size_t input_rows_count) const override {
    ...
    if (isDateTime(input_type)) return execute<DataTypeDateTime, DataTypeDateTime>(arguments, input_type, result_type, input_rows_count);
  ...
  ColumnPtr execute(const ColumnsWithTypeAndName &arguments, const DataTypePtr &input_type, const DataTypePtr &result_type,
    ...
    if constexpr (std::is_same_v<InputDataType, DataTypeDateTime64>) {
      ...
      Int64 deg = 1;
      for (size_t j = 0; j < scale; ++j) deg *= 10;
  ...
  Int64 getChangedDate(Int64 time, Float64 new_value, const DataTypePtr &result_type, const DateLUTImpl &date_lut, Int64 scale = 0,
                       Int64 fraction = 0) const {
    ...
    if (isDate(result_type)) {
      ...
      min_date = DecimalUtils::dateTimeFromComponents(date_lut.makeDateTime(1900, 1, 1, 0, 0, 0), static_cast<Int64>(0),
                                                      static_cast<UInt32>(scale));
      Int64 deg = 1;
      for (Int64 j = 0; j < scale; ++j) deg *= 10;
      max_date = DecimalUtils::dateTimeFromComponents(date_lut.makeDateTime(2299, 12, 31, 23, 59, 59), static_cast<Int64>(deg - 1),
                                                      static_cast<UInt32>(scale));
      min_year = 1900;
      max_year = 2299;
    }
    ...
    switch (component) {
      ...
      case Component::Month:
        if (new_value < 1 || new_value > 12) return min_date;
        month = static_cast<UInt8>(new_value);
        break;
      case Component::Day:
        if (new_value < 1 || new_value > 31) return min_date;
        day = static_cast<UInt8>(new_value);
        break;
      case Component::Hour:
        if (new_value < 0 || new_value > 23) return min_date;
        hours = static_cast<UInt8>(new_value);
        break;
      case Component::Minute:
        if (new_value < 0 || new_value > 59) return min_date;
    ...
    if (isDate(result_type) || isDate32(result_type))
      ...
      result = DecimalUtils::dateTimeFromComponents(date_lut.makeDateTime(year, month, day, hours, minutes, seconds), fraction,
                                                    static_cast<UInt32>(scale));
#else
    {
      UNUSED(fraction);
    ...
    if (result > max_date) return max_date;
...
REGISTER_FUNCTION(ChangeDate) {
  {
    ...
    FunctionDocumentation::ReturnedValue returned_value = {
        "Returns a value of the same type as `date_or_datetime` with modified year component.",
        {"Date", "Date32", "DateTime", "DateTime64"}};
    FunctionDocumentation::Examples example = {{"Usage example", "SELECT changeYear('2024-01-01'::DateTime, 2023)", "2023-01-01 00:00:00"}};
    ...
    factory.registerFunction(
        "changeYear", [](ContextPtr) { return FunctionChangeDate::create("changeYear", Component::Year); }, function_documentation);
  }
  {
    ...
    FunctionDocumentation::Arguments arguments = {
        ...
        {"value", "The new value.", {"(U)Int*"}}};
    FunctionDocumentation::ReturnedValue returned_value = {
        "Returns a value of the same type as `date_or_datetime` with modified month component.",
        {"Date", "Date32", "DateTime", "DateTime64"}};
    FunctionDocumentation::Examples example = {{"Usage example", "SELECT changeMonth('2024-01-01'::DateTime, 12)", "2024-12-01 00:00:00"}};
    FunctionDocumentation::IntroducedIn introduced_in = {24, 7};
    FunctionDocumentation::Category category = FunctionDocumentation::Category::DateAndTime;
    FunctionDocumentation function_documentation = {description, syntax, arguments, {}, returned_value, example, introduced_in, category};
    factory.registerFunction(
        "changeMonth", [](ContextPtr) { return FunctionChangeDate::create("changeMonth", Component::Month); }, function_documentation);
  }
  {
    ...
    FunctionDocumentation::ReturnedValue returned_value = {
        ...
        {"Date", "Date32", "DateTime", "DateTime64"}};
    FunctionDocumentation::Examples example = {{"Usage example", "SELECT changeDay('2024-01-31'::DateTime, 15)", "2024-01-15 00:00:00"}};
    FunctionDocumentation::IntroducedIn introduced_in = {24, 7};
    FunctionDocumentation::Category category = FunctionDocumentation::Category::DateAndTime;
    FunctionDocumentation function_documentation = {description, syntax, arguments, {}, returned_value, example, introduced_in, category};
    factory.registerFunction(
        "changeDay", [](ContextPtr) { return FunctionChangeDate::create("changeDay", Component::Day); }, function_documentation);
  }
  {
    ...
    FunctionDocumentation::Arguments arguments = {
        ...
        {"value", "The new value.", {"(U)Int*"}}};
    FunctionDocumentation::ReturnedValue returned_value = {
        "Returns a value of the same type as `date_or_datetime` with modified hour component.", {"DateTime", "DateTime64"}};
    ...
    FunctionDocumentation function_documentation = {description, syntax, arguments, {}, returned_value, example, introduced_in, category};
    factory.registerFunction(
        "changeHour", [](ContextPtr) { return FunctionChangeDate::create("changeHour", Component::Hour); }, function_documentation);
  }
  {
    ...
    FunctionDocumentation::Arguments arguments = {
        ...
        {"value", "The new value.", {"(U)Int*"}}};
    FunctionDocumentation::ReturnedValue returned_value = {
        "Returns a value of the same type as `date_or_datetime` with modified minute component.", {"DateTime", "DateTime64"}};
    FunctionDocumentation::Examples example = {
    ...
    FunctionDocumentation function_documentation = {description, syntax, arguments, {}, returned_value, example, introduced_in, category};
    factory.registerFunction(
        "changeMinute", [](ContextPtr) { return FunctionChangeDate::create("changeMinute", Component::Minute); }, function_documentation);
  }
  {
    ...
    FunctionDocumentation::Arguments arguments = {
        ...
        {"value", "The new value.", {"(U)Int*"}}};
    FunctionDocumentation::ReturnedValue returned_value = {
        "Returns a value of the same type as `date_or_datetime` with modified seconds component.", {"DateTime", "DateTime64"}};
    FunctionDocumentation::Examples example = {
    ...
    FunctionDocumentation function_documentation = {description, syntax, arguments, {}, returned_value, example, introduced_in, category};
    factory.registerFunction(
        "changeSecond", [](ContextPtr) { return FunctionChangeDate::create("changeSecond", Component::Second); }, function_documentation);
  }
}
