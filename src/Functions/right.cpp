...
- An empty string if `length` is `0`.
                                                         ...
                                                         {"String"}};
  FunctionDocumentation::Examples examples = {{"Positive offset", "SELECT right('Hello', 3)", "llo"},
...
- An empty string if `length` is `0`.
                                                              ...
                                                              {"String"}};
  FunctionDocumentation::Examples examples_utf8 = {{"Positive offset", "SELECT rightUTF8('Привет', 4)", "ивет"},
