...
It allows for enumeration of a multi-dimensional array with the ability to specify how deep to look inside the array.
  ...
  FunctionDocumentation::Arguments arguments = {
      {"clear_depth",
       "Enumerate elements at the specified level separately. Positive integer less than or equal to `max_arr_depth`.",
       {"UInt*"}},
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns an N-dimensional array the same size as `arr` with each element showing the position of that element in relation to other "
