...
enum class ArrayFirstLastStrategy : uint8_t { First, Last };

enum class ArrayFirstLastElementNotExistsStrategy : uint8_t { Default, Null };
...
struct ArrayFirstLastImpl {
  ...
  static DataTypePtr getReturnType(const DataTypePtr & /*expression_return*/, const DataTypePtr &array_element) {
    if constexpr (element_not_exists_strategy == ArrayFirstLastElementNotExistsStrategy::Null) return makeNullable(array_element);
  ...
  static ColumnPtr execute(const ColumnArray &array, ColumnPtr mapped) {
    ...
    if (!column_filter) {
      ...
      if (!column_filter_const)
        throw Exception(ErrorCodes::ILLEGAL_COLUMN,
                        "Unexpected type of filter column: {}; The result of the lambda is expected to be a UInt8", mapped->getDataType());
    ...
    for (size_t offset_index = 0; offset_index < offsets_size; ++offset_index) {
      ...
      if (!exists) {
        ...
        if constexpr (element_not_exists_strategy == ArrayFirstLastElementNotExistsStrategy::Null) (*vec_null_map_to)[offset_index] = true;
      }
    }
...
struct NameArrayFirstOrNull {
  static constexpr auto name = "arrayFirstOrNull";
};
...
struct NameArrayLast {
  static constexpr auto name = "arrayLast";
};
...
struct NameArrayLastOrNull {
  static constexpr auto name = "arrayLastOrNull";
};
...
Returns the first element in the source array for which `func(x[, y1, y2, ... yN])` returns true, otherwise it returns `NULL`.
  ...
  FunctionDocumentation::Arguments arguments_orNull = {
      ...
      {"[, cond1_arr, ... , condN_arr]",
       "Optional. N condition arrays providing additional arguments to the lambda function.",
       {"Array(T)"}}};
  FunctionDocumentation::ReturnedValue returned_value_orNull = {
  ...
  FunctionDocumentation documentation_orNull = {description_orNull,    syntax_orNull,   arguments_orNull,     {},
                                                returned_value_orNull, examples_orNull, introduced_in_orNull, category_orNull};
...
Returns the last element in the source array for which a lambda `func(x [, y1, y2, ... yN])` returns true, otherwise it returns a default value.
  ...
  FunctionDocumentation::Arguments arguments_last = {
      ...
      {"[, cond1, ... , condN]",
       "Optional. N condition arrays providing additional arguments to the lambda function. "
       "[`Array(T)`](/sql-reference/data-types/array)."}};
  FunctionDocumentation::ReturnedValue returned_value_last = {
  ...
  FunctionDocumentation documentation_last = {description_last,    syntax_last,   arguments_last,     {},
                                              returned_value_last, examples_last, introduced_in_last, category_last};
...
Returns the last element in the source array for which a lambda `func(x [, y1, y2, ... yN])` returns true, otherwise it returns `NULL`.
  ...
  FunctionDocumentation::Arguments arguments_last_null = {
      ...
      {"[, cond1_arr, ... , condN_arr]",
       "Optional. N condition arrays providing additional arguments to the lambda function. "
       "[`Array(T)`](/sql-reference/data-types/array)."}};
  FunctionDocumentation::ReturnedValue returned_value_last_null = {
  ...
  FunctionDocumentation documentation_last_null = {
      description_last_null,    syntax_last_null,   arguments_last_null,     {},
      returned_value_last_null, examples_last_null, introduced_in_last_null, category_last_null};
