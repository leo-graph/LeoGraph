...
enum class ArrayFirstLastIndexStrategy : uint8_t { First, Last };
...
struct NameArrayLastIndex {
  static constexpr auto name = "arrayLastIndex";
};
...
Returns the index of the first element in the source array for which `func(x[, y1, y2, ... yN])` returns true, otherwise it returns '0'.
  ...
  FunctionDocumentation::ReturnedValue returned_value_first = {
  ...
  FunctionDocumentation documentation_first = {description_first,    syntax_first,   arguments_first,     {},
                                               returned_value_first, examples_first, introduced_in_first, category_first};
