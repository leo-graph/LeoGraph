...
REGISTER_FUNCTION(ArrayEnumerateDenseRanked) {
  FunctionDocumentation::Description description =
      "Returns an array the same size as the source array, indicating where each element first appears in the source array. It allows for "
      "enumeration of a multidimensional array with the ability to specify how deep to look inside the array.";
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns an array denoting where each element first appears in the source array",
                                                         {"Array"}};
  FunctionDocumentation::Examples examples = {{"Basic usage", R"(
