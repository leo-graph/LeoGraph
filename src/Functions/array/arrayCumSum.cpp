...
struct ArrayCumSumImpl {
  ...
  static void NO_SANITIZE_UNDEFINED implConst(size_t size, const IColumn::Offset* __restrict offsets, Dst* __restrict res_values,
                                              Src src_value) {
    size_t pos = 0;
...
REGISTER_FUNCTION(ArrayCumSum) {
  FunctionDocumentation::Description description =
      "Returns an array of the partial (running) sums of the elements in the source array. If a lambda function is specified, the sum is "
      "computed from applying the lambda to the array elements at each position.";
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      ...
      {"Array(T)"}};
  FunctionDocumentation::Examples examples = {{"Basic usage", "SELECT arrayCumSum([1, 1, 1, 1]) AS res", "[1, 2, 3, 4]"},
