...
REGISTER_FUNCTION(Has) {
  FunctionDocumentation::Description description =
      "Returns whether the array contains the specified element, the map contains the specified key, or the JSON object contains the "
      "specified path.\n\n"
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `1` if the haystack contains the specified needle, otherwise `0`.",
                                                         {"UInt8"}};
  FunctionDocumentation::Examples examples = {{"Array basic usage", "SELECT has([1, 2, 3], 2)", "1"},
