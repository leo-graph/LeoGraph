...
Checks whether a string begins with the provided string.
  ...
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT startsWith('ClickHouse', 'Click');",
                                               R"(
┌─startsWith('⋯', 'Click')─┐
│                        1 │
└──────────────────────────┘
...
Checks whether a string begins with the provided case-insensitive string.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `1` if `s` starts with case-insensitive `prefix`, otherwise `0`.",
                                                         {"UInt8"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT startsWithCaseInsensitive('ClickHouse', 'CLICK');",
                                               R"(
