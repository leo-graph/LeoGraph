...
struct UniformDistribution {
  ...
  static void generate(Float64 min, Float64 max, ColumnFloat64::Container &container) {
    ...
    for (auto &elem : container) elem = distribution(thread_local_rng);
  }
};
...
struct BernoulliDistribution {
  ...
  static void generate(Float64 p, ColumnUInt8::Container &container) {
    ...
    for (auto &elem : container) elem = static_cast<UInt8>(distribution(thread_local_rng));
  }
};
...
struct BinomialDistribution {
  ...
  static void generate(UInt64 t, Float64 p, ColumnUInt64::Container &container) {
    ...
    for (auto &elem : container) elem = static_cast<UInt64>(distribution(thread_local_rng));
  }
};
...
class FunctionRandomDistribution : public IFunction {
 private:
  ...
  ResultType getParameterFromConstColumn(size_t parameter_number, const ColumnsWithTypeAndName &arguments) const {
    if (parameter_number >= arguments.size())
      throw Exception(ErrorCodes::LOGICAL_ERROR, "Parameter number ({}) is greater than the size of arguments ({}). This is a bug",
    ...
    if (isNaN(parameter) || !std::isfinite(parameter))
      throw Exception(ErrorCodes::BAD_ARGUMENTS, "Parameter number {} of function {} cannot be NaN of infinite", parameter_number,
                      getName());
 ...
 public:
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionRandomDistribution<Distribution>>(); }
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    ...
    if (arguments.size() != desired && arguments.size() != desired + 1)
      throw Exception(ErrorCodes::NUMBER_OF_ARGUMENTS_DOESNT_MATCH, "Wrong number of arguments for function {}. Should be {} or {}",
    ...
    for (size_t i = 0; i < Distribution::getNumberOfArguments(); ++i) {
      ...
      if (!which.isFloat() && !which.isNativeUInt())
        throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal type {} of argument of function {}, expected Float64 or integer",
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr & /*result_type*/,
    ...
    if constexpr (std::is_same_v<Distribution, BernoulliDistribution>) {
      ...
      auto &res_data = res_column->getData();
      Distribution::generate(getParameterFromConstColumn<UInt64>(0, arguments), getParameterFromConstColumn<Float64>(1, arguments),
                             res_data);
      return res_column;
      ...
      if constexpr (Distribution::getNumberOfArguments() == 1) {
        ...
        Distribution::generate(getParameterFromConstColumn<Float64>(0, arguments), getParameterFromConstColumn<Float64>(1, arguments),
                               res_data);
      } else {
...
Returns a random Float64 number drawn uniformly from the interval $[\min, \max]$.
  ...
  FunctionDocumentation::Arguments arguments = {
      ...
      {"x",
       "Optional and ignored. The only purpose of the argument is to prevent [common subexpression "
       "elimination](/sql-reference/functions/overview#common-subexpression-elimination) when the same function call is used multiple "
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns a random number drawn uniformly from the interval formed by `min` and `max`.", {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT randUniform(5.5, 10) FROM numbers(5)", R"(
┌─randUniform(5.5, 10)─┐
│    8.094978491443102 │
│   7.3181248914450885 │
│    7.177741903868262 │
...
Returns a random Float64 number drawn from a [normal distribution](https://en.wikipedia.org/wiki/Normal_distribution).
  ...
  FunctionDocumentation::Arguments arguments_normal = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_normal = {
      "Returns a random Float64 number drawn from the specified normal distribution.", {"Float64"}};
  FunctionDocumentation::Examples examples_normal = {{"Usage example", "SELECT randNormal(10, 2) FROM numbers(5)", R"(
┌──randNormal(10, 2)─┐
│ 13.389228911709653 │
│  8.622949707401295 │
│ 10.801887062682981 │
...
└────────────────────┘
  ...
  FunctionDocumentation documentation_normal = {description_normal,    syntax_normal,   arguments_normal,     {},
                                                returned_value_normal, examples_normal, introduced_in_normal, category_normal};
...
Returns a random Float64 number drawn from a [log-normal distribution](https://en.wikipedia.org/wiki/Log-normal_distribution).
  ...
  FunctionDocumentation::Arguments arguments_lognormal = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_lognormal = {
      "Returns a random Float64 number drawn from the specified log-normal distribution.", {"Float64"}};
  FunctionDocumentation::Examples examples_lognormal = {{"Usage example", "SELECT randLogNormal(100, 5) FROM numbers(5)", R"(
┌─randLogNormal(100, 5)─┐
...
└───────────────────────┘
  ...
  FunctionDocumentation documentation_lognormal = {
      description_lognormal,    syntax_lognormal,   arguments_lognormal,     {},
      returned_value_lognormal, examples_lognormal, introduced_in_lognormal, category_lognormal};
...
Returns a random Float64 number drawn from an [exponential distribution](https://en.wikipedia.org/wiki/Exponential_distribution).
  ...
  FunctionDocumentation::Arguments arguments_exponential = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_exponential = {
      "Returns a random Float64 number drawn from the specified exponential distribution.", {"Float64"}};
  FunctionDocumentation::Examples examples_exponential = {{"Usage example", "SELECT randExponential(1/10) FROM numbers(5)", R"(
...
└────────────────────────────────┘
  ...
  FunctionDocumentation documentation_exponential = {
      description_exponential,    syntax_exponential,   arguments_exponential,     {},
      returned_value_exponential, examples_exponential, introduced_in_exponential, category_exponential};
...
Returns a random Float64 number drawn from a [chi-square distribution](https://en.wikipedia.org/wiki/Chi-squared_distribution).
  ...
  FunctionDocumentation::Arguments arguments_chisquared = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_chisquared = {
      "Returns a random Float64 number drawn from the specified chi-square distribution.", {"Float64"}};
  FunctionDocumentation::Examples examples_chisquared = {{"Usage example", "SELECT randChiSquared(10) FROM numbers(5)", R"(
┌─randChiSquared(10)─┐
│ 10.015463656521543 │
│  9.621799919882768 │
│   2.71785015634699 │
...
└────────────────────┘
  ...
  FunctionDocumentation documentation_chisquared = {
      description_chisquared,    syntax_chisquared,   arguments_chisquared,     {},
      returned_value_chisquared, examples_chisquared, introduced_in_chisquared, category_chisquared};
...
Returns a random Float64 number drawn from a [Student's t-distribution](https://en.wikipedia.org/wiki/Student%27s_t-distribution).
  ...
  FunctionDocumentation::Arguments arguments_studentt = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_studentt = {
      "Returns a random Float64 number drawn from the specified Student's t-distribution.", {"Float64"}};
  FunctionDocumentation::Examples examples_studentt = {{"Usage example", "SELECT randStudentT(10) FROM numbers(5)", R"(
┌─────randStudentT(10)─┐
│   1.2217309938538725 │
│   1.7941971681200541 │
│ -0.28192176076784664 │
...
└──────────────────────┘
  ...
  FunctionDocumentation documentation_studentt = {description_studentt,    syntax_studentt,   arguments_studentt,     {},
                                                  returned_value_studentt, examples_studentt, introduced_in_studentt, category_studentt};
...
Returns a random Float64 number drawn from an [F-distribution](https://en.wikipedia.org/wiki/F-distribution).
  ...
  FunctionDocumentation::Arguments arguments_fisherf = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_fisherf = {"Returns a random Float64 number drawn from the specified F-distribution",
                                                                 {"Float64"}};
  FunctionDocumentation::Examples examples_fisherf = {{"Usage example", "SELECT randFisherF(10, 3) FROM numbers(5)", R"(
┌─randFisherF(10, 20)─┐
│  0.7204609609506184 │
│  0.9926258472572916 │
│  1.4010752726735863 │
...
└─────────────────────┘
  ...
  FunctionDocumentation documentation_fisherf = {description_fisherf,    syntax_fisherf,   arguments_fisherf,     {},
                                                 returned_value_fisherf, examples_fisherf, introduced_in_fisherf, category_fisherf};
...
Returns a random Float64 number drawn from a [Bernoulli distribution](https://en.wikipedia.org/wiki/Bernoulli_distribution).
  ...
  FunctionDocumentation::Arguments arguments_bernoulli = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_bernoulli = {
      "Returns a random Float64 number drawn from the specified Bernoulli distribution.", {"UInt64"}};
  FunctionDocumentation::Examples examples_bernoulli = {{"Usage example", "SELECT randBernoulli(.75) FROM numbers(5)", R"(
┌─randBernoulli(0.75)─┐
│                   1 │
│                   1 │
│                   0 │
...
└─────────────────────┘
  ...
  FunctionDocumentation documentation_bernoulli = {
      description_bernoulli,    syntax_bernoulli,   arguments_bernoulli,     {},
      returned_value_bernoulli, examples_bernoulli, introduced_in_bernoulli, category_bernoulli};
...
Returns a random Float64 number drawn from a [binomial distribution](https://en.wikipedia.org/wiki/Binomial_distribution).
  ...
  FunctionDocumentation::Arguments arguments_binomial = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_binomial = {
      "Returns a random Float64 number drawn from the specified binomial distribution.", {"UInt64"}};
  FunctionDocumentation::Examples examples_binomial = {{"Usage example", "SELECT randBinomial(100, .75) FROM numbers(5)", R"(
...
└─────────────────────────┘
  ...
  FunctionDocumentation documentation_binomial = {description_binomial,    syntax_binomial,   arguments_binomial,     {},
                                                  returned_value_binomial, examples_binomial, introduced_in_binomial, category_binomial};
...
Returns a random Float64 number drawn from a [negative binomial distribution](https://en.wikipedia.org/wiki/Negative_binomial_distribution).
  ...
  FunctionDocumentation::Arguments arguments_negativebinomial = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_negativebinomial = {
...
└─────────────────────────────────┘
  ...
  FunctionDocumentation documentation_negativebinomial = {
      description_negativebinomial,    syntax_negativebinomial,   arguments_negativebinomial,     {},
      returned_value_negativebinomial, examples_negativebinomial, introduced_in_negativebinomial, category_negativebinomial};
...
Returns a random Float64 number drawn from a [Poisson distribution](https://en.wikipedia.org/wiki/Poisson_distribution) distribution.
  ...
  FunctionDocumentation::Arguments arguments_poisson = {
      ...
      {"x",
       ...
       "times in a query.",
       {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value_poisson = {
      "Returns a random Float64 number drawn from the specified Poisson distribution.", {"UInt64"}};
  FunctionDocumentation::Examples examples_poisson = {{"Usage example", "SELECT randPoisson(10) FROM numbers(5)", R"(
┌─randPoisson(10)─┐
│               8 │
│               8 │
│               7 │
...
└─────────────────┘
  ...
  FunctionDocumentation documentation_poisson = {description_poisson,    syntax_poisson,   arguments_poisson,     {},
                                                 returned_value_poisson, examples_poisson, introduced_in_poisson, category_poisson};
