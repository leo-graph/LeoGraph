...
addDays(datetime, num)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `datetime` plus `num` days.",
                                                         {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples = {{"Add days to different date types", R"(
WITH
