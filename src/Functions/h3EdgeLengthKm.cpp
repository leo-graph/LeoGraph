...
Calculates the average length of an [H3](https://h3geo.org/docs/core-library/h3Indexing/) hexagon edge in kilometers.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the average length of an [H3](#h3-index) hexagon edge in kilometers.",
                                                         {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Get edge length for maximum resolution", "SELECT h3EdgeLengthKm(15) AS edgeLengthKm",
                                               R"(
┌─edgeLengthKm─┐
│  0.000509713 │
└──────────────┘
