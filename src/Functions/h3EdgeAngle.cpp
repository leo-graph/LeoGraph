...
Calculates the average length of an [H3](https://h3geo.org/docs/core-library/h3Indexing/) hexagon edge in grades.
  ...
  FunctionDocumentation::Arguments arguments = {{"resolution", "Index resolution. Range: `[0, 15]`.", {"UInt8"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the average length of an [H3](#h3-index) hexagon edge in grades.",
                                                         {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Get edge angle for resolution 10", "SELECT h3EdgeAngle(10) AS edgeAngle",
                                               R"(
┌───────h3EdgeAngle(10)─┐
