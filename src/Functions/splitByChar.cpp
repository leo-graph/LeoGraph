...
- The original string `s` is empty
  ...
  FunctionDocumentation::Arguments arguments = {
      ...
      {"max_substrings",
       "Optional. If `max_substrings > 0`, the returned array will contain at most `max_substrings` substrings, otherwise the function "
       "will return as many substrings as possible. The default value is `0`. ",
       {"Int64"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns an array of selected substrings.", {"Array(String)"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT splitByChar(',', '1,2,3,abcde');",
                                               R"(
