...
toRelativeHourNum(date)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the number of hours from a fixed reference point in the past.",
                                                         {"UInt32"}};
  FunctionDocumentation::Examples examples = {{"Get relative hour numbers", R"(
