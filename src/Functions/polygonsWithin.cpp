...
class FunctionPolygonsWithin : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionPolygonsWithin>(); }
...
Checks if a polygon is within another polygon.
  ...
  FunctionDocumentation::ReturnedValue returned_value_cartesian = {"Returns `1` if `polygon1` is contained in `polygon2`, otherwise `0`.",
                                                                   {"UInt8"}};
