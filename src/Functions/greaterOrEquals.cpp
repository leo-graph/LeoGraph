...
REGISTER_FUNCTION(GreaterOrEquals) {
  ...
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT 2 >= 1, 2 >= 2, 1 >= 2;", R"(
...
template <>
ColumnPtr FunctionComparison<GreaterOrEqualsOp, NameGreaterOrEquals>::executeTupleImpl(const ColumnsWithTypeAndName& x,
  ...
  return executeTupleLessGreaterImpl(greater, greater_or_equals, func_builder_and, func_builder_or, func_builder_equals, x, y, tuple_size,
                                     input_rows_count);
}
