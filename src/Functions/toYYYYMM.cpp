...
toYYYYMM(datetime[, timezone])
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a UInt32 number containing the year and month number (YYYY * 100 + MM).",
                                                         {"UInt32"}};
  FunctionDocumentation::Examples examples = {{"Convert current date to YYYYMM format", R"(
