...
A subsequence of a string is a sequence that can be derived from another string by deleting some or no characters without changing the order of the remaining characters.
  ...
  FunctionDocumentation::Arguments arguments = {{"haystack", "String in which to search for the subsequence.", {"String"}},
  ...
  FunctionDocumentation::Examples examples = {{"Basic subsequence check", "SELECT hasSubsequence('Hello World', 'HlWrd')",
                                               R"(
┌─hasSubsequence('Hello World', 'HlWrd')─┐
│                                      1 │
└────────────────────────────────────────┘
        )"},
                                              {"No subsequence found", "SELECT hasSubsequence('Hello World', 'xyz')",
                                               R"(
