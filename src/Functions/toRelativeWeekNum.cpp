...
toRelativeWeekNum(date)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the number of weeks from a fixed reference point in the past.",
                                                         {"UInt32"}};
  FunctionDocumentation::Examples examples = {{"Get relative week numbers", R"(
