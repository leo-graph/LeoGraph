...
:::
  ...
  FunctionDocumentation::Arguments arguments = {{"s", "A string type.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"A String data type value.", {"String"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT upperUTF8('München') AS Upperutf8",
                                               R"(
┌─Upperutf8─┐
│ MÜNCHEN   │
└───────────┘
