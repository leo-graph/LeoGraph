...
REGISTER_FUNCTION(MultiSearchAllPositionsCaseInsensitiveUTF8) {
  ...
  FunctionDocumentation::Arguments arguments = {{"haystack", "UTF-8 encoded string in which the search is performed.", {"String"}},
  ...
  FunctionDocumentation::Examples examples = {
      {"Case-insensitive UTF-8 search", "SELECT multiSearchAllPositionsCaseInsensitiveUTF8('Здравствуй, мир!', ['здравствуй', 'МИР']);",
       R"(
┌─multiSearchA⋯й', 'МИР'])─┐
│ [1, 13]                  │
└──────────────────────────┘
