...
using FunctionCountSubstringsCaseInsensitive =
    FunctionsStringSearch<CountSubstringsImpl<NameCountSubstringsCaseInsensitive, PositionCaseInsensitiveASCII>>;
...
REGISTER_FUNCTION(CountSubstringsCaseInsensitive) {
  ...
  FunctionDocumentation::Examples examples = {
      {"Usage example", "SELECT countSubstringsCaseInsensitive('AAAA', 'aa');",
       R"(
┌─countSubstri⋯AAA', 'aa')─┐
│                        2 │
└──────────────────────────┘
        )"},
      {"With start_pos argument", "SELECT countSubstringsCaseInsensitive('abc___ABC___abc', 'abc', 4);",
       R"(
┌─countSubstri⋯, 'abc', 4)─┐
│                        2 │
└──────────────────────────┘
