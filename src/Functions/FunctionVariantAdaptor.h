...
class ExecutableFunctionVariantAdaptor final : public IExecutableFunction {
 public:
  explicit ExecutableFunctionVariantAdaptor(std::shared_ptr<const IFunctionOverloadResolver> function_overload_resolver_,
 ...
 private:
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &result_type, size_t input_rows_count,
                        bool dry_run) const;
...
class FunctionBaseVariantAdaptor final : public IFunctionBase {
 public:
  FunctionBaseVariantAdaptor(std::shared_ptr<const IFunctionOverloadResolver> function_overload_resolver_,
  ...
  bool isShortCircuit(ShortCircuitSettings &settings, size_t number_of_arguments) const override {
    return function_overload_resolver->isShortCircuit(settings, number_of_arguments);
  }
