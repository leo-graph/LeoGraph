...
subtractQuarters(datetime, num)
  ...
  FunctionDocumentation::Arguments arguments = {{"datetime",
                                                 "Date or date with time to subtract specified number of quarters from.",
                                                 {"Date", "Date32", "DateTime", "DateTime64", "String"}},
                                                {"num", "Number of quarters to subtract.", {"(U)Int*", "Float*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `datetime` minus `num` quarters",
                                                         {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples = {{"Subtract quarters from different date types", R"(
WITH
