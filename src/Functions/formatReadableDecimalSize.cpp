...
The opposite operations of this function are [`parseReadableSize`](#parseReadableSize).
  ...
  FunctionDocumentation::Examples examples = {{"Format file sizes", R"(
SELECT
...
└────────────────┴────────────┘
  ...
  factory.registerFunction(
      ...
      [](ContextPtr) { return FunctionFormatReadable::create("formatReadableDecimalSize", formatReadableSizeWithDecimalSuffix); },
      documentation);
}
