...
Provides all of the unidirectional edges from the provided H3Index.
  ...
  FunctionDocumentation::Arguments arguments = {{"index", "Hexagon index number that represents a cell.", {"UInt64"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns an array of H3 indexes representing each unidirectional edge.",
                                                         {"Array(UInt64)"}};
  FunctionDocumentation::Examples examples = {{"Get all edges for an H3 index",
