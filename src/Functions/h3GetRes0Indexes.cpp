...
Returns an array of all the resolution 0 [H3](#h3-index) indices.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns an array of all resolution 0 H3 indices.", {"Array(UInt64)"}};
  FunctionDocumentation::Examples examples = {{"Get all resolution 0 H3 indices", "SELECT h3GetRes0Indexes() AS indexes",
                                               R"(
┌─indexes─────────────────────────────────────┐
