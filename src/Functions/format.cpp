...
Field names can be numbers (starting from zero) or empty (then they are implicitly given monotonically increasing numbers).
  ...
  FunctionDocumentation::Arguments arguments = {{"pattern", "The format string containing placeholders.", {"String"}},
  ...
  FunctionDocumentation::Examples examples = {{"Numbered placeholders", "SELECT format('{1} {0} {1}', 'World', 'Hello')",
                                               R"(
┌─format('{1} {0} {1}', 'World', 'Hello')─┐
│ Hello World Hello                       │
└─────────────────────────────────────────┘
        )"},
                                              {"Implicit numbering", "SELECT format('{} {}', 'Hello', 'World')",
                                               R"(
┌─format('{} {}', 'Hello', 'World')─┐
│ Hello World                       │
└───────────────────────────────────┘
