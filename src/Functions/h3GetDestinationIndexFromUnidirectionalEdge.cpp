...
Returns the destination hexagon index from the unidirectional edge [H3](#h3-index).
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the destination hexagon index from the unidirectional edge.", {"UInt64"}};
  FunctionDocumentation::Examples examples = {{"Get destination index from a unidirectional edge",
