...
class FunctionMaterialize : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionMaterialize<remove_special_representations>>(); }
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t /*input_rows_count*/) const override {
    ...
    if constexpr (remove_special_representations) res = removeSpecialRepresentations(res);
    return res;
  }
