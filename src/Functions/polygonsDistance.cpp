...
class FunctionPolygonsDistance : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionPolygonsDistance>(); }
...
Calculates distance between two polygons.
  ...
  FunctionDocumentation::Arguments arguments_cartesian = {{"polygon1", "A Polygon value", {"Polygon"}},
  ...
  FunctionDocumentation::Examples examples_cartesian = {{"Distance example",
                                                         R"(
...
Using this type of coordinate system speeds up execution, but of course is not precise.
  ...
  FunctionDocumentation::Arguments arguments_spherical = {{"polygon1", "The first Polygon value.", {"Polygon"}},
                                                          {"polygon2", "The second Polygon value.", {"Polygon"}}};
  FunctionDocumentation::ReturnedValue returned_value_spherical = {"Returns the minimal distance between the two polygons on a sphere",
                                                                   {"Float64"}};
  FunctionDocumentation::Examples examples_spherical = {{"Spherical distance",
                                                         R"(
