...
REGISTER_FUNCTION(Bitmap) {
  ...
  FunctionDocumentation::Description description_bitmapBuild =
      "Builds a bitmap from an unsigned integer array. It is the opposite of function "
      "[`bitmapToArray`](/sql-reference/functions/bitmap-functions#bitmapToArray).";
  ...
  FunctionDocumentation::ReturnedValue returned_value_bitmapBuild = {"Returns a bitmap from the provided array",
...
└─────┴──────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_bitmapBuild = {
      description_bitmapBuild,    syntax_bitmapBuild,   arguments_bitmapBuild,     {},
      returned_value_bitmapBuild, examples_bitmapBuild, introduced_in_bitmapBuild, category_bitmapBuild};

  factory.registerFunction<FunctionBitmapBuild>(documentation_bitmapBuild);

  /// Documentation for bitmapToArray
  FunctionDocumentation::Description description_bitmapToArray =
      "Converts a bitmap to an array of unsigned integers. It is the opposite of function "
      "[`bitmapBuild`](/sql-reference/functions/bitmap-functions#bitmapBuild).";
  ...
  FunctionDocumentation::ReturnedValue returned_value_bitmapToArray = {"Returns an array of unsigned integers contained in the bitmap",
                                                                       {"Array(UInt*)"}};
...
└─────────────────┘
  ...
  FunctionDocumentation documentation_bitmapToArray = {
      description_bitmapToArray,    syntax_bitmapToArray,   arguments_bitmapToArray,     {},
      returned_value_bitmapToArray, examples_bitmapToArray, introduced_in_bitmapToArray, category_bitmapToArray};

  factory.registerFunction<FunctionBitmapToArray>(documentation_bitmapToArray);

  /// Documentation for bitmapSubsetInRange
  FunctionDocumentation::Description description_bitmapSubsetInRange =
  ...
  FunctionDocumentation::ReturnedValue returned_value_bitmapSubsetInRange = {
      "Returns a bitmap containing only the set bits in the specified range", {"AggregateFunction(groupBitmap, T)"}};
  FunctionDocumentation::Examples examples_bitmapSubsetInRange = {
      {"Usage example", "SELECT bitmapToArray(bitmapSubsetInRange(bitmapBuild([1, 2, 3, 4, 5]), 2, 5)) AS res;",
       R"(
┌─res───────┐
│ [2, 3, 4] │
└───────────┘
  ...
  FunctionDocumentation documentation_bitmapSubsetInRange = {
      description_bitmapSubsetInRange,    syntax_bitmapSubsetInRange,   arguments_bitmapSubsetInRange,     {},
      returned_value_bitmapSubsetInRange, examples_bitmapSubsetInRange, introduced_in_bitmapSubsetInRange, category_bitmapSubsetInRange};
  ...
  FunctionDocumentation::Description description_bitmapSubsetLimit =
  ...
  FunctionDocumentation::ReturnedValue returned_value_bitmapSubsetLimit = {
      "Returns a bitmap containing at most `cardinality_limit` set bits, starting from `range_start`",
      {"AggregateFunction(groupBitmap, T)"}};
  FunctionDocumentation::Examples examples_bitmapSubsetLimit = {
      {"Usage example", "SELECT bitmapToArray(bitmapSubsetLimit(bitmapBuild([1, 5, 3, 2, 8]), 3, 2)) AS res;",
       R"(
┌─res────┐
│ [5, 3] │
└────────┘
  ...
  FunctionDocumentation documentation_bitmapSubsetLimit = {
      description_bitmapSubsetLimit,    syntax_bitmapSubsetLimit,   arguments_bitmapSubsetLimit,     {},
      returned_value_bitmapSubsetLimit, examples_bitmapSubsetLimit, introduced_in_bitmapSubsetLimit, category_bitmapSubsetLimit};

  factory.registerFunction<FunctionBitmapSubsetLimit>(documentation_bitmapSubsetLimit);

  /// Documentation for subBitmap (bitmapSubsetOffsetLimit is the unregistered alias see:
  /// https://github.com/ClickHouse/ClickHouse/pull/27234)
  FunctionDocumentation::Description description_subBitmap =
      "Returns a subset of the bitmap, starting from position `offset`. The maximum cardinality of the returned bitmap is "
      "`cardinality_limit`.";
  ...
  FunctionDocumentation::ReturnedValue returned_value_subBitmap = {
      "Returns a bitmap containing at most `limit` set bits, starting after skipping `offset` set bits in ascending order",
      {"AggregateFunction(groupBitmap, T)"}};
  FunctionDocumentation::Examples examples_subBitmap = {{"Usage example",
...
└────────┘
  ...
  FunctionDocumentation documentation_subBitmap = {
      description_subBitmap,    syntax_subBitmap,   arguments_subBitmap,     {},
      returned_value_subBitmap, examples_subBitmap, introduced_in_subBitmap, category_subBitmap};
...
Changes up to N bits in a bitmap by swapping specific bit values in `from_array` with corresponding ones in `to_array`.
  ...
  FunctionDocumentation::ReturnedValue returned_value_bitmapTransform = {
...
└───────────────────┘
  ...
  FunctionDocumentation documentation_bitmapTransform = {
      description_bitmapTransform,    syntax_bitmapTransform,   arguments_bitmapTransform,     {},
      returned_value_bitmapTransform, examples_bitmapTransform, introduced_in_bitmapTransform, category_bitmapTransform};
  ...
  FunctionDocumentation::Examples examples_bitmapCardinality = {{"Usage example",
...
└─────┘
  ...
  FunctionDocumentation documentation_bitmapCardinality = {
      description_bitmapCardinality,    syntax_bitmapCardinality,   arguments_bitmapCardinality,     {},
      returned_value_bitmapCardinality, examples_bitmapCardinality, introduced_in_bitmapCardinality, category_bitmapCardinality};

  factory.registerFunction<FunctionBitmapSelfCardinality>(documentation_bitmapCardinality);

  /// Documentation for bitmapMin
  FunctionDocumentation::Description description_bitmapMin =
      "Returns the position of the smallest bit set in a bitmap. If all bits are unset, or `UINT32_MAX` (`UINT64_MAX` if the bitmap "
      "contains more than `2^64` bits).";
  FunctionDocumentation::Syntax syntax_bitmapMin = "bitmapMin(bitmap)";
  FunctionDocumentation::Arguments arguments_bitmapMin = {
      {"bitmap", "Bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapMin = {
...
└─────┘
  ...
  FunctionDocumentation documentation_bitmapMin = {
      description_bitmapMin,    syntax_bitmapMin,   arguments_bitmapMin,     {},
      returned_value_bitmapMin, examples_bitmapMin, introduced_in_bitmapMin, category_bitmapMin};

  factory.registerFunction<FunctionBitmapMin>(documentation_bitmapMin);

  /// Documentation for bitmapMax
  FunctionDocumentation::Description description_bitmapMax =
  ...
  FunctionDocumentation::Arguments arguments_bitmapMax = {
      {"bitmap", "Bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapMax = {
...
└─────┘
  ...
  FunctionDocumentation documentation_bitmapMax = {
      description_bitmapMax,    syntax_bitmapMax,   arguments_bitmapMax,     {},
      returned_value_bitmapMax, examples_bitmapMax, introduced_in_bitmapMax, category_bitmapMax};

  factory.registerFunction<FunctionBitmapMax>(documentation_bitmapMax);

  /// Documentation for bitmapAndCardinality
  FunctionDocumentation::Description description_bitmapAndCardinality =
  ...
  FunctionDocumentation::ReturnedValue returned_value_bitmapAndCardinality = {
      "Returns the number of set bits in the intersection of the two bitmaps", {"UInt64"}};
  FunctionDocumentation::Examples examples_bitmapAndCardinality = {
      {"Usage example", "SELECT bitmapAndCardinality(bitmapBuild([1,2,3]), bitmapBuild([3,4,5])) AS res;",
       R"(
┌─res─┐
│   1 │
└─────┘
  ...
  FunctionDocumentation documentation_bitmapAndCardinality = {description_bitmapAndCardinality,    syntax_bitmapAndCardinality,
                                                              arguments_bitmapAndCardinality,      {},
                                                              returned_value_bitmapAndCardinality, examples_bitmapAndCardinality,
                                                              introduced_in_bitmapAndCardinality,  category_bitmapAndCardinality};
  ...
  FunctionDocumentation::Description description_bitmapOrCardinality =
  ...
  FunctionDocumentation::Arguments arguments_bitmapOrCardinality = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapOrCardinality = {
      "Returns the number of set bits in the union of the two bitmaps", {"UInt64"}};
  FunctionDocumentation::Examples examples_bitmapOrCardinality = {
      {"Usage example", "SELECT bitmapOrCardinality(bitmapBuild([1,2,3]), bitmapBuild([3,4,5])) AS res;",
       R"(
┌─res─┐
│   5 │
└─────┘
  ...
  FunctionDocumentation documentation_bitmapOrCardinality = {
      description_bitmapOrCardinality,    syntax_bitmapOrCardinality,   arguments_bitmapOrCardinality,     {},
      returned_value_bitmapOrCardinality, examples_bitmapOrCardinality, introduced_in_bitmapOrCardinality, category_bitmapOrCardinality};
  ...
  FunctionDocumentation::Description description_bitmapXorCardinality =
  ...
  FunctionDocumentation::Examples examples_bitmapXorCardinality = {
      {"Usage example", "SELECT bitmapXorCardinality(bitmapBuild([1,2,3]), bitmapBuild([3,4,5])) AS res;",
       R"(
┌─res─┐
│   4 │
└─────┘
  ...
  FunctionDocumentation documentation_bitmapXorCardinality = {description_bitmapXorCardinality,    syntax_bitmapXorCardinality,
                                                              arguments_bitmapXorCardinality,      {},
                                                              returned_value_bitmapXorCardinality, examples_bitmapXorCardinality,
                                                              introduced_in_bitmapXorCardinality,  category_bitmapXorCardinality};
  ...
  FunctionDocumentation::Description description_bitmapAndnotCardinality =
  ...
  FunctionDocumentation::Arguments arguments_bitmapAndnotCardinality = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapAndnotCardinality = {
      "Returns the number of set bits in the result of `bitmap1 AND-NOT bitmap2`", {"UInt64"}};
  FunctionDocumentation::Examples examples_bitmapAndnotCardinality = {
      {"Usage example", "SELECT bitmapAndnotCardinality(bitmapBuild([1,2,3]), bitmapBuild([3,4,5])) AS res;",
       R"(
┌─res─┐
│   2 │
└─────┘
  ...
  FunctionDocumentation documentation_bitmapAndnotCardinality = {description_bitmapAndnotCardinality,    syntax_bitmapAndnotCardinality,
                                                                 arguments_bitmapAndnotCardinality,      {},
                                                                 returned_value_bitmapAndnotCardinality, examples_bitmapAndnotCardinality,
  ...
  FunctionDocumentation::Arguments arguments_bitmapAnd = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapAnd = {"Returns a bitmap containing bits present in both input bitmaps",
                                                                   {"AggregateFunction(groupBitmap, T)"}};
  FunctionDocumentation::Examples examples_bitmapAnd = {
      {"Usage example", "SELECT bitmapToArray(bitmapAnd(bitmapBuild([1, 2, 3]), bitmapBuild([3, 4, 5]))) AS res;",
       R"(
┌─res─┐
│ [3] │
└─────┘
  ...
  FunctionDocumentation documentation_bitmapAnd = {
      description_bitmapAnd,    syntax_bitmapAnd,   arguments_bitmapAnd,     {},
      returned_value_bitmapAnd, examples_bitmapAnd, introduced_in_bitmapAnd, category_bitmapAnd};
  ...
  FunctionDocumentation::Arguments arguments_bitmapOr = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapOr = {"Returns a bitmap containing set bits present in either input bitmap",
                                                                  {"AggregateFunction(groupBitmap, T)"}};
  FunctionDocumentation::Examples examples_bitmapOr = {
      {"Usage example", "SELECT bitmapToArray(bitmapOr(bitmapBuild([1, 2, 3]), bitmapBuild([3, 4, 5]))) AS res;",
       R"(
┌─res─────────────┐
│ [1, 2, 3, 4, 5] │
└─────────────────┘
  ...
  FunctionDocumentation documentation_bitmapOr = {description_bitmapOr,    syntax_bitmapOr,   arguments_bitmapOr,     {},
                                                  returned_value_bitmapOr, examples_bitmapOr, introduced_in_bitmapOr, category_bitmapOr};
  ...
  FunctionDocumentation::Arguments arguments_bitmapXor = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapXor = {
      "Returns a bitmap containing set bits present in either input bitmap, but not in both", {"AggregateFunction(groupBitmap, T)"}};
  FunctionDocumentation::Examples examples_bitmapXor = {
      {"Usage example", "SELECT bitmapToArray(bitmapXor(bitmapBuild([1, 2, 3]), bitmapBuild([3, 4, 5]))) AS res;",
       R"(
┌─res──────────┐
│ [1, 2, 4, 5] │
└──────────────┘
  ...
  FunctionDocumentation documentation_bitmapXor = {
      description_bitmapXor,    syntax_bitmapXor,   arguments_bitmapXor,     {},
      returned_value_bitmapXor, examples_bitmapXor, introduced_in_bitmapXor, category_bitmapXor};
  ...
  FunctionDocumentation::Arguments arguments_bitmapAndnot = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapAndnot = {
      "Returns a bitmap containing set bits present in the first bitmap but not in the second", {"AggregateFunction(groupBitmap, T)"}};
  FunctionDocumentation::Examples examples_bitmapAndnot = {
      {"Usage example", "SELECT bitmapToArray(bitmapAndnot(bitmapBuild([1, 2, 3]), bitmapBuild([3, 4, 5]))) AS res;",
       R"(
┌─res────┐
│ [1, 2] │
└────────┘
  ...
  FunctionDocumentation documentation_bitmapAndnot = {
      description_bitmapAndnot,    syntax_bitmapAndnot,   arguments_bitmapAndnot,     {},
      returned_value_bitmapAndnot, examples_bitmapAndnot, introduced_in_bitmapAndnot, category_bitmapAndnot};
  ...
  FunctionDocumentation::Arguments arguments_bitmapHasAll = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapHasAll = {
      "Returns `1` if all set bits of the second bitmap are present in the first bitmap, otherwise `0`", {"UInt8"}};
  FunctionDocumentation::Examples examples_bitmapHasAll = {{"Usage example",
...
└─────┘
  ...
  FunctionDocumentation documentation_bitmapHasAll = {
      description_bitmapHasAll,    syntax_bitmapHasAll,   arguments_bitmapHasAll,     {},
      returned_value_bitmapHasAll, examples_bitmapHasAll, introduced_in_bitmapHasAll, category_bitmapHasAll};
  ...
  FunctionDocumentation::Arguments arguments_bitmapHasAny = {
      {"bitmap1", "First bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."},
      {"bitmap2", "Second bitmap object. [`AggregateFunction(groupBitmap, T)`](/sql-reference/data-types/aggregatefunction)."}};
  FunctionDocumentation::ReturnedValue returned_value_bitmapHasAny = {
      "Returns `1` if any bits of the second bitmap are present in the first bitmap, otherwise `0`", {"UInt8"}};
  FunctionDocumentation::Examples examples_bitmapHasAny = {{"Usage example",
...
└─────┘
  ...
  FunctionDocumentation documentation_bitmapHasAny = {
      description_bitmapHasAny,    syntax_bitmapHasAny,   arguments_bitmapHasAny,     {},
      returned_value_bitmapHasAny, examples_bitmapHasAny, introduced_in_bitmapHasAny, category_bitmapHasAny};
  ...
  FunctionDocumentation::ReturnedValue returned_value_bitmapContains = {
...
└─────┘
  ...
  FunctionDocumentation documentation_bitmapContains = {
      description_bitmapContains,    syntax_bitmapContains,   arguments_bitmapContains,     {},
      returned_value_bitmapContains, examples_bitmapContains, introduced_in_bitmapContains, category_bitmapContains};
