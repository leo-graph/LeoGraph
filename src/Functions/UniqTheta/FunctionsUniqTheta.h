 ...
 public:
  ...
  DataTypePtr getReturnTypeImpl(const DataTypes &arguments) const override {
    ...
    if (!(sketch_type0 && sketch_type0->getFunctionName() == "uniqTheta"))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "First argument for function {} must be a uniqTheta but it has type {}",
    ...
    if (!(sketch_type1 && sketch_type1->getFunctionName() == "uniqTheta"))
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Second argument for function {} must be a uniqTheta but it has type {}",
    ...
    if (arg_data_types0.size() != arg_data_types1.size())
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT,
                      ...
                      arg_data_types0.size(), arg_data_types1.size());
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (size_t i = 0; i < input_rows_count; ++i) {
      ...
      const AggregateFunctionUniqThetaData &sketch_data_2 = *reinterpret_cast<const AggregateFunctionUniqThetaData *>(data_ptr_1);
