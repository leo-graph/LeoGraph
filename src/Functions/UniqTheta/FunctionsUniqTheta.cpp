...
Two uniqThetaSketch objects to do union calculation(set operation ∪), the result is a new uniqThetaSketch.
  ...
  FunctionDocumentation::ReturnedValue returned_value_uniqThetaUnion = {"Returns a new uniqThetaSketch containing the union result.",
                                                                        {"UInt64"}};
  FunctionDocumentation::Examples examples_uniqThetaUnion = {{"Usage example",
                                                              R"(
...
└───────────┴───────────────┴───────────────┘
  ...
  FunctionDocumentation documentation_uniqThetaUnion = {
      description_uniqThetaUnion,    syntax_uniqThetaUnion,   arguments_uniqThetaUnion,     {},
      returned_value_uniqThetaUnion, examples_uniqThetaUnion, introduced_in_uniqThetaUnion, category_uniqThetaUnion};
...
Two uniqThetaSketch objects to do intersect calculation(set operation ∩), the result is a new uniqThetaSketch.
  ...
  FunctionDocumentation::Arguments arguments_uniqThetaIntersect = {
      {"uniqThetaSketch", "uniqThetaSketch object.", {"Tuple", "Array", "Date", "DateTime", "String", "(U)Int*", "Float*", "Decimal"}}};
  FunctionDocumentation::ReturnedValue returned_value_uniqThetaIntersect = {"A new uniqThetaSketch containing the intersect result.",
                                                                            {"UInt64"}};
  FunctionDocumentation::Examples examples_uniqThetaIntersect = {{"Usage example",
                                                                  R"(
...
└───────────────┴───────────────┴───────────────┘
  ...
  FunctionDocumentation documentation_uniqThetaIntersect = {
      description_uniqThetaIntersect,    syntax_uniqThetaIntersect,   arguments_uniqThetaIntersect,     {},
      returned_value_uniqThetaIntersect, examples_uniqThetaIntersect, introduced_in_uniqThetaIntersect, category_uniqThetaIntersect};
...
Two uniqThetaSketch objects to do a_not_b calculation(set operation ×), the result is a new uniqThetaSketch.
  ...
  FunctionDocumentation::Arguments arguments_uniqThetaNot = {
      {"uniqThetaSketch", "uniqThetaSketch object.", {"Tuple", "Array", "Date", "DateTime", "String", "(U)Int*", "Float*", "Decimal"}}};
  FunctionDocumentation::ReturnedValue returned_value_uniqThetaNot = {"Returns a new uniqThetaSketch containing the a_not_b result.",
                                                                      {"UInt64"}};
  FunctionDocumentation::Examples examples_uniqThetaNot = {{"Usage example",
                                                            R"(
...
└─────────┴───────────────┴───────────────┘
  ...
  FunctionDocumentation documentation_uniqThetaNot = {
      description_uniqThetaNot,    syntax_uniqThetaNot,   arguments_uniqThetaNot,     {},
      returned_value_uniqThetaNot, examples_uniqThetaNot, introduced_in_uniqThetaNot, category_uniqThetaNot};
