...
struct NameIdnaEncode {
  static constexpr auto name = "idnaEncode";
};
struct NameTryIdnaEncode {
  static constexpr auto name = "tryIdnaEncode";
};
struct NameIdnaDecode {
...
:::
  ...
  FunctionDocumentation::Arguments arguments_encode = {{"s", "Input string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_encode = {
      "Returns an ASCII representation of the input string according to the IDNA mechanism of the input value.", {"String"}};
  FunctionDocumentation::Examples examples_encode = {{"Usage example", "SELECT idnaEncode('straße.münchen.de')",
                                                      R"(
...
└─────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_encode = {description_encode,    syntax_encode,   arguments_encode, {},
                                                returned_value_encode, examples_encode, introduced_in,    category};
...
In case of an error it returns an empty string instead of throwing an exception.
  ...
  FunctionDocumentation::Arguments arguments_try_encode = {{"s", "Input string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_try_encode = {
      "Returns an ASCII representation of the input string according to the IDNA mechanism of the input value, or empty string if input is "
      "invalid.",
      {"String"}};
  FunctionDocumentation::Examples examples_try_encode = {{"Usage example", "SELECT tryIdnaEncode('straße.münchen.de')",
                                                          R"(
┌─tryIdnaEncode('straße.münchen.de')──┐
│ xn--strae-oqa.xn--mnchen-3ya.de     │
└─────────────────────────────────────┘
        )"}};
  FunctionDocumentation documentation_try_encode = {description_try_encode,    syntax_try_encode,   arguments_try_encode, {},
                                                    returned_value_try_encode, examples_try_encode, introduced_in,        category};
...
Note that repeated application of [`idnaEncode()`](#idnaEncode) and [`idnaDecode()`](#idnaDecode) does not necessarily return the original string due to case normalization.
  ...
  FunctionDocumentation::Arguments arguments_decode = {{"s", "Input string.", {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_decode = {
      "Returns a Unicode (UTF-8) representation of the input string according to the IDNA mechanism of the input value.", {"String"}};
  FunctionDocumentation::Examples examples_decode = {{"Usage example", "SELECT idnaDecode('xn--strae-oqa.xn--mnchen-3ya.de')",
                                                      R"(
┌─idnaDecode('xn--strae-oqa.xn--mnchen-3ya.de')─┐
│ straße.münchen.de                             │
└───────────────────────────────────────────────┘
        )"}};
  FunctionDocumentation documentation_decode = {description_decode,    syntax_decode,   arguments_decode, {},
                                                returned_value_decode, examples_decode, introduced_in,    category};
