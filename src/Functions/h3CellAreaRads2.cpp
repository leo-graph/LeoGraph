...
Returns the exact area of a specific cell in square radians corresponding to the given input [H3](#h3-index) index.
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the exact area of the H3 cell in square radians.", {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Get area of an H3 cell in square radians",
