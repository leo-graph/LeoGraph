...
Converts radians to degrees.
  ...
  FunctionDocumentation::Arguments arguments = {{"x", "Input in radians.", {"(U)Int*", "Float*", "Decimal*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the value of `x` in degrees.", {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Basic usage", "SELECT degrees(3.141592653589793)", "180"}};
