...
toDaysSinceYearZero(date[, time_zone])
  ...
  FunctionDocumentation::Arguments arguments = {
      {"date",
       "The date or date with time for which to calculate the number of days since year zero from.",
  ...
  FunctionDocumentation::Examples examples = {{"Calculate days since year zero", R"(
