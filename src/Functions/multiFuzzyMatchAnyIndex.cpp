...
using FunctionMultiFuzzyMatchAnyIndex = FunctionsMultiStringFuzzySearch<
    MultiMatchAnyImpl<NameMultiFuzzyMatchAnyIndex, /*ResultType*/ UInt64, MultiMatchTraits::Find::AnyIndex, /*WithEditDistance*/ true>>;

}  // namespace

REGISTER_FUNCTION(MultiFuzzyMatchAnyIndex) {
  FunctionDocumentation::Description description =
      "Like [`multiFuzzyMatchAny`](#multiFuzzyMatchAny) but returns any index that matches the haystack within a constant [edit "
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns the index (starting from 1) of any pattern that matches the haystack within the specified edit distance, otherwise `0`.",
      {"UInt64"}};
