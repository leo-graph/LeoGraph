...
using Base64DecodeImpl =
    BaseXXDecode<Base64DecodeTraits<Base64Variant::Normal>, NameBase64Decode, BaseXXDecodeErrorHandling::ReturnEmptyString>;
...
Like [`base64Decode`](#base64Decode), but returns an empty string in case of error.
  ...
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT tryBase64Decode('Y2xpY2tob3VzZQ==')",
                                               R"(
