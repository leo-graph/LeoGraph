...
toRelativeMinuteNum(date)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the number of minutes from a fixed reference point in the past.",
                                                         {"UInt32"}};
  FunctionDocumentation::Examples examples = {{"Get relative minute numbers", R"(
