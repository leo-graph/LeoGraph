...
struct DivideFloatingImpl {
  ...
  static llvm::Value* compile(llvm::IRBuilder<>& b, llvm::Value* left, llvm::Value* right, bool) {
    if (left->getType()->isIntegerTy()) throw Exception(ErrorCodes::LOGICAL_ERROR, "DivideFloatingImpl expected a floating-point type");
...
struct NameDivideOrNull {
  static constexpr auto name = "divideOrNull";
};
