...
Converts degrees to radians.
  ...
  FunctionDocumentation::Arguments arguments = {{"x", "Input in degrees.", {"(U)Int*", "Float*", "Decimal*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns value in radians", {"Float64"}};
  FunctionDocumentation::Examples examples = {{"Usage example", "SELECT radians(180)", "3.141592653589793"}};
