...
String getDictGetOrDefaultDescription(const String& type_name) {
  return fmt::format(
      "Converts a dictionary attribute value to `{}` data type regardless of the dictionary configuration, or returns the provided default "
      "value if the key is not found.",
      type_name);
}

/// Helper to get the syntax for dictGet<type> functions
String getDictGetSyntax(const String& type_name) { return fmt::format("dictGet{}(dict_name, attr_name, id_expr)", type_name); }
...
FunctionDocumentation::Arguments getDictGetArguments() {
  ...
  args.emplace_back(FunctionDocumentation::Argument{
      "id_expr",
      "Key value. An expression returning a dictionary key-type value or tuple value (dictionary configuration dependent).",
      {"Expression", "Tuple(T)"}});
  return args;
}
...
FunctionDocumentation::Arguments getDictGetOrDefaultArguments() {
  ...
  args.emplace_back(FunctionDocumentation::Argument{
      "id_expr",
      "Key value. Expression returning dictionary key-type value or tuple value (dictionary configuration dependent).",
      {"Expression", "Tuple(T)"}});
  args.emplace_back(FunctionDocumentation::Argument{"default_value_expr",
                                                    "Value(s) returned if the dictionary does not contain a row with the `id_expr` key.",
                                                    {"Expression", "Tuple(T)"}});
  return args;
}
...
If the key is not found, returns the content of the `<null_value>` element specified for the attribute in the dictionary configuration.
    ...
    FunctionDocumentation::Examples examples = {
        {"Retrieve a single attribute", "SELECT dictGet('ext_dict_test', 'c1', toUInt64(1)) AS val", "1"},
        {"Multiple attributes",
         R"(
SELECT
...
└─────────┴────────────────┘
    ...
    FunctionDocumentation documentation = {description,    syntax,   arguments,     {},
                                           returned_value, examples, introduced_in, category_dictionary};
...
If the key is not found, returns the `default_value` provided.
    ...
    FunctionDocumentation::Examples examples = {
        {"Get value with default", "SELECT dictGetOrDefault('ext_dict_mult', 'c1', toUInt64(999), 0) AS val", "0"}};
    FunctionDocumentation::IntroducedIn introduced_in = {18, 16};
    FunctionDocumentation documentation = {description,    syntax,   arguments,     {},
                                           returned_value, examples, introduced_in, category_dictionary};
  ...
  /// dictGetOrNull
  {
    ...
    FunctionDocumentation::Arguments arguments = {{"dict_name", "Name of the dictionary. String literal."},
...
(4,'2019-05-20')  \N
  ...
  /// dictGetUInt8
  {
    ...
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetUInt8('all_types_dict', 'UInt8_value', 1)",
                                                 R"(
...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_dictGetUInt8 = {description,    syntax,   arguments,     {},
                                                        returned_value, examples, introduced_in, category_dictionary};
...
└──────────────────────────┘
  ...
  /// dictGetUInt16
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetUInt16('all_types_dict', 'UInt16_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetUInt32
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetUInt32('all_types_dict', 'UInt32_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetUInt64
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetUInt64('all_types_dict', 'UInt64_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetInt8
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetInt8('all_types_dict', 'Int8_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetInt16
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetInt16('all_types_dict', 'Int16_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetInt32
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetInt32('all_types_dict', 'Int32_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetInt64
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetInt64('all_types_dict', 'Int64_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetFloat32
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetFloat32('all_types_dict', 'Float32_value', 1)",
                                                 R"(
...
└───────────────────────────┘
  ...
  /// dictGetFloat64
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetFloat64('all_types_dict', 'Float64_value', 1)",
                                                 R"(
┌─dictGetFloat⋯_value', 1)─┐
│                 -123.123 │
└──────────────────────────┘
...
└──────────────────────────┘
  ...
  /// dictGetDate
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetDate('all_types_dict', 'Date_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetDateTime
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetDateTime('all_types_dict', 'DateTime_value', 1)",
                                                 R"(
...
└──────────────────────────┘
  ...
  /// dictGetUUID
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetUUID('all_types_dict', 'UUID_value', 1)",
                                                 R"(
...
└────────────────────────────────────────┘
  ...
  /// dictGetIPv4
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetIPv4('all_types_dict', 'IPv4_value', 1)",
                                                 R"(
...
└──────────────────────────────┘
  ...
  /// dictGetIPv6
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetIPv6('all_types_dict', 'IPv6_value', 1)",
                                                 R"(
...
└──────────────────────────────┘
  ...
  /// dictGetString
  {
    ...
    FunctionDocumentation::Arguments arguments = getDictGetArguments();
    FunctionDocumentation::ReturnedValue returned_value = getDictGetReturnedValue();
    FunctionDocumentation::Examples examples = {{"Usage example", "SELECT dictGetString('all_types_dict', 'String_value', 1)",
                                                 R"(
...
Creates an array, containing all the parents of a key in the [hierarchical dictionary](/docs/sql-reference/statements/create/dictionary/layouts/hierarchical#hierarchical-dictionaries).
    ...
    FunctionDocumentation::Arguments arguments = {{"dict_name", "Name of the dictionary.", {"String"}},
                                                  {"key", "Key value.", {"const String"}}};
    FunctionDocumentation::ReturnedValue returned_value = {"Returns parents for the key.", {"Array(UInt64)"}};
    FunctionDocumentation::Examples examples = {{"Get hierarchy for a key",
                                                 R"(
...
Checks the ancestor of a key through the whole hierarchical chain in the dictionary.
    ...
    FunctionDocumentation::ReturnedValue returned_value_dictIsIn = {
        "Returns `0` if `child_id_expr` is not a child of `ancestor_id_expr`, `1` if `child_id_expr` is a child of `ancestor_id_expr` or "
        "if `child_id_expr` is an `ancestor_id_expr`.",
        {"UInt8"}};
    FunctionDocumentation::Examples examples_dictIsIn = {{"Check hierarchical relationship",
                                                          R"(
-- valid hierarchy
...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_dictIsIn = {description_dictIsIn,    syntax_dictIsIn,   arguments_dictIsIn,     {},
                                                    returned_value_dictIsIn, examples_dictIsIn, introduced_in_dictIsIn, category_dictIsIn};
...
Returns first-level children as an array of indexes. It is the inverse transformation for [dictGetHierarchy](#dictGetHierarchy).
    ...
    FunctionDocumentation::Arguments arguments_dictGetChildren = {{"dict_name", "Name of the dictionary.", {"String"}},
                                                                  {"key", "Key to be checked.", {"const String"}}};
    FunctionDocumentation::ReturnedValue returned_value_dictGetChildren = {"Returns the first-level descendants for the key.",
                                                                           {"Array(UInt64)"}};
    FunctionDocumentation::Examples examples_dictGetChildren = {{"Get the first-level children of a dictionary",
                                                                 R"(
...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_dictGetChildren = {
        description_dictGetChildren,    syntax_dictGetChildren,   arguments_dictGetChildren,     {},
        returned_value_dictGetChildren, examples_dictGetChildren, introduced_in_dictGetChildren, category_dictGetChildren};
...
Returns all descendants as if the [`dictGetChildren`](#dictGetChildren) function were applied `level` times recursively.
    ...
    FunctionDocumentation::Examples examples_dictGetDescendants = {{"Get the first-level children of a dictionary",
                                                                    R"(
...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_dictGetDescendants = {
        description_dictGetDescendants,    syntax_dictGetDescendants,   arguments_dictGetDescendants,     {},
        returned_value_dictGetDescendants, examples_dictGetDescendants, introduced_in_dictGetDescendants, category_dictGetDescendants};
  ...
  /// dictHas
  {
    ...
    FunctionDocumentation::Arguments arguments_dictHas = {{"dict_name", "Name of the dictionary.", {"String"}},
    ...
    FunctionDocumentation::Examples examples_dictHas = {{"Check for the existence of a key in a dictionary",
                                                         R"(
-- consider the following hierarchical dictionary:
-- 0 (Root)
-- └── 1 (Level 1 - Node 1)
...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_dictHas = {description_dictHas,    syntax_dictHas,   arguments_dictHas,     {},
                                                   returned_value_dictHas, examples_dictHas, introduced_in_dictHas, category_dictHas};
