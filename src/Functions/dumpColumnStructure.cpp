...
class FunctionDumpColumnStructure : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionDumpColumnStructure>(); }
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    return DataTypeString()
        .createColumnConst(input_rows_count, elem.type->getName() + ", " + elem.column->dumpStructure())
...
Outputs a detailed description of the internal structure of a column and its data type.
  ...
  FunctionDocumentation::Arguments arguments = {{"x", "Value for which to get the description of.", {"Any"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns a description of the column structure used for representing the value.",
                                                         {"String"}};
