...
subtractMinutes(datetime, num)
  ...
  FunctionDocumentation::Arguments arguments = {{"datetime",
                                                 "Date or date with time to subtract specified number of minutes from.",
  ...
  FunctionDocumentation::Examples examples = {{"Subtract minutes from different date types", R"(
WITH
