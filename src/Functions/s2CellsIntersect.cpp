...
class FunctionS2CellsIntersect : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionS2CellsIntersect>(); }
...
Determines if two provided S2 cells intersect or not.
  ...
  FunctionDocumentation::Arguments arguments = {{"s2index1", "First S2 cell identifier.", {"UInt64"}},
