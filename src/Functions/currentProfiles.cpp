...
class FunctionProfiles : public IFunction {
 public:
  ...
  explicit FunctionProfiles(const ContextPtr &context_, Kind kind_) : kind(kind_), context(context_) {}
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    for (const String &profile_name : profile_names) res_strings.insertData(profile_name.data(), profile_name.length());
  ...
  void initialize() const {
    ...
    switch (kind) {
      ...
      case Kind::defaultProfiles:
        ...
        if (user) profile_ids = user->settings.toProfileIDs();
        break;
    }
...
Returns an array of the setting profiles for the current user.
  ...
  FunctionDocumentation::ReturnedValue returned_value_currentProfiles = {"Returns an array of setting profiles for the current user.",
                                                                         {"Array(String)"}};
  FunctionDocumentation::Examples examples_currentProfiles = {{"Usage example",
                                                               R"(
...
└───────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_currentProfiles = {
      description_currentProfiles,    syntax_currentProfiles,   arguments_currentProfiles,     {},
      returned_value_currentProfiles, examples_currentProfiles, introduced_in_currentProfiles, category_currentProfiles};
...
Returns an array of setting profile names which are enabled for the current user.
  ...
  FunctionDocumentation::ReturnedValue returned_value_enabledProfiles = {
      "Returns an array of setting profile names which are enabled for the current user.", {"Array(String)"}};
  FunctionDocumentation::Examples examples_enabledProfiles = {{"Usage example",
                                                               R"(
...
└───────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_enabledProfiles = {
      description_enabledProfiles,    syntax_enabledProfiles,   arguments_enabledProfiles,     {},
      returned_value_enabledProfiles, examples_enabledProfiles, introduced_in_enabledProfiles, category_enabledProfiles};
...
Returns an array of default setting profile names for the current user.
  ...
  FunctionDocumentation::ReturnedValue returned_value_defaultProfiles = {
      "Returns an array of default setting profile names for the current user.", {"Array(String)"}};
  FunctionDocumentation::Examples examples_defaultProfiles = {{"Usage example",
                                                               R"(
...
└───────────────────┘
  ...
  FunctionDocumentation documentation_defaultProfiles = {
      description_defaultProfiles,    syntax_defaultProfiles,   arguments_defaultProfiles,     {},
      returned_value_defaultProfiles, examples_defaultProfiles, introduced_in_defaultProfiles, category_defaultProfiles};

  factory.registerFunction(
      "currentProfiles", [](ContextPtr context) { return std::make_shared<FunctionProfiles>(context, Kind::currentProfiles); },
      documentation_currentProfiles);
  factory.registerFunction(
      "enabledProfiles", [](ContextPtr context) { return std::make_shared<FunctionProfiles>(context, Kind::enabledProfiles); },
      documentation_enabledProfiles);
  factory.registerFunction(
      "defaultProfiles", [](ContextPtr context) { return std::make_shared<FunctionProfiles>(context, Kind::defaultProfiles); },
      documentation_defaultProfiles);
}
