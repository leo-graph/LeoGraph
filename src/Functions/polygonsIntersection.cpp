...
class FunctionPolygonsIntersection : public IFunction {
 public:
  ...
  static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionPolygonsIntersection>(); }
...
Calculates the intersection of polygons.
  ...
  FunctionDocumentation::ReturnedValue returned_value_cartesian = {"Returns the intersection of the polygons as a MultiPolygon.",
                                                                   {"MultiPolygon"}};
  FunctionDocumentation::Examples examples_cartesian = {{"Intersection example",
                                                         R"(
...
Calculates the intersection (AND) between polygons, coordinates are spherical.
  ...
  FunctionDocumentation::Arguments arguments_spherical = {{"polygon1", "First Polygon with spherical coordinates.", {"Polygon"}},
                                                          {"polygon2", "Second Polygon with spherical coordinates.", {"Polygon"}}};
  FunctionDocumentation::ReturnedValue returned_value_spherical = {"Returns the intersection of the polygons as a MultiPolygon.",
                                                                   {"MultiPolygon"}};
  FunctionDocumentation::Examples examples_spherical = {{"Spherical intersection example",
                                                         R"(
