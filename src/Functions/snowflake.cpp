...
class FunctionDateTimeToSnowflake : public IFunction {
 ...
 public:
  ...
  static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionDateTimeToSnowflake>(context); }

  explicit FunctionDateTimeToSnowflake(ContextPtr context)
      : allow_deprecated_snowflake_conversion_functions(
            context->getSettingsRef()[Setting::allow_deprecated_snowflake_conversion_functions]) {}
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    FunctionArgumentDescriptors args{{"value", static_cast<FunctionArgumentDescriptor::TypeValidator>(&isDateTime), nullptr, "DateTime"}};
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    if (!allow_deprecated_snowflake_conversion_functions)
      throw Exception(ErrorCodes::DEPRECATED_FUNCTION,
                      "Function {} is deprecated, to enable it set setting 'allow_deprecated_snowflake_conversion_functions' to 'true'",
                      getName());
    ...
    for (size_t i = 0; i < input_rows_count; ++i) res_data[i] = (Int64(src_data[i]) * 1000 - snowflake_epoch) << time_shift;
...
class FunctionSnowflakeToDateTime : public IFunction {
 ...
 public:
  ...
  static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionSnowflakeToDateTime>(context); }
  ...
  DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName &arguments) const override {
    ...
    String timezone;
    if (arguments.size() == 2) timezone = extractTimeZoneNameFromFunctionArguments(arguments, 1, 0, allow_nonconst_timezone_arguments);
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (const auto *src_column_non_const = typeid_cast<const ColumnInt64 *>(&src_column)) {
      ...
      for (size_t i = 0; i < input_rows_count; ++i) res_data[i] = static_cast<UInt32>(((src_val >> time_shift) + snowflake_epoch) / 1000);
    } else
...
class FunctionDateTime64ToSnowflake : public IFunction {
 ...
 public:
  ...
  static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionDateTime64ToSnowflake>(context); }
...
class FunctionSnowflakeToDateTime64 : public IFunction {
 ...
 public:
  ...
  static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionSnowflakeToDateTime64>(context); }
  ...
  ColumnPtr executeImpl(const ColumnsWithTypeAndName &arguments, const DataTypePtr &, size_t input_rows_count) const override {
    ...
    if (const auto *src_column_non_const = typeid_cast<const ColumnInt64 *>(&src_column)) {
      ...
      Int64 src_val = src_column_const->getValue<Int64>();
      for (size_t i = 0; i < input_rows_count; ++i) res_data[i] = (src_val >> time_shift) + snowflake_epoch;
    } else
      throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Illegal argument for function {}", name);
...
Extracts the timestamp component of a [Snowflake ID](https://en.wikipedia.org/wiki/Snowflake_ID) in [DateTime](../data-types/datetime.md) format.
  ...
  FunctionDocumentation::Arguments arguments_snowflakeToDateTime = {
      ...
      {"time_zone",
       "Optional. [Timezone](/operations/server-configuration-parameters/settings.md#timezone). The function parses `time_string` "
  ...
  FunctionDocumentation::Examples examples_snowflakeToDateTime = {{"Usage example",
                                                                   R"(
...
└──────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_snowflakeToDateTime = {
      description_snowflakeToDateTime,    syntax_snowflakeToDateTime,   arguments_snowflakeToDateTime,     {},
      returned_value_snowflakeToDateTime, examples_snowflakeToDateTime, introduced_in_snowflakeToDateTime, category_snowflakeToDateTime};
...
Extracts the timestamp component of a [Snowflake ID](https://en.wikipedia.org/wiki/Snowflake_ID) in [DateTime64](../data-types/datetime64.md) format.
  ...
  FunctionDocumentation::Arguments arguments_snowflakeToDateTime64 = {
      ...
      {"time_zone",
       ...
       "according to the timezone.",
       {"String"}}};
  FunctionDocumentation::ReturnedValue returned_value_snowflakeToDateTime64 = {"Returns the timestamp component of `value`.",
                                                                               {"DateTime64(3)"}};
  FunctionDocumentation::Examples examples_snowflakeToDateTime64 = {{"Usage example",
                                                                     R"(
...
└────────────────────────────────────────────────────────────────────┘
  ...
  FunctionDocumentation documentation_snowflakeToDateTime64 = {description_snowflakeToDateTime64,    syntax_snowflakeToDateTime64,
                                                               arguments_snowflakeToDateTime64,      {},
                                                               returned_value_snowflakeToDateTime64, examples_snowflakeToDateTime64,
                                                               introduced_in_snowflakeToDateTime64,  category_snowflakeToDateTime64};
...
Converts a [DateTime](../data-types/datetime.md) value to the first [Snowflake ID](https://en.wikipedia.org/wiki/Snowflake_ID) at the giving time.
  ...
  FunctionDocumentation::Arguments arguments_dateTimeToSnowflake = {{"value", "Date with time.", {"DateTime"}}};
  FunctionDocumentation::ReturnedValue returned_value_dateTimeToSnowflake = {
      "Returns the input value as the first Snowflake ID at that time.", {"Int64"}};
  FunctionDocumentation::Examples examples_dateTimeToSnowflake = {{"Usage example",
                                                                   R"(
...
└─────────────────────────┘
  ...
  FunctionDocumentation documentation_dateTimeToSnowflake = {
      description_dateTimeToSnowflake,    syntax_dateTimeToSnowflake,   arguments_dateTimeToSnowflake,     {},
      returned_value_dateTimeToSnowflake, examples_dateTimeToSnowflake, introduced_in_dateTimeToSnowflake, category_dateTimeToSnowflake};
...
Converts a [DateTime64](../data-types/datetime64.md) to the first [Snowflake ID](https://en.wikipedia.org/wiki/Snowflake_ID) at the giving time.
  ...
  FunctionDocumentation::Arguments arguments_dateTime64ToSnowflake = {{"value", "Date with time.", {"DateTime64"}}};
  FunctionDocumentation::ReturnedValue returned_value_dateTime64ToSnowflake = {
      "Returns the input value converted as the first Snowflake ID at that time.", {"Int64"}};
  FunctionDocumentation::Examples examples_dateTime64ToSnowflake = {{"Usage example",
                                                                     R"(
...
└─────────────────────────────┘
  ...
  FunctionDocumentation documentation_dateTime64ToSnowflake = {description_dateTime64ToSnowflake,    syntax_dateTime64ToSnowflake,
                                                               arguments_dateTime64ToSnowflake,      {},
                                                               returned_value_dateTime64ToSnowflake, examples_dateTime64ToSnowflake,
                                                               introduced_in_dateTime64ToSnowflake,  category_dateTime64ToSnowflake};
