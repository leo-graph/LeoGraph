...
The hash function is relatively fast but not cryptographic hash function.
  ...
  FunctionDocumentation::Arguments intHash32_arguments = {{"arg", "Integer to hash.", {"(U)Int*"}}};
  FunctionDocumentation::ReturnedValue intHash32_returned_value = {"Returns the computed 32-bit hash code of the input integer",
                                                                   {"UInt32"}};
  FunctionDocumentation::Examples intHash32_examples = {{"Usage example", "SELECT intHash32(42);",
                                                         R"(
┌─intHash32(42)─┐
│    1228623923 │
└───────────────┘
  ...
  FunctionDocumentation intHash32_documentation = {
      intHash32_description,    intHash32_syntax,   intHash32_arguments,     {},
      intHash32_returned_value, intHash32_examples, intHash32_introduced_in, intHash32_category};
...
The hash function is relatively fast (even faster than [`intHash32`](#intHash32)) but not a cryptographic hash function.
  ...
  FunctionDocumentation::Arguments intHash64_arguments = {{"int", "Integer to hash.", {"(U)Int*"}}};
  FunctionDocumentation::ReturnedValue intHash64_returned_value = {"64-bit hash code.", {"UInt64"}};
  FunctionDocumentation::Examples intHash64_examples = {{"Usage example", "SELECT intHash64(42);",
                                                         R"(
┌────────intHash64(42)─┐
...
└──────────────────────┘
  ...
  FunctionDocumentation intHash64_documentation = {
      intHash64_description,    intHash64_syntax,   intHash64_arguments,     {},
      intHash64_returned_value, intHash64_examples, intHash64_introduced_in, intHash64_category};
