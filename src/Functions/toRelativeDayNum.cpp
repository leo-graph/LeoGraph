...
toRelativeDayNum(date)
  ...
  FunctionDocumentation::ReturnedValue returned_value = {"Returns the number of days from a fixed reference point in the past.",
                                                         {"UInt32"}};
  FunctionDocumentation::Examples examples = {{"Get relative day numbers", R"(
