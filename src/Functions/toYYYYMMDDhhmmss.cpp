...
toYYYYMMDDhhmmss(datetime[, timezone])
  ...
  FunctionDocumentation::ReturnedValue returned_value = {
      "Returns a `UInt64` number containing the year, month, day, hour, minute and second (YYYY * 10000000000 + MM * 100000000 + DD * "
      "1000000 + hh * 10000 + mm * 100 + ss).",
      {"UInt64"}};
  FunctionDocumentation::Examples examples = {{"Convert current date and time to YYYYMMDDhhmmss format", R"(
