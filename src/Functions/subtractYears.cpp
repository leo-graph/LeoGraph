...
subtractYears(datetime, num)
  ...
  FunctionDocumentation::Arguments arguments = {{"datetime",
                                                 "Date or date with time to subtract specified number of years from.",
                                                 {"Date", "Date32", "DateTime", "DateTime64", "String"}},
                                                {"num", "Number of years to subtract.", {"(U)Int*", "Float*"}}};
  FunctionDocumentation::ReturnedValue returned_value = {"Returns `datetime` minus `num` years",
                                                         {"Date", "Date32", "DateTime", "DateTime64"}};
  FunctionDocumentation::Examples examples = {{"Subtract years from different date types", R"(
WITH
