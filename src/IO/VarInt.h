...
inline UInt64 encodeZigZag(Int64 value) { return (static_cast<UInt64>(value) << 1) ^ static_cast<UInt64>(value >> 63); }
...
inline char* writeVarInt(Int64 x, char* ostr) { return writeVarUInt(encodeZigZag(x), ostr); }
...
inline Int64 decodeZigZag(UInt64 n) { return static_cast<Int64>((n >> 1) ^ -(n & 1)); }
                    ...
                    : (x < (1ULL << 21)
                           ...
                           : (x < (1ULL << 28)
                                  ...
                                  : (x < (1ULL << 35)
                                         ...
                                         : (x < (1ULL << 42)
                                                ? 6
                                                : (x < (1ULL << 49) ? 7 : (x < (1ULL << 56) ? 8 : (x < (1ULL << 63) ? 9 : 10))))))));
}

inline size_t getLengthOfVarInt(Int64 x) { return getLengthOfVarUInt(encodeZigZag(x)); }
