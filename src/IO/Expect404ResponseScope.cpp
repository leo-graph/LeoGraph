...
Expect404ResponseScope::Expect404ResponseScope() : initial_thread_id(std::this_thread::get_id()) { ++expected_404_scope_count; }
...
bool Expect404ResponseScope::is404Expected() { return expected_404_scope_count != 0; }
