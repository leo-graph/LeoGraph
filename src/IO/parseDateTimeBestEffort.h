...
bool tryParseTime64BestEffort(Time64& res, UInt32 scale, ReadBuffer& in, const DateLUTImpl& local_time_zone,
                              const DateLUTImpl& utc_time_zone);
...
bool tryParseDateTime64BestEffortUS(DateTime64& res, UInt32 scale, ReadBuffer& in, const DateLUTImpl& local_time_zone,
                                    const DateLUTImpl& utc_time_zone);
void parseTime64BestEffortUS(Time64& res, UInt32 scale, ReadBuffer& in, const DateLUTImpl& local_time_zone,
                             const DateLUTImpl& utc_time_zone);
bool tryParseTime64BestEffortUS(Time64& res, UInt32 scale, ReadBuffer& in, const DateLUTImpl& local_time_zone,
                                const DateLUTImpl& utc_time_zone);
