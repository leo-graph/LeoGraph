...
class ReadBufferFromPocoSocketBase : public BufferWithOwnMemory<ReadBuffer> {
 ...
 public:
  ...
  explicit ReadBufferFromPocoSocketBase(Poco::Net::Socket& socket_, const ProfileEvents::Event& read_event_,
...
class ReadBufferFromPocoSocket : public ReadBufferFromPocoSocketBase {
 public:
  ...
  explicit ReadBufferFromPocoSocket(Poco::Net::Socket& socket_, const ProfileEvents::Event& read_event_,
                                    size_t buf_size = DBMS_DEFAULT_BUFFER_SIZE)
