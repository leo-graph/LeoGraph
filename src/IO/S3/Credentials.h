...
class AWSInstanceProfileCredentialsProvider : public Aws::Auth::AWSCredentialsProvider {
 public:
  ...
  static std::shared_ptr<Aws::Auth::AWSCredentialsProvider> create(const Aws::Client::ClientConfiguration& client_configuration,
                                                                   bool use_secure_pull);
...
class AwsAuthSTSAssumeRoleWebIdentityCredentialsProvider : public Aws::Auth::AWSCredentialsProvider {
 ...
 public:
  static std::shared_ptr<Aws::Auth::AWSCredentialsProvider> create(DB::S3::PocoHTTPClientConfiguration& aws_client_configuration,
                                                                   uint64_t expiration_window_seconds_, String role_arn_ = "");

  explicit AwsAuthSTSAssumeRoleWebIdentityCredentialsProvider(DB::S3::PocoHTTPClientConfiguration& aws_client_configuration,
                                                              uint64_t expiration_window_seconds_, Aws::String role_arn_,
...
class S3CredentialsProviderChain : public Aws::Auth::AWSCredentialsProviderChain {
 public:
  S3CredentialsProviderChain(const DB::S3::PocoHTTPClientConfiguration& configuration, const Aws::Auth::AWSCredentials& credentials,
...
class AWSAssumeRoleClient : public Aws::Client::AWSXMLClient {
 public:
  AWSAssumeRoleClient(const std::shared_ptr<Aws::Auth::AWSCredentialsProvider>& credentials_provider,
                      const Aws::Client::ClientConfiguration& client_configuration, const std::string& sts_endpoint_override = "");
...
class AwsAuthSTSAssumeRoleCredentialsProvider : public Aws::Auth::AWSCredentialsProvider {
 public:
  static std::shared_ptr<Aws::Auth::AWSCredentialsProvider> create(std::string role_arn_, std::string session_name_,
  ...
  AwsAuthSTSAssumeRoleCredentialsProvider(std::string role_arn_, std::string session_name_, uint64_t expiration_window_seconds_,
