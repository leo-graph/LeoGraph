...
class PocoAzureHTTPClient : public Azure::Core::Http::HttpTransport {
 ...
 private:
  ...
  std::unique_ptr<Azure::Core::Http::RawResponse> makeRequestInternalImpl(Azure::Core::Http::Request& request,
                                                                          const Azure::Core::Context& context, size_t redirects_left);
