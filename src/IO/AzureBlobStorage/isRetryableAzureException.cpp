...
bool isRetryableAzureException(const Azure::Core::RequestFailedException &e, bool may_be_provisioning_access) {
  ...
  if (dynamic_cast<const Azure::Core::Http::TransportException *>(&e)) return true;
  ...
  if (may_be_provisioning_access && e.StatusCode == Azure::Core::Http::HttpStatusCode::Forbidden) return true;
