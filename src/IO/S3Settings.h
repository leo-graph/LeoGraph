...
struct S3Settings {
  ...
  void loadFromConfigForObjectStorage(const Poco::Util::AbstractConfiguration& config, const std::string& config_prefix,
...
class S3SettingsByEndpoint {
 public:
  ...
  std::optional<S3Settings> getSettings(const std::string& endpoint, const std::string& user, bool ignore_user = false) const;
