...
bool S3Exception::isRetryableError() const {
  ...
  static const std::unordered_set<Aws::S3::S3Errors> unretryable_errors = {
      Aws::S3::S3Errors::NO_SUCH_KEY,       Aws::S3::S3Errors::ACCESS_DENIED,  Aws::S3::S3Errors::INVALID_ACCESS_KEY_ID,
      Aws::S3::S3Errors::INVALID_SIGNATURE, Aws::S3::S3Errors::NO_SUCH_UPLOAD, Aws::S3::S3Errors::NO_SUCH_BUCKET,
  };
...
bool S3Exception::isAccessTokenExpiredError() const {
  return code == Aws::S3::S3Errors::INVALID_ACCESS_KEY_ID || code == Aws::S3::S3Errors::ACCESS_DENIED ||
         code == Aws::S3::S3Errors::INVALID_SIGNATURE || code == Aws::S3::S3Errors::UNKNOWN;
}
...
HTTPHeaderEntries getHTTPHeaders(const std::string& config_elem, const Poco::Util::AbstractConfiguration& config,
  ...
  for (const std::string& subkey : subconfig_keys) {
    if (subkey.starts_with(header_key)) {
      ...
      if (delimiter == std::string::npos) throw Exception(ErrorCodes::INVALID_CONFIG_PARAMETER, "Malformed s3 header value");
...
static bool setValueFromConfig(const Poco::Util::AbstractConfiguration& config, const std::string& path,
