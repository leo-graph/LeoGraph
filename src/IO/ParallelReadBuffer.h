...
class ParallelReadBuffer : public SeekableReadBuffer, public WithFileSize {
 ...
 public:
  ParallelReadBuffer(SeekableReadBuffer& input, ThreadPoolCallbackRunnerUnsafe<void> schedule_, size_t max_working_readers,
                     size_t range_step_, size_t file_size);
