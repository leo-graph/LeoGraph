...
StaticThreadPool::StaticThreadPool(const String& name_, CurrentMetrics::Metric threads_metric_,
                                   CurrentMetrics::Metric threads_active_metric_, CurrentMetrics::Metric threads_scheduled_metric_)
    : name(name_),
...
void StaticThreadPool::initialize(size_t max_threads, size_t max_free_threads, size_t queue_size) {
  if (instance) throw Exception(ErrorCodes::LOGICAL_ERROR, "The {} is initialized twice", name);
...
void StaticThreadPool::initializeImpl(size_t max_threads, size_t max_free_threads, size_t queue_size) {
  ...
  instance = std::make_unique<ThreadPool>(threads_metric, threads_active_metric, threads_scheduled_metric, max_threads, max_free_threads,
                                          queue_size,
                                          /* shutdown_on_exception= */ false);
}

bool StaticThreadPool::isInitialized() const { return instance.operator bool(); }

void StaticThreadPool::reloadConfiguration(size_t max_threads, size_t max_free_threads, size_t queue_size) {
  if (!instance) throw Exception(ErrorCodes::LOGICAL_ERROR, "The {} is not initialized", name);
...
void StaticThreadPool::enableTurboMode() {
  ...
  ++turbo_mode_enabled;
  if (turbo_mode_enabled == 1) instance->setMaxThreads(max_threads_turbo);
}
...
void StaticThreadPool::disableTurboMode() {
  ...
  --turbo_mode_enabled;
  if (turbo_mode_enabled == 0) instance->setMaxThreads(max_threads_normal);
}
...
void StaticThreadPool::setMaxTurboThreads(size_t max_threads_turbo_) {
  ...
  if (turbo_mode_enabled > 0) instance->setMaxThreads(max_threads_turbo);
}
...
StaticThreadPool& getFetchPartitionThreadPool() {
  static StaticThreadPool instance("MergeTreeFetchPartitionThreadPool", CurrentMetrics::MergeTreeFetchPartitionThreads,
                                   CurrentMetrics::MergeTreeFetchPartitionThreadsActive,
                                   CurrentMetrics::MergeTreeFetchPartitionThreadsScheduled);
  return instance;
}

StaticThreadPool& getActivePartsLoadingThreadPool() {
  static StaticThreadPool instance("MergeTreePartsLoaderThreadPool", CurrentMetrics::MergeTreePartsLoaderThreads,
                                   CurrentMetrics::MergeTreePartsLoaderThreadsActive, CurrentMetrics::MergeTreePartsLoaderThreadsScheduled);
  return instance;
}

StaticThreadPool& getSnapshotCommitThreadPool() {
  static StaticThreadPool instance("MergeTreeSnapshotCommitThreadPool", CurrentMetrics::MergeTreeSnapshotCommitThreads,
                                   CurrentMetrics::MergeTreeSnapshotCommitThreadsActive,
                                   CurrentMetrics::MergeTreeSnapshotCommitThreadsScheduled);
  return instance;
}

StaticThreadPool& getPartsCleaningThreadPool() {
  static StaticThreadPool instance("MergeTreePartsCleanerThreadPool", CurrentMetrics::MergeTreePartsCleanerThreads,
...
StaticThreadPool& getOutdatedPartsLoadingThreadPool() {
  static StaticThreadPool instance("MergeTreeOutdatedPartsLoaderThreadPool", CurrentMetrics::MergeTreeOutdatedPartsLoaderThreads,
                                   CurrentMetrics::MergeTreeOutdatedPartsLoaderThreadsActive,
                                   CurrentMetrics::MergeTreeOutdatedPartsLoaderThreadsScheduled);
  return instance;
}

StaticThreadPool& getUnexpectedPartsLoadingThreadPool() {
  static StaticThreadPool instance("MergeTreeUnexpectedPartsLoaderThreadPool", CurrentMetrics::MergeTreeUnexpectedPartsLoaderThreads,
                                   CurrentMetrics::MergeTreeUnexpectedPartsLoaderThreadsActive,
                                   CurrentMetrics::MergeTreeUnexpectedPartsLoaderThreadsScheduled);
  return instance;
}

StaticThreadPool& getDatabaseReplicatedCreateTablesThreadPool() {
  static StaticThreadPool instance("CreateTablesThreadPool", CurrentMetrics::DatabaseReplicatedCreateTablesThreads,
                                   CurrentMetrics::DatabaseReplicatedCreateTablesThreadsActive,
                                   CurrentMetrics::DatabaseReplicatedCreateTablesThreadsScheduled);
  return instance;
}

/// ThreadPool used for dropping tables.
StaticThreadPool& getDatabaseCatalogDropTablesThreadPool() {
  static StaticThreadPool instance("DropTablesThreadPool", CurrentMetrics::DatabaseCatalogThreads,
                                   CurrentMetrics::DatabaseCatalogThreadsActive, CurrentMetrics::DatabaseCatalogThreadsScheduled);
  return instance;
}

StaticThreadPool& getMergeTreePrefixesDeserializationThreadPool() {
  static StaticThreadPool instance("MergeTreePrefixesDeserializationThreadPool", CurrentMetrics::MergeTreeSubcolumnsReaderThreads,
...
StaticThreadPool& getFormatParsingThreadPool() {
  static StaticThreadPool instance("FormatParsingThreadPool", CurrentMetrics::FormatParsingThreads,
                                   CurrentMetrics::FormatParsingThreadsActive, CurrentMetrics::FormatParsingThreadsScheduled);
  return instance;
}
