...
static String typeToString(FilesystemCacheLogElement::CacheType type) { return String(magic_enum::enum_name(type)); }
...
ColumnsDescription FilesystemCacheLogElement::getColumnsDescription() {
  ...
  return ColumnsDescription{
      ...
      {"read_type", std::make_shared<DataTypeString>(),
       "Read type: READ_FROM_CACHE, READ_FROM_FS_AND_DOWNLOADED_TO_CACHE, READ_FROM_FS_BYPASSING_CACHE"},
