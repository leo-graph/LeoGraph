...
#define DefineStringView(STRUCT)                              \
  ...
  template <>                                                 \
  inline bool check<STRUCT>(STRUCT x) {                       \
    return 0 == x.size();                                     \
  } /* NOLINT */                                              \
                                                              \
  template <>                                                 \
  inline void set<STRUCT>(STRUCT & x) {                       \
    x = STRUCT{};                                             \
  } /* NOLINT */                                              \
  }                                                           \
                                                              \
...
DefineStringView(StringView_Compare1_Ptrs) DefineStringView(StringView_Compare1_Index) DefineStringView(StringView_CompareMemcmp)
    DefineStringView(StringView_Compare8_1_byUInt64) DefineStringView(StringView_Compare16_1_byMemcmp)
        DefineStringView(StringView_Compare16_1_byUInt64_logicAnd) DefineStringView(StringView_Compare16_1_byUInt64_bitAnd)
#ifdef __SSE4_1__
            DefineStringView(StringView_Compare16_1_byIntSSE) DefineStringView(StringView_Compare16_1_byFloatSSE)
                DefineStringView(StringView_Compare16_1_bySSE4) DefineStringView(StringView_Compare16_1_bySSE4_wide)
                    DefineStringView(StringView_Compare16_1_bySSE_wide)
#endif

                        DefineStringView(StringView_CompareAlwaysTrue) DefineStringView(StringView_CompareAlmostAlwaysTrue)
...
inline bool operator==(StringView_Compare8_1_byUInt64 lhs, StringView_Compare8_1_byUInt64 rhs) {
  ...
  while (p1 < p1_end_8) {
    if (reinterpret_cast<const UInt64 *>(p1)[0] != reinterpret_cast<const UInt64 *>(p2)[0]) return false;
...
inline bool compare_byMemcmp(const char *p1, const char *p2) { return 0 == memcmp(p1, p2, 16); }
...
inline bool compare_byIntSSE(const char *p1, const char *p2) {
  return 0xFFFF == _mm_movemask_epi8(_mm_cmpeq_epi8(_mm_loadu_si128(reinterpret_cast<const __m128i *>(p1)),
...
inline bool compare_byFloatSSE(const char *p1, const char *p2) {
  return !_mm_movemask_ps(_mm_cmpneq_ps(  /// Looks like incorrect while comparing subnormal floats.
      _mm_loadu_ps(reinterpret_cast<const float *>(p1)), _mm_loadu_ps(reinterpret_cast<const float *>(p2))));
}
...
inline bool memequal(const char *p1, const char *p2, size_t size) {
  ...
  switch (size % 16)  // NOLINT(bugprone-switch-missing-default-case)
  {
    ...
    case 13:
      ...
      [[fallthrough]];
    case 12:
      if (reinterpret_cast<const UInt32 *>(p1)[2] == reinterpret_cast<const UInt32 *>(p2)[2])
        goto l8;
      else
        return false;
    case 11:
    ...
    case 5:
      ...
      [[fallthrough]];
    case 4:
      return reinterpret_cast<const UInt32 *>(p1)[0] == reinterpret_cast<const UInt32 *>(p2)[0];
    case 3:
      if (p1[2] != p2[2]) return false;
      [[fallthrough]];
    case 2:
      return reinterpret_cast<const UInt16 *>(p1)[0] == reinterpret_cast<const UInt16 *>(p2)[0];
    case 1:
...
inline bool memequal_sse41_wide(const char *p1, const char *p2, size_t size) {
  ...
  while (size >= 64) {
    if (_mm_testc_si128(zero16, _mm_xor_si128(_mm_loadu_si128(&reinterpret_cast<const __m128i *>(p1)[0]),
                                              _mm_loadu_si128(&reinterpret_cast<const __m128i *>(p2)[0]))) &&
        _mm_testc_si128(zero16, _mm_xor_si128(_mm_loadu_si128(&reinterpret_cast<const __m128i *>(p1)[1]),
                                              _mm_loadu_si128(&reinterpret_cast<const __m128i *>(p2)[1]))) &&
        _mm_testc_si128(zero16, _mm_xor_si128(_mm_loadu_si128(&reinterpret_cast<const __m128i *>(p1)[2]),
                                              _mm_loadu_si128(&reinterpret_cast<const __m128i *>(p2)[2]))) &&
        _mm_testc_si128(zero16, _mm_xor_si128(_mm_loadu_si128(&reinterpret_cast<const __m128i *>(p1)[3]),
  ...
  {
    case 3:
      if (!_mm_testc_si128(zero16, _mm_xor_si128(_mm_loadu_si128(&reinterpret_cast<const __m128i *>(p1)[2]),
                                                 _mm_loadu_si128(&reinterpret_cast<const __m128i *>(p2)[2]))))
        return false;
      [[fallthrough]];
    case 2:
      if (!_mm_testc_si128(zero16, _mm_xor_si128(_mm_loadu_si128(&reinterpret_cast<const __m128i *>(p1)[1]),
                                                 _mm_loadu_si128(&reinterpret_cast<const __m128i *>(p2)[1]))))
        return false;
      [[fallthrough]];
    case 1:
...
inline bool memequal_sse_wide(const char *p1, const char *p2, size_t size) {
  while (size >= 64) {
    if (compare_byIntSSE(p1, p2) && compare_byIntSSE(p1 + 16, p2 + 16) && compare_byIntSSE(p1 + 32, p2 + 32) &&
  ...
  {
    case 3:
      if (!compare_byIntSSE(p1 + 32, p2 + 32)) return false;
      [[fallthrough]];
    case 2:
      if (!compare_byIntSSE(p1 + 16, p2 + 16)) return false;
      [[fallthrough]];
    case 1:
      if (!compare_byIntSSE(p1, p2)) return false;
  }
...
inline bool operator==(StringView_CompareAlwaysTrue, StringView_CompareAlwaysTrue) { return true; }

inline bool operator==(StringView_CompareAlmostAlwaysTrue lhs, StringView_CompareAlmostAlwaysTrue rhs) { return lhs.size() == rhs.size(); }
