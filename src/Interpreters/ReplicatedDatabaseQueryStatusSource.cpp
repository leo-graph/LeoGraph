...
ReplicatedDatabaseQueryStatusSource::ReplicatedDatabaseQueryStatusSource(const String& zookeeper_name_, const String& zk_node_path,
                                                                         const String& zk_replicas_path, ContextPtr context_,
                                                                         const Strings& hosts_to_wait, DDLGuardPtr&& database_guard_)
    : DistributedQueryStatusSource(zookeeper_name_, zk_node_path, zk_replicas_path, std::make_shared<const Block>(getSampleBlock()),
                                   context_, hosts_to_wait, "ReplicatedDatabaseQueryStatusSource"),
...
Chunk ReplicatedDatabaseQueryStatusSource::handleTimeoutExceeded() {
  ...
  constexpr auto msg_format =
      "ReplicatedDatabase DDL task {} is not finished on {} of {} hosts "
