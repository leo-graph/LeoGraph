...
enum class EntryType : UInt8 { ENTRY, EXIT, ENTRY_AND_EXIT };
...
class InstrumentationManager {
 public:
  ...
  struct FunctionInfo {
    ...
    FunctionInfo(Int32 function_id_, const String &function_name_) : function_id(function_id_), function_name(function_name_) {}
  ...
  using FunctionsContainer = boost::multi_index_container<
      FunctionInfo, boost::multi_index::indexed_by<
                        boost::multi_index::hashed_unique<boost::multi_index::tag<FunctionId>,
                                                          boost::multi_index::member<FunctionInfo, Int32, &FunctionInfo::function_id>>,
                        boost::multi_index::hashed_unique<boost::multi_index::tag<FunctionName>,
                                                          boost::multi_index::member<FunctionInfo, String, &FunctionInfo::function_name>>>>;
  ...
  [[clang::xray_never_instrument]] void patchFunction(ContextPtr context, const String &function_name, const String &handler_name,
                                                      Instrumentation::EntryType entry_type,
                                                      const std::vector<InstrumentedParameter> &parameters);
 ...
 private:
  using InstrumentedPointContainer = boost::multi_index_container<
      ...
      boost::multi_index::indexed_by<
          ...
          boost::multi_index::ordered_non_unique<
              boost::multi_index::tag<FunctionId>,
              boost::multi_index::composite_key<
                  InstrumentedPointInfo, boost::multi_index::member<InstrumentedPointInfo, Int32, &InstrumentedPointInfo::function_id>,
                  boost::multi_index::member<InstrumentedPointInfo, UInt64, &InstrumentedPointInfo::id>>>>>;
  ...
  [[clang::xray_never_instrument]] TraceLogElement createTraceLogElement(const InstrumentedPointInfo &instrumented_point,
