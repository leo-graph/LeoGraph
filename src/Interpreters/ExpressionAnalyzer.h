...
class ExpressionAnalyzer : protected ExpressionAnalyzerData, private boost::noncopyable, protected WithContext {
 ...
 public:
  ...
  ExpressionActionsPtr getActions(bool add_aliases, bool remove_unused_result = true,
  ...
  void makeWindowDescriptionFromAST(const Context &context, const WindowDescriptions &existing_descriptions,
 ...
 protected:
  ExpressionAnalyzer(const ASTPtr &query_, const TreeRewriterResultPtr &syntax_analyzer_result_, ContextPtr context_,
                     size_t subquery_depth_, bool do_global_, bool is_explain_, PreparedSetsPtr prepared_sets_,
  ...
  AggregationKeysInfo getAggregationKeysInfo() const noexcept { return {aggregation_keys, aggregation_keys_indexes_list, group_by_kind}; }
};
...
struct ExpressionAnalysisResult {
  ...
  ExpressionAnalysisResult(SelectQueryExpressionAnalyzer &query_analyzer, const StorageMetadataPtr &metadata_snapshot, bool first_stage,
                           bool second_stage, bool only_types, const FilterDAGInfoPtr &row_policy_info,
  ...
  void finalize(const ExpressionActionsChain &chain, ssize_t &prewhere_step_num, ssize_t &where_step_num, ssize_t &having_step_num,
...
class SelectQueryExpressionAnalyzer : public ExpressionAnalyzer {
 public:
  ...
  SelectQueryExpressionAnalyzer(const ASTPtr &query_, const TreeRewriterResultPtr &syntax_analyzer_result_, ContextPtr context_,
                                const StorageMetadataPtr &metadata_snapshot_, const Names &required_result_columns_ = {},
                                bool do_global_ = false, const SelectQueryOptions &options_ = {}, PreparedSetsPtr prepared_sets_ = nullptr)
      : ExpressionAnalyzer(query_, syntax_analyzer_result_, context_, options_.subquery_depth, do_global_, options_.is_explain,
                           prepared_sets_, options_.is_create_parameterized_view),
 ...
 private:
  ...
  JoinPtr makeJoin(const ASTTablesInSelectQueryElement &join_element, const ColumnsWithTypeAndName &left_columns,
  ...
  /// Before aggregation:
  std::optional<ArrayJoin> appendArrayJoin(ExpressionActionsChain &chain, ActionsAndProjectInputsFlagPtr &before_array_join,
                                           bool only_types);
  ...
  ///  appendSelect
  ActionsAndProjectInputsFlagPtr appendOrderBy(ExpressionActionsChain &chain, bool only_types, bool optimize_read_in_order,
