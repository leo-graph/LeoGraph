...
void collectCrashLog(Int32 signal, Int32 signal_code, UInt64 thread_id, const String &query_id, const String &query,
                     const StackTrace &stack_trace, std::optional<UInt64> fault_address, const String &fault_access_type,
                     const String &signal_description, const FramePointers &current_exception_trace, size_t current_exception_trace_size);
...
class CrashLog : public SystemLog<CrashLogElement> {
  ...
  friend void ::collectCrashLog(Int32, Int32, UInt64, const String &, const String &, const StackTrace &, std::optional<UInt64>,
                                const String &, const String &, const FramePointers &, size_t);

  static std::weak_ptr<CrashLog> crash_log;

 public:
  static void initialize(std::shared_ptr<CrashLog> crash_log_) { crash_log = crash_log_; }
