...
struct RowRef {
  ...
  RowRef() = default;
  RowRef(const ColumnsInfo *columns_, size_t row_num_) : columns_info(columns_), row_num(static_cast<SizeT>(row_num_)) {}
};
...
struct RowRefList : RowRef {
  ...
  RowRefList(const ColumnsInfo *columns_, size_t row_start_, size_t rows_)
      : RowRef(columns_, row_start_), rows(static_cast<SizeT>(rows_)) {}
