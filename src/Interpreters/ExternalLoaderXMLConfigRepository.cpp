...
ExternalLoaderXMLConfigRepository::ExternalLoaderXMLConfigRepository(const std::string& app_path_, const std::string& main_config_path_,
                                                                     const std::unordered_set<std::string>& patterns_)
    : app_path(app_path_), main_config_path(main_config_path_), patterns(patterns_) {}
...
Poco::AutoPtr<Poco::Util::AbstractConfiguration> ExternalLoaderXMLConfigRepository::load(const std::string& config_file_path) {
