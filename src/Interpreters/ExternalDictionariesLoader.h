...
class ExternalDictionariesLoader : public ExternalLoader, WithContext {
 public:
  ...
  static DictionaryStructure getDictionaryStructure(const Poco::Util::AbstractConfiguration& config,
                                                    const std::string& key_in_config = "dictionary");
 ...
 protected:
  ...
  bool doesConfigChangeRequiresReloadingObject(const Poco::Util::AbstractConfiguration& old_config, const String& old_key_in_config,
                                               ...
                                               const String& new_key_in_config) const override;

  void updateObjectFromConfigWithoutReloading(IExternalLoadable& object, const Poco::Util::AbstractConfiguration& config,
                                              const String& key_in_config) const override;
