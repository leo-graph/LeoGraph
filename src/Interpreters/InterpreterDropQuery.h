...
class InterpreterDropQuery : public IInterpreter, WithMutableContext {
 ...
 private:
  ...
  BlockIO executeToDictionary(const String& database_name, const String& dictionary_name, ASTDropQuery::Kind kind, bool if_exists,
                              bool is_temporary, bool no_ddl_lock);
