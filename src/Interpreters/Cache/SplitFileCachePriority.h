...
class SplitFileCachePriority : public IFileCachePriority {
 public:
  class SplitIterator;
  using CachePriorityCreatorFunction = std::function<IFileCachePriorityPtr(size_t max_size, size_t max_elements, double size_ratio,
                                                                           size_t overcommit_eviction_evict_step, String description)>;
  ...
  SplitFileCachePriority(CachePriorityCreatorFunction creator_function, size_t max_size_, size_t max_elements_, double size_ratio,
                         double system_segment_size_ratio_, const std::string &description_ = "none");
  ...
  void iterate(IterateFunc func, FileCacheReserveStat &stat, const CachePriorityGuard::ReadLock &lock) override;
