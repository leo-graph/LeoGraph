...
class InterpreterSelectWithUnionQuery : public IInterpreterUnionOrSelectQuery {
 public:
  ...
  InterpreterSelectWithUnionQuery(const ASTPtr &query_ptr_, ContextPtr context_, const SelectQueryOptions &,
                                  const Names &required_result_column_names = {});

  InterpreterSelectWithUnionQuery(const ASTPtr &query_ptr_, ContextMutablePtr context_, const SelectQueryOptions &,
                                  const Names &required_result_column_names = {});
  ...
  static SharedHeader getSampleBlock(const ASTPtr &query_ptr_, ContextPtr context_, bool is_subquery = false,
