...
class DDLWorker {
 public:
  DDLWorker(int pool_size_, const std::string& zk_queue_dir, const std::string& zk_replicas_dir, ContextPtr context_,
  ...
  std::string getCommonHostID() const { return host_fqdn_id; }

  std::string getQueueDir() const { return queue_dir; }
 ...
 protected:
  ...
  bool tryExecuteQueryOnSingleReplica(DDLTaskBase& task, StoragePtr storage, const String& node_path, const ZooKeeperPtr& zookeeper,
