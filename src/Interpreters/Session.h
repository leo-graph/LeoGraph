...
class Session {
 public:
  ...
  /// `external_roles_` names of the additional roles (over what is granted via local access control mechanisms) that would be granted to
  /// user during this session. Role is not granted if it can't be found by name via AccessControl (i.e. doesn't exist on this instance).
