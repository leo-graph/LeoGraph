...
struct ZooKeeperLogElement {
  enum Type { UNKNOWN = 0, REQUEST = 1, RESPONSE = 2, FINALIZE = 3 };
...
class ZooKeeperLog : public SystemLog<ZooKeeperLogElement> {
 ...
 public:
  void setDurationMicrosecondsThreshold(size_t duration_microseconds_threshold_) {
    duration_microseconds_threshold = duration_microseconds_threshold_;
  }
