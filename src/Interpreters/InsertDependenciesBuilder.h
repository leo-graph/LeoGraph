...
class InsertDependenciesBuilder : public std::enable_shared_from_this<InsertDependenciesBuilder> {
 private:
  ...
  using StorageIDSet = std::unordered_set<StorageIDMaybeEmpty, StorageID::DatabaseAndTableNameHash, StorageID::DatabaseAndTableNameEqual>;
  ...
  using MapIdManyId = std::unordered_map<StorageIDMaybeEmpty, std::vector<StorageID>, StorageID::DatabaseAndTableNameHash,
                                         StorageID::DatabaseAndTableNameEqual>;
  using MapIdId = std::unordered_map<StorageIDMaybeEmpty, StorageIDMaybeEmpty, StorageID::DatabaseAndTableNameHash,
                                     StorageID::DatabaseAndTableNameEqual>;
  using MapIdStorage =
      std::unordered_map<StorageIDMaybeEmpty, StoragePtr, StorageID::DatabaseAndTableNameHash, StorageID::DatabaseAndTableNameEqual>;
  using MapIdMetadata = std::unordered_map<StorageIDMaybeEmpty, StorageMetadataPtr, StorageID::DatabaseAndTableNameHash,
                                           StorageID::DatabaseAndTableNameEqual>;

  using MapIdAST =
      std::unordered_map<StorageIDMaybeEmpty, ASTPtr, StorageID::DatabaseAndTableNameHash, StorageID::DatabaseAndTableNameEqual>;
  using MapIdLock =
      std::unordered_map<StorageIDMaybeEmpty, TableLockHolder, StorageID::DatabaseAndTableNameHash, StorageID::DatabaseAndTableNameEqual>;
  using MapIdContext =
  ...
  using MapIdThreadGroup =
      std::unordered_map<StorageIDMaybeEmpty, ThreadGroupPtr, StorageID::DatabaseAndTableNameHash, StorageID::DatabaseAndTableNameEqual>;
  using MapIdViewType = std::unordered_map<StorageIDMaybeEmpty, QueryViewsLogElement::ViewType, StorageID::DatabaseAndTableNameHash,
                                           StorageID::DatabaseAndTableNameEqual>;
 ...
 public:
  ...
  size_t getSinkStreamSize() const { return sink_stream_size; }

 protected:
  InsertDependenciesBuilder(StoragePtr table, ASTPtr query, SharedHeader insert_header, bool async_insert_, bool skip_destination_table_,
                            size_t max_insert_threads, ContextPtr context);
 ...
 private:
  ...
  /// When the insertion is made into a regular table (it is init_table_id), the root_view is {} / StorageID::createEmpty() and
  /// dependent_views contains init_table_id.
  ...
  using SquashingProcessorsMap = std::unordered_map<StorageIDMaybeEmpty, std::vector<std::list<ProcessorPtr>::const_iterator>,
                                                    StorageID::DatabaseAndTableNameHash, StorageID::DatabaseAndTableNameEqual>;
