...
struct UnlinkFileOperation final : public IMetadataOperation {
  UnlinkFileOperation(std::string path_, bool if_exists_, bool should_remove_objects_, const std::string& compatible_key_prefix_,
...
struct RemoveRecursiveOperation final : public IMetadataOperation {
  RemoveRecursiveOperation(std::string path_, IMetadataTransaction::ShouldRemoveObjectsPredicate should_remove_objects_,
...
struct RewriteFileOperation final : public IMetadataOperation {
  RewriteFileOperation(std::string path_, StoredObjects objects_, const std::string& compatible_key_prefix_, IDisk& disk_,
                       StoredObjects& objects_to_remove_);
