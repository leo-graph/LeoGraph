...
class S3ObjectStorage : public IObjectStorage {
 ...
 private:
  ...
  S3ObjectStorage(
      const char* logger_name, std::unique_ptr<S3::Client>&& client_, std::unique_ptr<S3Settings>&& s3_settings_, S3::URI uri_,
      const S3Capabilities& s3_capabilities_, ObjectStorageKeyGeneratorPtr key_generator_, const String& disk_name_,
