...
ObjectStoragePtr ObjectStorageRouter::takePointingTo(const Location& location) const { return object_storages.at(location); }

std::unordered_map<Location, ObjectStoragePtr> ObjectStorageRouter::getRegistry() const { return object_storages; }
