...
class StoragePolicy : public IStoragePolicy {
 public:
  ...
  StoragePolicy(StoragePolicyPtr storage_policy, const Poco::Util::AbstractConfiguration& config, const String& config_prefix,
...
class StoragePolicySelector {
 public:
  ...
  StoragePolicySelectorPtr updateFromConfig(const Poco::Util::AbstractConfiguration& config, const String& config_prefix,
                                            DiskSelectorPtr disks, Strings& new_disks) const;
