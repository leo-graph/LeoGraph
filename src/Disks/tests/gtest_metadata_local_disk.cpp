...
class MetadataLocalDiskTest : public testing::Test {
 public:
  void SetUp() override { DB::ServerUUID::setRandomForUnitTests(); }
  ...
  std::shared_ptr<DB::IMetadataStorage> getMetadataStorage(const std::string& path) {
    ...
    if (!active_metadatas[path]) active_metadatas[path] = createMetadataStorage(path);
  ...
  void TearDown() override {
    for (const auto& [path, metadata] : active_metadatas) metadata->shutdown();

    for (const auto& [_, disk] : active_disks) fs::remove_all(disk->getPath());
  }
...
TEST_F(MetadataLocalDiskTest, TestHardlinkRewrite) {
...

  {
    ...
    transaction->createMetadataFile("original_file",
  ...
  {
    auto transaction = metadata->createTransaction();
    transaction->createMetadataFile("hardlinked_file",
...
TEST_F(MetadataLocalDiskTest, TestValidAddBlob) {
...

  {
    ...
    transaction->addBlobToMetadata(
        "f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidAddBlob", "hello").serialize(), "f.txt", 1000));
...

  {
    ...
    transaction->addBlobToMetadata(
        "f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidAddBlob", "goodbye").serialize(), "f.txt", 300));
    transaction->addBlobToMetadata("f.txt",
                                   DB::StoredObject(DB::ObjectStorageKey::createAsAbsolute("everybody").serialize(), "f.txt", 400));
    transaction->commit(DB::NoCommitOptions{});
  }
...

  {
    ...
    transaction->addBlobToMetadata(
        "f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidAddBlob", "I've").serialize(), "f.txt", 500));
    transaction->addBlobToMetadata(
        "f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidAddBlob", "got").serialize(), "f.txt", 600));
    transaction->addBlobToMetadata(
        "f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidAddBlob", "to go").serialize(), "f.txt", 700));

    transaction->addBlobToMetadata(
        "fff.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidAddBlob", "goodbye").serialize(), "fff.txt", 700));
    transaction->addBlobToMetadata(
        "fff.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidAddBlob", "everybody").serialize(), "fff.txt", 800));
...
TEST_F(MetadataLocalDiskTest, TestValidCreateMetadataAddBlob) {
...

  {
    ...
    transaction->createMetadataFile(
        "tmp_part/f.txt.tmp",
        {DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidCreateMetadataAddBlob", "hello").serialize(),
                          "tmp_part/f.txt.tmp", 1000)});
    transaction->moveFile("tmp_part/f.txt.tmp", "tmp_part/f.txt");
    transaction->moveDirectory("tmp_part", "part");
    transaction->addBlobToMetadata(
        "part/f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidCreateMetadataAddBlob", "world").serialize(),
                                       "part/f.txt", 2000));
    transaction->commit(DB::NoCommitOptions{});
  }

  {
    ...
    transaction->addBlobToMetadata(
        "part/f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidCreateMetadataAddBlob", "goodbye").serialize(),
                                       "part/f.txt", 300));
    transaction->commit(DB::NoCommitOptions{});
  }

  {
    ...
    transaction->addBlobToMetadata(
        "part/f.txt", DB::StoredObject(DB::ObjectStorageKey::createAsRelative("/TestValidCreateMetadataAddBlob", "everybody").serialize(),
                                       "part/f.txt", 400));
    transaction->commit(DB::NoCommitOptions{});
  }
...
TEST_F(MetadataLocalDiskTest, TestValidComplexOperationsMutatePartWithProjections) {
  ...
  transaction->createHardLink("data/database/table/all_0_0_0/someprojection.proj/columns.txt",
                              "data/database/table/all_0_0_0_5/someprojection.proj/columns.txt");
  transaction->createHardLink("data/database/table/all_0_0_0/someprojection.proj/primary.idx",
                              "data/database/table/all_0_0_0_5/someprojection.proj/primary.idx");
...
TEST_F(MetadataLocalDiskTest, TestValidComplexOperationsMutatePartWithProjectionsWithTmp) {
  ...
  transaction->createHardLink("data/database/table/all_0_0_0/someprojection.proj/columns.txt",
                              "data/database/table/tmp_all_0_0_0_5/someprojection.proj/columns.txt");
  transaction->createHardLink("data/database/table/all_0_0_0/someprojection.proj/primary.idx",
                              "data/database/table/tmp_all_0_0_0_5/someprojection.proj/primary.idx");
...
TEST_F(MetadataLocalDiskTest, ManyMetadataTx) {
  ...
  for (int i = 0; i < 1000; ++i) {
    ...
    transaction->createHardLink("data/database/table/all_0_0_0/someprojection.proj/columns.txt",
                                tmp_dir + "/someprojection.proj/columns.txt");
    transaction->createHardLink("data/database/table/all_0_0_0/someprojection.proj/primary.idx",
                                tmp_dir + "/someprojection.proj/primary.idx");
  ...
  for (auto& transaction : transactions) transaction->commit(DB::NoCommitOptions{});
...
TEST_F(MetadataLocalDiskTest, TestValidComplexOperationsRemovePartOrdinary) {
  ...
  transaction->unlinkFile("data/database/table/all_0_0_0/someprojection.proj/primary.idx", /*if_exists=*/false,
                          /*should_remove_objects=*/true);
  transaction->unlinkFile("data/database/table/all_0_0_0/someprojection.proj/columns.txt", /*if_exists=*/false,
                          /*should_remove_objects=*/true);
    ...
    EXPECT_THROW(
        {
          transaction->createMetadataFile(
              ...
              {DB::StoredObject(DB::ObjectStorageKey::createAsAbsolute("blob_name").serialize(), "non-existing/file.txt", 42)});
          transaction->commit(DB::NoCommitOptions{});
        },
        std::exception);
  }
