...
DiskPtr DiskFactory::create(const String& name, const Poco::Util::AbstractConfiguration& config, const String& config_prefix,
...
void DiskFactory::clearRegistry() { registry.clear(); }
}  // namespace DB
