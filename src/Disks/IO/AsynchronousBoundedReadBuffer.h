...
class AsynchronousBoundedReadBuffer : public ReadBufferFromFileBase {
 public:
  ...
  explicit AsynchronousBoundedReadBuffer(ImplPtr impl_, IAsynchronousReader& reader_, const ReadSettings& settings_, size_t buffer_size_,
                                         size_t min_bytes_for_seek_, AsyncReadCountersPtr async_read_counters_ = nullptr,
