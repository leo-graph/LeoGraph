...
class XDBCDictionarySource final : public IDictionarySource, WithContext {
 public:
  ...
  XDBCDictionarySource(const DictionaryStructure &dict_struct_, const Configuration &configuration_, const Block &sample_block_,
                       ContextPtr context_, BridgeHelperPtr bridge);
