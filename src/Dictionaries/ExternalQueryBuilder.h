...
struct ExternalQueryBuilder {
  ...
  ExternalQueryBuilder(const DictionaryStructure &dict_struct_, const std::string &db_, const std::string &schema_,
  ...
  std::string composeLoadKeysQuery(const Columns &key_columns, const VectorWithMemoryTracking<size_t> &requested_rows,
                                   LoadKeysMethod method, size_t partition_key_prefix = 0) const;
 ...
 protected:
  ...
  void composeInWithTuples(const Columns &key_columns, const VectorWithMemoryTracking<size_t> &requested_rows, WriteBuffer &out, size_t beg,
                           size_t end) const;
  ...
  void composeKeysCondition(const Columns &key_columns, const VectorWithMemoryTracking<size_t> &requested_rows, LoadKeysMethod method,
                            size_t partition_key_prefix, WriteBuffer &out) const;
