...
class HashedArrayDictionary final : public IDictionary {
  using DictionaryParallelLoaderType =
      HashedDictionaryImpl::HashedDictionaryParallelLoader<dictionary_key_type, HashedArrayDictionary<dictionary_key_type, sharded>>;
  friend class HashedDictionaryImpl::HashedDictionaryParallelLoader<dictionary_key_type,
                                                                    HashedArrayDictionary<dictionary_key_type, sharded>>;

 public:
  using KeyType = std::conditional_t<dictionary_key_type == DictionaryKeyType::Simple, UInt64, std::string_view>;

  HashedArrayDictionary(const StorageID& dict_id_, const DictionaryStructure& dict_struct_, DictionarySourcePtr source_ptr_,
                        const HashedArrayDictionaryStorageConfiguration& configuration_, BlockPtr update_field_loaded_block_ = nullptr);
  ...
  std::shared_ptr<IExternalLoadable> clone() const override {
    return std::make_shared<HashedArrayDictionary<dictionary_key_type, sharded>>(getDictionaryID(), dict_struct, source_ptr->clone(),
  ...
  Columns getColumns(const Strings& attribute_names, const DataTypes& attribute_types, const Columns& key_columns,
                     const DataTypes& key_types, DefaultsOrFilter defaults_or_filter) const override;
 ...
 private:
  using KeyContainerType = std::conditional_t<dictionary_key_type == DictionaryKeyType::Simple, HashMap<UInt64, size_t>,
  ...
  struct Attribute final {
    std::variant<AttributeContainerShardsType<UInt8>, AttributeContainerShardsType<UInt16>, AttributeContainerShardsType<UInt32>,
                 AttributeContainerShardsType<UInt64>, AttributeContainerShardsType<UInt128>, AttributeContainerShardsType<UInt256>,
                 AttributeContainerShardsType<Int8>, AttributeContainerShardsType<Int16>, AttributeContainerShardsType<Int32>,
                 AttributeContainerShardsType<Int64>, AttributeContainerShardsType<Int128>, AttributeContainerShardsType<Int256>,
                 AttributeContainerShardsType<Decimal32>, AttributeContainerShardsType<Decimal64>, AttributeContainerShardsType<Decimal128>,
                 AttributeContainerShardsType<Decimal256>, AttributeContainerShardsType<DateTime64>, AttributeContainerShardsType<Float32>,
                 AttributeContainerShardsType<Float64>, AttributeContainerShardsType<UUID>, AttributeContainerShardsType<IPv4>,
                 AttributeContainerShardsType<IPv6>, AttributeContainerShardsType<std::string_view>, AttributeContainerShardsType<Array>>
        containers;
  ...
  ColumnPtr getAttributeColumn(const Attribute& attribute, const DictionaryAttribute& dictionary_attribute, size_t keys_size,
                               DefaultOrFilter default_or_filter, KeysProvider&& keys_object) const;
  ...
  template <typename AttributeType, bool is_nullable, typename ValueSetter, typename DefaultValueExtractor>
  void getItemsImpl(const Attribute& attribute, const KeyIndexToElementIndex& key_index_to_element_index, ValueSetter&& set_value,
                    DefaultValueExtractor& default_value_extractor) const;

  template <typename AttributeType, bool is_nullable, typename ValueSetter>
  void getItemsShortCircuitImpl(const Attribute& attribute, const KeyIndexToElementIndex& key_index_to_element_index,
                                ValueSetter&& set_value, IColumn::Filter& default_mask [[maybe_unused]]) const;
