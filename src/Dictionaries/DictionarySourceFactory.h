...
class DictionarySourceFactory : private boost::noncopyable {
 public:
  ...
  using Creator = std::function<DictionarySourcePtr(const String& name, const DictionaryStructure& dict_struct,
  ...
  DictionarySourcePtr create(const std::string& name, const Poco::Util::AbstractConfiguration& config, const std::string& config_prefix,
                             const DictionaryStructure& dict_struct, ContextPtr global_context, const std::string& default_database,
