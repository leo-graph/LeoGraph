...
class Keeper : public BaseDaemon, public IServer {
 public:
  ...
  ContextMutablePtr context() const override { throw Exception(ErrorCodes::LOGICAL_ERROR, "Cannot fetch context for Keeper"); }
 ...
 private:
  Poco::Net::SocketAddress socketBindListen(Poco::Net::ServerSocket& socket, const std::string& host, UInt16 port,
